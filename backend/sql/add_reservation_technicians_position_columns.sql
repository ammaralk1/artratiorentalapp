...
ALTER TABLE reservation_technicians
  ADD COLUMN position_id INT UNSIGNED NULL AFTER role,
  ADD COLUMN position_key VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER position_id,
  ADD COLUMN position_name VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER position_key,
  ADD COLUMN position_label_ar VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER position_name,
  ADD COLUMN position_label_en VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL AFTER position_label_ar,
