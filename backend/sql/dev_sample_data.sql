...
INSERT INTO projects (project_code, title, type, client_id, client_company, description, start_datetime, end_datetime, apply_tax, payment_status, equipment_estimate, expenses_total, tax_amount, total_with_tax, confirmed) VALUES
('PRJ-0001', 'حفل إطلاق منتج', 'Event', 1, 'الأفق الإعلامية', 'تنظيم وإضاءة حفل إطلاق منتج جديد', '2025-09-20 18:00:00', '2025-09-21 02:00:00', 1, 'in_progress', 35000, 5000, 1750, 41750, 1);
