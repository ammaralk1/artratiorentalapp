import{r as _,t as s,e as q,l as A,k as I,g as L,h as C,p as H,a as X,K as G}from"./calculations.C8eyJRj0.js";import"./reservationsService.BZLG_R6A.js";import"./auth.Bccf-xsM.js";import"./technicians.BROQVNHZ.js";const B=`@page { size: A4; margin: 0; }
...
`)],{type:"text/csv;charset=utf-8"}),f=URL.createObjectURL(b),r=document.createElement("a");r.href=f,r.download=`${s("reservations.reports.export.filePrefix","تقرير-الحجوزات","reservations-report")}.csv`,r.style.display="none",document.body.appendChild(r),r.click(),setTimeout(()=>{URL.revokeObjectURL(f),r.remove()},1500)}}const oe="https://assets.art-ratio.com/AR-Logo-v3.5-curved.png";function M(){try{const t=localStorage.getItem("reportsPdf.logoUrl");if(t&&/^https?:|^data:|^blob:/.test(t))return t}catch{}return oe}export{O as buildA4ReportPages,me as exportA4ReportCsv,ce as exportA4ReportExcel,de as exportA4ReportPdf};
