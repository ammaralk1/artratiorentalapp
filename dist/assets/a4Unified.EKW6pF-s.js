import{r as C,t as a,e as I,d as T,b as _,p as M}from"./calculations.BlsvwTLx.js";import{e as H,l as F,a as X,b as q}from"./reports.BimlG5kI.js";import"./reservationsService.DwVbVNH4.js";import"./auth.D09_E0J1.js";import"./dashboard.BpCZvySk.js";import"./controller.CIwgBb3g.js";/* empty css              */import"./dashboardShell.BTjbDc9Z.js";import"./customers.Cpz8J_vg.js";import"./maintenanceService.DLPgwUA9.js";const B=`@page { size: A4; margin: 0; }
...
`)],{type:"text/csv;charset=utf-8"}),w=URL.createObjectURL(g),r=document.createElement("a");r.href=w,r.download=`${a("reservations.reports.export.filePrefix","تقرير-الحجوزات","reservations-report")}.csv`,r.style.display="none",document.body.appendChild(r),r.click(),setTimeout(()=>{URL.revokeObjectURL(w),r.remove()},1500)}}const oe="https://art-ratio.sirv.com/AR-Logo-v3.5-curved.png";function U(){try{const t=localStorage.getItem("reportsPdf.logoUrl");if(t&&/^https?:|^data:|^blob:/.test(t))return t}catch{}return oe}export{A as buildA4ReportPages,be as exportA4ReportCsv,ge as exportA4ReportExcel,fe as exportA4ReportPdf};
