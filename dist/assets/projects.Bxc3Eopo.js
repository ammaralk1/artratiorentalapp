import{s as da,f as ua,e as _t,u as ft,j as M,t as n,d as Bt,n as j,q as pa,a as ma,m as fa,c as ha,i as ba,v as At,p as Oe}from"./auth.BFR8Y3ym.js";import{i as ya}from"./dashboardShell.BAk5SsJR.js";import{d as b,r as we,a as De,u as Fe,s as $,b as va,f as ht,h as ga,i as ja,j as o,k as P,l as xa,m as bt,n as Sa,o as $t,e as rt,p as Nt,q as wa,t as Ta,v as Pa,w as Aa,g as $a,c as Na,x as Ea,y as Ht,z as Ca,A as ka,B as La,C as Da,D as Fa,E as Ia,F as Ma,G as Ra,H as _a,I as Ba,J as Ha,K as Ue,L as qa,M as qt,N as Va,O as Oa}from"./form.D9tQ5toC.js";import"./customers.Shj-Fh8v.js";import"./state.uepyuVVl.js";import{e as Ua,r as za}from"./controller.IS28vYjb.js";import{e as Vt}from"./reservationsActions.lKCqMmGa.js";import{updateProjectApi as Ot,getProjectsState as yt,isApiError as ze,buildProjectPayload as Wa,refreshProjectsFromApi as Ut,ensureProjectsLoaded as Ka}from"./projectsService.Cwss6WRR.js";import{P as vt,a as gt,b as Et,c as He,s as Ga,d as ot,e as it}from"./constants.ahksS1fi.js";import{g as jt,f as Ja,c as qe,d as ct,e as zt,D as lt,r as Ya}from"./reservationsService.CQfVwYeY.js";import{g as Xa,w as Qa}from"./uiBridge.Dv6JMAlF.js";import{c as Za}from"./calculations.DEalIgcD.js";import"./details.D8A8CH_k.js";import"./equipment.Dy1tRg0o.js";import"./quotePdf.C2lQPEPC.js";import"./canvasColorUtils.CviLtv6S.js";let Ct=null;function en(e){e&&Wt()!==e&&ft({[vt]:e}).catch(t=>{console.warn("⚠️ [projects] Failed to persist projects main tab preference",t)})}function Wt(){return _t()?.[vt]||""}function Kt(e){e&&dt()!==e&&ft({[gt]:e}).catch(t=>{console.warn("⚠️ [projects] Failed to persist projects sub-tab preference",t)})}function dt(){return _t()?.[gt]||""}function tn(e){if(!e)return"";const t=e.trim();return t?Object.values(Et).includes(t)?t:Et[t]||"":""}function an(){if(typeof window>"u")return"";try{const t=new URLSearchParams(window.location.search||"").get("subTab");if(t){const a=tn(t);if(a)return a}}catch{}return""}function Gt(e,t){!e||!b.tabPanes||!b.tabButtons||(b.tabButtons.forEach(a=>{const s=a===t;a.classList.toggle("active",s),a.classList.contains("tab-button")&&a.classList.toggle("tab-active",s)}),b.tabPanes.forEach(a=>{a.dataset.tabPane===e?a.classList.remove("d-none"):a.classList.add("d-none")}),t&&en(e))}function nn(){if(!b.tabButtons||!b.tabButtons.length)return;b.tabButtons.forEach(a=>{a.dataset.tabListenerAttached!=="true"&&(a.addEventListener("click",s=>{s.preventDefault();const r=a.dataset.tabTarget;r&&(Gt(r,a),r==="projects-section"&&($.filters.search="",b.search&&(b.search.value=""),we(),De(),Fe()))}),a.dataset.tabListenerAttached="true")});const e=Wt(),t=e&&b.tabButtons.find(a=>a.dataset.tabTarget===e);t&&t.click()}function xt(e,t){!e||!b.projectSubTabButtons||!b.projectSubTabPanes||(b.projectSubTabButtons.forEach(a=>{const s=a===t;a.classList.toggle("active",s),a.classList.contains("tab")&&a.classList.toggle("tab-active",s)}),b.projectSubTabPanes.forEach(a=>{a.dataset.projectSubtab===e?a.classList.remove("d-none"):a.classList.add("d-none")}))}function sn(){!b.projectSubTabButtons||!b.projectSubTabButtons.length||(b.projectSubTabButtons.forEach(e=>{e.dataset.tabListenerAttached!=="true"&&(e.addEventListener("click",t=>{t.preventDefault();const a=e.dataset.projectSubtabTarget;a&&(xt(a,e),Kt(a))}),e.dataset.tabListenerAttached="true")}),rn())}function rn(){const t=an()||dt();if(!t)return;const a=b.projectSubTabButtons?.[0],s=b.projectSubTabButtons?.find(l=>l.dataset.projectSubtabTarget===t)||a,r=s?.dataset.projectSubtabTarget;r&&(t!==dt()&&Kt(r),xt(r,s))}function on(){return b.tabButtons?b.tabButtons.find(t=>t.classList.contains("active"))?.dataset.tabTarget==="projects-section":!1}function kt(e={}){if(e){if(b.tabButtons&&b.tabButtons.length){const a=b.tabButtons.find(r=>r.classList.contains("active"))?.dataset.tabTarget||"",s=e[vt];if(s&&s!==a){const r=b.tabButtons.find(l=>l.dataset.tabTarget===s);r&&Gt(s,r)}}if(b.projectSubTabButtons&&b.projectSubTabButtons.length&&on()){const a=b.projectSubTabButtons.find(r=>r.classList.contains("active"))?.dataset.projectSubtabTarget||"",s=e[gt];if(s&&s!==a){const r=b.projectSubTabButtons.find(l=>l.dataset.projectSubtabTarget===s);r&&xt(s,r)}}}}function cn(){Ct||(Ct=da(e=>{kt(e)})),ua().then(e=>{kt(e)}).catch(e=>{console.warn("⚠️ [projects] Failed to synchronise project preferences",e)})}function ge(e){const t=$.projects.find(w=>String(w.id)===String(e));if(!t||!b.detailsBody)return;b.detailsBody.dataset.mode="view",b.detailsBody.dataset.projectId=String(t.id);const s=($.customers.length?$.customers:Bt().customers||[]).find(w=>String(w.id)===String(t.clientId)),r=Qt(t.type),i=t.description?.trim()||n("projects.fallback.noDescription","لا يوجد وصف"),u=s?.customerName||n("projects.fallback.unknownClient","عميل غير معروف"),c=s?.phone??s?.customerPhone??t.clientPhone??t.customerPhone??"",f=c?j(String(c).trim()):n("projects.details.client.noPhone","لا يوجد رقم متاح"),d=s?.email??t.clientEmail??t.customerEmail??"",y=d?String(d).trim():n("projects.details.client.noEmail","لا يوجد بريد متاح"),x=(t.clientCompany||s?.companyName||"").trim(),z=t.projectCode||`PRJ-${j(String(t.id))}`,N=j(z),R=ht(t.id),_=R.reduce((w,D)=>w+Zt(D),0),B=Number(_.toFixed(2)),k=R.length,{subtotal:re,applyTax:J,expensesTotal:oe}=ga(t),te=Number(t?.servicesClientPrice??t?.services_client_price??0),Te=re,Ke=J?Number(((Te+B)*He).toFixed(2)):0,Ge=Number((Te+B+Ke).toFixed(2)),Pe=ja(t),ye=t?.cancelled===!0||t?.status==="cancelled"||t?.status==="canceled"?"cancelled":Pe,me=n(`projects.status.${ye}`,Ga[ye]||ye),Ae=(()=>{try{const w=t.start?new Date(t.start):null,D=t.end?new Date(t.end):w?new Date(w.getTime()+3600*1e3):null;return!w||!D||Number.isNaN(w.getTime())||Number.isNaN(D.getTime())?!1:$.projects.some(F=>{if(!F||String(F.id)===String(t.id))return!1;const H=F.start?new Date(F.start):null,I=F.end?new Date(F.end):H?new Date(H.getTime()+3600*1e3):null;if(!H||!I||Number.isNaN(H.getTime())||Number.isNaN(I.getTime()))return!1;const U=Math.max(w.getTime(),H.getTime()),de=Math.min(D.getTime(),I.getTime());return U<de})}catch{return!1}})()&&(ye==="upcoming"||ye==="ongoing")?"conflict":ye,Je={upcoming:"قادم",ongoing:"قيد التنفيذ",completed:"مكتمل",conflict:"تعارض"}[Ae]||me,ae={upcoming:"timeline-status-badge timeline-status-badge--upcoming",ongoing:"timeline-status-badge timeline-status-badge--ongoing",completed:"timeline-status-badge timeline-status-badge--completed",conflict:"timeline-status-badge timeline-status-badge--conflict",cancelled:"timeline-status-badge timeline-status-badge--cancelled"}[Ae]||"timeline-status-badge timeline-status-badge--upcoming",Se=typeof t.paymentStatus=="string"?t.paymentStatus.toLowerCase():"",fe=gn(t),Me=fe.length>0,$e=Me?0:Number(t.paidAmount)||0,Ne=Me?0:Number(t.paidPercent)||0;let m=Ge,h,v,g,S,T,E,L,V,Q,G;const Z=yn(fe),Ye=n("projects.focus.confirmed","✅ مشروع مؤكد"),Ee=t.confirmed===!0||t.confirmed==="true"?`<span class="reservation-chip status-confirmed">${o(Ye)}</span>`:"";let C=[];if(k>0){const w=R.reduce((he,le)=>{const ia=Array.isArray(le.items)?le.items:[],Pt=Array.isArray(le.crewAssignments)?le.crewAssignments:[],be=Pt.length?Pt:Array.isArray(le.technicians)?le.technicians:[],ca=Array.isArray(be)&&be.length&&typeof be[0]=="object",la=Array.isArray(be)&&be.length&&typeof be[0]!="object",st=Ja({items:ia,technicianIds:la?be:[],crewAssignments:ca?be:[],discount:le.discount??0,discountType:le.discountType||"percent",applyTax:!1,start:le.start,end:le.end,companySharePercent:null});return he.equipment+=Number(st.equipmentTotal||0),he.crew+=Number(st.crewTotal||0),he.crewCost+=Number(st.crewCostTotal||0),he},{equipment:0,crew:0,crewCost:0}),D=Number(oe||0),F=Number((w.equipment+w.crew+te).toFixed(2)),H=Number.parseFloat(t?.discount??t?.discountValue??0)||0;let U=(t?.discountType==="amount"?"amount":"percent")==="amount"?H:F*(H/100);(!Number.isFinite(U)||U<0)&&(U=0),U>F&&(U=F);const de=J===!0,ce=t?.companyShareEnabled===!0||t?.companyShareEnabled==="true"||t?.company_share_enabled===!0||t?.company_share_enabled==="true",ne=Number.parseFloat(t?.companySharePercent??t?.company_share_percent??t?.companyShare??t?.company_share??0)||0,ve=ce&&ne>0?ne:0,q=Math.max(0,F-U),K=Number((q*(ve/100)).toFixed(2)),O=de?Number(((q+K)*He).toFixed(2)):0,ue=Number((q+K+O).toFixed(2)),pe=Number((ue-K-O-D-w.crewCost).toFixed(2));w.equipment>0&&C.push({icon:"🎛️",label:n("projects.details.summary.equipmentTotal","إجمالي المعدات"),value:P(w.equipment)}),w.crew>0&&C.push({icon:"😎",label:n("projects.details.summary.crewTotal","إجمالي الفريق"),value:P(w.crew)}),w.crewCost>0&&C.push({icon:"🧾",label:n("projects.details.summary.crewCostTotal","تكلفة الفريق"),value:P(w.crewCost)}),te>0&&C.push({icon:"💼",label:n("projects.details.summary.servicesClientPrice","الخدمات الإنتاجية"),value:P(te)}),D>0&&C.push({icon:"🧾",label:n("projects.details.summary.expensesTotal","تكلفة الخدمات الإنتاجية"),value:P(D)}),U>0&&C.push({icon:"🏷️",label:n("projects.details.summary.discount","الخصم"),value:`−${P(U)}`}),C.push({icon:"🧮",label:n("projects.details.summary.grossAfterDiscount","الإجمالي بعد الخصم"),value:P(q)}),K>0&&C.push({icon:"🏦",label:n("projects.details.summary.companyShare","نسبة الشركة"),value:`−${P(K)}`}),O>0&&C.push({icon:"💸",label:n("projects.details.summary.tax","الضريبة (15٪)"),value:`−${P(O)}`}),C.push({icon:"💵",label:n("projects.details.summary.netProfit","صافي الربح"),value:P(pe)}),C.push({icon:"💰",label:n("projects.details.summary.finalTotal","المجموع النهائي"),value:P(ue)}),m=ue}else{const w=Number(oe||0),D=Math.max(0,Number(te)||0),F=Number.parseFloat(t?.discount??t?.discountValue??0)||0;let I=(t?.discountType==="amount"?"amount":"percent")==="amount"?F:D*(F/100);(!Number.isFinite(I)||I<0)&&(I=0),I>D&&(I=D);const U=Math.max(0,D-I),de=J===!0,ce=t?.companyShareEnabled===!0||t?.companyShareEnabled==="true"||t?.company_share_enabled===!0||t?.company_share_enabled==="true",ne=Number.parseFloat(t?.companySharePercent??t?.company_share_percent??t?.companyShare??t?.company_share??0)||0,ve=ce&&ne>0?ne:0,q=Number((U*(ve/100)).toFixed(2)),K=de?Number(((U+q)*He).toFixed(2)):0,O=Number((U+q+K).toFixed(2)),ue=Number((O-q-K-w).toFixed(2));C=[],C.push({icon:"💼",label:n("projects.details.summary.servicesClientPrice","الخدمات الإنتاجية"),value:P(D)}),I>0&&C.push({icon:"🏷️",label:n("projects.details.summary.discount","الخصم"),value:`−${P(I)}`}),C.push({icon:"🧮",label:n("projects.details.summary.grossAfterDiscount","الإجمالي بعد الخصم"),value:P(U)}),q>0&&C.push({icon:"🏦",label:n("projects.details.summary.companyShare","نسبة الشركة"),value:`−${P(q)}`}),K>0&&C.push({icon:"💸",label:n("projects.details.summary.tax","الضريبة (15٪)"),value:`−${P(K)}`}),C.push({icon:"💵",label:n("projects.details.summary.netProfit","صافي الربح"),value:P(ue)}),C.push({icon:"💰",label:n("projects.details.summary.finalTotal","المجموع النهائي"),value:P(O)}),m=O}h=qe({totalAmount:m,paidAmount:$e,paidPercent:Ne,history:fe}),v=ct({manualStatus:Se||"unpaid",paidAmount:h.paidAmount,paidPercent:h.paidPercent,totalAmount:m}),g=n(`projects.paymentStatus.${v}`,v==="paid"?"Paid":v==="partial"?"Partial":"Unpaid"),S=v==="paid"?"status-paid":v==="partial"?"status-partial":"status-unpaid",T=Number.isFinite(Number(h.paidAmount))?Number(h.paidAmount):0,E=Number.isFinite(Number(h.paidPercent))?Number(h.paidPercent):0,L=Math.max(0,Number((m-T).toFixed(2))),V=P(T),Q=`${j(E.toFixed(2))}%`,G=P(L);const Xe=C.map(({icon:w,label:D,value:F})=>`
  ...
  `,tt=k>0?n("projects.details.chips.linkedReservation","مربوط بحجز"):n("projects.details.chips.notLinkedReservation","غير مربوط بحجز"),at=k>0?"reservation-chip status-confirmed":"reservation-chip status-info",ke=[`<span class="${ae}">${o(Je)}</span>`,`<span class="${at}">${o(tt)}</span>`,`<span class="reservation-chip ${S}">${o(g)}</span>`,Ee].filter(Boolean).join("");n("projects.details.expensesTotal","تكلفة الخدمات الإنتاجية"),n("projects.details.reservationsTotal","إجمالي الحجوزات");const Re=n("projects.details.expenses","خدمات إنتاجية ({amount})").replace("{amount}",P(oe)),nt=ln(Array.isArray(t.expenses)?t.expenses:[]);b.detailsBody.innerHTML=`
