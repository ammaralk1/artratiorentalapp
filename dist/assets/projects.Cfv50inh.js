import{s as fa,f as ha,e as qt,u as yt,j as F,t as n,d as Vt,n as j,q as ba,a as ya,m as va,c as ga,i as ja,v as Et,p as We}from"./auth.BFR8Y3ym.js";import{i as xa}from"./dashboardShell.BAk5SsJR.js";import{d as b,r as we,a as Fe,u as Ie,s as $,b as Sa,f as vt,h as wa,i as Ta,j as o,k as P,l as Pa,m as gt,n as Aa,o as Ct,e as ct,p as kt,q as $a,t as Na,v as Ea,w as Ca,g as ka,c as La,x as Da,y as Ot,z as Fa,A as Ia,B as Ma,C as Ra,D as _a,E as Ba,F as Ha,G as qa,H as Va,I as Oa,J as Ua,K as Ke,L as za,M as Ut,N as Wa,O as Ka}from"./form.mx8qzWEv.js";import"./customers.Shj-Fh8v.js";import"./state.uepyuVVl.js";import{e as Ga,r as Ja}from"./controller.GBcB8mrz.js";import{e as zt}from"./reservationsActions.6IHU5WrU.js";import{updateProjectApi as Wt,getProjectsState as jt,isApiError as Ge,buildProjectPayload as Ya,refreshProjectsFromApi as Kt,ensureProjectsLoaded as Xa}from"./projectsService.Cwss6WRR.js";import{P as xt,a as St,b as Lt,c as Oe,s as Qa,d as lt,e as dt}from"./constants.BIgUxBcz.js";import{g as wt,f as Za,c as Ue,d as ut,e as Gt,D as pt,r as en}from"./reservationsService.BLWi30Ug.js";import{g as tn,w as an}from"./uiBridge.Dv6JMAlF.js";import{c as nn}from"./calculations.B5_9wvzn.js";import"./details.CECYHGKK.js";import"./equipment.Dy1tRg0o.js";import"./quotePdf.C2lQPEPC.js";import"./canvasColorUtils.CviLtv6S.js";let Dt=null;function sn(e){e&&Jt()!==e&&yt({[xt]:e}).catch(t=>{console.warn("⚠️ [projects] Failed to persist projects main tab preference",t)})}function Jt(){return qt()?.[xt]||""}function Yt(e){e&&mt()!==e&&yt({[St]:e}).catch(t=>{console.warn("⚠️ [projects] Failed to persist projects sub-tab preference",t)})}function mt(){return qt()?.[St]||""}function rn(e){if(!e)return"";const t=e.trim();return t?Object.values(Lt).includes(t)?t:Lt[t]||"":""}function on(){if(typeof window>"u")return"";try{const t=new URLSearchParams(window.location.search||"").get("subTab");if(t){const a=rn(t);if(a)return a}}catch{}return""}function Xt(e,t){!e||!b.tabPanes||!b.tabButtons||(b.tabButtons.forEach(a=>{const s=a===t;a.classList.toggle("active",s),a.classList.contains("tab-button")&&a.classList.toggle("tab-active",s)}),b.tabPanes.forEach(a=>{a.dataset.tabPane===e?a.classList.remove("d-none"):a.classList.add("d-none")}),t&&sn(e))}function cn(){if(!b.tabButtons||!b.tabButtons.length)return;b.tabButtons.forEach(a=>{a.dataset.tabListenerAttached!=="true"&&(a.addEventListener("click",s=>{s.preventDefault();const r=a.dataset.tabTarget;r&&(Xt(r,a),r==="projects-section"&&($.filters.search="",b.search&&(b.search.value=""),we(),Fe(),Ie()))}),a.dataset.tabListenerAttached="true")});const e=Jt(),t=e&&b.tabButtons.find(a=>a.dataset.tabTarget===e);t&&t.click()}function Tt(e,t){!e||!b.projectSubTabButtons||!b.projectSubTabPanes||(b.projectSubTabButtons.forEach(a=>{const s=a===t;a.classList.toggle("active",s),a.classList.contains("tab")&&a.classList.toggle("tab-active",s)}),b.projectSubTabPanes.forEach(a=>{a.dataset.projectSubtab===e?a.classList.remove("d-none"):a.classList.add("d-none")}))}function ln(){!b.projectSubTabButtons||!b.projectSubTabButtons.length||(b.projectSubTabButtons.forEach(e=>{e.dataset.tabListenerAttached!=="true"&&(e.addEventListener("click",t=>{t.preventDefault();const a=e.dataset.projectSubtabTarget;a&&(Tt(a,e),Yt(a))}),e.dataset.tabListenerAttached="true")}),dn())}function dn(){const t=on()||mt();if(!t)return;const a=b.projectSubTabButtons?.[0],s=b.projectSubTabButtons?.find(l=>l.dataset.projectSubtabTarget===t)||a,r=s?.dataset.projectSubtabTarget;r&&(t!==mt()&&Yt(r),Tt(r,s))}function un(){return b.tabButtons?b.tabButtons.find(t=>t.classList.contains("active"))?.dataset.tabTarget==="projects-section":!1}function Ft(e={}){if(e){if(b.tabButtons&&b.tabButtons.length){const a=b.tabButtons.find(r=>r.classList.contains("active"))?.dataset.tabTarget||"",s=e[xt];if(s&&s!==a){const r=b.tabButtons.find(l=>l.dataset.tabTarget===s);r&&Xt(s,r)}}if(b.projectSubTabButtons&&b.projectSubTabButtons.length&&un()){const a=b.projectSubTabButtons.find(r=>r.classList.contains("active"))?.dataset.projectSubtabTarget||"",s=e[St];if(s&&s!==a){const r=b.projectSubTabButtons.find(l=>l.dataset.projectSubtabTarget===s);r&&Tt(s,r)}}}}function pn(){Dt||(Dt=fa(e=>{Ft(e)})),ha().then(e=>{Ft(e)}).catch(e=>{console.warn("⚠️ [projects] Failed to synchronise project preferences",e)})}function ve(e){const t=$.projects.find(x=>String(x.id)===String(e));if(!t||!b.detailsBody)return;b.detailsBody.dataset.mode="view",b.detailsBody.dataset.projectId=String(t.id);const s=($.customers.length?$.customers:Vt().customers||[]).find(x=>String(x.id)===String(t.clientId)),r=ta(t.type),i=t.description?.trim()||n("projects.fallback.noDescription","لا يوجد وصف"),u=s?.customerName||n("projects.fallback.unknownClient","عميل غير معروف"),c=s?.phone??s?.customerPhone??t.clientPhone??t.customerPhone??"",f=c?j(String(c).trim()):n("projects.details.client.noPhone","لا يوجد رقم متاح"),d=s?.email??t.clientEmail??t.customerEmail??"",y=d?String(d).trim():n("projects.details.client.noEmail","لا يوجد بريد متاح"),S=(t.clientCompany||s?.companyName||"").trim(),O=t.projectCode||`PRJ-${j(String(t.id))}`,N=j(O),I=vt(t.id),M=I.reduce((x,L)=>x+aa(L),0),R=Number(M.toFixed(2)),k=I.length,{subtotal:ce,applyTax:K,expensesTotal:le}=wa(t),se=Number(t?.servicesClientPrice??t?.services_client_price??0),Te=ce,Ye=K?Number(((Te+R)*Oe).toFixed(2)):0,Xe=Number((Te+R+Ye).toFixed(2)),Pe=Ta(t),he=t?.cancelled===!0||t?.status==="cancelled"||t?.status==="canceled"?"cancelled":Pe,ue=n(`projects.status.${he}`,Qa[he]||he),Ae=(()=>{try{const x=t.start?new Date(t.start):null,L=t.end?new Date(t.end):x?new Date(x.getTime()+3600*1e3):null;return!x||!L||Number.isNaN(x.getTime())||Number.isNaN(L.getTime())?!1:$.projects.some(H=>{if(!H||String(H.id)===String(t.id))return!1;const J=H.start?new Date(H.start):null,B=H.end?new Date(H.end):J?new Date(J.getTime()+3600*1e3):null;if(!J||!B||Number.isNaN(J.getTime())||Number.isNaN(B.getTime()))return!1;const q=Math.max(x.getTime(),J.getTime()),U=Math.min(L.getTime(),B.getTime());return q<U})}catch{return!1}})()&&(he==="upcoming"||he==="ongoing")?"conflict":he,Qe={upcoming:"قادم",ongoing:"قيد التنفيذ",completed:"مكتمل",conflict:"تعارض"}[Ae]||ue,re={upcoming:"timeline-status-badge timeline-status-badge--upcoming",ongoing:"timeline-status-badge timeline-status-badge--ongoing",completed:"timeline-status-badge timeline-status-badge--completed",conflict:"timeline-status-badge timeline-status-badge--conflict",cancelled:"timeline-status-badge timeline-status-badge--cancelled"}[Ae]||"timeline-status-badge timeline-status-badge--upcoming",xe=typeof t.paymentStatus=="string"?t.paymentStatus.toLowerCase():"",pe=wn(t),Re=pe.length>0,$e=Re?0:Number(t.paidAmount)||0,Ne=Re?0:Number(t.paidPercent)||0;let m=Xe,h,v,g,w,T,E,D,_,te,z;const ae=xn(pe),Ze=n("projects.focus.confirmed","✅ مشروع مؤكد"),Ee=t.confirmed===!0||t.confirmed==="true"?`<span class="reservation-chip status-confirmed">${o(Ze)}</span>`:"";let C=[];if(k>0){const x=I.reduce((He,oe)=>{const ua=Array.isArray(oe.items)?oe.items:[],Nt=Array.isArray(oe.crewAssignments)?oe.crewAssignments:[],fe=Nt.length?Nt:Array.isArray(oe.technicians)?oe.technicians:[],pa=Array.isArray(fe)&&fe.length&&typeof fe[0]=="object",ma=Array.isArray(fe)&&fe.length&&typeof fe[0]!="object",it=Za({items:ua,technicianIds:ma?fe:[],crewAssignments:pa?fe:[],discount:oe.discount??0,discountType:oe.discountType||"percent",applyTax:!1,start:oe.start,end:oe.end,companySharePercent:null,groupingSource:oe});return He.equipment+=Number(it.equipmentTotal||0),He.crew+=Number(it.crewTotal||0),He.crewCost+=Number(it.crewCostTotal||0),He},{equipment:0,crew:0,crewCost:0}),L=Number(le||0),H=Number((x.equipment+x.crew+se).toFixed(2)),J=Number.parseFloat(t?.discount??t?.discountValue??0)||0;let q=(t?.discountType==="amount"?"amount":"percent")==="amount"?J:H*(J/100);(!Number.isFinite(q)||q<0)&&(q=0),q>H&&(q=H);const U=K===!0,Y=t?.companyShareEnabled===!0||t?.companyShareEnabled==="true"||t?.company_share_enabled===!0||t?.company_share_enabled==="true",V=Number.parseFloat(t?.companySharePercent??t?.company_share_percent??t?.companyShare??t?.company_share??0)||0,ye=Y&&V>0?V:0,W=Math.max(0,H-q),Z=Number((W*(ye/100)).toFixed(2)),me=U?Number(((W+Z)*Oe).toFixed(2)):0,Le=Number((W+Z+me).toFixed(2)),da=Number((Le-Z-me-L-x.crewCost).toFixed(2));x.equipment>0&&C.push({icon:"🎛️",label:n("projects.details.summary.equipmentTotal","إجمالي المعدات"),value:P(x.equipment)}),x.crew>0&&C.push({icon:"😎",label:n("projects.details.summary.crewTotal","إجمالي الفريق"),value:P(x.crew)}),x.crewCost>0&&C.push({icon:"🧾",label:n("projects.details.summary.crewCostTotal","تكلفة الفريق"),value:P(x.crewCost)}),se>0&&C.push({icon:"💼",label:n("projects.details.summary.servicesClientPrice","الخدمات الإنتاجية"),value:P(se)}),L>0&&C.push({icon:"🧾",label:n("projects.details.summary.expensesTotal","تكلفة الخدمات الإنتاجية"),value:P(L)}),q>0&&C.push({icon:"🏷️",label:n("projects.details.summary.discount","الخصم"),value:`−${P(q)}`}),C.push({icon:"🧮",label:n("projects.details.summary.grossAfterDiscount","الإجمالي بعد الخصم"),value:P(W)}),Z>0&&C.push({icon:"🏦",label:n("projects.details.summary.companyShare","نسبة الشركة"),value:`−${P(Z)}`}),me>0&&C.push({icon:"💸",label:n("projects.details.summary.tax","الضريبة (15٪)"),value:`−${P(me)}`}),C.push({icon:"💵",label:n("projects.details.summary.netProfit","صافي الربح"),value:P(da)}),C.push({icon:"💰",label:n("projects.details.summary.finalTotal","المجموع النهائي"),value:P(Le)}),m=Le}else{const x=Number(le||0),L=Math.max(0,Number(se)||0),H=Number.parseFloat(t?.discount??t?.discountValue??0)||0;let B=(t?.discountType==="amount"?"amount":"percent")==="amount"?H:L*(H/100);(!Number.isFinite(B)||B<0)&&(B=0),B>L&&(B=L);const q=Math.max(0,L-B),U=K===!0,Y=t?.companyShareEnabled===!0||t?.companyShareEnabled==="true"||t?.company_share_enabled===!0||t?.company_share_enabled==="true",V=Number.parseFloat(t?.companySharePercent??t?.company_share_percent??t?.companyShare??t?.company_share??0)||0,ye=Y&&V>0?V:0,W=Number((q*(ye/100)).toFixed(2)),Z=U?Number(((q+W)*Oe).toFixed(2)):0,me=Number((q+W+Z).toFixed(2)),Le=Number((me-W-Z-x).toFixed(2));C=[],C.push({icon:"💼",label:n("projects.details.summary.servicesClientPrice","الخدمات الإنتاجية"),value:P(L)}),B>0&&C.push({icon:"🏷️",label:n("projects.details.summary.discount","الخصم"),value:`−${P(B)}`}),C.push({icon:"🧮",label:n("projects.details.summary.grossAfterDiscount","الإجمالي بعد الخصم"),value:P(q)}),W>0&&C.push({icon:"🏦",label:n("projects.details.summary.companyShare","نسبة الشركة"),value:`−${P(W)}`}),Z>0&&C.push({icon:"💸",label:n("projects.details.summary.tax","الضريبة (15٪)"),value:`−${P(Z)}`}),C.push({icon:"💵",label:n("projects.details.summary.netProfit","صافي الربح"),value:P(Le)}),C.push({icon:"💰",label:n("projects.details.summary.finalTotal","المجموع النهائي"),value:P(me)}),m=me}h=Ue({totalAmount:m,paidAmount:$e,paidPercent:Ne,history:pe}),v=ut({manualStatus:xe||"unpaid",paidAmount:h.paidAmount,paidPercent:h.paidPercent,totalAmount:m}),g=n(`projects.paymentStatus.${v}`,v==="paid"?"Paid":v==="partial"?"Partial":"Unpaid"),w=v==="paid"?"status-paid":v==="partial"?"status-partial":"status-unpaid",T=Number.isFinite(Number(h.paidAmount))?Number(h.paidAmount):0,E=Number.isFinite(Number(h.paidPercent))?Number(h.paidPercent):0,D=Math.max(0,Number((m-T).toFixed(2))),_=P(T),te=`${j(E.toFixed(2))}%`,z=P(D);const et=C.map(({icon:x,label:L,value:H})=>`
  ...
  `,tt=calculateReservationDays(t.start,t.end),at=Mt("start",t.start),Se=Mt("end",t.end),nt=Se?{...Se,meta:(Se.meta?`${Se.meta} — `:"")+`${n("projects.details.labels.days","عدد الأيام")}: ${j(String(tt))}`}:null,st=[{icon:"👤",label:n("projects.details.client","العميل"),value:u},{icon:"📞",label:n("projects.details.labels.clientPhone","رقم العميل"),value:f},{icon:"✉️",label:n("projects.details.labels.clientEmail","البريد الإلكتروني"),value:y},S?{icon:"🏢",label:n("projects.details.company","شركة العميل"),value:S}:null,{icon:"🏷️",label:n("projects.details.type","نوع المشروع"),value:`<span class="project-type-chip project-type-chip--${t.type||"default"}">${o(r)}</span>`},at,nt].filter(Boolean),ke=n("projects.details.overview.heading","معلومات المشروع"),_e=`
  ...
  `,rt=k>0?n("projects.details.chips.linkedReservation","مربوط بحجز"):n("projects.details.chips.notLinkedReservation","غير مربوط بحجز"),Q=k>0?"reservation-chip status-confirmed":"reservation-chip status-info",ot=[`<span class="${re}">${o(Qe)}</span>`,`<span class="${Q}">${o(rt)}</span>`,`<span class="reservation-chip ${w}">${o(g)}</span>`,Ee].filter(Boolean).join("");n("projects.details.expensesTotal","تكلفة الخدمات الإنتاجية"),n("projects.details.reservationsTotal","إجمالي الحجوزات");const Be=n("projects.details.expenses","خدمات إنتاجية ({amount})").replace("{amount}",P(le)),be=mn(Array.isArray(t.expenses)?t.expenses:[]);b.detailsBody.innerHTML=`
  ...
  `,bn(t);const G=b.detailsBody.querySelector("#project-details-export-btn");G&&G.addEventListener("click",async x=>{if(x.preventDefault(),G.blur(),!G.disabled){G.disabled=!0;try{await Ga({project:t})}catch(L){console.error("❌ [projects/details] export project PDF failed",L),F(n("projects.details.exportFailed","⚠️ تعذر تصدير المشروع إلى PDF"),"error")}finally{G.disabled=!1}}}),b.detailsModalEl&&window.bootstrap?.Modal&&window.bootstrap.Modal.getOrCreateInstance(b.detailsModalEl).show()}function mn(e=[]){if(!(Array.isArray(e)&&e.length>0)){const s=o(n("projects.expenses.table.empty","ستظهر المصاريف المسجلة هنا فور إضافتها."));return`
  ...
  `}function xn(e=[]){return!Array.isArray(e)||e.length===0?`<div class="reservation-payment-history-empty">${o(n("reservations.paymentHistory.empty","لا توجد دفعات مسجلة"))}</div>`:`<ul class="reservation-payment-history-list">${e.map(t=>{const a=t?.type==="percent"?n("reservations.paymentHistory.type.percent","دفعة نسبة"):t?.type==="amount"?n("reservations.paymentHistory.type.amount","دفعة مالية"):n("reservations.paymentHistory.type.unknown","دفعة"),s=Number.isFinite(Number(t?.amount))&&Number(t.amount)>0?o(P(Number(t.amount))):"—",r=Number.isFinite(Number(t?.percentage))&&Number(t.percentage)>0?`${j(Number(t.percentage).toFixed(2))}%`:"—",l=t?.recordedAt?j(gt(t.recordedAt)):"—",i=t?.note?`<div class="payment-history-note">${o(j(t.note))}</div>`:"";return`
      <li>
    ...
    `}).join("")}</ul>`}function Sn(e=[]){if(!Array.isArray(e)||e.length===0)return`<div class="reservation-payment-history__empty">${o(n("reservations.paymentHistory.empty","لا توجد دفعات مسجلة"))}</div>`;const t=e.map((a,s)=>{const r=a?.type==="percent"?n("reservations.paymentHistory.type.percent","دفعة نسبة"):n("reservations.paymentHistory.type.amount","دفعة مالية"),l=Number.isFinite(Number(a?.amount))&&Number(a.amount)>0?o(P(Number(a.amount))):"—",i=Number.isFinite(Number(a?.percentage))&&Number(a.percentage)>0?`${j(Number(a.percentage).toFixed(2))}%`:"—",u=a?.recordedAt?j(gt(a.recordedAt)):"—",c=a?.note?o(j(a.note)):"",f=o(n("reservations.paymentHistory.actions.delete","حذف الدفعة"));return`
      <tr>
        <td>${o(r)}</td>
        <td>${l}</td>
        <td>${i}</td>
  ...
  `}function wn(e={}){const a=(Array.isArray(e.paymentHistory)?e.paymentHistory:Array.isArray(e.payment_history)?e.payment_history:[]).map(Tn).filter(Boolean);if(a.length>0)return a;const s=ze(e.paidPercent??e.paid_percent),r=ze(e.paidAmount??e.paid_amount),l=e.updatedAt??e.updated_at??e.createdAt??e.created_at??null,i=ea(l);return s!=null&&s>0?[{type:"percent",amount:r!=null&&r>0?r:null,percentage:s,value:s,note:null,recordedAt:i}]:r!=null&&r>0?[{type:"amount",amount:r,percentage:null,value:r,note:null,recordedAt:i}]:[]}function Tn(e){if(!e||typeof e!="object")return null;const t=e.type??e.payment_type??e.paymentType??null;let a=typeof t=="string"?t.toLowerCase().trim():null;a!=="percent"&&(a="amount");const s=ze(e.amount??(a==="amount"?e.value:null)),r=ze(e.percentage??(a==="percent"?e.value:null)),l=a==="percent"?r??null:s??null,i=e.note??e.memo??null,u=ea(e.recordedAt??e.recorded_at??e.date??e.created_at??null);return a==="amount"&&s==null||a==="percent"&&r==null?null:{type:a,amount:s??null,percentage:r??null,value:l,note:i&&String(i).trim().length?String(i).trim():null,recordedAt:u}}function ze(e){if(e==null||e==="")return null;const t=j(String(e)).replace(/%/g,"").trim();if(!t)return null;const a=Number.parseFloat(t);return Number.isFinite(a)?a:null}function ea(e){if(!e)return new Date().toISOString();const t=new Date(e);return Number.isNaN(t.getTime())?new Date().toISOString():t.toISOString()}function Mt(e,t){if(!t)return null;const{date:a,time:s}=Pn(gt(t)),r=e==="start",l=r?"⏱️":"⌛",i=r?n("projects.details.labels.start","بداية المشروع"):n("projects.details.labels.end","نهاية المشروع");return{icon:l,label:i,value:a,meta:s}}function Pn(e){if(!e||e==="—")return{date:"—",time:""};const t=e.split(" ").filter(Boolean),a=t.shift()||"—",s=t.join(" ");return{date:a,time:s}}function ta(e){if(!e)return n("projects.form.types.unknown","نوع غير محدد");const t={commercial:"projects.form.types.commercial",coverage:"projects.form.types.coverage",photography:"projects.form.types.photography",social:"projects.form.types.social"}[e]||"projects.form.types.unknown";return n(t,e)}function aa(e){if(!e)return 0;const t=Array.isArray(e.items)?e.items:[],a=e.discount??0,s=Number(j(String(a)))||0,r=e.discountType||"percent",l=Array.isArray(e.crewAssignments)?e.crewAssignments:[],i=l.length?l:Array.isArray(e.technicians)?e.technicians:[],u=Gt(t,s,r,!1,i,{start:e.start,end:e.end});if(Number.isFinite(u))return u;const c=Number(j(String(e.cost??0)));return Number.isFinite(c)?Math.round(c):0}function Pt(e){if(typeof window>"u")return null;try{const s=new URLSearchParams(window.location.search||"").get(e);if(s)return s}catch{}const t=window.location.hash?window.location.hash.replace(/^#/,""):"";if(t&&t.includes(`${e}=`))try{const s=new URLSearchParams(t).get(e);if(s)return s}catch{}return null}function An(){return Pt(lt)}function $n(){return Pt(dt)}function Nn(){if(!(typeof window>"u"||typeof window.history?.replaceState!="function"))try{const e=new URLSearchParams(window.location.search||""),t=window.location.hash?window.location.hash.replace(/^#/,""):"";let a=!1;[lt,dt,"linked"].forEach(c=>{e.has(c)&&(e.delete(c),a=!0)});let s=t,r=!1;if(t)try{const c=new URLSearchParams(t);let f=!1;[lt,dt,"linked"].forEach(d=>{c.has(d)&&(c.delete(d),f=!0)}),f&&(s=c.toString(),r=!0)}catch{}if(!a&&!r)return;const l=window.location.pathname,i=e.toString(),u=`${l}${i?`?${i}`:""}${s?`#${s}`:""}`;window.history.replaceState({},"",u)}catch{}}function En(){const e=An(),t=$n(),a=Pt("linked");e&&($.pendingProjectDetailId=e),t&&($.pendingProjectEditId=t,$.pendingProjectDetailId||($.pendingProjectDetailId=t)),a!=null&&String(a)!==""&&String(a)!=="0"&&String(a).toLowerCase()!=="false"&&($.pendingLinkedToast=!0),(e||t)&&Nn()}function Cn(){if(!$.pendingProjectDetailId)return;const e=$.pendingProjectDetailId,t=String(e),a=$.projects.find(r=>[r?.id,r?.projectId,r?.project_id].some(i=>i!=null&&String(i)===t));if(!a)return;$.pendingProjectDetailId=null;const s=a?.id??a?.projectId??a?.project_id??t;if(ve(s),$.pendingLinkedToast){$.pendingLinkedToast=!1;try{F(n("projects.toast.linkedReservationCreated","✅ تم ربط الحجز بالمشروع"))}catch{}}if($.pendingProjectEditId!=null){const r=String($.pendingProjectEditId);[a.id,a.projectId,a.project_id].some(i=>i!=null&&String(i)===r)&&($.pendingProjectEditId=null,setTimeout(()=>Qt(a),0))}}function kn(){document.addEventListener("DOMContentLoaded",()=>{pn(),En(),Da(),Ot(),Fa(),cn(),ln(),Ia(),Ma(),Ra(),_a(),Ba(),Ha(),qa({onViewDetails:ve}),fn({onOpenProject:ve}),Va(),Ln()}),document.addEventListener("language:changed",Rt),document.addEventListener("language:translationsReady",Rt),document.addEventListener("customers:changed",Dn),document.addEventListener("technicians:updated",Fn),document.addEventListener("reservations:changed",()=>Oa(ve)),document.addEventListener(ba.USER_UPDATED,()=>{we()})}async function Ln(){try{await zt({suppressError:!0}),await Kt()}catch(e){console.error("❌ [projects] Failed to initialise projects data",e);const t=e?.message||n("projects.toast.fetchFailed","تعذر تحميل بيانات المشاريع، حاول لاحقًا");F(t,"error")}finally{Ua(),Ke(),za(),Ut(),we(),Ie(),Fe(),Cn()}}function Rt(){Ke(),Ut(),we(),Ie(),Fe(),Ot()}function Dn(){Wa(),Ke()}function Fn(){Ka(),Ke()}ya();va();ga();Ja();kn();document.addEventListener("DOMContentLoaded",()=>{xa(),ja()});const ft=.15,qe={},In="https://cdn.jsdelivr.net/npm/apexcharts@3.49.0/dist/apexcharts.min.js";let De=0;const A={projects:[],customers:[],reservations:[],totalProjects:0,filters:{search:"",statuses:["upcoming","ongoing","completed"],payment:"all",range:"all",startDate:"",endDate:""}},p={search:null,payment:null,dateRange:null,customRangeWrapper:null,startDate:null,endDate:null,refreshBtn:null,kpiGrid:null,statusChips:null,table:null,tableBody:null,tableMeta:null,tableEmpty:null,chartCards:{},chartLoaders:{}},Ve=Object.freeze({projects:`
  ...
  `});let ee=null;const na=["upcoming","ongoing","completed"];async function Mn({forceProjects:e=!1}={}){try{await zt({suppressError:!0}),await Xa({force:e})}catch(t){console.error("❌ [projectsReports] Failed to load initial data",t),Ge(t)&&console.warn("Projects API error:",t.message)}ia()}async function Rn(){Hn(),ra(),await _n();try{await Mn({forceProjects:!0}),la(),Wn(),ie()}finally{oa()}document.addEventListener("language:changed",Gn),document.addEventListener("projects:changed",()=>{ht().catch(e=>{console.error("❌ [projectsReports] Failed to refresh after projects change",e)})}),document.addEventListener("reservations:changed",()=>{ht().catch(e=>{console.error("❌ [projectsReports] Failed to refresh after reservations change",e)})}),window.addEventListener("storage",Jn)}document.addEventListener("DOMContentLoaded",Rn);async function _n(){if(ee)return ee;if(typeof window>"u")return null;if(window.ApexCharts)return ee=window.ApexCharts,ee;try{await Bn(In),ee=window.ApexCharts||null}catch(e){console.warn("ApexCharts failed to load",e),ee=null}return ee}function Bn(e){return new Promise((t,a)=>{if(typeof document>"u"){a(new Error("Document is not available to load scripts."));return}const s=document.querySelector(`script[src="${e}"]`);if(s){if(s.dataset.loaded==="true"){t();return}s.addEventListener("load",t,{once:!0}),s.addEventListener("error",()=>a(new Error(`Failed to load script ${e}`)),{once:!0});return}const r=document.createElement("script");r.src=e,r.async=!0,r.dataset.loaded="false",r.onload=()=>{r.dataset.loaded="true",t()},r.onerror=()=>a(new Error(`Failed to load script ${e}`)),document.head.appendChild(r)})}function Hn(){p.search=document.getElementById("reports-search"),p.statusChips=document.getElementById("reports-status-chips"),p.payment=document.getElementById("reports-payment"),p.dateRange=document.getElementById("reports-date-range"),p.customRangeWrapper=document.getElementById("reports-custom-range"),p.startDate=document.getElementById("reports-start-date"),p.endDate=document.getElementById("reports-end-date"),p.refreshBtn=document.getElementById("reports-refresh"),p.kpiGrid=document.getElementById("reports-kpi-grid"),p.table=document.getElementById("reports-table"),p.tableBody=p.table?.querySelector("tbody"),p.tableMeta=document.getElementById("reports-table-meta"),p.tableEmpty=document.getElementById("reports-empty"),p.chartCards={},p.chartLoaders={},document.querySelectorAll("[data-chart-card]").forEach(e=>{const t=e.dataset.chartCard;if(!t)return;p.chartCards[t]=e;const a=e.querySelector("[data-chart-loading]");a&&(p.chartLoaders[t]=a)})}function sa(e){const t=!!e;Object.entries(p.chartCards||{}).forEach(([a,s])=>{if(!s)return;s.classList.toggle("is-loading",t),s.setAttribute("aria-busy",t?"true":"false");const r=p.chartLoaders?.[a];r&&(r.hidden=!t)})}function ra(){De+=1,De===1&&sa(!0)}function oa(){De=Math.max(0,De-1),De===0&&sa(!1)}function ia(){const{customers:e=[]}=Vt();A.customers=Array.isArray(e)?e:[],A.reservations=wt();const t=new Map(A.customers.map(s=>[String(s.id),s])),a=jt();A.projects=Array.isArray(a)?a.map(s=>qn(s,t)):[],A.totalProjects=A.projects.length}function qn(e,t){const a=e.paymentStatus==="paid"?"paid":"unpaid",s=t.get(String(e.clientId)),r=Vn(e.id),l=r.reduce((M,R)=>M+On(R),0),i=Un(e),u=Number(e?.equipmentEstimate)||0,c=Number((u+i).toFixed(2)),f=e?.applyTax===!0||e?.applyTax==="true",d=f?Number((c*ft).toFixed(2)):0,y=f?Number(((c+l)*ft).toFixed(2)):0,S=Number((c+l+y).toFixed(2)),O=zn(e),N=e.start?new Date(e.start):null,I=e.end?new Date(e.end):null;return{raw:e,id:e.id,projectCode:e.projectCode||e.id,title:(e.title||"").trim(),clientId:e.clientId,clientName:s?.customerName||s?.name||"",clientCompany:e.clientCompany||s?.companyName||"",type:e.type||e.projectType||"",description:e.description||"",paymentStatus:a,confirmed:e.confirmed===!0||e.confirmed==="true",start:N,end:I,applyTax:f,status:O,reservationsTotal:Number(l.toFixed(2)),expensesTotal:i,subtotal:c,taxAmount:d,combinedTaxAmount:y,overallTotal:S,unpaidValue:a==="paid"?0:S,reservationsCount:r.length}}function Vn(e){return Array.isArray(A.reservations)?A.reservations.filter(t=>String(t.projectId)===String(e)):[]}function On(e){if(!e)return 0;const t=Array.isArray(e.items)?e.items:[],a=e.discount??0,s=Number(j(String(a)))||0,r=e.discountType||"percent",l=Array.isArray(e.crewAssignments)?e.crewAssignments:[],i=l.length?l:Array.isArray(e.technicians)?e.technicians:[],u=Gt(t,s,r,!1,i,{start:e.start,end:e.end});if(Number.isFinite(u))return u;const c=Number(j(String(e.cost??0)));return Number.isFinite(c)?Math.round(c):0}function Un(e){return typeof e.expensesTotal=="number"?Number(e.expensesTotal)||0:Array.isArray(e.expenses)?e.expenses.reduce((t,a)=>t+(Number(a.amount)||0),0):0}function zn(e){const t=new Date,a=e.start?new Date(e.start):null,s=e.end?new Date(e.end):null;return a&&!Number.isNaN(a.getTime())&&a>t?"upcoming":s&&!Number.isNaN(s.getTime())&&s<t?"completed":"ongoing"}function Wn(){if(p.search){let e;p.search.addEventListener("input",()=>{clearTimeout(e),e=setTimeout(()=>{A.filters.search=p.search.value.trim(),ie()},180)})}p.payment&&(p.payment.value=A.filters.payment,p.payment.addEventListener("change",()=>{A.filters.payment=p.payment.value||"all",ie()})),p.dateRange&&(p.dateRange.addEventListener("change",Kn),p.dateRange.value=A.filters.range),p.startDate&&p.startDate.addEventListener("change",()=>{A.filters.startDate=p.startDate.value,A.filters.range==="custom"&&ie()}),p.endDate&&p.endDate.addEventListener("change",()=>{A.filters.endDate=p.endDate.value,A.filters.range==="custom"&&ie()}),p.refreshBtn&&p.refreshBtn.addEventListener("click",()=>{if(A.filters.range!=="custom"){ie();return}A.filters.startDate=p.startDate?.value||"",A.filters.endDate=p.endDate?.value||"",ie()})}function Kn(e){const t=e.target.value;A.filters.range=t,t==="custom"?p.customRangeWrapper?.classList.add("active"):(p.customRangeWrapper?.classList.remove("active"),A.filters.startDate="",A.filters.endDate="",p.startDate&&(p.startDate.value=""),p.endDate&&(p.endDate.value=""),ie())}async function ht(){ra();try{await Promise.all([Kt(),en()])}catch(e){console.error("❌ [projectsReports] Data mutation refresh failed",e),Ge(e)&&console.warn("Projects API error:",e.message)}finally{ia(),ie(),oa()}}function Gn(){la(),ie()}function Jn(e){e.key&&!["projects","reservations","customers"].includes(e.key)||ht().catch(t=>{console.error("❌ [projectsReports] Storage sync failed",t)})}function ie(){const e=Yn();At(),Zn(e),ns(e),ss(e),rs(e),os(e),is(e)}function Yn(){const{search:e,statuses:t,payment:a,range:s,startDate:r,endDate:l}=A.filters,i=ca(e),u=new Date,c=Number(s);let f=null;if(s==="custom"){f=r?new Date(r):null;const d=l?new Date(l):null;return A.projects.filter(y=>!_t(y,t)||!Bt(y,a)||!Ht(y,i)?!1:Qn(y.start,f,d))}return s!=="all"&&Number.isFinite(c)&&(f=new Date,f.setDate(u.getDate()-c)),A.projects.filter(d=>!_t(d,t)||!Bt(d,a)||!Ht(d,i)?!1:s==="all"?!0:Xn(d.start,f,u))}function _t(e,t){return t.includes(e.status)}function Bt(e,t){return t==="all"?!0:e.paymentStatus===t}function Ht(e,t){return t?ca([e.title,e.projectCode,e.clientName,e.clientCompany,e.type,e.description].filter(Boolean).join(" ")).includes(t):!0}function Xn(e,t,a){return!e||!(e instanceof Date)||Number.isNaN(e.getTime())?!1:t?e>=t&&e<=a:!0}function Qn(e,t,a){if(!t&&!a)return!0;if(!e||Number.isNaN(e.getTime()))return!1;const s=e.getTime();return!(t&&!Number.isNaN(t.getTime())&&s<t.getTime()||a&&!Number.isNaN(a.getTime())&&s>a.getTime())}function ca(e){return e?j(String(e)).toLowerCase().trim():""}function Zn(e){if(!p.kpiGrid)return;const t=e.length,a=e.reduce((i,u)=>i+u.overallTotal,0),s=e.reduce((i,u)=>i+u.unpaidValue,0),r=e.reduce((i,u)=>i+u.expensesTotal,0),l=[{icon:Ve.projects,label:n("projects.reports.kpi.totalProjects","Total projects"),value:bt(t),meta:n("projects.reports.kpi.totalProjectsMeta","After applying the current filters")},{icon:Ve.value,label:n("projects.reports.kpi.totalValue","Total value"),value:ne(a),meta:n("projects.reports.kpi.totalValueMeta","Includes projects and linked reservations")},{icon:Ve.outstanding,label:n("projects.reports.kpi.unpaidValue","Outstanding value"),value:ne(s),meta:n("projects.reports.kpi.unpaidValueMeta","Projects not fully paid yet")},{icon:Ve.expenses,label:n("projects.reports.kpi.expenses","تكلفة الخدمات الإنتاجية"),value:ne(r),meta:n("projects.reports.kpi.expensesMeta","تكلفة الخدمات الإنتاجية للمشاريع المحددة")}];p.kpiGrid.innerHTML=l.map(({icon:i,label:u,value:c,meta:f})=>`
  ...
  `).join(""),es(e)}function es(e){try{const t=ts(e),a="projects-revenue-breakdown";let s=document.getElementById(a);const r=[{label:n("reservations.reports.kpi.revenue.details.gross","الإيراد الكلي","Gross revenue"),value:ne(t.grossRevenue)},{label:n("reservations.reports.kpi.revenue.details.share","نسبة الشركة","Company share"),value:ne(t.companyShareTotal)},{label:n("reservations.reports.kpi.revenue.details.tax","الضريبة","Tax"),value:ne(t.taxTotal)},{label:n("reservations.reports.kpi.revenue.details.crewGross","إجمالي الطاقم","Crew total"),value:ne(t.crewTotal)},{label:n("reservations.reports.kpi.revenue.details.crew","تكلفة الطاقم","Crew cost"),value:ne(t.crewCostTotal)},{label:n("reservations.reports.kpi.revenue.details.equipment","إجمالي المعدات","Equipment total"),value:ne(t.equipmentTotalCombined)},{label:n("projects.reports.kpi.revenue.details.projectExpenses","تكلفة الخدمات الإنتاجية","Project expenses"),value:`−${ne(t.projectExpensesTotal)}`},{label:n("reservations.reports.kpi.revenue.details.net","صافي الربح","Net profit"),value:ne(t.netProfit)}],l=`
    ...
    `}).join("");if(p.tableBody.innerHTML=t,p.tableMeta){const a=n("projects.reports.table.meta","Showing {count} of {total} projects");p.tableMeta.textContent=a.replace("{count}",bt(e.length)).replace("{total}",bt(A.totalProjects))}}function cs(e,t){if(!e&&!t)return"—";const a=e?Et(e.toISOString()):"—",s=t?Et(t.toISOString()):"—";return t?`${a} → ${s}`:a}function ne(e){const t=Number(e)||0,s=We()==="ar"?"ar-SA-u-ca-gregory-nu-latn":"en-US",r=new Intl.NumberFormat(s,{minimumFractionDigits:0,maximumFractionDigits:0}).format(Math.round(t));return`${j(r)} SR`}function bt(e){const a=We()==="ar"?"ar-SA-u-ca-gregory-nu-latn":"en-US";return j(new Intl.NumberFormat(a).format(e))}function ge(e){const a=We()==="ar"?"ar-SA-u-ca-gregory-nu-latn":"en-US";return j(new Intl.NumberFormat(a,{notation:"compact",compactDisplay:"short"}).format(e))}function ls(){return We()==="ar"?"ar-SA-u-ca-gregory-nu-latn":"en-US"}function X(e=""){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}
