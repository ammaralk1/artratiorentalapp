...
/* توازن الحشوات رأسياً في نسخة التصدير فقط (المطبوع) لرفع النص داخل الفقاعة بصرياً */
#quotation-pdf-root[data-quote-render-context="export"] .totals-inline__item { padding: 8px 12px 5px; }
#quotation-pdf-root[data-quote-render-context="export"] .totals-item--final { padding: 12px 16px 8px; }
#quotation-pdf-root[data-quote-render-context="export"] .quote-table-subtotal__pill { padding: 10px 14px 7px; }
