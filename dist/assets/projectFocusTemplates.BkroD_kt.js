import{t,n as u,g as ve}from"./auth.CqiyQgTP.js";import{c as Se,e as s,d as ye,t as Ce,f as p,g as ge,a as Te,r as we,i as Ne,D as me,u as Pe}from"./reservationsService.DLocEoFG.js";const K=.15,Ae="bg-primary",Re=2,je={upcoming:"Upcoming",ongoing:"In Progress",completed:"Completed"},Fe={upcoming:"bg-info",ongoing:"bg-warning",completed:"bg-success"},De={upcoming:"status-pending",ongoing:"status-confirmed",completed:"status-completed"};function re(e){if(!e)return null;const n=[e?.id,e?.reservationId,e?.reservation_id,e?.reservationID].find(r=>r!=null&&r!=="");return n!=null?String(n):null}function ce(e=[]){const a=ge();return e.map(n=>{const r=n?.reservation??n;if(!r||typeof r!="object")return null;let o=Number.isInteger(n?.index)&&n.index>=0?n.index:Number.isInteger(n?.reservationIndex)&&n.reservationIndex>=0?n.reservationIndex:null;if(!Number.isInteger(o)||o<0){const i=re(r);i&&(o=a.findIndex(d=>{const c=re(d);return c&&c===i}))}return{reservation:r,index:Number.isInteger(o)&&o>=0?o:-1}}).filter(Boolean)}function ie(e){return e?e.id!=null?String(e.id):e.projectId!=null?String(e.projectId):e.project_id!=null?String(e.project_id):null:null}function He(e,{customer:a=null,techniciansMap:n=new Map,reservations:r=[]}={}){const i=ce(r).map(({reservation:S})=>S),d=ie(e),c=d?s(d):"",l=ye(e),b=t(`projects.status.${l}`,je[l]),v=Fe[l]||"bg-secondary",f=e?.paymentStatus==="paid"?"paid":"unpaid",x=t(`projects.paymentStatus.${f}`,f==="paid"?"Paid":"Unpaid"),$=f==="paid"?"status-paid":"status-unpaid",y=[f==="paid"?"project-focus-card--paid":"project-focus-card--unpaid"],g=e?.confirmed===!0||e?.confirmed==="true";g&&y.push("project-focus-card--confirmed");const h=e?.projectCode||(d?`PRJ-${u(d)}`:""),T=h?u(String(h).replace(/^#/,"")):"",A=T?`<span class="project-code-badge project-focus-card__code">#${s(T)}</span>`:"",_=de(e?.type),R=_?`<span class="badge project-focus-card__badge ${Ae}">${s(_)}</span>`:"",P=`<span class="project-focus-card__status-chip ${v}">${s(b)}</span>`,k=`<span class="reservation-chip ${$} project-focus-card__payment-chip">${s(x)}</span>`,z=(e?.title||"").trim()||t("projects.fallback.untitled","Untitled project"),M=(e?.description||"").trim(),H=M?s(Ce(M,110)):s(t("projects.fallback.noDescription","No description")),q=Array.isArray(e?.technicians)?e.technicians:[],F=q.map(S=>n.get(String(S))?.name).filter(Boolean),D=F.length?Ie(F):"",O=a?.customerName||e?.clientName||"",Y=(e?.clientCompany||a?.companyName||"").trim(),U=i.reduce((S,L)=>{const ae=le(L),ne=(Array.isArray(L?.items)?L.items:[]).reduce((xe,_e)=>xe+(Number(_e?.qty)||0),0),E=Array.isArray(L?.technicians)?L.technicians.length:0;return{total:S.total+ae,equipment:S.equipment+ne,crew:S.crew+E}},{total:0,equipment:0,crew:0}),J=Number(U.total.toFixed(2)),Z=U.equipment,j=U.crew||q.length,I=$e(e),G=I.applyTax?Number(((I.subtotal+J)*K).toFixed(2)):0,m=Number((I.subtotal+J+G).toFixed(2)),w=[T?{icon:"🆔",label:t("projectCards.meta.code","رقم المشروع"),value:`#${T}`}:null,O?{icon:"👤",label:t("projectCards.meta.client","العميل"),value:O}:null,Y?{icon:"🏢",label:t("projectCards.meta.company","شركة العميل"),value:Y}:null,_?{icon:"🏷️",label:t("projectCards.meta.type","نوع المشروع"),value:_}:null,D?{icon:"👥",label:t("projectCards.stats.crewLabel","عدد الطاقم"),value:D}:null,{icon:"📅",label:t("projectCards.meta.startDate","تاريخ البداية"),value:be(e?.start)},{icon:"📅",label:t("projectCards.meta.endDate","تاريخ النهاية"),value:e?.end?be(e.end):"—"}].filter(Boolean),C=[{icon:"📦",label:t("projectCards.stats.equipmentCount","عدد المعدات"),value:u(String(Z))},{icon:"😎",label:t("projectCards.stats.crewCount","عدد أفراد الطاقم"),value:u(String(j))},{icon:"💵",label:t("projectCards.stats.reservationValue","إجمالي الحجوزات"),value:p(J)}],X=[{icon:"💳",label:t("projectCards.stats.paymentStatus","حالة الدفع"),value:x},{icon:"💸",label:t("projectCards.stats.expensesTotal","إجمالي المصاريف"),value:p(I.expensesTotal)},{icon:"💰",label:t("projectCards.stats.projectSubtotal","التكلفة التقديرية"),value:p(I.subtotal)},{icon:"🧾",label:t("projectCards.stats.taxTotal","الضريبة"),value:p(G)},{icon:"💵",label:t("projectCards.stats.overallTotal","المجموع الكلي"),value:p(m)}],pe=[oe("projectCards.groups.meta","بيانات المشروع",w),oe("projectCards.groups.reservations","موجز الحجز",C),oe("projectCards.groups.payment","ملخص الدفع",X)].filter(Boolean).join(""),N=t("projects.focus.confirmed","✅ مشروع مؤكد"),ee=t("projects.focus.pending","⌛ بانتظار التأكيد"),se=`<div class="project-focus-card__actions"><span class="reservation-chip ${g?"status-confirmed":"status-pending"} project-focus-card__confirm-indicator">${s(g?N:ee)}</span></div>`,V=[A,R,P,k].filter(Boolean).join(`
          `);return`
  ...
  `}function Ie(e=[]){if(!e.length)return"";const a=e.slice(0,Re),n=e.length-a.length,r=ve()==="ar"?"، ":", ";let o=a.join(r);return n>0&&(o+=`${r}+${u(String(n))}`),o}function Oe(e,{customer:a=null,reservations:n=[]}={}){const r=ce(n),o=r.map(({reservation:m})=>m),i=$e(e),d=o.reduce((m,w)=>m+le(w),0),c=Number(d.toFixed(2)),l=o.length,b=i.applyTax?Number(((i.subtotal+c)*K).toFixed(2)):0,v=Number((i.subtotal+c+b).toFixed(2)),f=ye(e),x=t(`projects.status.${f}`,je[f]),$=De[f]||"status-confirmed",y=ie(e)||"",g=e?.projectCode||(y?`PRJ-${u(y)}`:""),h=g?u(String(g).replace(/^#/,"")):"",T=h?`<span class="project-code-badge">#${s(h)}</span>`:"",A=i.applyTax,_=A?t("projects.details.chips.vatOn","شامل الضريبة 15٪"):t("projects.details.chips.vatOff","غير شامل الضريبة"),R=A?"status-paid":"status-unpaid",P=e?.paymentStatus==="paid"?"paid":"unpaid",k=t(`projects.paymentStatus.${P}`,P==="paid"?"Paid":"Unpaid"),z=P==="paid"?"status-paid":"status-unpaid",H=t("projects.details.chips.reservations","{count} حجوزات").replace("{count}",u(String(l))),q=e?.confirmed===!0||e?.confirmed==="true"?`<span class="reservation-chip status-confirmed">${s(t("projects.focus.confirmed","✅ مشروع مؤكد"))}</span>`:"",F=a?.customerName||e?.clientName||"",D=(e?.clientCompany||a?.companyName||"").trim(),Y=(e?.description||"").trim()||t("projects.fallback.noDescription","لا يوجد وصف"),U=[h?{icon:"🆔",label:t("projects.details.labels.code","رقم المشروع"),value:`#${h}`}:null,F?{icon:"👤",label:t("projects.details.client","العميل"),value:F}:null,D?{icon:"🏢",label:t("projects.details.company","شركة العميل"),value:D}:null,{icon:"🏷️",label:t("projects.details.type","نوع المشروع"),value:de(e?.type)},{icon:"🗓️",label:t("projects.details.labels.start","تاريخ البداية"),value:Q(e?.start)},{icon:"🗓️",label:t("projects.details.labels.end","تاريخ النهاية"),value:e?.end?Q(e.end):"—"},{icon:"🔗",label:t("projects.details.labels.reservationsCount","عدد الحجوزات"),value:u(String(l))}].filter(Boolean),J=t("projects.details.expenses","المصروفات ({amount})").replace("{amount}",p(i.expensesTotal)),Z=i.expensesTotal>0?`<ul class="project-details-list">${(e?.expenses||[]).map(m=>`
          <li>
            <span class="project-expense-label">${s(m.label??"")}</span>
            <span class="project-expense-amount">${p(m.amount)}</span>
          </li>
        `).join("")}</ul>`:`<div class="text-muted">${s(t("projects.details.noItems","لا يوجد"))}</div>`;let j=[];if(j.push({icon:"💳",label:t("projects.details.summary.paymentStatus","حالة الدفع"),value:k}),l>0){const m=o.reduce((W,ne)=>{const E=typeof computeReservationFinancials=="function"?computeReservationFinancials(ne):null;return E&&typeof E=="object"&&(W.equipment+=Number(E.equipmentTotal||0),W.crew+=Number(E.crewTotal||0),W.crewCost+=Number(E.crewCostTotal||0)),W},{equipment:0,crew:0,crewCost:0}),w=Number(i.expensesTotal||0),C=Number((m.equipment+m.crew).toFixed(2)),X=Number.parseFloat(e?.discount??e?.discountValue??0)||0;let N=(e?.discountType==="amount"?"amount":"percent")==="amount"?X:C*(X/100);(!Number.isFinite(N)||N<0)&&(N=0),N>C&&(N=C);const ee=e?.applyTax===!0||e?.applyTax==="true",ue=e?.companyShareEnabled===!0||e?.companyShareEnabled==="true"||e?.company_share_enabled===!0||e?.company_share_enabled==="true",te=Number.parseFloat(e?.companySharePercent??e?.company_share_percent??e?.companyShare??e?.company_share??0)||0,se=ue&&te>0?te:0,V=Math.max(0,C-N),B=Number((V*(se/100)).toFixed(2)),S=ee?Number(((V+B)*K).toFixed(2)):0,L=Number((V-B-S-w-m.crewCost).toFixed(2)),ae=Number((V+B+S).toFixed(2));j.push({icon:"🎛️",label:t("projects.details.summary.equipmentTotal","إجمالي المعدات"),value:p(m.equipment)}),j.push({icon:"😎",label:t("projects.details.summary.crewTotal","إجمالي الفريق"),value:p(m.crew)}),j.push({icon:"🧾",label:t("projects.details.summary.crewCostTotal","تكلفة الفريق"),value:p(m.crewCost)}),j.push({icon:"🧾",label:t("projects.details.summary.expensesTotal","مصروفات المشروع"),value:p(w)}),j.push({icon:"🧮",label:t("projects.details.summary.gross","الإجمالي"),value:p(C)}),N>0&&j.push({icon:"🏷️",label:t("projects.details.summary.discount","الخصم"),value:`−${p(N)}`}),B>0&&j.push({icon:"🏦",label:t("projects.details.summary.companyShare","نسبة الشركة"),value:`−${p(B)}`}),S>0&&j.push({icon:"💸",label:t("projects.details.summary.tax","الضريبة (15٪)"),value:`−${p(S)}`}),j.push({icon:"💵",label:t("projects.details.summary.netProfit","صافي الربح"),value:p(L)}),j.push({icon:"💰",label:t("projects.details.summary.finalTotal","المجموع النهائي"),value:p(ae)})}else j.push({icon:"💼",label:t("projects.details.summary.projectSubtotal","إجمالي المشروع"),value:p(i.subtotal)}),j.push({icon:"🧮",label:t("projects.details.summary.combinedTax","إجمالي الضريبة الكلية (15٪)"),value:p(b)}),j.push({icon:"💰",label:t("projects.details.summary.overallTotal","الإجمالي الكلي"),value:p(v)});const I=j.map(({icon:m,label:w,value:C})=>`
    <div class="summary-details-row">
      <span class="summary-details-label">${s(m)} ${s(w)}</span>
  ...
  `).join(""),G=Le({project:e,reservations:r});return`
    ...
    <div class="project-details-info mb-4">
      ${U.map(({icon:m,label:w,value:C})=>he(m,w,C)).join("")}
    </div>
    ...
    <article class="project-reservation-card" data-reservation-id="${s(o)}">
      <div class="project-reservation-card__header">
        ...
        <div class="project-reservation-card__badges">
          ...
          <span class="project-reservation-card__badge ${T}">${s(h)}</span>
          ${_}
        </div>
      </div>
  ...
  `}function $e(e){const a=Number(e?.equipmentEstimate)||0,n=Se(e),r=a+n,o=e?.applyTax===!0||e?.applyTax==="true",i=Number.parseFloat(e?.discount??e?.discountValue??0)||0;let c=(e?.discountType==="amount"?"amount":"percent")==="amount"?i:r*(i/100);(!Number.isFinite(c)||c<0)&&(c=0),c>r&&(c=r);const l=Math.max(0,r-c),b=e?.companyShareEnabled===!0||e?.companyShareEnabled==="true"||e?.company_share_enabled===!0||e?.company_share_enabled==="true",v=Number.parseFloat(e?.companySharePercent??e?.company_share_percent??e?.companyShare??e?.company_share??0)||0,f=b&&o&&v>0?v:0,x=f>0?Number((l*(f/100)).toFixed(2)):0,$=l+x;let y=o?$*K:0;(!Number.isFinite(y)||y<0)&&(y=0),y=Number(y.toFixed(2));let g=o?Number(e?.totalWithTax):$;return o?(!Number.isFinite(g)||g<=0)&&(g=Number(($+y).toFixed(2))):g=$,{equipmentEstimate:a,expensesTotal:n,baseSubtotal:r,discountAmount:c,subtotalAfterDiscount:l,companyShareAmount:x,subtotal:$,applyTax:o,taxAmount:y,totalWithTax:g}}function le(e){if(!e)return 0;const a=Array.isArray(e?.items)?e.items:[],n=e?.discount??0,r=Number(u(String(n)))||0,o=e?.discountType||"percent",i=Array.isArray(e?.crewAssignments)?e.crewAssignments:[],d=i.length?i:Array.isArray(e?.technicians)?e.technicians:[],c=Te(a,r,o,!1,d,{start:e?.start,end:e?.end});if(Number.isFinite(c))return c;const l=Number(u(String(e?.cost??e?.total??0)));return Number.isFinite(l)?Math.round(l):0}function be(e){if(!e)return"—";const a=new Date(e);if(Number.isNaN(a.getTime()))return"—";const r=ve()==="ar"?"ar-SA-u-ca-gregory-nu-latn":"en-GB",o=new Intl.DateTimeFormat(r,{day:"2-digit",month:"short",year:"numeric",hour:"2-digit",minute:"2-digit"});return u(o.format(a))}function Q(e){if(!e)return"—";const a=new Date(e);if(Number.isNaN(a.getTime()))return"—";const n=String(a.getDate()).padStart(2,"0"),r=String(a.getMonth()+1).padStart(2,"0"),o=String(a.getFullYear()),i=String(a.getMinutes()).padStart(2,"0"),d=a.getHours(),c=d>=12?"PM":"AM",l=d%12||12,b=String(l).padStart(2,"0"),v=`${n}/${r}/${o} ${b}:${i} ${c}`;return u(v)}function ke(e,a){if(!e)return"—";const n=Q(e);return a?`${n} - ${Q(a)}`:n}function de(e){if(!e)return t("projects.form.types.unknown","نوع غير محدد");const n={commercial:"projects.form.types.commercial",coverage:"projects.form.types.coverage",photography:"projects.form.types.photography",social:"projects.form.types.social"}[e]||"projects.form.types.unknown";return t(n,e)}function Ue(e,{clientName:a="",clientCompany:n=""}={}){const r=ie(e)||"",o=e?.projectCode||(r?`PRJ-${u(r)}`:""),i=o?u(String(o)):"",d=Me(e?.type),c=fe(e?.start||""),l=fe(e?.end||""),b=typeof e?.paymentStatus=="string"?e.paymentStatus.toLowerCase():"",v=["paid","partial"].includes(b)?b:"unpaid",f=e?.applyTax===!0||e?.applyTax==="true",x=e?.description||"",$=e?.discountType==="amount"?"amount":"percent",y=u(String(e?.discount??e?.discountValue??0)),g=e?.companySharePercent??e?.company_share_percent??e?.companyShare??e?.company_share??me,h=Number.parseFloat(u(String(g))),T=e?.companyShareEnabled===!0||e?.companyShareEnabled==="true"||e?.company_share_enabled===!0||e?.company_share_enabled==="true"||f&&Number.isFinite(h)&&h>0,A=Number.isFinite(h)&&h>0?h:me,_=e?.paymentProgressType==="amount"?"amount":e?.paymentProgressType==="percent"?"percent":e?.payment_progress_type==="amount"?"amount":(e?.payment_progress_type==="percent","percent"),R=u(String(e?.paymentProgressValue??e?.payment_progress_value??(_==="amount"?e?.paidAmount??e?.paid_amount:e?.paidPercent??e?.paid_percent)??"")),P=t("projects.details.labels.code","رقم المشروع"),k=t("projects.form.labels.client","العميل"),z=t("projects.form.labels.clientCompany","شركة العميل"),M=[i?{icon:"🆔",label:P,value:`#${i}`}:null,a?{icon:"👤",label:k,value:a}:null,n?{icon:"🏢",label:z,value:n}:null].filter(Boolean),H=M.length?`<div class="project-details-info mb-3">
        ...
        <div class="col-md-4">
          ...
          <div class="d-flex flex-column gap-2">
            <div class="form-check form-switch m-0">
              <input class="form-check-input" type="checkbox" role="switch" id="project-edit-company-share" name="project-company-share" data-company-share="${s(String(A))}" ${T?"checked":""}>
