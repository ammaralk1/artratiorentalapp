import{v as la,w as da,x as _t,o as ft,s as D,t as n,l as Bt,n as x,A as ua,e as pa,m as ma,h as fa,i as ha,f as At,g as We}from"./auth.D9iQr7TS.js";/* empty css              */import{i as ba}from"./dashboardShell.BnOPGN2x.js";import{d as f,r as Se,a as De,u as Le,s as P,b as ya,f as ht,h as va,i as ga,j as o,k as j,l as ja,m as bt,n as xa,o as $t,e as rt,p as Nt,q as Sa,t as Ta,g as wa,c as Pa,v as Aa,w as qt,x as $a,y as Na,z as Ea,A as Ca,B as ka,C as Da,D as La,E as Fa,F as Ma,G as Ra,H as Ia,I as Ge,J as _a,K as Ht,L as Ba,M as qa}from"./form.BXegXNhF.js";import"./customers.DdK3-bvN.js";import{g as yt,b as Ha,o as Oe,q as ot,a as Vt,D as it,l as Va}from"./reservationsService.cbvx-9hp.js";import{P as vt,l as gt,n as Et,u as Ot,o as jt,p as Ke,t as Ue,v as Oa,x as Ua,i as za,h as Wa,w as Ga,y as ct,z as lt,e as Ut,A as zt,B as Ka,C as Ja}from"./controller.DmOvCIO9.js";import{a as Ya}from"./calculations.DcWKoq9W.js";let Ct=null;function Xa(e){e&&Wt()!==e&&ft({[vt]:e}).catch(t=>{console.warn("⚠️ [projects] Failed to persist projects main tab preference",t)})}function Wt(){return _t()?.[vt]||""}function Gt(e){e&&dt()!==e&&ft({[gt]:e}).catch(t=>{console.warn("⚠️ [projects] Failed to persist projects sub-tab preference",t)})}function dt(){return _t()?.[gt]||""}function Qa(e){if(!e)return"";const t=e.trim();return t?Object.values(Et).includes(t)?t:Et[t]||"":""}function Za(){if(typeof window>"u")return"";try{const t=new URLSearchParams(window.location.search||"").get("subTab");if(t){const a=Qa(t);if(a)return a}}catch{}return""}function Kt(e,t){!e||!f.tabPanes||!f.tabButtons||(f.tabButtons.forEach(a=>{const s=a===t;a.classList.toggle("active",s),a.classList.contains("tab-button")&&a.classList.toggle("tab-active",s)}),f.tabPanes.forEach(a=>{a.dataset.tabPane===e?a.classList.remove("d-none"):a.classList.add("d-none")}),t&&Xa(e))}function en(){if(!f.tabButtons||!f.tabButtons.length)return;f.tabButtons.forEach(a=>{a.dataset.tabListenerAttached!=="true"&&(a.addEventListener("click",s=>{s.preventDefault();const r=a.dataset.tabTarget;r&&(Kt(r,a),r==="projects-section"&&(P.filters.search="",f.search&&(f.search.value=""),Se(),De(),Le()))}),a.dataset.tabListenerAttached="true")});const e=Wt(),t=e&&f.tabButtons.find(a=>a.dataset.tabTarget===e);t&&t.click()}function xt(e,t){!e||!f.projectSubTabButtons||!f.projectSubTabPanes||(f.projectSubTabButtons.forEach(a=>{const s=a===t;a.classList.toggle("active",s),a.classList.contains("tab")&&a.classList.toggle("tab-active",s)}),f.projectSubTabPanes.forEach(a=>{a.dataset.projectSubtab===e?a.classList.remove("d-none"):a.classList.add("d-none")}))}function tn(){!f.projectSubTabButtons||!f.projectSubTabButtons.length||(f.projectSubTabButtons.forEach(e=>{e.dataset.tabListenerAttached!=="true"&&(e.addEventListener("click",t=>{t.preventDefault();const a=e.dataset.projectSubtabTarget;a&&(xt(a,e),Gt(a))}),e.dataset.tabListenerAttached="true")}),an())}function an(){const t=Za()||dt();if(!t)return;const a=f.projectSubTabButtons?.[0],s=f.projectSubTabButtons?.find(l=>l.dataset.projectSubtabTarget===t)||a,r=s?.dataset.projectSubtabTarget;r&&(t!==dt()&&Gt(r),xt(r,s))}function nn(){return f.tabButtons?f.tabButtons.find(t=>t.classList.contains("active"))?.dataset.tabTarget==="projects-section":!1}function kt(e={}){if(e){if(f.tabButtons&&f.tabButtons.length){const a=f.tabButtons.find(r=>r.classList.contains("active"))?.dataset.tabTarget||"",s=e[vt];if(s&&s!==a){const r=f.tabButtons.find(l=>l.dataset.tabTarget===s);r&&Kt(s,r)}}if(f.projectSubTabButtons&&f.projectSubTabButtons.length&&nn()){const a=f.projectSubTabButtons.find(r=>r.classList.contains("active"))?.dataset.projectSubtabTarget||"",s=e[gt];if(s&&s!==a){const r=f.projectSubTabButtons.find(l=>l.dataset.projectSubtabTarget===s);r&&xt(s,r)}}}}function sn(){Ct||(Ct=la(e=>{kt(e)})),da().then(e=>{kt(e)}).catch(e=>{console.warn("⚠️ [projects] Failed to synchronise project preferences",e)})}function ge(e){const t=P.projects.find(y=>String(y.id)===String(e));if(!t||!f.detailsBody)return;f.detailsBody.dataset.mode="view",f.detailsBody.dataset.projectId=String(t.id);const s=(P.customers.length?P.customers:Bt().customers||[]).find(y=>String(y.id)===String(t.clientId)),r=Qt(t.type),i=t.description?.trim()||n("projects.fallback.noDescription","لا يوجد وصف"),d=s?.customerName||n("projects.fallback.unknownClient","عميل غير معروف"),c=s?.phone??s?.customerPhone??t.clientPhone??t.customerPhone??"",m=c?x(String(c).trim()):n("projects.details.client.noPhone","لا يوجد رقم متاح"),u=s?.email??t.clientEmail??t.customerEmail??"",v=u?String(u).trim():n("projects.details.client.noEmail","لا يوجد بريد متاح"),F=(t.clientCompany||s?.companyName||"").trim(),C=t.projectCode||`PRJ-${x(String(t.id))}`,B=x(C),N=ht(t.id),te=N.reduce((y,L)=>y+Zt(L),0),k=Number(te.toFixed(2)),A=N.length,{subtotal:O,applyTax:re,expensesTotal:G}=va(t),pe=Number(t?.servicesClientPrice??t?.services_client_price??0),Fe=O,Te=re?Number(((Fe+k)*Ue).toFixed(2)):0,me=Number((Fe+k+Te).toFixed(2)),de=ga(t),we=n(`projects.status.${de}`,Oa[de]||de),ae=(()=>{try{const y=t.start?new Date(t.start):null,L=t.end?new Date(t.end):y?new Date(y.getTime()+3600*1e3):null;return!y||!L||Number.isNaN(y.getTime())||Number.isNaN(L.getTime())?!1:P.projects.some(R=>{if(!R||String(R.id)===String(t.id))return!1;const W=R.start?new Date(R.start):null,E=R.end?new Date(R.end):W?new Date(W.getTime()+3600*1e3):null;if(!W||!E||Number.isNaN(W.getTime())||Number.isNaN(E.getTime()))return!1;const I=Math.max(y.getTime(),W.getTime()),ne=Math.min(L.getTime(),E.getTime());return I<ne})}catch{return!1}})()&&de!=="completed"?"conflict":de,xe={upcoming:"قادم",ongoing:"قيد التنفيذ",completed:"مكتمل",conflict:"تعارض"}[ae]||we,Ye={upcoming:"timeline-status-badge timeline-status-badge--upcoming",ongoing:"timeline-status-badge timeline-status-badge--ongoing",completed:"timeline-status-badge timeline-status-badge--completed",conflict:"timeline-status-badge timeline-status-badge--conflict"}[ae]||"timeline-status-badge timeline-status-badge--upcoming",Ae=typeof t.paymentStatus=="string"?t.paymentStatus.toLowerCase():"",fe=bn(t),b=fe.length>0,h=b?0:Number(t.paidAmount)||0,S=b?0:Number(t.paidPercent)||0;let g=me,T,$,V,q,M,Q,H,K,Me,$e;const Ne=fn(fe),Xe=n("projects.focus.confirmed","✅ مشروع مؤكد"),Re=t.confirmed===!0||t.confirmed==="true"?`<span class="reservation-chip status-confirmed">${o(Xe)}</span>`:"";let _=[];if(A>0){const y=N.reduce((qe,ce)=>{const ca=Array.isArray(ce.items)?ce.items:[],Pt=Array.isArray(ce.crewAssignments)?ce.crewAssignments:[],ve=Pt.length?Pt:Array.isArray(ce.technicians)?ce.technicians:[],st=Ha({items:ca,technicianIds:Array.isArray(ve)&&!ve.length?ve:[],crewAssignments:Array.isArray(ve)&&ve.length&&typeof ve[0]=="object"?ve:[],discount:ce.discount??0,discountType:ce.discountType||"percent",applyTax:!1,start:ce.start,end:ce.end,companySharePercent:null});return qe.equipment+=Number(st.equipmentTotal||0),qe.crew+=Number(st.crewTotal||0),qe.crewCost+=Number(st.crewCostTotal||0),qe},{equipment:0,crew:0,crewCost:0}),L=Number(G||0),R=Number((y.equipment+y.crew+pe).toFixed(2)),W=Number.parseFloat(t?.discount??t?.discountValue??0)||0;let I=(t?.discountType==="amount"?"amount":"percent")==="amount"?W:R*(W/100);(!Number.isFinite(I)||I<0)&&(I=0),I>R&&(I=R);const ne=re===!0,be=t?.companyShareEnabled===!0||t?.companyShareEnabled==="true"||t?.company_share_enabled===!0||t?.company_share_enabled==="true",Y=Number.parseFloat(t?.companySharePercent??t?.company_share_percent??t?.companyShare??t?.company_share??0)||0,ye=be&&Y>0?Y:0,oe=Math.max(0,R-I),ie=Number((oe*(ye/100)).toFixed(2)),ue=ne?Number(((oe+ie)*Ue).toFixed(2)):0,Ce=Number((oe+ie+ue).toFixed(2)),ia=Number((Ce-ie-ue-L-y.crewCost).toFixed(2));y.equipment>0&&_.push({icon:"🎛️",label:n("projects.details.summary.equipmentTotal","إجمالي المعدات"),value:j(y.equipment)}),y.crew>0&&_.push({icon:"😎",label:n("projects.details.summary.crewTotal","إجمالي الفريق"),value:j(y.crew)}),y.crewCost>0&&_.push({icon:"🧾",label:n("projects.details.summary.crewCostTotal","تكلفة الفريق"),value:j(y.crewCost)}),L>0&&_.push({icon:"🧾",label:n("projects.details.summary.expensesTotal","تكلفة الخدمات الإنتاجية"),value:j(L)}),pe>0&&_.push({icon:"💼",label:n("projects.details.summary.servicesClientPrice","الخدمات الإنتاجية"),value:j(pe)}),I>0&&_.push({icon:"🏷️",label:n("projects.details.summary.discount","الخصم"),value:`−${j(I)}`}),_.push({icon:"🧮",label:n("projects.details.summary.grossAfterDiscount","الإجمالي بعد الخصم"),value:j(oe)}),ie>0&&_.push({icon:"🏦",label:n("projects.details.summary.companyShare","نسبة الشركة"),value:`−${j(ie)}`}),ue>0&&_.push({icon:"💸",label:n("projects.details.summary.tax","الضريبة (15٪)"),value:`−${j(ue)}`}),_.push({icon:"💵",label:n("projects.details.summary.netProfit","صافي الربح"),value:j(ia)}),_.push({icon:"💰",label:n("projects.details.summary.finalTotal","المجموع النهائي"),value:j(Ce)}),g=Ce}else{const y=Number(G||0),L=Math.max(0,Number(pe)||0),R=Number.parseFloat(t?.discount??t?.discountValue??0)||0;let E=(t?.discountType==="amount"?"amount":"percent")==="amount"?R:L*(R/100);(!Number.isFinite(E)||E<0)&&(E=0),E>L&&(E=L);const I=Math.max(0,L-E),ne=re===!0,be=t?.companyShareEnabled===!0||t?.companyShareEnabled==="true"||t?.company_share_enabled===!0||t?.company_share_enabled==="true",Y=Number.parseFloat(t?.companySharePercent??t?.company_share_percent??t?.companyShare??t?.company_share??0)||0,ye=be&&Y>0?Y:0,oe=Number((I*(ye/100)).toFixed(2)),ie=ne?Number(((I+oe)*Ue).toFixed(2)):0,ue=Number((I+oe+ie).toFixed(2)),Ce=Number((ue-oe-ie-y).toFixed(2));_=[],_.push({icon:"💼",label:n("projects.details.summary.servicesClientPrice","الخدمات الإنتاجية"),value:j(L)}),E>0&&_.push({icon:"🏷️",label:n("projects.details.summary.discount","الخصم"),value:`−${j(E)}`}),_.push({icon:"🧮",label:n("projects.details.summary.grossAfterDiscount","الإجمالي بعد الخصم"),value:j(I)}),oe>0&&_.push({icon:"🏦",label:n("projects.details.summary.companyShare","نسبة الشركة"),value:`−${j(oe)}`}),ie>0&&_.push({icon:"💸",label:n("projects.details.summary.tax","الضريبة (15٪)"),value:`−${j(ie)}`}),_.push({icon:"💵",label:n("projects.details.summary.netProfit","صافي الربح"),value:j(Ce)}),_.push({icon:"💰",label:n("projects.details.summary.finalTotal","المجموع النهائي"),value:j(ue)}),g=ue}T=Oe({totalAmount:g,paidAmount:h,paidPercent:S,history:fe}),$=ot({manualStatus:Ae||"unpaid",paidAmount:T.paidAmount,paidPercent:T.paidPercent,totalAmount:g}),V=n(`projects.paymentStatus.${$}`,$==="paid"?"Paid":$==="partial"?"Partial":"Unpaid"),q=$==="paid"?"status-paid":$==="partial"?"status-partial":"status-unpaid",M=Number.isFinite(Number(T.paidAmount))?Number(T.paidAmount):0,Q=Number.isFinite(Number(T.paidPercent))?Number(T.paidPercent):0,H=Math.max(0,Number((g-M).toFixed(2))),K=j(M),Me=`${x(Q.toFixed(2))}%`,$e=j(H);const Qe=_.map(({icon:y,label:L,value:R})=>`
  ...
  `,et=[{icon:"👤",label:n("projects.details.client","العميل"),value:d},{icon:"📞",label:n("projects.details.labels.clientPhone","رقم العميل"),value:m},{icon:"✉️",label:n("projects.details.labels.clientEmail","البريد الإلكتروني"),value:v},F?{icon:"🏢",label:n("projects.details.company","شركة العميل"),value:F}:null,{icon:"🏷️",label:n("projects.details.type","نوع المشروع"),value:`<span class="project-type-chip project-type-chip--${t.type||"default"}">${o(r)}</span>`},Lt("start",t.start),Lt("end",t.end)].filter(Boolean),tt=n("projects.details.overview.heading","معلومات المشروع"),Ee=`
  ...
  `,_e=A>0?n("projects.details.chips.linkedReservation","مربوط بحجز"):n("projects.details.chips.notLinkedReservation","غير مربوط بحجز"),at=A>0?"reservation-chip status-confirmed":"reservation-chip status-info",z=[`<span class="${Ye}">${o(xe)}</span>`,`<span class="${at}">${o(_e)}</span>`,`<span class="reservation-chip ${q}">${o(V)}</span>`,Re].filter(Boolean).join(""),nt=n("projects.details.expensesTotal","تكلفة الخدمات الإنتاجية"),Be=n("projects.details.reservationsTotal","إجمالي الحجوزات"),he=n("projects.details.expenses","خدمات إنتاجية ({amount})").replace("{amount}",j(G)),Z=rn(Array.isArray(t.expenses)?t.expenses:[]);f.detailsBody.innerHTML=`
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3">
          ...
          <div class="d-flex flex-column gap-2">
            <div class="form-check form-switch m-0">
              <input class="form-check-input" type="checkbox" role="switch" id="project-edit-company-share" name="project-company-share" data-company-share="${o(String(v))}" ${F?"checked":""}>
  ...
  `).join(""),Gn(e)}function Gn(e){try{const t=Kn(e),a="projects-revenue-breakdown";let s=document.getElementById(a);const r=[{label:n("reservations.reports.kpi.revenue.details.gross","الإيراد الكلي","Gross revenue"),value:ee(t.grossRevenue)},{label:n("reservations.reports.kpi.revenue.details.share","نسبة الشركة","Company share"),value:ee(t.companyShareTotal)},{label:n("reservations.reports.kpi.revenue.details.tax","الضريبة","Tax"),value:ee(t.taxTotal)},{label:n("reservations.reports.kpi.revenue.details.crewGross","إجمالي الطاقم","Crew total"),value:ee(t.crewTotal)},{label:n("reservations.reports.kpi.revenue.details.crew","تكلفة الطاقم","Crew cost"),value:ee(t.crewCostTotal)},{label:n("reservations.reports.kpi.revenue.details.equipment","إجمالي المعدات","Equipment total"),value:ee(t.equipmentTotalCombined)},{label:n("projects.reports.kpi.revenue.details.projectExpenses","تكلفة الخدمات الإنتاجية","Project expenses"),value:`−${ee(t.projectExpensesTotal)}`},{label:n("reservations.reports.kpi.revenue.details.net","صافي الربح","Net profit"),value:ee(t.netProfit)}],l=`
    ...
    `}).join("");if(p.tableBody.innerHTML=t,p.tableMeta){const a=n("projects.reports.table.meta","Showing {count} of {total} projects");p.tableMeta.textContent=a.replace("{count}",mt(e.length)).replace("{total}",mt(w.totalProjects))}}function ts(e,t){if(!e&&!t)return"—";const a=e?At(e.toISOString()):"—",s=t?At(t.toISOString()):"—";return t?`${a} → ${s}`:a}function ee(e){const t=Number(e)||0,s=We()==="ar"?"ar-SA-u-ca-gregory-nu-latn":"en-US",r=new Intl.NumberFormat(s,{minimumFractionDigits:0,maximumFractionDigits:0}).format(Math.round(t));return`${x(r)} SR`}function mt(e){const a=We()==="ar"?"ar-SA-u-ca-gregory-nu-latn":"en-US";return x(new Intl.NumberFormat(a).format(e))}function je(e){const a=We()==="ar"?"ar-SA-u-ca-gregory-nu-latn":"en-US";return x(new Intl.NumberFormat(a,{notation:"compact",compactDisplay:"short"}).format(e))}function as(){return We()==="ar"?"ar-SA-u-ca-gregory-nu-latn":"en-US"}function U(e=""){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}
