import{v as oa,w as ia,x as Mt,o as dt,s as L,t as n,l as Rt,n as j,A as ca,e as la,m as da,h as ua,i as pa,f as Pt,g as Oe}from"./auth.CFmUxZww.js";/* empty css              */import{i as ma}from"./dashboardShell.CpG9SyUN.js";import{d as f,r as Pe,a as Ne,u as Ce,s as T,b as fa,f as ut,h as ha,i as ba,j as o,k as S,l as ya,m as pt,n as va,o as wt,e as tt,p as Tt,q as ga,t as ja,g as xa,c as Sa,v as Pa,w as It,x as wa,y as Ta,z as Aa,A as $a,B as Ea,C as Na,D as Ca,E as ka,F as La,G as Da,H as Fa,I as Ue,J as Ma,K as _t,L as Ra,M as Ia}from"./form.DRYuBmS7.js";import"./customers.xSpaFc27.js";import{g as mt,b as _a,o as qe,q as at,a as Bt,D as nt,l as Ba}from"./reservationsService.BuzBSxm1.js";import{P as ft,l as ht,n as At,u as qt,o as bt,p as ze,t as He,v as qa,x as Ha,i as Va,h as Oa,w as Ua,y as st,z as rt,e as Ht,A as Vt,B as za,C as Wa}from"./controller.Dp7EiJmF.js";import{a as Ga}from"./calculations.JNZK6KVD.js";let $t=null;function Ja(e){e&&Ot()!==e&&dt({[ft]:e}).catch(t=>{console.warn("⚠️ [projects] Failed to persist projects main tab preference",t)})}function Ot(){return Mt()?.[ft]||""}function Ut(e){e&&ot()!==e&&dt({[ht]:e}).catch(t=>{console.warn("⚠️ [projects] Failed to persist projects sub-tab preference",t)})}function ot(){return Mt()?.[ht]||""}function Ka(e){if(!e)return"";const t=e.trim();return t?Object.values(At).includes(t)?t:At[t]||"":""}function Ya(){if(typeof window>"u")return"";try{const t=new URLSearchParams(window.location.search||"").get("subTab");if(t){const a=Ka(t);if(a)return a}}catch{}return""}function zt(e,t){!e||!f.tabPanes||!f.tabButtons||(f.tabButtons.forEach(a=>{const s=a===t;a.classList.toggle("active",s),a.classList.contains("tab-button")&&a.classList.toggle("tab-active",s)}),f.tabPanes.forEach(a=>{a.dataset.tabPane===e?a.classList.remove("d-none"):a.classList.add("d-none")}),t&&Ja(e))}function Xa(){if(!f.tabButtons||!f.tabButtons.length)return;f.tabButtons.forEach(a=>{a.dataset.tabListenerAttached!=="true"&&(a.addEventListener("click",s=>{s.preventDefault();const r=a.dataset.tabTarget;r&&(zt(r,a),r==="projects-section"&&(T.filters.search="",f.search&&(f.search.value=""),Pe(),Ne(),Ce()))}),a.dataset.tabListenerAttached="true")});const e=Ot(),t=e&&f.tabButtons.find(a=>a.dataset.tabTarget===e);t&&t.click()}function yt(e,t){!e||!f.projectSubTabButtons||!f.projectSubTabPanes||(f.projectSubTabButtons.forEach(a=>{const s=a===t;a.classList.toggle("active",s),a.classList.contains("tab")&&a.classList.toggle("tab-active",s)}),f.projectSubTabPanes.forEach(a=>{a.dataset.projectSubtab===e?a.classList.remove("d-none"):a.classList.add("d-none")}))}function Qa(){!f.projectSubTabButtons||!f.projectSubTabButtons.length||(f.projectSubTabButtons.forEach(e=>{e.dataset.tabListenerAttached!=="true"&&(e.addEventListener("click",t=>{t.preventDefault();const a=e.dataset.projectSubtabTarget;a&&(yt(a,e),Ut(a))}),e.dataset.tabListenerAttached="true")}),Za())}function Za(){const t=Ya()||ot();if(!t)return;const a=f.projectSubTabButtons?.[0],s=f.projectSubTabButtons?.find(l=>l.dataset.projectSubtabTarget===t)||a,r=s?.dataset.projectSubtabTarget;r&&(t!==ot()&&Ut(r),yt(r,s))}function en(){return f.tabButtons?f.tabButtons.find(t=>t.classList.contains("active"))?.dataset.tabTarget==="projects-section":!1}function Et(e={}){if(e){if(f.tabButtons&&f.tabButtons.length){const a=f.tabButtons.find(r=>r.classList.contains("active"))?.dataset.tabTarget||"",s=e[ft];if(s&&s!==a){const r=f.tabButtons.find(l=>l.dataset.tabTarget===s);r&&zt(s,r)}}if(f.projectSubTabButtons&&f.projectSubTabButtons.length&&en()){const a=f.projectSubTabButtons.find(r=>r.classList.contains("active"))?.dataset.projectSubtabTarget||"",s=e[ht];if(s&&s!==a){const r=f.projectSubTabButtons.find(l=>l.dataset.projectSubtabTarget===s);r&&yt(s,r)}}}}function tn(){$t||($t=oa(e=>{Et(e)})),ia().then(e=>{Et(e)}).catch(e=>{console.warn("⚠️ [projects] Failed to synchronise project preferences",e)})}function be(e){const t=T.projects.find(g=>String(g.id)===String(e));if(!t||!f.detailsBody)return;f.detailsBody.dataset.mode="view",f.detailsBody.dataset.projectId=String(t.id);const s=(T.customers.length?T.customers:Rt().customers||[]).find(g=>String(g.id)===String(t.clientId)),r=Kt(t.type),i=t.description?.trim()||n("projects.fallback.noDescription","لا يوجد وصف"),u=s?.customerName||n("projects.fallback.unknownClient","عميل غير معروف"),c=s?.phone??s?.customerPhone??t.clientPhone??t.customerPhone??"",m=c?j(String(c).trim()):n("projects.details.client.noPhone","لا يوجد رقم متاح"),d=s?.email??t.clientEmail??t.customerEmail??"",x=d?String(d).trim():n("projects.details.client.noEmail","لا يوجد بريد متاح"),D=(t.clientCompany||s?.companyName||"").trim(),N=t.projectCode||`PRJ-${j(String(t.id))}`,I=j(N),A=ut(t.id),ae=A.reduce((g,E)=>g+Yt(E),0),C=Number(ae.toFixed(2)),$=A.length,{subtotal:H,applyTax:Q,expensesTotal:K}=ha(t),de=Number(t?.servicesClientPrice??t?.services_client_price??0),ke=H,we=Q?Number(((ke+C)*He).toFixed(2)):0,ue=Number((ke+C+we).toFixed(2)),pe=ba(t),Te=n(`projects.status.${pe}`,qa[pe]||pe),re={upcoming:"status-pending",ongoing:"status-confirmed",completed:"status-completed"}[pe]||"status-confirmed",oe=Q?n("projects.details.chips.vatOn","شامل الضريبة 15٪"):n("projects.details.chips.vatOff","غير شامل الضريبة"),ve=Q?"status-paid":"status-unpaid",ge=n("projects.details.chips.reservations","{count} حجوزات").replace("{count}",j(String($))),Ge=typeof t.paymentStatus=="string"?t.paymentStatus.toLowerCase():"",me=mn(t),je=me.length>0,b=je?0:Number(t.paidAmount)||0,h=je?0:Number(t.paidPercent)||0;let y=ue,v,w,F,q,M,R,Z,_,Y,Le;const De=un(me),Ae=n("projects.focus.confirmed","✅ مشروع مؤكد"),Je=t.confirmed===!0||t.confirmed==="true"?`<span class="reservation-chip status-confirmed">${o(Ae)}</span>`:"";let k=[];if($>0){const g=A.reduce((Ie,ce)=>{const ra=Array.isArray(ce.items)?ce.items:[],St=Array.isArray(ce.crewAssignments)?ce.crewAssignments:[],he=St.length?St:Array.isArray(ce.technicians)?ce.technicians:[],et=_a({items:ra,technicianIds:Array.isArray(he)&&!he.length?he:[],crewAssignments:Array.isArray(he)&&he.length&&typeof he[0]=="object"?he:[],discount:ce.discount??0,discountType:ce.discountType||"percent",applyTax:!1,start:ce.start,end:ce.end,companySharePercent:null});return Ie.equipment+=Number(et.equipmentTotal||0),Ie.crew+=Number(et.crewTotal||0),Ie.crewCost+=Number(et.crewCostTotal||0),Ie},{equipment:0,crew:0,crewCost:0}),E=Number(K||0),V=Number((g.equipment+g.crew+de).toFixed(2)),le=Number.parseFloat(t?.discount??t?.discountValue??0)||0;let O=(t?.discountType==="amount"?"amount":"percent")==="amount"?le:V*(le/100);(!Number.isFinite(O)||O<0)&&(O=0),O>V&&(O=V);const U=Q===!0,ie=t?.companyShareEnabled===!0||t?.companyShareEnabled==="true"||t?.company_share_enabled===!0||t?.company_share_enabled==="true",ne=Number.parseFloat(t?.companySharePercent??t?.company_share_percent??t?.companyShare??t?.company_share??0)||0,fe=ie&&ne>0?ne:0,B=Math.max(0,V-O),J=Number((B*(fe/100)).toFixed(2)),xe=U?Number(((B+J)*He).toFixed(2)):0,Se=Number((B+J+xe).toFixed(2)),sa=Number((Se-J-xe-E-g.crewCost).toFixed(2));g.equipment>0&&k.push({icon:"🎛️",label:n("projects.details.summary.equipmentTotal","إجمالي المعدات"),value:S(g.equipment)}),g.crew>0&&k.push({icon:"😎",label:n("projects.details.summary.crewTotal","إجمالي الفريق"),value:S(g.crew)}),g.crewCost>0&&k.push({icon:"🧾",label:n("projects.details.summary.crewCostTotal","تكلفة الفريق"),value:S(g.crewCost)}),E>0&&k.push({icon:"🧾",label:n("projects.details.summary.expensesTotal","تكلفة خدمات الإنتاجية"),value:S(E)}),de>0&&k.push({icon:"💼",label:n("projects.details.summary.servicesClientPrice","سعر العميل للخدمات الإنتاجية"),value:S(de)}),O>0&&k.push({icon:"🏷️",label:n("projects.details.summary.discount","الخصم"),value:`−${S(O)}`}),k.push({icon:"🧮",label:n("projects.details.summary.grossAfterDiscount","الإجمالي بعد الخصم"),value:S(B)}),J>0&&k.push({icon:"🏦",label:n("projects.details.summary.companyShare","نسبة الشركة"),value:`−${S(J)}`}),xe>0&&k.push({icon:"💸",label:n("projects.details.summary.tax","الضريبة (15٪)"),value:`−${S(xe)}`}),k.push({icon:"💵",label:n("projects.details.summary.netProfit","صافي الربح"),value:S(sa)}),k.push({icon:"💰",label:n("projects.details.summary.finalTotal","المجموع النهائي"),value:S(Se)}),y=Se}else{const g=Number(K||0),E=Math.max(0,Number(de)||0),V=Number.parseFloat(t?.discount??t?.discountValue??0)||0;let G=(t?.discountType==="amount"?"amount":"percent")==="amount"?V:E*(V/100);(!Number.isFinite(G)||G<0)&&(G=0),G>E&&(G=E);const O=Math.max(0,E-G),U=Q===!0,ie=t?.companyShareEnabled===!0||t?.companyShareEnabled==="true"||t?.company_share_enabled===!0||t?.company_share_enabled==="true",ne=Number.parseFloat(t?.companySharePercent??t?.company_share_percent??t?.companyShare??t?.company_share??0)||0,fe=ie&&ne>0?ne:0,B=Number((O*(fe/100)).toFixed(2)),J=U?Number(((O+B)*He).toFixed(2)):0,xe=Number((E-G-B-J-g).toFixed(2)),Se=Number((O+B+J).toFixed(2));k=[],k.push({icon:"💼",label:n("projects.details.summary.servicesClientPrice","الخدمات الإنتاجية"),value:S(E)}),G>0&&k.push({icon:"🏷️",label:n("projects.details.summary.discount","الخصم"),value:`−${S(G)}`}),k.push({icon:"🧮",label:n("projects.details.summary.grossAfterDiscount","الإجمالي بعد الخصم"),value:S(O)}),B>0&&k.push({icon:"🏦",label:n("projects.details.summary.companyShare","نسبة الشركة"),value:`−${S(B)}`}),J>0&&k.push({icon:"💸",label:n("projects.details.summary.tax","الضريبة (15٪)"),value:`−${S(J)}`}),k.push({icon:"💵",label:n("projects.details.summary.netProfit","صافي الربح"),value:S(xe)}),k.push({icon:"💰",label:n("projects.details.summary.finalTotal","المجموع النهائي"),value:S(Se)}),y=Se}v=qe({totalAmount:y,paidAmount:b,paidPercent:h,history:me}),w=at({manualStatus:Ge||"unpaid",paidAmount:v.paidAmount,paidPercent:v.paidPercent,totalAmount:y}),F=n(`projects.paymentStatus.${w}`,w==="paid"?"Paid":w==="partial"?"Partial":"Unpaid"),q=w==="paid"?"status-paid":w==="partial"?"status-partial":"status-unpaid",M=Number.isFinite(Number(v.paidAmount))?Number(v.paidAmount):0,R=Number.isFinite(Number(v.paidPercent))?Number(v.paidPercent):0,Z=Math.max(0,Number((y-M).toFixed(2))),_=S(M),Y=`${j(R.toFixed(2))}%`,Le=S(Z);const xt=k.map(({icon:g,label:E,value:V})=>`
    <div class="summary-details-row">
      <span class="summary-details-label">${g} ${o(E)}</span>
  ...
  `,Me=[`<span class="reservation-chip ${re}">${o(Te)}</span>`,`<span class="reservation-chip ${ve}">${o(oe)}</span>`,`<span class="reservation-chip status-info">${o(ge)}</span>`,`<span class="reservation-chip ${q}">${o(F)}</span>`,Je].filter(Boolean).join(""),Qe=n("projects.details.expensesTotal","إجمالي المصاريف"),W=n("projects.details.reservationsTotal","إجمالي الحجوزات"),Ze=n("projects.details.expenses","خدمات إنتاجية ({amount})").replace("{amount}",S(K)),Re=an(Array.isArray(t.expenses)?t.expenses:[]);f.detailsBody.innerHTML=`
  ...
  `}function nn({onOpenProject:e}){!f.focusCards||f.focusCards.dataset.listenerAttached==="true"||(f.focusCards.addEventListener("click",t=>{const a=t.target.closest("[data-action]");if(a){const{action:r,id:l}=a.dataset;if(r==="confirm-project"){t.preventDefault(),t.stopPropagation(),cn(l);return}r==="view"?e?.(l):r==="highlight"&&sn(l);return}const s=t.target.closest(".project-focus-card");s?.dataset.projectId&&e?.(s.dataset.projectId)}),f.focusCards.dataset.listenerAttached="true")}function sn(e){if(!f.projectsTableBody)return;const t=`tr[data-project-id="${CSS.escape(String(e))}"]`,a=f.projectsTableBody.querySelector(t);if(!a){L(n("projects.focus.toastNotFound","⚠️ تعذّر العثور على المشروع في القائمة"));return}a.classList.add("project-row-highlight"),a.scrollIntoView({behavior:"smooth",block:"center"}),window.setTimeout(()=>{a.classList.remove("project-row-highlight")},2200)}function rn(e){if(!f.detailsBody)return;const t=f.detailsBody.querySelector('[data-action="create-reservation"]'),a=f.detailsBody.querySelector('[data-action="edit-project"]'),s=f.detailsBody.querySelector('[data-action="delete-project"]'),r=f.detailsBody.querySelector(".project-reservations-list");if(t&&e)try{(ut(e.id)||[]).some(u=>{const c=String(u?.status||u?.reservationStatus||"").toLowerCase();return c!=="cancelled"&&c!=="canceled"})?(t.disabled=!0,t.classList?.add("disabled"),t.setAttribute?.("aria-disabled","true"),t.title=n("projects.details.reservations.createDisabled","⚠️ يوجد حجز مرتبط بالفعل بهذا المشروع")):(t.disabled=!1,t.classList?.remove("disabled"),t.removeAttribute?.("aria-disabled"),t.removeAttribute?.("title"),t.addEventListener("click",u=>{u.preventDefault(),Nt(e)}))}catch{t.disabled=!1,t.classList?.remove("disabled"),t.removeAttribute?.("aria-disabled"),t.removeAttribute?.("title"),t.addEventListener("click",i=>{i.preventDefault(),Nt(e)})}if(a&&e&&a.addEventListener("click",l=>{l.preventDefault(),Wt(e)}),s&&e&&s.addEventListener("click",async l=>{l.preventDefault();const i=l.currentTarget;i.disabled=!0;try{await va(e.id),!T.projects.some(c=>String(c.id)===String(e.id))&&f.detailsModalEl&&window.bootstrap?.Modal.getInstance(f.detailsModalEl)?.hide()}finally{T.projects.some(c=>String(c.id)===String(e.id))&&(i.disabled=!1)}}),r){const l=async i=>{if(!Number.isInteger(i)||i<0)return!1;const u=Oa("showReservationDetails");if(typeof u=="function")return u(i),!0;try{const c=await Ua("showReservationDetails");if(typeof c=="function")return c(i),!0}catch(c){console.warn("⚠️ [projects/projectDetails] Unable to resolve reservation UI handler",c)}return!1};r.addEventListener("click",async i=>{const u=i.target.closest('[data-action="view-reservation"]');if(!u)return;const c=u.dataset.index||u.dataset.reservationIndex,m=Number.parseInt(c||"-1",10);if(!Number.isInteger(m)||m<0)return;await l(m)||(window.location.href="dashboard.html#reservations")}),r.addEventListener("keydown",i=>{if(!["Enter"," "].includes(i.key))return;const u=i.target.closest('[data-action="view-reservation"]');u&&(i.preventDefault(),u.click())})}}function Wt(e){if(!e||!f.detailsBody)return;const t=T.projects.find(d=>String(d.id)===String(e.id));if(!t)return;const a=T.customers.find(d=>String(d.id)===String(t.clientId));a?.customerName||a?.name||t.clientName||t.customerName,t.clientCompany||a?.companyName||a?.company;const s=Array.isArray(t.expenses)?t.expenses.map((d,x)=>({id:d?.id||`expense-${t.id}-${x}-${Date.now()}`,label:d?.label||"",amount:Number(d?.amount)||0,salePrice:Number.isFinite(Number(d?.sale_price??d?.salePrice))?Number(d?.sale_price??d?.salePrice):0})):[];let r=Array.isArray(t.paymentHistory)?t.paymentHistory.map((d,x)=>({type:d?.type==="percent"?"percent":"amount",amount:Number.isFinite(Number(d?.amount))?Number(d.amount):null,percentage:Number.isFinite(Number(d?.percentage))?Number(d.percentage):null,value:Number.isFinite(Number(d?.value))?Number(d.value):null,note:d?.note??null,recordedAt:d?.recordedAt??d?.recorded_at??new Date().toISOString(),key:`payment-${t.id}-${x}`})):[],l=r.reduce((d,x)=>d+(Number(x?.amount)||0),0),i=r.reduce((d,x)=>d+(Number(x?.percentage)||0),0),u=Number.isFinite(Number(t.paidAmount))?Number(t.paidAmount):0,c=Number.isFinite(Number(t.paidPercent))?Number(t.paidPercent):0;if(!r.length&&(u>0||c>0)){const d=t.updatedAt??t.createdAt??new Date().toISOString();c>0?r=[{type:"percent",amount:Number.isFinite(u)&&u>0?u:null,percentage:c,value:c,note:null,recordedAt:d,key:`legacy-payment-${t.id}-percent`}]:u>0&&(r=[{type:"amount",amount:u,percentage:null,value:u,note:null,recordedAt:d,key:`legacy-payment-${t.id}-amount`}]),l=r.reduce((x,D)=>x+(Number(D?.amount)||0),0),i=r.reduce((x,D)=>x+(Number(D?.percentage)||0),0),u=0,c=0}l>0&&Math.abs(u-l)<.01&&(u=0),i>0&&Math.abs(c-i)<.01&&(c=0);const m={expenses:s,payments:r,basePaidAmount:u,basePaidPercent:c};f.detailsBody.dataset.mode="edit",f.detailsBody.innerHTML=ln(t,m),on(t,m)}function on(e,t={expenses:[]}){const a=f.detailsBody?.querySelector("#project-details-edit-form");if(!a)return;const s=a.querySelector('[data-action="cancel-edit"]');s&&s.addEventListener("click",b=>{b.preventDefault(),be(e.id)});const r=a.querySelector("#project-edit-expense-label"),l=a.querySelector("#project-edit-expense-amount"),i=a.querySelector("#project-edit-expense-sale"),u=a.querySelector('[data-action="add-expense"]'),c=a.querySelector("#project-edit-expense-list"),m=a.querySelector('[name="project-start-date"]'),d=a.querySelector('[name="project-start-time"]'),x=a.querySelector('[name="project-end-date"]'),D=a.querySelector('[name="project-end-time"]'),N=a.querySelector('[name="project-payment-status"]'),I=a.querySelector("#project-edit-tax"),A=a.querySelector("#project-edit-company-share"),ae=a.querySelector("#project-edit-discount"),C=a.querySelector("#project-edit-discount-type"),$=a.querySelector("#project-edit-payment-progress-type"),H=a.querySelector("#project-edit-payment-progress-value"),Q=a.querySelector("#project-edit-payment-add"),K=a.querySelector("#project-edit-payment-history"),de=a.querySelector("#project-edit-payment-summary"),ke=n("reservations.create.summary.currency","SR");let we=!1;const ue=()=>(Array.isArray(t.payments)||(t.payments=[]),t.payments),pe=()=>{const b=Number(e.equipmentEstimate)||0,h=Array.isArray(t.expenses)?t.expenses.reduce((_,Y)=>_+(Number(Y.amount)||0),0):0,y=Array.isArray(t.expenses)?Math.max(0,Math.round(t.expenses.reduce((_,Y)=>_+Number(Y?.salePrice??0),0)*100)/100):Math.max(0,Number(e?.servicesClientPrice??0)),v=C?.value==="amount"?"amount":"percent",w=j(ae?.value||"0");let F=Number.parseFloat(w);(!Number.isFinite(F)||F<0)&&(F=0);const q=I?.checked===!0,M=A?.checked===!0;let R=M?xa(A):null;(!Number.isFinite(R)||R<=0)&&(R=M?nt:null);const Z=Sa({equipmentEstimate:b,expensesTotal:h,servicesClientPrice:y,discountValue:F,discountType:v,applyTax:q,companyShareEnabled:M,companySharePercent:R});return{equipmentEstimate:b,expensesTotal:h,discountValue:F,discountTypeValue:v,applyTax:q,companyShareEnabled:M,companySharePercent:R,servicesClientPrice:y,finance:Z}},Te=()=>{const b=pe(),h=ue(),v=(ut(e.id)||[]).reduce((R,Z)=>R+(Number(Z?.totalAmount)||Yt(Z)||0),0),w=Number(b.finance?.taxableAmount||0),F=b.applyTax?Number(((w+v)*He).toFixed(2)):0,q=Number((w+v+F).toFixed(2)),M=qe({totalAmount:q,paidAmount:t.basePaidAmount||0,paidPercent:t.basePaidPercent||0,history:h});return{...b,combinedTotalWithTax:q,payments:h,progress:M}},jt=()=>{K&&(K.innerHTML=pn(ue()))},re=()=>{if(!de)return;const{combinedTotalWithTax:b,progress:h}=Te(),y=Number.isFinite(Number(b))?Number(b):0,v=Number.isFinite(Number(h.paidAmount))?Number(h.paidAmount):0,w=Number.isFinite(Number(h.paidPercent))?Number(h.paidPercent):0,F=Math.max(0,Math.round((y-v)*100)/100),q=[{label:n("projects.form.paymentSummary.total","الإجمالي الكلي"),value:S(y)},{label:n("projects.form.paymentSummary.paidAmount","إجمالي المدفوع"),value:S(v)},{label:n("projects.form.paymentSummary.paidPercent","نسبة الدفعات"),value:`${j(w.toFixed(2))}%`},{label:n("projects.form.paymentSummary.remaining","المتبقي"),value:S(F)}];de.innerHTML=q.map(({label:M,value:R})=>`
        <div class="project-details-grid-item">
          <span>${o(M)}</span>
          <strong>${o(R)}</strong>
        </div>
      `).join("")},oe=(b="auto")=>{if(!N)return;const h=N.dataset?.userSelected==="true";if(b==="auto"&&h)return;const{finance:y,progress:v}=Te(),w=at({manualStatus:h?N.value:e.paymentStatus||"unpaid",paidAmount:v.paidAmount,paidPercent:v.paidPercent,totalAmount:y.totalWithTax});h||(N.value=w)},ve=()=>{jt(),re(),oe("auto")},ge=1e-4,Ge=()=>{const b=$?.value==="amount"?"amount":"percent",h=j(H?.value||"").replace("%","").trim();let y=Number.parseFloat(h);if(!Number.isFinite(y)||y<=0){L(n("projects.toast.paymentInvalid","⚠️ يرجى إدخال قيمة دفعة صحيحة")),H?.focus();return}const v=Te(),w=Number.isFinite(Number(v.finance.totalWithTax))?Number(v.finance.totalWithTax):0;if(w<=0){L(n("projects.toast.paymentTotalMissing","⚠️ يرجى التأكد من إدخال البيانات المالية للمشروع قبل تسجيل الدفعة"));return}const F=Number(v.progress.paidAmount)||0,q=Number(v.progress.paidPercent)||0;let M=null,R=null;if(b==="percent"){const _=Math.max(0,100-q);if(_<=ge){L(n("projects.toast.paymentNoRemainingBalance","⚠️ تم تسجيل كامل قيمة المشروع، لا يمكن إضافة دفعة جديدة"));return}if(y>_){y=_;const Y=j(y.toFixed(2));L(n("projects.toast.paymentCappedPercent","ℹ️ تم ضبط الدفعة إلى {value}% لاستكمال 100%").replace("{value}",Y))}R=Math.round(y*100)/100,w>0&&(M=Math.round(R/100*w*100)/100)}else{const _=Math.max(0,w-F);if(_<=ge){L(n("projects.toast.paymentNoRemainingBalance","⚠️ تم تسجيل كامل قيمة المشروع، لا يمكن إضافة دفعة جديدة"));return}if(y>_){y=_;const Y=`${j(y.toFixed(2))} ${ke}`;L(n("projects.toast.paymentCappedAmount","ℹ️ تم ضبط الدفعة إلى {amount} لاستكمال المبلغ المتبقي").replace("{amount}",Y))}M=Math.round(y*100)/100,w>0&&(R=Math.round(M/w*100*100)/100)}const Z={type:b,amount:M??null,percentage:R??null,value:b==="amount"?M:R,note:null,recordedAt:new Date().toISOString()};t.payments=[...ue(),Z],H&&(H.value=""),$&&($.value="percent"),ve(),L(n("projects.toast.paymentAdded","✅ تم تسجيل الدفعة"))},me=b=>{!I||!A||we||(we=!0,b==="share"?A.checked?(I.checked||(I.checked=!0),tt(A)):I.checked&&(I.checked=!1):b==="tax"&&(I.checked?tt(A):A.checked&&(A.checked=!1)),we=!1)};function je(){c&&(c.innerHTML=Gt(t.expenses))}je(),ve(),ae&&!ae.dataset.listenerAttached&&(ae.addEventListener("input",b=>{const h=b.target;h instanceof HTMLInputElement&&(h.value=j(h.value||""),re(),oe("auto"))}),ae.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.addEventListener("input",b=>{const h=b.target;h instanceof HTMLInputElement&&(h.value=j(h.value||""))}),i.dataset.listenerAttached="true"),C&&!C.dataset.listenerAttached&&(C.addEventListener("change",()=>{re(),oe("auto")}),C.dataset.listenerAttached="true"),H&&!H.dataset.listenerAttached&&(H.addEventListener("input",b=>{const h=b.target;h instanceof HTMLInputElement&&(h.value=j(h.value||""))}),H.dataset.listenerAttached="true"),N&&!N.dataset.listenerAttached&&(N.addEventListener("change",()=>{N.dataset.userSelected="true"}),N.dataset.listenerAttached="true"),l&&!l.dataset.listenerAttached&&(l.addEventListener("input",b=>{const h=b.target;h instanceof HTMLInputElement&&(h.value=j(h.value||""))}),l.dataset.listenerAttached="true"),A&&!A.dataset.listenerAttached&&(A.addEventListener("change",()=>{me("share"),re(),oe("auto")}),A.dataset.listenerAttached="true"),I&&!I.dataset.listenerAttached&&(I.addEventListener("change",()=>{me("tax"),re(),oe("auto")}),I.dataset.listenerAttached="true"),A?.checked&&tt(A),me(A?.checked?"share":"tax"),re(),oe("auto"),u&&u.addEventListener("click",b=>{b.preventDefault();const h=r?.value.trim()||"",y=j(l?.value||"0"),v=Number(y),w=j(i?.value||"0"),F=Number(w);if(!h){L(n("projects.toast.missingExpenseLabel","⚠️ يرجى إدخال وصف المصروف")),r?.focus();return}if(!Number.isFinite(v)||v<=0){L(n("projects.toast.invalidExpenseAmount","⚠️ يرجى إدخال مبلغ صحيح")),l?.focus();return}t.expenses.push({id:`expense-${e.id}-${Date.now()}`,label:h,amount:v,salePrice:Number.isFinite(F)&&F>0?F:0}),r&&(r.value=""),l&&(l.value=""),i&&(i.value=""),je(),re(),oe("auto")}),c&&c.addEventListener("click",b=>{const h=b.target.closest('[data-action="remove-expense"]');if(!h)return;const{id:y}=h.dataset;t.expenses=t.expenses.filter(v=>String(v.id)!==String(y)),je(),re(),oe("auto")}),Q&&!Q.dataset.listenerAttached&&(Q.addEventListener("click",b=>{b.preventDefault(),Ge()}),Q.dataset.listenerAttached="true"),K&&!K.dataset.listenerAttached&&(K.addEventListener("click",b=>{const h=b.target.closest('[data-action="remove-payment"]');if(!h)return;const y=Number.parseInt(h.dataset.index||"-1",10);if(!Number.isInteger(y)||y<0)return;const v=ue();if(y>=v.length)return;const w=v.filter((F,q)=>q!==y);t.payments=w,ve(),L(n("projects.toast.paymentRemoved","🗑️ تم حذف الدفعة"))}),K.dataset.listenerAttached="true"),a.addEventListener("submit",async b=>{if(b.preventDefault(),a.dataset.submitting==="true")return;const h=a.querySelector('[name="project-title"]'),y=a.querySelector('[name="project-type"]'),v=a.querySelector('[name="project-description"]'),w=h?.value.trim()||"",F=y?.value||"",q=m?.value.trim()||"",M=d?.value.trim()||"",R=v?.value.trim()||"",Z=(N?.value||"unpaid").toLowerCase(),_=["paid","partial"].includes(Z)?Z:"unpaid";if(!w||!F||!q){L(n("projects.toast.missingRequiredFields","⚠️ يرجى تعبئة البيانات المطلوبة")),h?.focus();return}const Y=x?.value.trim()||"",Le=D?.value.trim()||"",De=Tt(q,M),Ae=Y?Tt(Y,Le):"",Je=new Date(De),k=Ae?new Date(Ae):null;if(k&&Je>k){L(n("projects.toast.invalidDateRange","⚠️ تاريخ النهاية يجب أن يكون بعد تاريخ البداية")),x?.focus();return}if(T.projects.findIndex(U=>String(U.id)===String(e.id))===-1){L(n("projects.toast.editMissing","⚠️ تعذّر العثور على المشروع المطلوب تعديله"));return}const Fe=pe(),{equipmentEstimate:Ke,discountValue:Ye,discountTypeValue:Xe,applyTax:$e,companyShareEnabled:Me,companySharePercent:Qe,finance:W}=Fe,Ze=$?.value==="amount"?"amount":"percent",Re=j(H?.value||"");let ee=Re?Number.parseFloat(Re):null,g=[...ue()];if(Number.isFinite(ee)&&ee>0&&Number.isFinite(Number(W.totalWithTax))){const U=qe({totalAmount:W.totalWithTax,paidAmount:t.basePaidAmount||0,paidPercent:t.basePaidPercent||0,history:g}),ie=new Date().toISOString();if(Ze==="percent"){const ne=Math.max(0,100-(U.paidPercent||0));if(ne>ge){const fe=Math.min(ee,ne),B=Math.round(fe*100)/100,J=W.totalWithTax>0?Math.round(B/100*W.totalWithTax*100)/100:null;g=[...g,{type:"percent",amount:J,percentage:B,value:B,note:null,recordedAt:ie}]}}else{const ne=Math.max(0,W.totalWithTax-(U.paidAmount||0));if(ne>ge){const fe=Math.min(ee,ne),B=Math.round(fe*100)/100,J=W.totalWithTax>0?Math.round(B/W.totalWithTax*100*100)/100:null;g=[...g,{type:"amount",amount:B,percentage:J,value:B,note:null,recordedAt:ie}]}}g!==t.payments&&(t.payments=g,ve()),H&&(H.value=""),$&&($.value="percent"),ee=null}const E=qe({totalAmount:W.totalWithTax,paidAmount:t.basePaidAmount||0,paidPercent:t.basePaidPercent||0,history:g}),V=N?.dataset?.userSelected==="true",le=at({manualStatus:V?_:e.paymentStatus||_,paidAmount:E.paidAmount,paidPercent:E.paidPercent,totalAmount:W.totalWithTax}),G=V?_:le;!V&&N&&(N.value=G),N?.dataset&&delete N.dataset.userSelected,t.payments=g;const O=Va({projectCode:e.projectCode,title:w,type:F,clientId:e.clientId,clientCompany:e.clientCompany,description:R,start:De,end:Ae||null,applyTax:$e,paymentStatus:G,equipmentEstimate:Ke,expenses:t.expenses,servicesClientPrice:context.servicesClientPrice,discount:Ye,discountType:Xe,companyShareEnabled:Me&&$e,companySharePercent:Me&&$e?Qe:null,companyShareAmount:W.companyShareAmount,taxAmount:W.taxAmount,totalWithTax:W.totalWithTax,confirmed:e.confirmed,technicians:Array.isArray(e.technicians)?e.technicians:[],equipment:ga(e),paidAmount:E.paidAmount,paidPercentage:E.paidPercent,paymentProgressType:E.paymentProgressType,paymentProgressValue:E.paymentProgressValue,payments:g});a.dataset.submitting="true";try{const U=await qt(e.projectId??e.id,O),ie=U?.projectId??U?.id??e.id;await ja(ie,G),T.projects=bt(),T.reservations=mt(),L(n("projects.toast.updated","✅ تم تحديث المشروع بنجاح")),Pe(),Ne(),Ce(),be(e.id)}catch(U){console.error("❌ [projects] Failed to update project from details view",U);const ie=ze(U)?U.message:n("projects.toast.updateFailed","تعذر تحديث المشروع، حاول مرة أخرى");L(ie,"error")}finally{delete a.dataset.submitting}})}function Nt(e){if(!e)return;const t={projectId:e.id,customerId:e.clientId||null,start:e.start||null,end:e.end||null,forceNotes:!!e.description,fromProjectForm:!0,draftStorageKey:"projects:create:draft",returnUrl:`projects.html?project=${encodeURIComponent(e.id)}&linked=1#projects-section`};dt({dashboardTab:"reservations-tab",dashboardSubTab:"create-tab"}).catch(r=>{console.warn("⚠️ [projects] Failed to persist dashboard tab preference",r)});let a="";try{a=encodeURIComponent(JSON.stringify(t))}catch(r){console.warn("⚠️ [projects] Unable to encode reservation context",r)}f.detailsModalEl&&window.bootstrap?.Modal&&window.bootstrap.Modal.getOrCreateInstance(f.detailsModalEl)?.hide();const s=a?`?reservationProjectContext=${a}`:"";window.location.href=`dashboard.html${s}#reservations`}async function cn(e){if(!e)return;const t=T.projects.find(a=>String(a.id)===String(e));if(!t){L(n("projects.toast.editMissing","⚠️ تعذّر العثور على المشروع المطلوب تعديله"));return}if(t.confirmed===!0||t.confirmed==="true"){L(n("projects.toast.alreadyConfirmed","ℹ️ المشروع مؤكّد مسبقًا"));return}try{await qt(t.projectId??t.id,{confirmed:!0});const a=await fa(e);T.projects=bt(),T.reservations=mt(),Pe(),Ne(),Ce(),f.detailsModalEl&&f.detailsModalEl.classList.contains("show")&&f.detailsBody?.dataset.projectId===String(e)&&be(e),document.dispatchEvent(new CustomEvent("projects:changed")),a&&document.dispatchEvent(new CustomEvent("reservations:changed")),L(n("projects.toast.confirmed","✅ تم تأكيد المشروع"))}catch(a){console.error("❌ [projects] confirmProject failed",a);const s=ze(a)?a.message:n("projects.toast.updateFailed","تعذر تحديث المشروع، حاول مرة أخرى");L(s,"error")}}function ln(e,t={clientName:"",clientCompany:"",expenses:[]}){const{date:a,time:s}=wt(e.start||""),{date:r,time:l}=wt(e.end||""),i=e.applyTax===!0||e.applyTax==="true";typeof e.paymentStatus=="string"&&e.paymentStatus.toLowerCase();const u=e.discountType==="amount"?"amount":"percent",c=j(String(e.discount??e.discountValue??0));j(String(e.servicesClientPrice??e.services_client_price??0));const m=e.companySharePercent??e.company_share_percent??e.companyShare??e.company_share??e.companyShareAmountPercent??nt,d=Number.parseFloat(j(String(m))),x=Number.isFinite(d)&&d>0?d:nt,D=e.companyShareEnabled===!0||e.companyShareEnabled==="true"||e.company_share_enabled===!0||e.company_share_enabled==="true"||i&&Number.isFinite(d)&&d>0;return`
  ...
  `).join(""),Un(e)}function Un(e){try{const t=zn(e),a="projects-revenue-breakdown";let s=document.getElementById(a);const r=[{label:n("reservations.reports.kpi.revenue.details.gross","الإيراد الكلي","Gross revenue"),value:te(t.grossRevenue)},{label:n("reservations.reports.kpi.revenue.details.share","نسبة الشركة","Company share"),value:te(t.companyShareTotal)},{label:n("reservations.reports.kpi.revenue.details.tax","الضريبة","Tax"),value:te(t.taxTotal)},{label:n("reservations.reports.kpi.revenue.details.crewGross","إجمالي الطاقم","Crew total"),value:te(t.crewTotal)},{label:n("reservations.reports.kpi.revenue.details.crew","تكلفة الطاقم","Crew cost"),value:te(t.crewCostTotal)},{label:n("reservations.reports.kpi.revenue.details.equipment","إجمالي المعدات","Equipment total"),value:te(t.equipmentTotalCombined)},{label:n("projects.reports.kpi.revenue.details.projectExpenses","مصروفات المشروع","Project expenses"),value:`−${te(t.projectExpensesTotal)}`},{label:n("reservations.reports.kpi.revenue.details.net","صافي الربح","Net profit"),value:te(t.netProfit)}],l=`
    ...
    `}).join("");if(p.tableBody.innerHTML=t,p.tableMeta){const a=n("projects.reports.table.meta","Showing {count} of {total} projects");p.tableMeta.textContent=a.replace("{count}",lt(e.length)).replace("{total}",lt(P.totalProjects))}}function Qn(e,t){if(!e&&!t)return"—";const a=e?Pt(e.toISOString()):"—",s=t?Pt(t.toISOString()):"—";return t?`${a} → ${s}`:a}function te(e){const t=Number(e)||0,s=Oe()==="ar"?"ar-SA-u-ca-gregory-nu-latn":"en-US",r=new Intl.NumberFormat(s,{minimumFractionDigits:0,maximumFractionDigits:0}).format(Math.round(t));return`${j(r)} SR`}function lt(e){const a=Oe()==="ar"?"ar-SA-u-ca-gregory-nu-latn":"en-US";return j(new Intl.NumberFormat(a).format(e))}function ye(e){const a=Oe()==="ar"?"ar-SA-u-ca-gregory-nu-latn":"en-US";return j(new Intl.NumberFormat(a,{notation:"compact",compactDisplay:"short"}).format(e))}function Zn(){return Oe()==="ar"?"ar-SA-u-ca-gregory-nu-latn":"en-US"}function z(e=""){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}
