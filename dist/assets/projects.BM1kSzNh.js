import{v as oa,w as ia,x as Rt,o as dt,s as C,t as n,l as Mt,n as g,A as ca,e as la,m as da,h as ua,i as pa,f as Pt,g as He}from"./auth.CFmUxZww.js";/* empty css              */import{i as ma}from"./dashboardShell.CpG9SyUN.js";import{d as f,r as je,a as $e,u as Ee,s as T,b as fa,f as ut,h as ha,i as ba,j as o,k as S,l as ya,m as pt,n as va,o as wt,e as et,p as Tt,q as ga,t as ja,g as xa,c as Sa,v as Pa,w as It,x as wa,y as Ta,z as Aa,A as $a,B as Ea,C as Na,D as Ca,E as ka,F as La,G as Da,H as Fa,I as Oe,J as Ra,K as _t,L as Ma,M as Ia}from"./form.DRYuBmS7.js";import"./customers.xSpaFc27.js";import{g as mt,b as _a,o as Be,q as tt,a as Bt,D as at,l as Ba}from"./reservationsService.BuzBSxm1.js";import{P as ft,l as ht,n as At,u as qt,o as bt,p as Ve,t as nt,v as qa,x as Ha,i as Oa,h as Va,w as Ua,y as st,z as rt,e as Ht,A as Ot,B as za,C as Wa}from"./controller.Dp7EiJmF.js";import{a as Ga}from"./calculations.JNZK6KVD.js";let $t=null;function Ja(e){e&&Vt()!==e&&dt({[ft]:e}).catch(t=>{console.warn("⚠️ [projects] Failed to persist projects main tab preference",t)})}function Vt(){return Rt()?.[ft]||""}function Ut(e){e&&ot()!==e&&dt({[ht]:e}).catch(t=>{console.warn("⚠️ [projects] Failed to persist projects sub-tab preference",t)})}function ot(){return Rt()?.[ht]||""}function Ka(e){if(!e)return"";const t=e.trim();return t?Object.values(At).includes(t)?t:At[t]||"":""}function Ya(){if(typeof window>"u")return"";try{const t=new URLSearchParams(window.location.search||"").get("subTab");if(t){const a=Ka(t);if(a)return a}}catch{}return""}function zt(e,t){!e||!f.tabPanes||!f.tabButtons||(f.tabButtons.forEach(a=>{const s=a===t;a.classList.toggle("active",s),a.classList.contains("tab-button")&&a.classList.toggle("tab-active",s)}),f.tabPanes.forEach(a=>{a.dataset.tabPane===e?a.classList.remove("d-none"):a.classList.add("d-none")}),t&&Ja(e))}function Xa(){if(!f.tabButtons||!f.tabButtons.length)return;f.tabButtons.forEach(a=>{a.dataset.tabListenerAttached!=="true"&&(a.addEventListener("click",s=>{s.preventDefault();const r=a.dataset.tabTarget;r&&(zt(r,a),r==="projects-section"&&(T.filters.search="",f.search&&(f.search.value=""),je(),$e(),Ee()))}),a.dataset.tabListenerAttached="true")});const e=Vt(),t=e&&f.tabButtons.find(a=>a.dataset.tabTarget===e);t&&t.click()}function yt(e,t){!e||!f.projectSubTabButtons||!f.projectSubTabPanes||(f.projectSubTabButtons.forEach(a=>{const s=a===t;a.classList.toggle("active",s),a.classList.contains("tab")&&a.classList.toggle("tab-active",s)}),f.projectSubTabPanes.forEach(a=>{a.dataset.projectSubtab===e?a.classList.remove("d-none"):a.classList.add("d-none")}))}function Qa(){!f.projectSubTabButtons||!f.projectSubTabButtons.length||(f.projectSubTabButtons.forEach(e=>{e.dataset.tabListenerAttached!=="true"&&(e.addEventListener("click",t=>{t.preventDefault();const a=e.dataset.projectSubtabTarget;a&&(yt(a,e),Ut(a))}),e.dataset.tabListenerAttached="true")}),Za())}function Za(){const t=Ya()||ot();if(!t)return;const a=f.projectSubTabButtons?.[0],s=f.projectSubTabButtons?.find(l=>l.dataset.projectSubtabTarget===t)||a,r=s?.dataset.projectSubtabTarget;r&&(t!==ot()&&Ut(r),yt(r,s))}function en(){return f.tabButtons?f.tabButtons.find(t=>t.classList.contains("active"))?.dataset.tabTarget==="projects-section":!1}function Et(e={}){if(e){if(f.tabButtons&&f.tabButtons.length){const a=f.tabButtons.find(r=>r.classList.contains("active"))?.dataset.tabTarget||"",s=e[ft];if(s&&s!==a){const r=f.tabButtons.find(l=>l.dataset.tabTarget===s);r&&zt(s,r)}}if(f.projectSubTabButtons&&f.projectSubTabButtons.length&&en()){const a=f.projectSubTabButtons.find(r=>r.classList.contains("active"))?.dataset.projectSubtabTarget||"",s=e[ht];if(s&&s!==a){const r=f.projectSubTabButtons.find(l=>l.dataset.projectSubtabTarget===s);r&&yt(s,r)}}}}function tn(){$t||($t=oa(e=>{Et(e)})),ia().then(e=>{Et(e)}).catch(e=>{console.warn("⚠️ [projects] Failed to synchronise project preferences",e)})}function me(e){const t=T.projects.find(x=>String(x.id)===String(e));if(!t||!f.detailsBody)return;f.detailsBody.dataset.mode="view",f.detailsBody.dataset.projectId=String(t.id);const s=(T.customers.length?T.customers:Mt().customers||[]).find(x=>String(x.id)===String(t.clientId)),r=Kt(t.type),i=t.description?.trim()||n("projects.fallback.noDescription","لا يوجد وصف"),u=s?.customerName||n("projects.fallback.unknownClient","عميل غير معروف"),c=s?.phone??s?.customerPhone??t.clientPhone??t.customerPhone??"",m=c?g(String(c).trim()):n("projects.details.client.noPhone","لا يوجد رقم متاح"),d=s?.email??t.clientEmail??t.customerEmail??"",j=d?String(d).trim():n("projects.details.client.noEmail","لا يوجد بريد متاح"),k=(t.clientCompany||s?.companyName||"").trim(),N=t.projectCode||`PRJ-${g(String(t.id))}`,R=g(N),A=ut(t.id),Q=A.reduce((x,I)=>x+Yt(I),0),$=Number(Q.toFixed(2)),E=A.length,{subtotal:q,applyTax:Z,expensesTotal:W}=ha(t),he=Number(t?.servicesClientPrice??t?.services_client_price??0),xe=q,be=Z?Number(((xe+$)*nt).toFixed(2)):0,oe=Number((xe+$+be).toFixed(2)),le=ba(t),Se=n(`projects.status.${le}`,qa[le]||le),te={upcoming:"status-pending",ongoing:"status-confirmed",completed:"status-completed"}[le]||"status-confirmed",ae=Z?n("projects.details.chips.vatOn","شامل الضريبة 15٪"):n("projects.details.chips.vatOff","غير شامل الضريبة"),ye=Z?"status-paid":"status-unpaid",ve=n("projects.details.chips.reservations","{count} حجوزات").replace("{count}",g(String(E))),ze=typeof t.paymentStatus=="string"?t.paymentStatus.toLowerCase():"",de=mn(t),ge=de.length>0,b=ge?0:Number(t.paidAmount)||0,h=ge?0:Number(t.paidPercent)||0;let y=oe,v,w,L,_,D,F,G,M,V,Ne;const Ce=un(de),Pe=n("projects.focus.confirmed","✅ مشروع مؤكد"),We=t.confirmed===!0||t.confirmed==="true"?`<span class="reservation-chip status-confirmed">${o(Pe)}</span>`:"";let B=[];if(E>0){const x=A.reduce((Me,se)=>{const ra=Array.isArray(se.items)?se.items:[],St=Array.isArray(se.crewAssignments)?se.crewAssignments:[],pe=St.length?St:Array.isArray(se.technicians)?se.technicians:[],Ze=_a({items:ra,technicianIds:Array.isArray(pe)&&!pe.length?pe:[],crewAssignments:Array.isArray(pe)&&pe.length&&typeof pe[0]=="object"?pe:[],discount:se.discount??0,discountType:se.discountType||"percent",applyTax:!1,start:se.start,end:se.end,companySharePercent:null});return Me.equipment+=Number(Ze.equipmentTotal||0),Me.crew+=Number(Ze.crewTotal||0),Me.crewCost+=Number(Ze.crewCostTotal||0),Me},{equipment:0,crew:0,crewCost:0}),I=Number(W||0),K=Number((x.equipment+x.crew+he).toFixed(2)),ue=Number.parseFloat(t?.discount??t?.discountValue??0)||0;let ne=(t?.discountType==="amount"?"amount":"percent")==="amount"?ue:K*(ue/100);(!Number.isFinite(ne)||ne<0)&&(ne=0),ne>K&&(ne=K);const U=Z===!0,ie=t?.companyShareEnabled===!0||t?.companyShareEnabled==="true"||t?.company_share_enabled===!0||t?.company_share_enabled==="true",ce=Number.parseFloat(t?.companySharePercent??t?.company_share_percent??t?.companyShare??t?.company_share??0)||0,Te=ie&&ce>0?ce:0,Y=Math.max(0,K-ne),re=Number((Y*(Te/100)).toFixed(2)),Re=U?Number(((Y+re)*nt).toFixed(2)):0,Qe=Number((Y+re+Re).toFixed(2)),sa=Number((Qe-re-Re-I-x.crewCost).toFixed(2));x.equipment>0&&B.push({icon:"🎛️",label:n("projects.details.summary.equipmentTotal","إجمالي المعدات"),value:S(x.equipment)}),x.crew>0&&B.push({icon:"😎",label:n("projects.details.summary.crewTotal","إجمالي الفريق"),value:S(x.crew)}),x.crewCost>0&&B.push({icon:"🧾",label:n("projects.details.summary.crewCostTotal","تكلفة الفريق"),value:S(x.crewCost)}),I>0&&B.push({icon:"🧾",label:n("projects.details.summary.expensesTotal","تكلفة خدمات الإنتاجية"),value:S(I)}),he>0&&B.push({icon:"💼",label:n("projects.details.summary.servicesClientPrice","سعر العميل للخدمات الإنتاجية"),value:S(he)}),ne>0&&B.push({icon:"🏷️",label:n("projects.details.summary.discount","الخصم"),value:`−${S(ne)}`}),B.push({icon:"🧮",label:n("projects.details.summary.grossAfterDiscount","الإجمالي بعد الخصم"),value:S(Y)}),re>0&&B.push({icon:"🏦",label:n("projects.details.summary.companyShare","نسبة الشركة"),value:`−${S(re)}`}),Re>0&&B.push({icon:"💸",label:n("projects.details.summary.tax","الضريبة (15٪)"),value:`−${S(Re)}`}),B.push({icon:"💵",label:n("projects.details.summary.netProfit","صافي الربح"),value:S(sa)}),B.push({icon:"💰",label:n("projects.details.summary.finalTotal","المجموع النهائي"),value:S(Qe)}),y=Qe}else B=[{icon:"💼",label:n("projects.details.summary.projectSubtotal","إجمالي المشروع"),value:S(xe)},{icon:"🔗",label:n("projects.details.summary.reservationsTotal","إجمالي المعدات / طاقم العمل"),value:S($)},{icon:"🧮",label:n("projects.details.summary.combinedTax","إجمالي الضريبة الكلية (15٪)"),value:S(be)},{icon:"💰",label:n("projects.details.summary.overallTotal","الإجمالي الكلي"),value:S(oe)}];v=Be({totalAmount:y,paidAmount:b,paidPercent:h,history:de}),w=tt({manualStatus:ze||"unpaid",paidAmount:v.paidAmount,paidPercent:v.paidPercent,totalAmount:y}),L=n(`projects.paymentStatus.${w}`,w==="paid"?"Paid":w==="partial"?"Partial":"Unpaid"),_=w==="paid"?"status-paid":w==="partial"?"status-partial":"status-unpaid",D=Number.isFinite(Number(v.paidAmount))?Number(v.paidAmount):0,F=Number.isFinite(Number(v.paidPercent))?Number(v.paidPercent):0,G=Math.max(0,Number((y-D).toFixed(2))),M=S(D),V=`${g(F.toFixed(2))}%`,Ne=S(G);const xt=B.map(({icon:x,label:I,value:K})=>`
    <div class="summary-details-row">
      <span class="summary-details-label">${x} ${o(I)}</span>
      <span class="summary-details-value">${o(K)}</span>
    </div>
  `).join(""),ke=n("projects.details.labels.code","رقم المشروع"),Ge=`
    <div class="project-details-code-badge" title="${o(ke)}">
      <span class="project-details-code-badge__label">
        <span class="project-details-code-badge__icon" aria-hidden="true">🗂️</span>
        ${o(ke)}
      </span>
      <span class="project-details-code-badge__value">${o(R)}</span>
    </div>
  `,Je=[{icon:"👤",label:n("projects.details.client","العميل"),value:u},{icon:"📞",label:n("projects.details.labels.clientPhone","رقم العميل"),value:m},{icon:"✉️",label:n("projects.details.labels.clientEmail","البريد الإلكتروني"),value:j},k?{icon:"🏢",label:n("projects.details.company","شركة العميل"),value:k}:null,{icon:"🏷️",label:n("projects.details.type","نوع المشروع"),value:r},Ct("start",t.start),Ct("end",t.end)].filter(Boolean),Ke=n("projects.details.overview.heading","معلومات المشروع"),we=`
  ...
  `,Le=[`<span class="reservation-chip ${te}">${o(Se)}</span>`,`<span class="reservation-chip ${ye}">${o(ae)}</span>`,`<span class="reservation-chip status-info">${o(ve)}</span>`,`<span class="reservation-chip ${_}">${o(L)}</span>`,We].filter(Boolean).join(""),Ye=n("projects.details.expensesTotal","إجمالي المصاريف"),O=n("projects.details.reservationsTotal","إجمالي الحجوزات"),Xe=n("projects.details.expenses","خدمات إنتاجية ({amount})").replace("{amount}",S(W)),De=an(Array.isArray(t.expenses)?t.expenses:[]);f.detailsBody.innerHTML=`
    <section class="project-details-primary">
      <header class="project-details-header">
        <div class="project-details-header__info">
          <div class="project-details-chips">${Le}</div>
        </div>
  ...
  `}function nn({onOpenProject:e}){!f.focusCards||f.focusCards.dataset.listenerAttached==="true"||(f.focusCards.addEventListener("click",t=>{const a=t.target.closest("[data-action]");if(a){const{action:r,id:l}=a.dataset;if(r==="confirm-project"){t.preventDefault(),t.stopPropagation(),cn(l);return}r==="view"?e?.(l):r==="highlight"&&sn(l);return}const s=t.target.closest(".project-focus-card");s?.dataset.projectId&&e?.(s.dataset.projectId)}),f.focusCards.dataset.listenerAttached="true")}function sn(e){if(!f.projectsTableBody)return;const t=`tr[data-project-id="${CSS.escape(String(e))}"]`,a=f.projectsTableBody.querySelector(t);if(!a){C(n("projects.focus.toastNotFound","⚠️ تعذّر العثور على المشروع في القائمة"));return}a.classList.add("project-row-highlight"),a.scrollIntoView({behavior:"smooth",block:"center"}),window.setTimeout(()=>{a.classList.remove("project-row-highlight")},2200)}function rn(e){if(!f.detailsBody)return;const t=f.detailsBody.querySelector('[data-action="create-reservation"]'),a=f.detailsBody.querySelector('[data-action="edit-project"]'),s=f.detailsBody.querySelector('[data-action="delete-project"]'),r=f.detailsBody.querySelector(".project-reservations-list");if(t&&e)try{(ut(e.id)||[]).some(u=>{const c=String(u?.status||u?.reservationStatus||"").toLowerCase();return c!=="cancelled"&&c!=="canceled"})?(t.disabled=!0,t.classList?.add("disabled"),t.setAttribute?.("aria-disabled","true"),t.title=n("projects.details.reservations.createDisabled","⚠️ يوجد حجز مرتبط بالفعل بهذا المشروع")):(t.disabled=!1,t.classList?.remove("disabled"),t.removeAttribute?.("aria-disabled"),t.removeAttribute?.("title"),t.addEventListener("click",u=>{u.preventDefault(),Nt(e)}))}catch{t.disabled=!1,t.classList?.remove("disabled"),t.removeAttribute?.("aria-disabled"),t.removeAttribute?.("title"),t.addEventListener("click",i=>{i.preventDefault(),Nt(e)})}if(a&&e&&a.addEventListener("click",l=>{l.preventDefault(),Wt(e)}),s&&e&&s.addEventListener("click",async l=>{l.preventDefault();const i=l.currentTarget;i.disabled=!0;try{await va(e.id),!T.projects.some(c=>String(c.id)===String(e.id))&&f.detailsModalEl&&window.bootstrap?.Modal.getInstance(f.detailsModalEl)?.hide()}finally{T.projects.some(c=>String(c.id)===String(e.id))&&(i.disabled=!1)}}),r){const l=async i=>{if(!Number.isInteger(i)||i<0)return!1;const u=Va("showReservationDetails");if(typeof u=="function")return u(i),!0;try{const c=await Ua("showReservationDetails");if(typeof c=="function")return c(i),!0}catch(c){console.warn("⚠️ [projects/projectDetails] Unable to resolve reservation UI handler",c)}return!1};r.addEventListener("click",async i=>{const u=i.target.closest('[data-action="view-reservation"]');if(!u)return;const c=u.dataset.index||u.dataset.reservationIndex,m=Number.parseInt(c||"-1",10);if(!Number.isInteger(m)||m<0)return;await l(m)||(window.location.href="dashboard.html#reservations")}),r.addEventListener("keydown",i=>{if(!["Enter"," "].includes(i.key))return;const u=i.target.closest('[data-action="view-reservation"]');u&&(i.preventDefault(),u.click())})}}function Wt(e){if(!e||!f.detailsBody)return;const t=T.projects.find(d=>String(d.id)===String(e.id));if(!t)return;const a=T.customers.find(d=>String(d.id)===String(t.clientId));a?.customerName||a?.name||t.clientName||t.customerName,t.clientCompany||a?.companyName||a?.company;const s=Array.isArray(t.expenses)?t.expenses.map((d,j)=>({id:d?.id||`expense-${t.id}-${j}-${Date.now()}`,label:d?.label||"",amount:Number(d?.amount)||0,salePrice:Number.isFinite(Number(d?.sale_price??d?.salePrice))?Number(d?.sale_price??d?.salePrice):0})):[];let r=Array.isArray(t.paymentHistory)?t.paymentHistory.map((d,j)=>({type:d?.type==="percent"?"percent":"amount",amount:Number.isFinite(Number(d?.amount))?Number(d.amount):null,percentage:Number.isFinite(Number(d?.percentage))?Number(d.percentage):null,value:Number.isFinite(Number(d?.value))?Number(d.value):null,note:d?.note??null,recordedAt:d?.recordedAt??d?.recorded_at??new Date().toISOString(),key:`payment-${t.id}-${j}`})):[],l=r.reduce((d,j)=>d+(Number(j?.amount)||0),0),i=r.reduce((d,j)=>d+(Number(j?.percentage)||0),0),u=Number.isFinite(Number(t.paidAmount))?Number(t.paidAmount):0,c=Number.isFinite(Number(t.paidPercent))?Number(t.paidPercent):0;if(!r.length&&(u>0||c>0)){const d=t.updatedAt??t.createdAt??new Date().toISOString();c>0?r=[{type:"percent",amount:Number.isFinite(u)&&u>0?u:null,percentage:c,value:c,note:null,recordedAt:d,key:`legacy-payment-${t.id}-percent`}]:u>0&&(r=[{type:"amount",amount:u,percentage:null,value:u,note:null,recordedAt:d,key:`legacy-payment-${t.id}-amount`}]),l=r.reduce((j,k)=>j+(Number(k?.amount)||0),0),i=r.reduce((j,k)=>j+(Number(k?.percentage)||0),0),u=0,c=0}l>0&&Math.abs(u-l)<.01&&(u=0),i>0&&Math.abs(c-i)<.01&&(c=0);const m={expenses:s,payments:r,basePaidAmount:u,basePaidPercent:c};f.detailsBody.dataset.mode="edit",f.detailsBody.innerHTML=ln(t,m),on(t,m)}function on(e,t={expenses:[]}){const a=f.detailsBody?.querySelector("#project-details-edit-form");if(!a)return;const s=a.querySelector('[data-action="cancel-edit"]');s&&s.addEventListener("click",b=>{b.preventDefault(),me(e.id)});const r=a.querySelector("#project-edit-expense-label"),l=a.querySelector("#project-edit-expense-amount"),i=a.querySelector("#project-edit-expense-sale"),u=a.querySelector('[data-action="add-expense"]'),c=a.querySelector("#project-edit-expense-list"),m=a.querySelector('[name="project-start-date"]'),d=a.querySelector('[name="project-start-time"]'),j=a.querySelector('[name="project-end-date"]'),k=a.querySelector('[name="project-end-time"]'),N=a.querySelector('[name="project-payment-status"]'),R=a.querySelector("#project-edit-tax"),A=a.querySelector("#project-edit-company-share"),Q=a.querySelector("#project-edit-discount"),$=a.querySelector("#project-edit-discount-type"),E=a.querySelector("#project-edit-payment-progress-type"),q=a.querySelector("#project-edit-payment-progress-value"),Z=a.querySelector("#project-edit-payment-add"),W=a.querySelector("#project-edit-payment-history"),he=a.querySelector("#project-edit-payment-summary"),xe=n("reservations.create.summary.currency","SR");let be=!1;const oe=()=>(Array.isArray(t.payments)||(t.payments=[]),t.payments),le=()=>{const b=Number(e.equipmentEstimate)||0,h=Array.isArray(t.expenses)?t.expenses.reduce((M,V)=>M+(Number(V.amount)||0),0):0,y=Array.isArray(t.expenses)?Math.max(0,Math.round(t.expenses.reduce((M,V)=>M+Number(V?.salePrice??0),0)*100)/100):Math.max(0,Number(e?.servicesClientPrice??0)),v=$?.value==="amount"?"amount":"percent",w=g(Q?.value||"0");let L=Number.parseFloat(w);(!Number.isFinite(L)||L<0)&&(L=0);const _=R?.checked===!0,D=A?.checked===!0;let F=D?xa(A):null;(!Number.isFinite(F)||F<=0)&&(F=D?at:null);const G=Sa({equipmentEstimate:b,expensesTotal:h,servicesClientPrice:y,discountValue:L,discountType:v,applyTax:_,companyShareEnabled:D,companySharePercent:F});return{equipmentEstimate:b,expensesTotal:h,discountValue:L,discountTypeValue:v,applyTax:_,companyShareEnabled:D,companySharePercent:F,servicesClientPrice:y,finance:G}},Se=()=>{const b=le(),h=oe(),v=(ut(e.id)||[]).reduce((F,G)=>F+(Number(G?.totalAmount)||Yt(G)||0),0),w=Number(b.finance?.taxableAmount||0),L=b.applyTax?Number(((w+v)*nt).toFixed(2)):0,_=Number((w+v+L).toFixed(2)),D=Be({totalAmount:_,paidAmount:t.basePaidAmount||0,paidPercent:t.basePaidPercent||0,history:h});return{...b,combinedTotalWithTax:_,payments:h,progress:D}},jt=()=>{W&&(W.innerHTML=pn(oe()))},te=()=>{if(!he)return;const{combinedTotalWithTax:b,progress:h}=Se(),y=Number.isFinite(Number(b))?Number(b):0,v=Number.isFinite(Number(h.paidAmount))?Number(h.paidAmount):0,w=Number.isFinite(Number(h.paidPercent))?Number(h.paidPercent):0,L=Math.max(0,Math.round((y-v)*100)/100),_=[{label:n("projects.form.paymentSummary.total","الإجمالي الكلي"),value:S(y)},{label:n("projects.form.paymentSummary.paidAmount","إجمالي المدفوع"),value:S(v)},{label:n("projects.form.paymentSummary.paidPercent","نسبة الدفعات"),value:`${g(w.toFixed(2))}%`},{label:n("projects.form.paymentSummary.remaining","المتبقي"),value:S(L)}];he.innerHTML=_.map(({label:D,value:F})=>`
        <div class="project-details-grid-item">
          <span>${o(D)}</span>
          <strong>${o(F)}</strong>
        </div>
      `).join("")},ae=(b="auto")=>{if(!N)return;const h=N.dataset?.userSelected==="true";if(b==="auto"&&h)return;const{finance:y,progress:v}=Se(),w=tt({manualStatus:h?N.value:e.paymentStatus||"unpaid",paidAmount:v.paidAmount,paidPercent:v.paidPercent,totalAmount:y.totalWithTax});h||(N.value=w)},ye=()=>{jt(),te(),ae("auto")},ve=1e-4,ze=()=>{const b=E?.value==="amount"?"amount":"percent",h=g(q?.value||"").replace("%","").trim();let y=Number.parseFloat(h);if(!Number.isFinite(y)||y<=0){C(n("projects.toast.paymentInvalid","⚠️ يرجى إدخال قيمة دفعة صحيحة")),q?.focus();return}const v=Se(),w=Number.isFinite(Number(v.finance.totalWithTax))?Number(v.finance.totalWithTax):0;if(w<=0){C(n("projects.toast.paymentTotalMissing","⚠️ يرجى التأكد من إدخال البيانات المالية للمشروع قبل تسجيل الدفعة"));return}const L=Number(v.progress.paidAmount)||0,_=Number(v.progress.paidPercent)||0;let D=null,F=null;if(b==="percent"){const M=Math.max(0,100-_);if(M<=ve){C(n("projects.toast.paymentNoRemainingBalance","⚠️ تم تسجيل كامل قيمة المشروع، لا يمكن إضافة دفعة جديدة"));return}if(y>M){y=M;const V=g(y.toFixed(2));C(n("projects.toast.paymentCappedPercent","ℹ️ تم ضبط الدفعة إلى {value}% لاستكمال 100%").replace("{value}",V))}F=Math.round(y*100)/100,w>0&&(D=Math.round(F/100*w*100)/100)}else{const M=Math.max(0,w-L);if(M<=ve){C(n("projects.toast.paymentNoRemainingBalance","⚠️ تم تسجيل كامل قيمة المشروع، لا يمكن إضافة دفعة جديدة"));return}if(y>M){y=M;const V=`${g(y.toFixed(2))} ${xe}`;C(n("projects.toast.paymentCappedAmount","ℹ️ تم ضبط الدفعة إلى {amount} لاستكمال المبلغ المتبقي").replace("{amount}",V))}D=Math.round(y*100)/100,w>0&&(F=Math.round(D/w*100*100)/100)}const G={type:b,amount:D??null,percentage:F??null,value:b==="amount"?D:F,note:null,recordedAt:new Date().toISOString()};t.payments=[...oe(),G],q&&(q.value=""),E&&(E.value="percent"),ye(),C(n("projects.toast.paymentAdded","✅ تم تسجيل الدفعة"))},de=b=>{!R||!A||be||(be=!0,b==="share"?A.checked?(R.checked||(R.checked=!0),et(A)):R.checked&&(R.checked=!1):b==="tax"&&(R.checked?et(A):A.checked&&(A.checked=!1)),be=!1)};function ge(){c&&(c.innerHTML=Gt(t.expenses))}ge(),ye(),Q&&!Q.dataset.listenerAttached&&(Q.addEventListener("input",b=>{const h=b.target;h instanceof HTMLInputElement&&(h.value=g(h.value||""),te(),ae("auto"))}),Q.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.addEventListener("input",b=>{const h=b.target;h instanceof HTMLInputElement&&(h.value=g(h.value||""))}),i.dataset.listenerAttached="true"),$&&!$.dataset.listenerAttached&&($.addEventListener("change",()=>{te(),ae("auto")}),$.dataset.listenerAttached="true"),q&&!q.dataset.listenerAttached&&(q.addEventListener("input",b=>{const h=b.target;h instanceof HTMLInputElement&&(h.value=g(h.value||""))}),q.dataset.listenerAttached="true"),N&&!N.dataset.listenerAttached&&(N.addEventListener("change",()=>{N.dataset.userSelected="true"}),N.dataset.listenerAttached="true"),l&&!l.dataset.listenerAttached&&(l.addEventListener("input",b=>{const h=b.target;h instanceof HTMLInputElement&&(h.value=g(h.value||""))}),l.dataset.listenerAttached="true"),A&&!A.dataset.listenerAttached&&(A.addEventListener("change",()=>{de("share"),te(),ae("auto")}),A.dataset.listenerAttached="true"),R&&!R.dataset.listenerAttached&&(R.addEventListener("change",()=>{de("tax"),te(),ae("auto")}),R.dataset.listenerAttached="true"),A?.checked&&et(A),de(A?.checked?"share":"tax"),te(),ae("auto"),u&&u.addEventListener("click",b=>{b.preventDefault();const h=r?.value.trim()||"",y=g(l?.value||"0"),v=Number(y),w=g(i?.value||"0"),L=Number(w);if(!h){C(n("projects.toast.missingExpenseLabel","⚠️ يرجى إدخال وصف المصروف")),r?.focus();return}if(!Number.isFinite(v)||v<=0){C(n("projects.toast.invalidExpenseAmount","⚠️ يرجى إدخال مبلغ صحيح")),l?.focus();return}t.expenses.push({id:`expense-${e.id}-${Date.now()}`,label:h,amount:v,salePrice:Number.isFinite(L)&&L>0?L:0}),r&&(r.value=""),l&&(l.value=""),i&&(i.value=""),ge(),te(),ae("auto")}),c&&c.addEventListener("click",b=>{const h=b.target.closest('[data-action="remove-expense"]');if(!h)return;const{id:y}=h.dataset;t.expenses=t.expenses.filter(v=>String(v.id)!==String(y)),ge(),te(),ae("auto")}),Z&&!Z.dataset.listenerAttached&&(Z.addEventListener("click",b=>{b.preventDefault(),ze()}),Z.dataset.listenerAttached="true"),W&&!W.dataset.listenerAttached&&(W.addEventListener("click",b=>{const h=b.target.closest('[data-action="remove-payment"]');if(!h)return;const y=Number.parseInt(h.dataset.index||"-1",10);if(!Number.isInteger(y)||y<0)return;const v=oe();if(y>=v.length)return;const w=v.filter((L,_)=>_!==y);t.payments=w,ye(),C(n("projects.toast.paymentRemoved","🗑️ تم حذف الدفعة"))}),W.dataset.listenerAttached="true"),a.addEventListener("submit",async b=>{if(b.preventDefault(),a.dataset.submitting==="true")return;const h=a.querySelector('[name="project-title"]'),y=a.querySelector('[name="project-type"]'),v=a.querySelector('[name="project-description"]'),w=h?.value.trim()||"",L=y?.value||"",_=m?.value.trim()||"",D=d?.value.trim()||"",F=v?.value.trim()||"",G=(N?.value||"unpaid").toLowerCase(),M=["paid","partial"].includes(G)?G:"unpaid";if(!w||!L||!_){C(n("projects.toast.missingRequiredFields","⚠️ يرجى تعبئة البيانات المطلوبة")),h?.focus();return}const V=j?.value.trim()||"",Ne=k?.value.trim()||"",Ce=Tt(_,D),Pe=V?Tt(V,Ne):"",We=new Date(Ce),B=Pe?new Date(Pe):null;if(B&&We>B){C(n("projects.toast.invalidDateRange","⚠️ تاريخ النهاية يجب أن يكون بعد تاريخ البداية")),j?.focus();return}if(T.projects.findIndex(U=>String(U.id)===String(e.id))===-1){C(n("projects.toast.editMissing","⚠️ تعذّر العثور على المشروع المطلوب تعديله"));return}const ke=le(),{equipmentEstimate:Ge,discountValue:Je,discountTypeValue:Ke,applyTax:we,companyShareEnabled:Le,companySharePercent:Ye,finance:O}=ke,Xe=E?.value==="amount"?"amount":"percent",De=g(q?.value||"");let J=De?Number.parseFloat(De):null,x=[...oe()];if(Number.isFinite(J)&&J>0&&Number.isFinite(Number(O.totalWithTax))){const U=Be({totalAmount:O.totalWithTax,paidAmount:t.basePaidAmount||0,paidPercent:t.basePaidPercent||0,history:x}),ie=new Date().toISOString();if(Xe==="percent"){const ce=Math.max(0,100-(U.paidPercent||0));if(ce>ve){const Te=Math.min(J,ce),Y=Math.round(Te*100)/100,re=O.totalWithTax>0?Math.round(Y/100*O.totalWithTax*100)/100:null;x=[...x,{type:"percent",amount:re,percentage:Y,value:Y,note:null,recordedAt:ie}]}}else{const ce=Math.max(0,O.totalWithTax-(U.paidAmount||0));if(ce>ve){const Te=Math.min(J,ce),Y=Math.round(Te*100)/100,re=O.totalWithTax>0?Math.round(Y/O.totalWithTax*100*100)/100:null;x=[...x,{type:"amount",amount:Y,percentage:re,value:Y,note:null,recordedAt:ie}]}}x!==t.payments&&(t.payments=x,ye()),q&&(q.value=""),E&&(E.value="percent"),J=null}const I=Be({totalAmount:O.totalWithTax,paidAmount:t.basePaidAmount||0,paidPercent:t.basePaidPercent||0,history:x}),K=N?.dataset?.userSelected==="true",ue=tt({manualStatus:K?M:e.paymentStatus||M,paidAmount:I.paidAmount,paidPercent:I.paidPercent,totalAmount:O.totalWithTax}),Fe=K?M:ue;!K&&N&&(N.value=Fe),N?.dataset&&delete N.dataset.userSelected,t.payments=x;const ne=Oa({projectCode:e.projectCode,title:w,type:L,clientId:e.clientId,clientCompany:e.clientCompany,description:F,start:Ce,end:Pe||null,applyTax:we,paymentStatus:Fe,equipmentEstimate:Ge,expenses:t.expenses,servicesClientPrice:context.servicesClientPrice,discount:Je,discountType:Ke,companyShareEnabled:Le&&we,companySharePercent:Le&&we?Ye:null,companyShareAmount:O.companyShareAmount,taxAmount:O.taxAmount,totalWithTax:O.totalWithTax,confirmed:e.confirmed,technicians:Array.isArray(e.technicians)?e.technicians:[],equipment:ga(e),paidAmount:I.paidAmount,paidPercentage:I.paidPercent,paymentProgressType:I.paymentProgressType,paymentProgressValue:I.paymentProgressValue,payments:x});a.dataset.submitting="true";try{const U=await qt(e.projectId??e.id,ne),ie=U?.projectId??U?.id??e.id;await ja(ie,Fe),T.projects=bt(),T.reservations=mt(),C(n("projects.toast.updated","✅ تم تحديث المشروع بنجاح")),je(),$e(),Ee(),me(e.id)}catch(U){console.error("❌ [projects] Failed to update project from details view",U);const ie=Ve(U)?U.message:n("projects.toast.updateFailed","تعذر تحديث المشروع، حاول مرة أخرى");C(ie,"error")}finally{delete a.dataset.submitting}})}function Nt(e){if(!e)return;const t={projectId:e.id,customerId:e.clientId||null,start:e.start||null,end:e.end||null,forceNotes:!!e.description,fromProjectForm:!0,draftStorageKey:"projects:create:draft",returnUrl:`projects.html?project=${encodeURIComponent(e.id)}&linked=1#projects-section`};dt({dashboardTab:"reservations-tab",dashboardSubTab:"create-tab"}).catch(r=>{console.warn("⚠️ [projects] Failed to persist dashboard tab preference",r)});let a="";try{a=encodeURIComponent(JSON.stringify(t))}catch(r){console.warn("⚠️ [projects] Unable to encode reservation context",r)}f.detailsModalEl&&window.bootstrap?.Modal&&window.bootstrap.Modal.getOrCreateInstance(f.detailsModalEl)?.hide();const s=a?`?reservationProjectContext=${a}`:"";window.location.href=`dashboard.html${s}#reservations`}async function cn(e){if(!e)return;const t=T.projects.find(a=>String(a.id)===String(e));if(!t){C(n("projects.toast.editMissing","⚠️ تعذّر العثور على المشروع المطلوب تعديله"));return}if(t.confirmed===!0||t.confirmed==="true"){C(n("projects.toast.alreadyConfirmed","ℹ️ المشروع مؤكّد مسبقًا"));return}try{await qt(t.projectId??t.id,{confirmed:!0});const a=await fa(e);T.projects=bt(),T.reservations=mt(),je(),$e(),Ee(),f.detailsModalEl&&f.detailsModalEl.classList.contains("show")&&f.detailsBody?.dataset.projectId===String(e)&&me(e),document.dispatchEvent(new CustomEvent("projects:changed")),a&&document.dispatchEvent(new CustomEvent("reservations:changed")),C(n("projects.toast.confirmed","✅ تم تأكيد المشروع"))}catch(a){console.error("❌ [projects] confirmProject failed",a);const s=Ve(a)?a.message:n("projects.toast.updateFailed","تعذر تحديث المشروع، حاول مرة أخرى");C(s,"error")}}function ln(e,t={clientName:"",clientCompany:"",expenses:[]}){const{date:a,time:s}=wt(e.start||""),{date:r,time:l}=wt(e.end||""),i=e.applyTax===!0||e.applyTax==="true";typeof e.paymentStatus=="string"&&e.paymentStatus.toLowerCase();const u=e.discountType==="amount"?"amount":"percent",c=g(String(e.discount??e.discountValue??0));g(String(e.servicesClientPrice??e.services_client_price??0));const m=e.companySharePercent??e.company_share_percent??e.companyShare??e.company_share??e.companyShareAmountPercent??at,d=Number.parseFloat(g(String(m))),j=Number.isFinite(d)&&d>0?d:at,k=e.companyShareEnabled===!0||e.companyShareEnabled==="true"||e.company_share_enabled===!0||e.company_share_enabled==="true"||i&&Number.isFinite(d)&&d>0;return`
        ...
        <div class="col-sm-6 col-lg-4 col-xl-3">
          ...
          <div class="d-flex flex-column gap-2">
            <div class="form-check form-switch m-0">
              <input class="form-check-input" type="checkbox" role="switch" id="project-edit-company-share" name="project-company-share" data-company-share="${o(String(j))}" ${k?"checked":""}>
  ...
  `}function mn(e={}){const a=(Array.isArray(e.paymentHistory)?e.paymentHistory:Array.isArray(e.payment_history)?e.payment_history:[]).map(fn).filter(Boolean);if(a.length>0)return a;const s=qe(e.paidPercent??e.paid_percent),r=qe(e.paidAmount??e.paid_amount),l=e.updatedAt??e.updated_at??e.createdAt??e.created_at??null,i=Jt(l);return s!=null&&s>0?[{type:"percent",amount:r!=null&&r>0?r:null,percentage:s,value:s,note:null,recordedAt:i}]:r!=null&&r>0?[{type:"amount",amount:r,percentage:null,value:r,note:null,recordedAt:i}]:[]}function fn(e){if(!e||typeof e!="object")return null;const t=e.type??e.payment_type??e.paymentType??null;let a=typeof t=="string"?t.toLowerCase().trim():null;a!=="percent"&&(a="amount");const s=qe(e.amount??(a==="amount"?e.value:null)),r=qe(e.percentage??(a==="percent"?e.value:null)),l=a==="percent"?r??null:s??null,i=e.note??e.memo??null,u=Jt(e.recordedAt??e.recorded_at??e.date??e.created_at??null);return a==="amount"&&s==null||a==="percent"&&r==null?null:{type:a,amount:s??null,percentage:r??null,value:l,note:i&&String(i).trim().length?String(i).trim():null,recordedAt:u}}function qe(e){if(e==null||e==="")return null;const t=g(String(e)).replace(/%/g,"").trim();if(!t)return null;const a=Number.parseFloat(t);return Number.isFinite(a)?a:null}function Jt(e){if(!e)return new Date().toISOString();const t=new Date(e);return Number.isNaN(t.getTime())?new Date().toISOString():t.toISOString()}function Ct(e,t){if(!t)return null;const{date:a,time:s}=hn(pt(t)),r=e==="start",l=r?"⏱️":"⌛",i=r?n("projects.details.labels.start","بداية الحجز"):n("projects.details.labels.end","نهاية الحجز");return{icon:l,label:i,value:a,meta:s}}function hn(e){if(!e||e==="—")return{date:"—",time:""};const t=e.split(" ").filter(Boolean),a=t.shift()||"—",s=t.join(" ");return{date:a,time:s}}function Kt(e){if(!e)return n("projects.form.types.unknown","نوع غير محدد");const t={commercial:"projects.form.types.commercial",coverage:"projects.form.types.coverage",photography:"projects.form.types.photography",social:"projects.form.types.social"}[e]||"projects.form.types.unknown";return n(t,e)}function Yt(e){if(!e)return 0;const t=Array.isArray(e.items)?e.items:[],a=e.discount??0,s=Number(g(String(a)))||0,r=e.discountType||"percent",l=Array.isArray(e.crewAssignments)?e.crewAssignments:[],i=l.length?l:Array.isArray(e.technicians)?e.technicians:[],u=Bt(t,s,r,!1,i,{start:e.start,end:e.end});if(Number.isFinite(u))return u;const c=Number(g(String(e.cost??0)));return Number.isFinite(c)?Math.round(c):0}function vt(e){if(typeof window>"u")return null;try{const s=new URLSearchParams(window.location.search||"").get(e);if(s)return s}catch{}const t=window.location.hash?window.location.hash.replace(/^#/,""):"";if(t&&t.includes(`${e}=`))try{const s=new URLSearchParams(t).get(e);if(s)return s}catch{}return null}function bn(){return vt(st)}function yn(){return vt(rt)}function vn(){if(!(typeof window>"u"||typeof window.history?.replaceState!="function"))try{const e=new URLSearchParams(window.location.search||""),t=window.location.hash?window.location.hash.replace(/^#/,""):"";let a=!1;[st,rt,"linked"].forEach(c=>{e.has(c)&&(e.delete(c),a=!0)});let s=t,r=!1;if(t)try{const c=new URLSearchParams(t);let m=!1;[st,rt,"linked"].forEach(d=>{c.has(d)&&(c.delete(d),m=!0)}),m&&(s=c.toString(),r=!0)}catch{}if(!a&&!r)return;const l=window.location.pathname,i=e.toString(),u=`${l}${i?`?${i}`:""}${s?`#${s}`:""}`;window.history.replaceState({},"",u)}catch{}}function gn(){const e=bn(),t=yn(),a=vt("linked");e&&(T.pendingProjectDetailId=e),t&&(T.pendingProjectEditId=t,T.pendingProjectDetailId||(T.pendingProjectDetailId=t)),a!=null&&String(a)!==""&&String(a)!=="0"&&String(a).toLowerCase()!=="false"&&(T.pendingLinkedToast=!0),(e||t)&&vn()}function jn(){if(!T.pendingProjectDetailId)return;const e=T.pendingProjectDetailId,t=String(e),a=T.projects.find(r=>[r?.id,r?.projectId,r?.project_id].some(i=>i!=null&&String(i)===t));if(!a)return;T.pendingProjectDetailId=null;const s=a?.id??a?.projectId??a?.project_id??t;if(me(s),T.pendingLinkedToast){T.pendingLinkedToast=!1;try{C(n("projects.toast.linkedReservationCreated","✅ تم ربط الحجز بالمشروع"))}catch{}}if(T.pendingProjectEditId!=null){const r=String(T.pendingProjectEditId);[a.id,a.projectId,a.project_id].some(i=>i!=null&&String(i)===r)&&(T.pendingProjectEditId=null,setTimeout(()=>Wt(a),0))}}function xn(){document.addEventListener("DOMContentLoaded",()=>{tn(),gn(),Pa(),It(),wa(),Xa(),Qa(),Ta(),Aa(),$a(),Ea(),Na(),Ca(),ka({onViewDetails:me}),nn({onOpenProject:me}),La(),Sn()}),document.addEventListener("language:changed",kt),document.addEventListener("language:translationsReady",kt),document.addEventListener("customers:changed",Pn),document.addEventListener("technicians:updated",wn),document.addEventListener("reservations:changed",()=>Da(me)),document.addEventListener(ca.USER_UPDATED,()=>{je()})}async function Sn(){try{await Ht({suppressError:!0}),await Ot()}catch(e){console.error("❌ [projects] Failed to initialise projects data",e);const t=e?.message||n("projects.toast.fetchFailed","تعذر تحميل بيانات المشاريع، حاول لاحقًا");C(t,"error")}finally{Fa(),Oe(),Ra(),_t(),je(),Ee(),$e(),jn()}}function kt(){Oe(),_t(),je(),Ee(),$e(),It()}function Pn(){Ma(),Oe()}function wn(){Ia(),Oe()}la();da();ua();za();xn();document.addEventListener("DOMContentLoaded",()=>{ma(),pa()});const it=.15,Ie={},Tn="https://cdn.jsdelivr.net/npm/apexcharts@3.49.0/dist/apexcharts.min.js";let Ae=0;const P={projects:[],customers:[],reservations:[],totalProjects:0,filters:{search:"",statuses:["upcoming","ongoing","completed"],payment:"all",range:"all",startDate:"",endDate:""}},p={search:null,payment:null,dateRange:null,customRangeWrapper:null,startDate:null,endDate:null,refreshBtn:null,kpiGrid:null,statusChips:null,table:null,tableBody:null,tableMeta:null,tableEmpty:null,chartCards:{},chartLoaders:{}},_e=Object.freeze({projects:`
  ...
  `});let z=null;const Xt=["upcoming","ongoing","completed"];async function An({forceProjects:e=!1}={}){try{await Ht({suppressError:!0}),await Wa({force:e})}catch(t){console.error("❌ [projectsReports] Failed to load initial data",t),Ve(t)&&console.warn("Projects API error:",t.message)}ta()}async function $n(){Cn(),Zt(),await En();try{await An({forceProjects:!0}),na(),Mn(),ee()}finally{ea()}document.addEventListener("language:changed",_n),document.addEventListener("projects:changed",()=>{ct().catch(e=>{console.error("❌ [projectsReports] Failed to refresh after projects change",e)})}),document.addEventListener("reservations:changed",()=>{ct().catch(e=>{console.error("❌ [projectsReports] Failed to refresh after reservations change",e)})}),window.addEventListener("storage",Bn)}document.addEventListener("DOMContentLoaded",$n);async function En(){if(z)return z;if(typeof window>"u")return null;if(window.ApexCharts)return z=window.ApexCharts,z;try{await Nn(Tn),z=window.ApexCharts||null}catch(e){console.warn("ApexCharts failed to load",e),z=null}return z}function Nn(e){return new Promise((t,a)=>{if(typeof document>"u"){a(new Error("Document is not available to load scripts."));return}const s=document.querySelector(`script[src="${e}"]`);if(s){if(s.dataset.loaded==="true"){t();return}s.addEventListener("load",t,{once:!0}),s.addEventListener("error",()=>a(new Error(`Failed to load script ${e}`)),{once:!0});return}const r=document.createElement("script");r.src=e,r.async=!0,r.dataset.loaded="false",r.onload=()=>{r.dataset.loaded="true",t()},r.onerror=()=>a(new Error(`Failed to load script ${e}`)),document.head.appendChild(r)})}function Cn(){p.search=document.getElementById("reports-search"),p.statusChips=document.getElementById("reports-status-chips"),p.payment=document.getElementById("reports-payment"),p.dateRange=document.getElementById("reports-date-range"),p.customRangeWrapper=document.getElementById("reports-custom-range"),p.startDate=document.getElementById("reports-start-date"),p.endDate=document.getElementById("reports-end-date"),p.refreshBtn=document.getElementById("reports-refresh"),p.kpiGrid=document.getElementById("reports-kpi-grid"),p.table=document.getElementById("reports-table"),p.tableBody=p.table?.querySelector("tbody"),p.tableMeta=document.getElementById("reports-table-meta"),p.tableEmpty=document.getElementById("reports-empty"),p.chartCards={},p.chartLoaders={},document.querySelectorAll("[data-chart-card]").forEach(e=>{const t=e.dataset.chartCard;if(!t)return;p.chartCards[t]=e;const a=e.querySelector("[data-chart-loading]");a&&(p.chartLoaders[t]=a)})}function Qt(e){const t=!!e;Object.entries(p.chartCards||{}).forEach(([a,s])=>{if(!s)return;s.classList.toggle("is-loading",t),s.setAttribute("aria-busy",t?"true":"false");const r=p.chartLoaders?.[a];r&&(r.hidden=!t)})}function Zt(){Ae+=1,Ae===1&&Qt(!0)}function ea(){Ae=Math.max(0,Ae-1),Ae===0&&Qt(!1)}function ta(){const{customers:e=[]}=Mt();P.customers=Array.isArray(e)?e:[],P.reservations=mt();const t=new Map(P.customers.map(s=>[String(s.id),s])),a=bt();P.projects=Array.isArray(a)?a.map(s=>kn(s,t)):[],P.totalProjects=P.projects.length}function kn(e,t){const a=e.paymentStatus==="paid"?"paid":"unpaid",s=t.get(String(e.clientId)),r=Ln(e.id),l=r.reduce((Q,$)=>Q+Dn($),0),i=Fn(e),u=Number(e?.equipmentEstimate)||0,c=Number((u+i).toFixed(2)),m=e?.applyTax===!0||e?.applyTax==="true",d=m?Number((c*it).toFixed(2)):0,j=m?Number(((c+l)*it).toFixed(2)):0,k=Number((c+l+j).toFixed(2)),N=Rn(e),R=e.start?new Date(e.start):null,A=e.end?new Date(e.end):null;return{raw:e,id:e.id,projectCode:e.projectCode||e.id,title:(e.title||"").trim(),clientId:e.clientId,clientName:s?.customerName||s?.name||"",clientCompany:e.clientCompany||s?.companyName||"",type:e.type||e.projectType||"",description:e.description||"",paymentStatus:a,confirmed:e.confirmed===!0||e.confirmed==="true",start:R,end:A,applyTax:m,status:N,reservationsTotal:Number(l.toFixed(2)),expensesTotal:i,subtotal:c,taxAmount:d,combinedTaxAmount:j,overallTotal:k,unpaidValue:a==="paid"?0:k,reservationsCount:r.length}}function Ln(e){return Array.isArray(P.reservations)?P.reservations.filter(t=>String(t.projectId)===String(e)):[]}function Dn(e){if(!e)return 0;const t=Array.isArray(e.items)?e.items:[],a=e.discount??0,s=Number(g(String(a)))||0,r=e.discountType||"percent",l=Array.isArray(e.crewAssignments)?e.crewAssignments:[],i=l.length?l:Array.isArray(e.technicians)?e.technicians:[],u=Bt(t,s,r,!1,i,{start:e.start,end:e.end});if(Number.isFinite(u))return u;const c=Number(g(String(e.cost??0)));return Number.isFinite(c)?Math.round(c):0}function Fn(e){return typeof e.expensesTotal=="number"?Number(e.expensesTotal)||0:Array.isArray(e.expenses)?e.expenses.reduce((t,a)=>t+(Number(a.amount)||0),0):0}function Rn(e){const t=new Date,a=e.start?new Date(e.start):null,s=e.end?new Date(e.end):null;return a&&!Number.isNaN(a.getTime())&&a>t?"upcoming":s&&!Number.isNaN(s.getTime())&&s<t?"completed":"ongoing"}function Mn(){if(p.search){let e;p.search.addEventListener("input",()=>{clearTimeout(e),e=setTimeout(()=>{P.filters.search=p.search.value.trim(),ee()},180)})}p.payment&&(p.payment.value=P.filters.payment,p.payment.addEventListener("change",()=>{P.filters.payment=p.payment.value||"all",ee()})),p.dateRange&&(p.dateRange.addEventListener("change",In),p.dateRange.value=P.filters.range),p.startDate&&p.startDate.addEventListener("change",()=>{P.filters.startDate=p.startDate.value,P.filters.range==="custom"&&ee()}),p.endDate&&p.endDate.addEventListener("change",()=>{P.filters.endDate=p.endDate.value,P.filters.range==="custom"&&ee()}),p.refreshBtn&&p.refreshBtn.addEventListener("click",()=>{if(P.filters.range!=="custom"){ee();return}P.filters.startDate=p.startDate?.value||"",P.filters.endDate=p.endDate?.value||"",ee()})}function In(e){const t=e.target.value;P.filters.range=t,t==="custom"?p.customRangeWrapper?.classList.add("active"):(p.customRangeWrapper?.classList.remove("active"),P.filters.startDate="",P.filters.endDate="",p.startDate&&(p.startDate.value=""),p.endDate&&(p.endDate.value=""),ee())}async function ct(){Zt();try{await Promise.all([Ot(),Ba()])}catch(e){console.error("❌ [projectsReports] Data mutation refresh failed",e),Ve(e)&&console.warn("Projects API error:",e.message)}finally{ta(),ee(),ea()}}function _n(){na(),ee()}function Bn(e){e.key&&!["projects","reservations","customers"].includes(e.key)||ct().catch(t=>{console.error("❌ [projectsReports] Storage sync failed",t)})}function ee(){const e=qn();gt(),Vn(e),Gn(e),Jn(e),Kn(e),Yn(e),Xn(e)}function qn(){const{search:e,statuses:t,payment:a,range:s,startDate:r,endDate:l}=P.filters,i=aa(e),u=new Date,c=Number(s);let m=null;if(s==="custom"){m=r?new Date(r):null;const d=l?new Date(l):null;return P.projects.filter(j=>!Lt(j,t)||!Dt(j,a)||!Ft(j,i)?!1:On(j.start,m,d))}return s!=="all"&&Number.isFinite(c)&&(m=new Date,m.setDate(u.getDate()-c)),P.projects.filter(d=>!Lt(d,t)||!Dt(d,a)||!Ft(d,i)?!1:s==="all"?!0:Hn(d.start,m,u))}function Lt(e,t){return t.includes(e.status)}function Dt(e,t){return t==="all"?!0:e.paymentStatus===t}function Ft(e,t){return t?aa([e.title,e.projectCode,e.clientName,e.clientCompany,e.type,e.description].filter(Boolean).join(" ")).includes(t):!0}function Hn(e,t,a){return!e||!(e instanceof Date)||Number.isNaN(e.getTime())?!1:t?e>=t&&e<=a:!0}function On(e,t,a){if(!t&&!a)return!0;if(!e||Number.isNaN(e.getTime()))return!1;const s=e.getTime();return!(t&&!Number.isNaN(t.getTime())&&s<t.getTime()||a&&!Number.isNaN(a.getTime())&&s>a.getTime())}function aa(e){return e?g(String(e)).toLowerCase().trim():""}function Vn(e){if(!p.kpiGrid)return;const t=e.length,a=e.reduce((i,u)=>i+u.overallTotal,0),s=e.reduce((i,u)=>i+u.unpaidValue,0),r=e.reduce((i,u)=>i+u.expensesTotal,0),l=[{icon:_e.projects,label:n("projects.reports.kpi.totalProjects","Total projects"),value:lt(t),meta:n("projects.reports.kpi.totalProjectsMeta","After applying the current filters")},{icon:_e.value,label:n("projects.reports.kpi.totalValue","Total value"),value:X(a),meta:n("projects.reports.kpi.totalValueMeta","Includes projects and linked reservations")},{icon:_e.outstanding,label:n("projects.reports.kpi.unpaidValue","Outstanding value"),value:X(s),meta:n("projects.reports.kpi.unpaidValueMeta","Projects not fully paid yet")},{icon:_e.expenses,label:n("projects.reports.kpi.expenses","خدمات إنتاجية (التكلفة)"),value:X(r),meta:n("projects.reports.kpi.expensesMeta","تكلفة الخدمات الإنتاجية للمشاريع المحددة")}];p.kpiGrid.innerHTML=l.map(({icon:i,label:u,value:c,meta:m})=>`
  ...
  `).join(""),Un(e)}function Un(e){try{const t=zn(e),a="projects-revenue-breakdown";let s=document.getElementById(a);const r=[{label:n("reservations.reports.kpi.revenue.details.gross","الإيراد الكلي","Gross revenue"),value:X(t.grossRevenue)},{label:n("reservations.reports.kpi.revenue.details.share","نسبة الشركة","Company share"),value:X(t.companyShareTotal)},{label:n("reservations.reports.kpi.revenue.details.tax","الضريبة","Tax"),value:X(t.taxTotal)},{label:n("reservations.reports.kpi.revenue.details.crewGross","إجمالي الطاقم","Crew total"),value:X(t.crewTotal)},{label:n("reservations.reports.kpi.revenue.details.crew","تكلفة الطاقم","Crew cost"),value:X(t.crewCostTotal)},{label:n("reservations.reports.kpi.revenue.details.equipment","إجمالي المعدات","Equipment total"),value:X(t.equipmentTotalCombined)},{label:n("projects.reports.kpi.revenue.details.projectExpenses","مصروفات المشروع","Project expenses"),value:`−${X(t.projectExpensesTotal)}`},{label:n("reservations.reports.kpi.revenue.details.net","صافي الربح","Net profit"),value:X(t.netProfit)}],l=`
    ...
    `}).join("");if(p.tableBody.innerHTML=t,p.tableMeta){const a=n("projects.reports.table.meta","Showing {count} of {total} projects");p.tableMeta.textContent=a.replace("{count}",lt(e.length)).replace("{total}",lt(P.totalProjects))}}function Qn(e,t){if(!e&&!t)return"—";const a=e?Pt(e.toISOString()):"—",s=t?Pt(t.toISOString()):"—";return t?`${a} → ${s}`:a}function X(e){const t=Number(e)||0,s=He()==="ar"?"ar-SA-u-ca-gregory-nu-latn":"en-US",r=new Intl.NumberFormat(s,{minimumFractionDigits:0,maximumFractionDigits:0}).format(Math.round(t));return`${g(r)} SR`}function lt(e){const a=He()==="ar"?"ar-SA-u-ca-gregory-nu-latn":"en-US";return g(new Intl.NumberFormat(a).format(e))}function fe(e){const a=He()==="ar"?"ar-SA-u-ca-gregory-nu-latn":"en-US";return g(new Intl.NumberFormat(a,{notation:"compact",compactDisplay:"short"}).format(e))}function Zn(){return He()==="ar"?"ar-SA-u-ca-gregory-nu-latn":"en-US"}function H(e=""){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}
