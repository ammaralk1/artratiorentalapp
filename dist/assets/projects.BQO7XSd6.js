import{v as la,w as da,x as _t,o as mt,s as L,t as n,l as Bt,n as g,A as ua,e as pa,m as ma,h as fa,i as ha,f as At,g as Oe}from"./auth.D9iQr7TS.js";/* empty css              */import{i as ba}from"./dashboardShell.BnOPGN2x.js";import{d as h,r as we,a as Ce,u as ke,s as T,b as ya,f as ft,h as va,i as ga,j as o,k as w,l as ja,m as ht,n as xa,o as $t,e as st,p as Nt,q as wa,t as Sa,g as Ta,c as Pa,v as Aa,w as Ht,x as $a,y as Na,z as Ea,A as Ca,B as ka,C as Da,D as La,E as Fa,F as Ia,G as Ma,H as Ra,I as Ue,J as _a,K as qt,L as Ba,M as Ha}from"./form.BXegXNhF.js";import"./customers.DdK3-bvN.js";import{g as bt,b as qa,o as He,q as rt,a as Vt,D as ot,l as Va}from"./reservationsService.cbvx-9hp.js";import{P as yt,l as vt,n as Et,u as Ot,o as gt,p as ze,t as qe,v as Oa,x as Ua,i as za,h as Wa,w as Ka,y as it,z as ct,e as Ut,A as zt,B as Ga,C as Ja}from"./controller.DmOvCIO9.js";import{a as Ya}from"./calculations.DcWKoq9W.js";let Ct=null;function Xa(e){e&&Wt()!==e&&mt({[yt]:e}).catch(t=>{console.warn("⚠️ [projects] Failed to persist projects main tab preference",t)})}function Wt(){return _t()?.[yt]||""}function Kt(e){e&&lt()!==e&&mt({[vt]:e}).catch(t=>{console.warn("⚠️ [projects] Failed to persist projects sub-tab preference",t)})}function lt(){return _t()?.[vt]||""}function Qa(e){if(!e)return"";const t=e.trim();return t?Object.values(Et).includes(t)?t:Et[t]||"":""}function Za(){if(typeof window>"u")return"";try{const t=new URLSearchParams(window.location.search||"").get("subTab");if(t){const a=Qa(t);if(a)return a}}catch{}return""}function Gt(e,t){!e||!h.tabPanes||!h.tabButtons||(h.tabButtons.forEach(a=>{const s=a===t;a.classList.toggle("active",s),a.classList.contains("tab-button")&&a.classList.toggle("tab-active",s)}),h.tabPanes.forEach(a=>{a.dataset.tabPane===e?a.classList.remove("d-none"):a.classList.add("d-none")}),t&&Xa(e))}function en(){if(!h.tabButtons||!h.tabButtons.length)return;h.tabButtons.forEach(a=>{a.dataset.tabListenerAttached!=="true"&&(a.addEventListener("click",s=>{s.preventDefault();const r=a.dataset.tabTarget;r&&(Gt(r,a),r==="projects-section"&&(T.filters.search="",h.search&&(h.search.value=""),we(),Ce(),ke()))}),a.dataset.tabListenerAttached="true")});const e=Wt(),t=e&&h.tabButtons.find(a=>a.dataset.tabTarget===e);t&&t.click()}function jt(e,t){!e||!h.projectSubTabButtons||!h.projectSubTabPanes||(h.projectSubTabButtons.forEach(a=>{const s=a===t;a.classList.toggle("active",s),a.classList.contains("tab")&&a.classList.toggle("tab-active",s)}),h.projectSubTabPanes.forEach(a=>{a.dataset.projectSubtab===e?a.classList.remove("d-none"):a.classList.add("d-none")}))}function tn(){!h.projectSubTabButtons||!h.projectSubTabButtons.length||(h.projectSubTabButtons.forEach(e=>{e.dataset.tabListenerAttached!=="true"&&(e.addEventListener("click",t=>{t.preventDefault();const a=e.dataset.projectSubtabTarget;a&&(jt(a,e),Kt(a))}),e.dataset.tabListenerAttached="true")}),an())}function an(){const t=Za()||lt();if(!t)return;const a=h.projectSubTabButtons?.[0],s=h.projectSubTabButtons?.find(l=>l.dataset.projectSubtabTarget===t)||a,r=s?.dataset.projectSubtabTarget;r&&(t!==lt()&&Kt(r),jt(r,s))}function nn(){return h.tabButtons?h.tabButtons.find(t=>t.classList.contains("active"))?.dataset.tabTarget==="projects-section":!1}function kt(e={}){if(e){if(h.tabButtons&&h.tabButtons.length){const a=h.tabButtons.find(r=>r.classList.contains("active"))?.dataset.tabTarget||"",s=e[yt];if(s&&s!==a){const r=h.tabButtons.find(l=>l.dataset.tabTarget===s);r&&Gt(s,r)}}if(h.projectSubTabButtons&&h.projectSubTabButtons.length&&nn()){const a=h.projectSubTabButtons.find(r=>r.classList.contains("active"))?.dataset.projectSubtabTarget||"",s=e[vt];if(s&&s!==a){const r=h.projectSubTabButtons.find(l=>l.dataset.projectSubtabTarget===s);r&&jt(s,r)}}}}function sn(){Ct||(Ct=la(e=>{kt(e)})),da().then(e=>{kt(e)}).catch(e=>{console.warn("⚠️ [projects] Failed to synchronise project preferences",e)})}function be(e){const t=T.projects.find(v=>String(v.id)===String(e));if(!t||!h.detailsBody)return;h.detailsBody.dataset.mode="view",h.detailsBody.dataset.projectId=String(t.id);const s=(T.customers.length?T.customers:Bt().customers||[]).find(v=>String(v.id)===String(t.clientId)),r=Qt(t.type),i=t.description?.trim()||n("projects.fallback.noDescription","لا يوجد وصف"),u=s?.customerName||n("projects.fallback.unknownClient","عميل غير معروف"),c=s?.phone??s?.customerPhone??t.clientPhone??t.customerPhone??"",m=c?g(String(c).trim()):n("projects.details.client.noPhone","لا يوجد رقم متاح"),d=s?.email??t.clientEmail??t.customerEmail??"",x=d?String(d).trim():n("projects.details.client.noEmail","لا يوجد بريد متاح"),P=(t.clientCompany||s?.companyName||"").trim(),k=t.projectCode||`PRJ-${g(String(t.id))}`,_=g(k),E=ft(t.id),ne=E.reduce((v,$)=>v+Zt($),0),D=Number(ne.toFixed(2)),N=E.length,{subtotal:z,applyTax:oe,expensesTotal:Y}=va(t),pe=Number(t?.servicesClientPrice??t?.services_client_price??0),De=z,Se=oe?Number(((De+D)*qe).toFixed(2)):0,St=Number((De+D+Se).toFixed(2)),Z=ga(t),me=n(`projects.status.${Z}`,Oa[Z]||Z),ve=(()=>{try{const v=t.start?new Date(t.start):null,$=t.end?new Date(t.end):v?new Date(v.getTime()+3600*1e3):null;return!v||!$||Number.isNaN(v.getTime())||Number.isNaN($.getTime())?!1:T.projects.some(M=>{if(!M||String(M.id)===String(t.id))return!1;const G=M.start?new Date(M.start):null,V=M.end?new Date(M.end):G?new Date(G.getTime()+3600*1e3):null;if(!G||!V||Number.isNaN(G.getTime())||Number.isNaN(V.getTime()))return!1;const O=Math.max(v.getTime(),G.getTime()),U=Math.min($.getTime(),V.getTime());return O<U})}catch{return!1}})()&&Z!=="completed"?"conflict":Z,ie={upcoming:"قادم",ongoing:"قيد التنفيذ",completed:"مكتمل",conflict:"تعارض"}[ve]||me,ge={upcoming:"timeline-status-badge timeline-status-badge--upcoming",ongoing:"timeline-status-badge timeline-status-badge--ongoing",completed:"timeline-status-badge timeline-status-badge--completed",conflict:"timeline-status-badge timeline-status-badge--conflict"}[ve]||"timeline-status-badge timeline-status-badge--upcoming",je=typeof t.paymentStatus=="string"?t.paymentStatus.toLowerCase():"",Te=bn(t),xe=Te.length>0,Pe=xe?0:Number(t.paidAmount)||0,f=xe?0:Number(t.paidPercent)||0;let b=St,y,j,A,C,F,B,R,ee,H,X;const Ge=fn(Te),Le=n("projects.focus.confirmed","✅ مشروع مؤكد"),Ae=t.confirmed===!0||t.confirmed==="true"?`<span class="reservation-chip status-confirmed">${o(Le)}</span>`:"";let I=[];if(N>0){const v=E.reduce((Re,le)=>{const ca=Array.isArray(le.items)?le.items:[],Pt=Array.isArray(le.crewAssignments)?le.crewAssignments:[],he=Pt.length?Pt:Array.isArray(le.technicians)?le.technicians:[],nt=qa({items:ca,technicianIds:Array.isArray(he)&&!he.length?he:[],crewAssignments:Array.isArray(he)&&he.length&&typeof he[0]=="object"?he:[],discount:le.discount??0,discountType:le.discountType||"percent",applyTax:!1,start:le.start,end:le.end,companySharePercent:null});return Re.equipment+=Number(nt.equipmentTotal||0),Re.crew+=Number(nt.crewTotal||0),Re.crewCost+=Number(nt.crewCostTotal||0),Re},{equipment:0,crew:0,crewCost:0}),$=Number(Y||0),M=Number((v.equipment+v.crew+pe).toFixed(2)),G=Number.parseFloat(t?.discount??t?.discountValue??0)||0;let O=(t?.discountType==="amount"?"amount":"percent")==="amount"?G:M*(G/100);(!Number.isFinite(O)||O<0)&&(O=0),O>M&&(O=M);const U=oe===!0,ce=t?.companyShareEnabled===!0||t?.companyShareEnabled==="true"||t?.company_share_enabled===!0||t?.company_share_enabled==="true",se=Number.parseFloat(t?.companySharePercent??t?.company_share_percent??t?.companyShare??t?.company_share??0)||0,fe=ce&&se>0?se:0,q=Math.max(0,M-O),J=Number((q*(fe/100)).toFixed(2)),ue=U?Number(((q+J)*qe).toFixed(2)):0,Ne=Number((q+J+ue).toFixed(2)),ia=Number((Ne-J-ue-$-v.crewCost).toFixed(2));v.equipment>0&&I.push({icon:"🎛️",label:n("projects.details.summary.equipmentTotal","إجمالي المعدات"),value:w(v.equipment)}),v.crew>0&&I.push({icon:"😎",label:n("projects.details.summary.crewTotal","إجمالي الفريق"),value:w(v.crew)}),v.crewCost>0&&I.push({icon:"🧾",label:n("projects.details.summary.crewCostTotal","تكلفة الفريق"),value:w(v.crewCost)}),$>0&&I.push({icon:"🧾",label:n("projects.details.summary.expensesTotal","تكلفة الخدمات الإنتاجية"),value:w($)}),pe>0&&I.push({icon:"💼",label:n("projects.details.summary.servicesClientPrice","الخدمات الإنتاجية"),value:w(pe)}),O>0&&I.push({icon:"🏷️",label:n("projects.details.summary.discount","الخصم"),value:`−${w(O)}`}),I.push({icon:"🧮",label:n("projects.details.summary.grossAfterDiscount","الإجمالي بعد الخصم"),value:w(q)}),J>0&&I.push({icon:"🏦",label:n("projects.details.summary.companyShare","نسبة الشركة"),value:`−${w(J)}`}),ue>0&&I.push({icon:"💸",label:n("projects.details.summary.tax","الضريبة (15٪)"),value:`−${w(ue)}`}),I.push({icon:"💵",label:n("projects.details.summary.netProfit","صافي الربح"),value:w(ia)}),I.push({icon:"💰",label:n("projects.details.summary.finalTotal","المجموع النهائي"),value:w(Ne)}),b=Ne}else{const v=Number(Y||0),$=Math.max(0,Number(pe)||0),M=Number.parseFloat(t?.discount??t?.discountValue??0)||0;let V=(t?.discountType==="amount"?"amount":"percent")==="amount"?M:$*(M/100);(!Number.isFinite(V)||V<0)&&(V=0),V>$&&(V=$);const O=Math.max(0,$-V),U=oe===!0,ce=t?.companyShareEnabled===!0||t?.companyShareEnabled==="true"||t?.company_share_enabled===!0||t?.company_share_enabled==="true",se=Number.parseFloat(t?.companySharePercent??t?.company_share_percent??t?.companyShare??t?.company_share??0)||0,fe=ce&&se>0?se:0,q=Number((O*(fe/100)).toFixed(2)),J=U?Number(((O+q)*qe).toFixed(2)):0,ue=Number((O+q+J).toFixed(2)),Ne=Number((ue-q-J-v).toFixed(2));I=[],I.push({icon:"💼",label:n("projects.details.summary.servicesClientPrice","الخدمات الإنتاجية"),value:w($)}),V>0&&I.push({icon:"🏷️",label:n("projects.details.summary.discount","الخصم"),value:`−${w(V)}`}),I.push({icon:"🧮",label:n("projects.details.summary.grossAfterDiscount","الإجمالي بعد الخصم"),value:w(O)}),q>0&&I.push({icon:"🏦",label:n("projects.details.summary.companyShare","نسبة الشركة"),value:`−${w(q)}`}),J>0&&I.push({icon:"💸",label:n("projects.details.summary.tax","الضريبة (15٪)"),value:`−${w(J)}`}),I.push({icon:"💵",label:n("projects.details.summary.netProfit","صافي الربح"),value:w(Ne)}),I.push({icon:"💰",label:n("projects.details.summary.finalTotal","المجموع النهائي"),value:w(ue)}),b=ue}y=He({totalAmount:b,paidAmount:Pe,paidPercent:f,history:Te}),j=rt({manualStatus:je||"unpaid",paidAmount:y.paidAmount,paidPercent:y.paidPercent,totalAmount:b}),A=n(`projects.paymentStatus.${j}`,j==="paid"?"Paid":j==="partial"?"Partial":"Unpaid"),C=j==="paid"?"status-paid":j==="partial"?"status-partial":"status-unpaid",F=Number.isFinite(Number(y.paidAmount))?Number(y.paidAmount):0,B=Number.isFinite(Number(y.paidPercent))?Number(y.paidPercent):0,R=Math.max(0,Number((b-F).toFixed(2))),ee=w(F),H=`${g(B.toFixed(2))}%`,X=w(R);const Fe=I.map(({icon:v,label:$,value:M})=>`
  ...
  `,Xe=[{icon:"👤",label:n("projects.details.client","العميل"),value:u},{icon:"📞",label:n("projects.details.labels.clientPhone","رقم العميل"),value:m},{icon:"✉️",label:n("projects.details.labels.clientEmail","البريد الإلكتروني"),value:x},P?{icon:"🏢",label:n("projects.details.company","شركة العميل"),value:P}:null,{icon:"🏷️",label:n("projects.details.type","نوع المشروع"),value:`<span class="project-type-chip project-type-chip--${t.type||"default"}">${o(r)}</span>`},Lt("start",t.start),Lt("end",t.end)].filter(Boolean),Qe=n("projects.details.overview.heading","معلومات المشروع"),Ze=`
    <div class="project-details-outline">
      ...
      <ul class="project-details-outline__list">
        ${Xe.map(({icon:v,label:$,value:M,meta:G})=>`
          <li>
            <span class="project-details-outline__label">${o(v)} ${o($)}</span>
            <span class="project-details-outline__value-group">
              <span class="project-details-outline__value">${o(M)}</span>
              ${G?`<span class="project-details-outline__meta">${o(G)}</span>`:""}
            </span>
          </li>
        `).join("")}
      </ul>
    </div>
  `,et=N>0?n("projects.details.chips.linkedReservation","مربوط بحجز"):n("projects.details.chips.notLinkedReservation","غير مربوط بحجز"),$e=N>0?"reservation-chip status-confirmed":"reservation-chip status-info",Ie=[`<span class="${ge}">${o(ie)}</span>`,`<span class="${$e}">${o(et)}</span>`,`<span class="reservation-chip ${C}">${o(A)}</span>`,Ae].filter(Boolean).join(""),tt=n("projects.details.expensesTotal","تكلفة الخدمات الإنتاجية"),K=n("projects.details.reservationsTotal","إجمالي الحجوزات"),at=n("projects.details.expenses","خدمات إنتاجية ({amount})").replace("{amount}",w(Y)),Me=rn(Array.isArray(t.expenses)?t.expenses:[]);h.detailsBody.innerHTML=`
  ...
  `,ln(t);const te=h.detailsBody.querySelector("#project-details-export-btn");te&&te.addEventListener("click",async v=>{if(v.preventDefault(),te.blur(),!te.disabled){te.disabled=!0;try{await Ua({project:t})}catch($){console.error("❌ [projects/details] export project PDF failed",$),L(n("projects.details.exportFailed","⚠️ تعذر تصدير المشروع إلى PDF"),"error")}finally{te.disabled=!1}}}),h.detailsModalEl&&window.bootstrap?.Modal&&window.bootstrap.Modal.getOrCreateInstance(h.detailsModalEl).show()}function rn(e=[]){if(!(Array.isArray(e)&&e.length>0)){const s=o(n("projects.expenses.table.empty","ستظهر المصاريف المسجلة هنا فور إضافتها."));return`
  ...
  `}function on({onOpenProject:e}){!h.focusCards||h.focusCards.dataset.listenerAttached==="true"||(h.focusCards.addEventListener("click",t=>{const a=t.target.closest("[data-action]");if(a){const{action:r,id:l}=a.dataset;if(r==="confirm-project"){t.preventDefault(),t.stopPropagation(),un(l);return}r==="view"?e?.(l):r==="highlight"&&cn(l);return}const s=t.target.closest(".project-focus-card");s?.dataset.projectId&&e?.(s.dataset.projectId)}),h.focusCards.dataset.listenerAttached="true")}function cn(e){if(!h.projectsTableBody)return;const t=`tr[data-project-id="${CSS.escape(String(e))}"]`,a=h.projectsTableBody.querySelector(t);if(!a){L(n("projects.focus.toastNotFound","⚠️ تعذّر العثور على المشروع في القائمة"));return}a.classList.add("project-row-highlight"),a.scrollIntoView({behavior:"smooth",block:"center"}),window.setTimeout(()=>{a.classList.remove("project-row-highlight")},2200)}function ln(e){if(!h.detailsBody)return;const t=h.detailsBody.querySelector('[data-action="create-reservation"]'),a=h.detailsBody.querySelector('[data-action="edit-project"]'),s=h.detailsBody.querySelector('[data-action="delete-project"]'),r=h.detailsBody.querySelector(".project-reservations-list");if(t&&e)try{(ft(e.id)||[]).some(u=>{const c=String(u?.status||u?.reservationStatus||"").toLowerCase();return c!=="cancelled"&&c!=="canceled"})?(t.classList?.add("disabled"),t.setAttribute?.("aria-disabled","true"),t.title=n("projects.details.reservations.createDisabled","⚠️ المشروع مربوط بحجز مسبقاً"),t.addEventListener("click",u=>{u.preventDefault(),L(n("projects.details.reservations.createDisabledToast","⚠️ المشروع مربوط بحجز مسبقاً"))})):(t.disabled=!1,t.classList?.remove("disabled"),t.classList?.remove("btn-disabled"),t.removeAttribute?.("aria-disabled"),t.removeAttribute?.("title"),t.addEventListener("click",u=>{u.preventDefault(),Dt(e)}))}catch{t.disabled=!1,t.classList?.remove("disabled"),t.classList?.remove("btn-disabled"),t.removeAttribute?.("aria-disabled"),t.removeAttribute?.("title"),t.addEventListener("click",i=>{i.preventDefault(),Dt(e)})}if(a&&e&&a.addEventListener("click",l=>{l.preventDefault(),Jt(e)}),s&&e&&s.addEventListener("click",async l=>{l.preventDefault();const i=l.currentTarget;i.disabled=!0;try{await xa(e.id),!T.projects.some(c=>String(c.id)===String(e.id))&&h.detailsModalEl&&window.bootstrap?.Modal.getInstance(h.detailsModalEl)?.hide()}finally{T.projects.some(c=>String(c.id)===String(e.id))&&(i.disabled=!1)}}),r){const l=async i=>{if(!Number.isInteger(i)||i<0)return!1;const u=Wa("showReservationDetails");if(typeof u=="function")return u(i),!0;try{const c=await Ka("showReservationDetails");if(typeof c=="function")return c(i),!0}catch(c){console.warn("⚠️ [projects/projectDetails] Unable to resolve reservation UI handler",c)}return!1};r.addEventListener("click",async i=>{const u=i.target.closest('[data-action="view-reservation"]');if(!u)return;const c=u.dataset.index||u.dataset.reservationIndex,m=Number.parseInt(c||"-1",10);if(!Number.isInteger(m)||m<0)return;await l(m)||(window.location.href="dashboard.html#reservations")}),r.addEventListener("keydown",i=>{if(!["Enter"," "].includes(i.key))return;const u=i.target.closest('[data-action="view-reservation"]');u&&(i.preventDefault(),u.click())})}}function Jt(e){if(!e||!h.detailsBody)return;const t=T.projects.find(d=>String(d.id)===String(e.id));if(!t)return;const a=T.customers.find(d=>String(d.id)===String(t.clientId));a?.customerName||a?.name||t.clientName||t.customerName,t.clientCompany||a?.companyName||a?.company;const s=Array.isArray(t.expenses)?t.expenses.map((d,x)=>({id:d?.id||`expense-${t.id}-${x}-${Date.now()}`,label:d?.label||"",amount:Number(d?.amount)||0,salePrice:Number.isFinite(Number(d?.sale_price??d?.salePrice))?Number(d?.sale_price??d?.salePrice):0})):[];let r=Array.isArray(t.paymentHistory)?t.paymentHistory.map((d,x)=>({type:d?.type==="percent"?"percent":"amount",amount:Number.isFinite(Number(d?.amount))?Number(d.amount):null,percentage:Number.isFinite(Number(d?.percentage))?Number(d.percentage):null,value:Number.isFinite(Number(d?.value))?Number(d.value):null,note:d?.note??null,recordedAt:d?.recordedAt??d?.recorded_at??new Date().toISOString(),key:`payment-${t.id}-${x}`})):[],l=r.reduce((d,x)=>d+(Number(x?.amount)||0),0),i=r.reduce((d,x)=>d+(Number(x?.percentage)||0),0),u=Number.isFinite(Number(t.paidAmount))?Number(t.paidAmount):0,c=Number.isFinite(Number(t.paidPercent))?Number(t.paidPercent):0;if(!r.length&&(u>0||c>0)){const d=t.updatedAt??t.createdAt??new Date().toISOString();c>0?r=[{type:"percent",amount:Number.isFinite(u)&&u>0?u:null,percentage:c,value:c,note:null,recordedAt:d,key:`legacy-payment-${t.id}-percent`}]:u>0&&(r=[{type:"amount",amount:u,percentage:null,value:u,note:null,recordedAt:d,key:`legacy-payment-${t.id}-amount`}]),l=r.reduce((x,P)=>x+(Number(P?.amount)||0),0),i=r.reduce((x,P)=>x+(Number(P?.percentage)||0),0),u=0,c=0}l>0&&Math.abs(u-l)<.01&&(u=0),i>0&&Math.abs(c-i)<.01&&(c=0);const m={expenses:s,payments:r,basePaidAmount:u,basePaidPercent:c};h.detailsBody.dataset.mode="edit",h.detailsBody.innerHTML=pn(t,m),dn(t,m)}function dn(e,t={expenses:[]}){const a=h.detailsBody?.querySelector("#project-details-edit-form");if(!a)return;const s=a.querySelector('[data-action="cancel-edit"]');s&&s.addEventListener("click",f=>{f.preventDefault(),be(e.id)});const r=a.querySelector("#project-edit-expense-label"),l=a.querySelector("#project-edit-expense-amount"),i=a.querySelector("#project-edit-expense-sale"),u=a.querySelector('[data-action="add-expense"]'),c=a.querySelector("#project-edit-expense-list"),m=a.querySelector('[name="project-start-date"]'),d=a.querySelector('[name="project-start-time"]'),x=a.querySelector('[name="project-end-date"]'),P=a.querySelector('[name="project-end-time"]'),k=a.querySelector('[name="project-payment-status"]'),_=a.querySelector("#project-edit-tax"),E=a.querySelector("#project-edit-company-share"),ne=a.querySelector("#project-edit-discount"),D=a.querySelector("#project-edit-discount-type"),N=a.querySelector("#project-edit-payment-progress-type"),z=a.querySelector("#project-edit-payment-progress-value"),oe=a.querySelector("#project-edit-payment-add"),Y=a.querySelector("#project-edit-payment-history"),pe=a.querySelector("#project-edit-payment-summary"),De=n("reservations.create.summary.currency","SR");let Se=!1;(()=>{const f=(typeof window<"u"?window.flatpickr:null)||(typeof globalThis<"u"?globalThis.flatpickr:null);f&&(m&&f(m,{dateFormat:"Y-m-d",allowInput:!0}),x&&f(x,{dateFormat:"Y-m-d",allowInput:!0}),d&&f(d,{enableTime:!0,noCalendar:!0,dateFormat:"H:i",altInput:!0,altFormat:"h:i K",time_24hr:!1,defaultHour:9,defaultMinute:0,minuteIncrement:5,disableMobile:!0,allowInput:!0,altInputClass:"flatpickr-alt-input form-control"}),P&&f(P,{enableTime:!0,noCalendar:!0,dateFormat:"H:i",altInput:!0,altFormat:"h:i K",time_24hr:!1,defaultHour:9,defaultMinute:0,minuteIncrement:5,disableMobile:!0,allowInput:!0,altInputClass:"flatpickr-alt-input form-control"}))})();const Z=f=>{if(!f||f.dataset.normalizedDigits==="true")return;const b=()=>{const y=f.value||"",j=g(y);if(j!==y){const A=f.selectionStart,C=f.selectionEnd;f.value=j;try{if(typeof A=="number"&&typeof C=="number"){const F=j.length-y.length;f.setSelectionRange(Math.max(0,A+F),Math.max(0,C+F))}}catch{}}};f.addEventListener("input",b),f.addEventListener("blur",b);try{f.setAttribute("inputmode","numeric")}catch{}f.dataset.normalizedDigits="true"};Z(m),Z(d),Z(x),Z(P),d&&d._flatpickr?.altInput&&Z(d._flatpickr.altInput),P&&P._flatpickr?.altInput&&Z(P._flatpickr.altInput);const me=()=>(Array.isArray(t.payments)||(t.payments=[]),t.payments),Ke=()=>{const f=Number(e.equipmentEstimate)||0,b=Array.isArray(t.expenses)?t.expenses.reduce((H,X)=>H+(Number(X.amount)||0),0):0,y=Array.isArray(t.expenses)?Math.max(0,Math.round(t.expenses.reduce((H,X)=>H+Number(X?.salePrice??0),0)*100)/100):Math.max(0,Number(e?.servicesClientPrice??0)),j=D?.value==="amount"?"amount":"percent",A=g(ne?.value||"0");let C=Number.parseFloat(A);(!Number.isFinite(C)||C<0)&&(C=0);const F=_?.checked===!0,B=E?.checked===!0;let R=B?Ta(E):null;(!Number.isFinite(R)||R<=0)&&(R=B?ot:null);const ee=Pa({equipmentEstimate:f,expensesTotal:b,servicesClientPrice:y,discountValue:C,discountType:j,applyTax:F,companyShareEnabled:B,companySharePercent:R});return{equipmentEstimate:f,expensesTotal:b,discountValue:C,discountTypeValue:j,applyTax:F,companyShareEnabled:B,companySharePercent:R,servicesClientPrice:y,finance:ee}},ve=()=>{const f=Ke(),b=me(),j=(ft(e.id)||[]).reduce((R,ee)=>R+(Number(ee?.totalAmount)||Zt(ee)||0),0),A=Number(f.finance?.taxableAmount||0),C=f.applyTax?Number(((A+j)*qe).toFixed(2)):0,F=Number((A+j+C).toFixed(2)),B=He({totalAmount:F,paidAmount:t.basePaidAmount||0,paidPercent:t.basePaidPercent||0,history:b});return{...f,combinedTotalWithTax:F,payments:b,progress:B}},Tt=()=>{Y&&(Y.innerHTML=hn(me()))},ie=()=>{if(!pe)return;const{combinedTotalWithTax:f,progress:b}=ve(),y=Number.isFinite(Number(f))?Number(f):0,j=Number.isFinite(Number(b.paidAmount))?Number(b.paidAmount):0,A=Number.isFinite(Number(b.paidPercent))?Number(b.paidPercent):0,C=Math.max(0,Math.round((y-j)*100)/100),F=[{label:n("projects.form.paymentSummary.total","الإجمالي الكلي"),value:w(y)},{label:n("projects.form.paymentSummary.paidAmount","إجمالي المدفوع"),value:w(j)},{label:n("projects.form.paymentSummary.paidPercent","نسبة الدفعات"),value:`${g(A.toFixed(2))}%`},{label:n("projects.form.paymentSummary.remaining","المتبقي"),value:w(C)}];pe.innerHTML=F.map(({label:B,value:R})=>`
        <div class="project-details-grid-item">
          <span>${o(B)}</span>
          <strong>${o(R)}</strong>
        </div>
      `).join("")},de=(f="auto")=>{if(!k)return;const b=k.dataset?.userSelected==="true";if(f==="auto"&&b)return;const{finance:y,progress:j}=ve(),A=rt({manualStatus:b?k.value:e.paymentStatus||"unpaid",paidAmount:j.paidAmount,paidPercent:j.paidPercent,totalAmount:y.totalWithTax});b||(k.value=A)},ge=()=>{Tt(),ie(),de("auto")},je=1e-4,Te=()=>{const f=N?.value==="amount"?"amount":"percent",b=g(z?.value||"").replace("%","").trim();let y=Number.parseFloat(b);if(!Number.isFinite(y)||y<=0){L(n("projects.toast.paymentInvalid","⚠️ يرجى إدخال قيمة دفعة صحيحة")),z?.focus();return}const j=ve(),A=Number.isFinite(Number(j.finance.totalWithTax))?Number(j.finance.totalWithTax):0;if(A<=0){L(n("projects.toast.paymentTotalMissing","⚠️ يرجى التأكد من إدخال البيانات المالية للمشروع قبل تسجيل الدفعة"));return}const C=Number(j.progress.paidAmount)||0,F=Number(j.progress.paidPercent)||0;let B=null,R=null;if(f==="percent"){const H=Math.max(0,100-F);if(H<=je){L(n("projects.toast.paymentNoRemainingBalance","⚠️ تم تسجيل كامل قيمة المشروع، لا يمكن إضافة دفعة جديدة"));return}if(y>H){y=H;const X=g(y.toFixed(2));L(n("projects.toast.paymentCappedPercent","ℹ️ تم ضبط الدفعة إلى {value}% لاستكمال 100%").replace("{value}",X))}R=Math.round(y*100)/100,A>0&&(B=Math.round(R/100*A*100)/100)}else{const H=Math.max(0,A-C);if(H<=je){L(n("projects.toast.paymentNoRemainingBalance","⚠️ تم تسجيل كامل قيمة المشروع، لا يمكن إضافة دفعة جديدة"));return}if(y>H){y=H;const X=`${g(y.toFixed(2))} ${De}`;L(n("projects.toast.paymentCappedAmount","ℹ️ تم ضبط الدفعة إلى {amount} لاستكمال المبلغ المتبقي").replace("{amount}",X))}B=Math.round(y*100)/100,A>0&&(R=Math.round(B/A*100*100)/100)}const ee={type:f,amount:B??null,percentage:R??null,value:f==="amount"?B:R,note:null,recordedAt:new Date().toISOString()};t.payments=[...me(),ee],z&&(z.value=""),N&&(N.value="percent"),ge(),L(n("projects.toast.paymentAdded","✅ تم تسجيل الدفعة"))},xe=f=>{!_||!E||Se||(Se=!0,f==="share"?E.checked?(_.checked||(_.checked=!0),st(E)):_.checked&&(_.checked=!1):f==="tax"&&(_.checked?st(E):E.checked&&(E.checked=!1)),Se=!1)};function Pe(){c&&(c.innerHTML=Yt(t.expenses))}Pe(),ge(),ne&&!ne.dataset.listenerAttached&&(ne.addEventListener("input",f=>{const b=f.target;b instanceof HTMLInputElement&&(b.value=g(b.value||""),ie(),de("auto"))}),ne.dataset.listenerAttached="true"),i&&!i.dataset.listenerAttached&&(i.addEventListener("input",f=>{const b=f.target;b instanceof HTMLInputElement&&(b.value=g(b.value||""))}),i.dataset.listenerAttached="true"),D&&!D.dataset.listenerAttached&&(D.addEventListener("change",()=>{ie(),de("auto")}),D.dataset.listenerAttached="true"),z&&!z.dataset.listenerAttached&&(z.addEventListener("input",f=>{const b=f.target;b instanceof HTMLInputElement&&(b.value=g(b.value||""))}),z.dataset.listenerAttached="true"),k&&!k.dataset.listenerAttached&&(k.addEventListener("change",()=>{k.dataset.userSelected="true"}),k.dataset.listenerAttached="true"),l&&!l.dataset.listenerAttached&&(l.addEventListener("input",f=>{const b=f.target;b instanceof HTMLInputElement&&(b.value=g(b.value||""))}),l.dataset.listenerAttached="true"),E&&!E.dataset.listenerAttached&&(E.addEventListener("change",()=>{xe("share"),ie(),de("auto")}),E.dataset.listenerAttached="true"),_&&!_.dataset.listenerAttached&&(_.addEventListener("change",()=>{xe("tax"),ie(),de("auto")}),_.dataset.listenerAttached="true"),E?.checked&&st(E),xe(E?.checked?"share":"tax"),ie(),de("auto"),u&&u.addEventListener("click",f=>{f.preventDefault();const b=r?.value.trim()||"",y=g(l?.value||"0"),j=Number(y),A=g(i?.value||"0"),C=Number(A);if(!b){L(n("projects.toast.missingExpenseLabel","⚠️ يرجى إدخال وصف المصروف")),r?.focus();return}if(!Number.isFinite(j)||j<=0){L(n("projects.toast.invalidExpenseAmount","⚠️ يرجى إدخال مبلغ صحيح")),l?.focus();return}t.expenses.push({id:`expense-${e.id}-${Date.now()}`,label:b,amount:j,salePrice:Number.isFinite(C)&&C>0?C:0}),r&&(r.value=""),l&&(l.value=""),i&&(i.value=""),Pe(),ie(),de("auto")}),c&&c.addEventListener("click",f=>{const b=f.target.closest('[data-action="remove-expense"]');if(!b)return;const{id:y}=b.dataset;t.expenses=t.expenses.filter(j=>String(j.id)!==String(y)),Pe(),ie(),de("auto")}),oe&&!oe.dataset.listenerAttached&&(oe.addEventListener("click",f=>{f.preventDefault(),Te()}),oe.dataset.listenerAttached="true"),Y&&!Y.dataset.listenerAttached&&(Y.addEventListener("click",f=>{const b=f.target.closest('[data-action="remove-payment"]');if(!b)return;const y=Number.parseInt(b.dataset.index||"-1",10);if(!Number.isInteger(y)||y<0)return;const j=me();if(y>=j.length)return;const A=j.filter((C,F)=>F!==y);t.payments=A,ge(),L(n("projects.toast.paymentRemoved","🗑️ تم حذف الدفعة"))}),Y.dataset.listenerAttached="true"),a.addEventListener("submit",async f=>{if(f.preventDefault(),a.dataset.submitting==="true")return;const b=a.querySelector('[name="project-title"]'),y=a.querySelector('[name="project-type"]'),j=a.querySelector('[name="project-description"]'),A=b?.value.trim()||"",C=y?.value||"",F=g(m?.value.trim()||""),B=g(d?.value.trim()||""),R=j?.value.trim()||"",ee=(k?.value||"unpaid").toLowerCase(),H=["paid","partial"].includes(ee)?ee:"unpaid";if(!A||!C||!F){L(n("projects.toast.missingRequiredFields","⚠️ يرجى تعبئة البيانات المطلوبة")),b?.focus();return}const X=g(x?.value.trim()||""),Ge=g(P?.value.trim()||""),Le=Nt(F,B),Ae=X?Nt(X,Ge):"",I=new Date(Le),Fe=Ae?new Date(Ae):null;if(Fe&&I>Fe){L(n("projects.toast.invalidDateRange","⚠️ تاريخ النهاية يجب أن يكون بعد تاريخ البداية")),x?.focus();return}if(T.projects.findIndex(U=>String(U.id)===String(e.id))===-1){L(n("projects.toast.editMissing","⚠️ تعذّر العثور على المشروع المطلوب تعديله"));return}const Ye=Ke(),{equipmentEstimate:Xe,servicesClientPrice:Qe,discountValue:Ze,discountTypeValue:et,applyTax:$e,companyShareEnabled:Ie,companySharePercent:tt,finance:K}=Ye,at=N?.value==="amount"?"amount":"percent",Me=g(z?.value||"");let te=Me?Number.parseFloat(Me):null,v=[...me()];if(Number.isFinite(te)&&te>0&&Number.isFinite(Number(K.totalWithTax))){const U=He({totalAmount:K.totalWithTax,paidAmount:t.basePaidAmount||0,paidPercent:t.basePaidPercent||0,history:v}),ce=new Date().toISOString();if(at==="percent"){const se=Math.max(0,100-(U.paidPercent||0));if(se>je){const fe=Math.min(te,se),q=Math.round(fe*100)/100,J=K.totalWithTax>0?Math.round(q/100*K.totalWithTax*100)/100:null;v=[...v,{type:"percent",amount:J,percentage:q,value:q,note:null,recordedAt:ce}]}}else{const se=Math.max(0,K.totalWithTax-(U.paidAmount||0));if(se>je){const fe=Math.min(te,se),q=Math.round(fe*100)/100,J=K.totalWithTax>0?Math.round(q/K.totalWithTax*100*100)/100:null;v=[...v,{type:"amount",amount:q,percentage:J,value:q,note:null,recordedAt:ce}]}}v!==t.payments&&(t.payments=v,ge()),z&&(z.value=""),N&&(N.value="percent"),te=null}const $=He({totalAmount:K.totalWithTax,paidAmount:t.basePaidAmount||0,paidPercent:t.basePaidPercent||0,history:v}),M=k?.dataset?.userSelected==="true",G=rt({manualStatus:M?H:e.paymentStatus||H,paidAmount:$.paidAmount,paidPercent:$.paidPercent,totalAmount:K.totalWithTax}),V=M?H:G;!M&&k&&(k.value=V),k?.dataset&&delete k.dataset.userSelected,t.payments=v;const O=za({projectCode:e.projectCode,title:A,type:C,clientId:e.clientId,clientCompany:e.clientCompany,description:R,start:Le,end:Ae||null,applyTax:$e,paymentStatus:V,equipmentEstimate:Xe,expenses:t.expenses,servicesClientPrice:Qe,discount:Ze,discountType:et,companyShareEnabled:Ie&&$e,companySharePercent:Ie&&$e?tt:null,companyShareAmount:K.companyShareAmount,taxAmount:K.taxAmount,totalWithTax:K.totalWithTax,confirmed:e.confirmed,technicians:Array.isArray(e.technicians)?e.technicians:[],equipment:wa(e),paidAmount:$.paidAmount,paidPercentage:$.paidPercent,paymentProgressType:$.paymentProgressType,paymentProgressValue:$.paymentProgressValue,payments:v});a.dataset.submitting="true";try{const U=await Ot(e.projectId??e.id,O),ce=U?.projectId??U?.id??e.id;await Sa(ce,V),T.projects=gt(),T.reservations=bt(),L(n("projects.toast.updated","✅ تم تحديث المشروع بنجاح")),we(),Ce(),ke(),be(e.id)}catch(U){console.error("❌ [projects] Failed to update project from details view",U);const ce=ze(U)?U.message:n("projects.toast.updateFailed","تعذر تحديث المشروع، حاول مرة أخرى");L(ce,"error")}finally{delete a.dataset.submitting}})}function Dt(e){if(!e)return;const t={projectId:e.id,customerId:e.clientId||null,start:e.start||null,end:e.end||null,forceNotes:!!e.description,fromProjectForm:!0,draftStorageKey:"projects:create:draft",returnUrl:`projects.html?project=${encodeURIComponent(e.id)}&linked=1#projects-section`};mt({dashboardTab:"reservations-tab",dashboardSubTab:"create-tab"}).catch(r=>{console.warn("⚠️ [projects] Failed to persist dashboard tab preference",r)});let a="";try{a=encodeURIComponent(JSON.stringify(t))}catch(r){console.warn("⚠️ [projects] Unable to encode reservation context",r)}h.detailsModalEl&&window.bootstrap?.Modal&&window.bootstrap.Modal.getOrCreateInstance(h.detailsModalEl)?.hide();const s=a?`?reservationProjectContext=${a}`:"";window.location.href=`dashboard.html${s}#reservations`}async function un(e){if(!e)return;const t=T.projects.find(a=>String(a.id)===String(e));if(!t){L(n("projects.toast.editMissing","⚠️ تعذّر العثور على المشروع المطلوب تعديله"));return}if(t.confirmed===!0||t.confirmed==="true"){L(n("projects.toast.alreadyConfirmed","ℹ️ المشروع مؤكّد مسبقًا"));return}try{await Ot(t.projectId??t.id,{confirmed:!0});const a=await ya(e);T.projects=gt(),T.reservations=bt(),we(),Ce(),ke(),h.detailsModalEl&&h.detailsModalEl.classList.contains("show")&&h.detailsBody?.dataset.projectId===String(e)&&be(e),document.dispatchEvent(new CustomEvent("projects:changed")),a&&document.dispatchEvent(new CustomEvent("reservations:changed")),L(n("projects.toast.confirmed","✅ تم تأكيد المشروع"))}catch(a){console.error("❌ [projects] confirmProject failed",a);const s=ze(a)?a.message:n("projects.toast.updateFailed","تعذر تحديث المشروع، حاول مرة أخرى");L(s,"error")}}function pn(e,t={clientName:"",clientCompany:"",expenses:[]}){const{date:a,time:s}=$t(e.start||""),{date:r,time:l}=$t(e.end||""),i=e.applyTax===!0||e.applyTax==="true";typeof e.paymentStatus=="string"&&e.paymentStatus.toLowerCase();const u=e.discountType==="amount"?"amount":"percent",c=g(String(e.discount??e.discountValue??0));g(String(e.servicesClientPrice??e.services_client_price??0));const m=e.companySharePercent??e.company_share_percent??e.companyShare??e.company_share??e.companyShareAmountPercent??ot,d=Number.parseFloat(g(String(m))),x=Number.isFinite(d)&&d>0?d:ot,P=e.companyShareEnabled===!0||e.companyShareEnabled==="true"||e.company_share_enabled===!0||e.company_share_enabled==="true"||i&&Number.isFinite(d)&&d>0;return`
  ...
  `}function mn(e){return["commercial","coverage","photography","social"].map(a=>{const s=Qt(a),r=a===e?"selected":"";return`<option value="${o(a)}" ${r}>${o(s)}</option>`}).join("")}function Yt(e=[]){if(!Array.isArray(e)||e.length===0){const i=o(n("projects.selected.emptyExpenses","لم يتم تسجيل أي مصروف"));return`
      ...
      </div>`}const t=o(n("actions.remove","إزالة")),a=e.map(i=>{const u=o(i?.label||""),c=o(w(i?.amount||0)),m=o(w(i?.salePrice||i?.sale_price||0)),d=o(String(i?.id||""));return`
      <tr>
        <td>${u}</td>
        <td>${c}</td>
        <td>${m}</td>
        <td><button type="button" class="btn btn-sm btn-link text-danger" data-action="remove-expense" data-id="${d}" aria-label="${t}">✖</button></td>
      </tr>`}).join(""),s=e.reduce((i,u)=>i+(Number(u?.salePrice??u?.sale_price)||0),0),r=o(w(s)),l=o(n("projects.expenses.table.totalSale","مجموع سعر البيع"));return`
    <div class="table-responsive">
      <table class="table table-sm table-hover align-middle project-services-table">
        <thead class="table-light">
          <tr>
  ...
  `});let Q=null;const ea=["upcoming","ongoing","completed"];async function En({forceProjects:e=!1}={}){try{await Ut({suppressError:!0}),await Ja({force:e})}catch(t){console.error("❌ [projectsReports] Failed to load initial data",t),ze(t)&&console.warn("Projects API error:",t.message)}sa()}async function Cn(){Ln(),aa(),await kn();try{await En({forceProjects:!0}),oa(),Bn(),re()}finally{na()}document.addEventListener("language:changed",qn),document.addEventListener("projects:changed",()=>{ut().catch(e=>{console.error("❌ [projectsReports] Failed to refresh after projects change",e)})}),document.addEventListener("reservations:changed",()=>{ut().catch(e=>{console.error("❌ [projectsReports] Failed to refresh after reservations change",e)})}),window.addEventListener("storage",Vn)}document.addEventListener("DOMContentLoaded",Cn);async function kn(){if(Q)return Q;if(typeof window>"u")return null;if(window.ApexCharts)return Q=window.ApexCharts,Q;try{await Dn(Nn),Q=window.ApexCharts||null}catch(e){console.warn("ApexCharts failed to load",e),Q=null}return Q}function Dn(e){return new Promise((t,a)=>{if(typeof document>"u"){a(new Error("Document is not available to load scripts."));return}const s=document.querySelector(`script[src="${e}"]`);if(s){if(s.dataset.loaded==="true"){t();return}s.addEventListener("load",t,{once:!0}),s.addEventListener("error",()=>a(new Error(`Failed to load script ${e}`)),{once:!0});return}const r=document.createElement("script");r.src=e,r.async=!0,r.dataset.loaded="false",r.onload=()=>{r.dataset.loaded="true",t()},r.onerror=()=>a(new Error(`Failed to load script ${e}`)),document.head.appendChild(r)})}function Ln(){p.search=document.getElementById("reports-search"),p.statusChips=document.getElementById("reports-status-chips"),p.payment=document.getElementById("reports-payment"),p.dateRange=document.getElementById("reports-date-range"),p.customRangeWrapper=document.getElementById("reports-custom-range"),p.startDate=document.getElementById("reports-start-date"),p.endDate=document.getElementById("reports-end-date"),p.refreshBtn=document.getElementById("reports-refresh"),p.kpiGrid=document.getElementById("reports-kpi-grid"),p.table=document.getElementById("reports-table"),p.tableBody=p.table?.querySelector("tbody"),p.tableMeta=document.getElementById("reports-table-meta"),p.tableEmpty=document.getElementById("reports-empty"),p.chartCards={},p.chartLoaders={},document.querySelectorAll("[data-chart-card]").forEach(e=>{const t=e.dataset.chartCard;if(!t)return;p.chartCards[t]=e;const a=e.querySelector("[data-chart-loading]");a&&(p.chartLoaders[t]=a)})}function ta(e){const t=!!e;Object.entries(p.chartCards||{}).forEach(([a,s])=>{if(!s)return;s.classList.toggle("is-loading",t),s.setAttribute("aria-busy",t?"true":"false");const r=p.chartLoaders?.[a];r&&(r.hidden=!t)})}function aa(){Ee+=1,Ee===1&&ta(!0)}function na(){Ee=Math.max(0,Ee-1),Ee===0&&ta(!1)}function sa(){const{customers:e=[]}=Bt();S.customers=Array.isArray(e)?e:[],S.reservations=bt();const t=new Map(S.customers.map(s=>[String(s.id),s])),a=gt();S.projects=Array.isArray(a)?a.map(s=>Fn(s,t)):[],S.totalProjects=S.projects.length}function Fn(e,t){const a=e.paymentStatus==="paid"?"paid":"unpaid",s=t.get(String(e.clientId)),r=In(e.id),l=r.reduce((ne,D)=>ne+Mn(D),0),i=Rn(e),u=Number(e?.equipmentEstimate)||0,c=Number((u+i).toFixed(2)),m=e?.applyTax===!0||e?.applyTax==="true",d=m?Number((c*dt).toFixed(2)):0,x=m?Number(((c+l)*dt).toFixed(2)):0,P=Number((c+l+x).toFixed(2)),k=_n(e),_=e.start?new Date(e.start):null,E=e.end?new Date(e.end):null;return{raw:e,id:e.id,projectCode:e.projectCode||e.id,title:(e.title||"").trim(),clientId:e.clientId,clientName:s?.customerName||s?.name||"",clientCompany:e.clientCompany||s?.companyName||"",type:e.type||e.projectType||"",description:e.description||"",paymentStatus:a,confirmed:e.confirmed===!0||e.confirmed==="true",start:_,end:E,applyTax:m,status:k,reservationsTotal:Number(l.toFixed(2)),expensesTotal:i,subtotal:c,taxAmount:d,combinedTaxAmount:x,overallTotal:P,unpaidValue:a==="paid"?0:P,reservationsCount:r.length}}function In(e){return Array.isArray(S.reservations)?S.reservations.filter(t=>String(t.projectId)===String(e)):[]}function Mn(e){if(!e)return 0;const t=Array.isArray(e.items)?e.items:[],a=e.discount??0,s=Number(g(String(a)))||0,r=e.discountType||"percent",l=Array.isArray(e.crewAssignments)?e.crewAssignments:[],i=l.length?l:Array.isArray(e.technicians)?e.technicians:[],u=Vt(t,s,r,!1,i,{start:e.start,end:e.end});if(Number.isFinite(u))return u;const c=Number(g(String(e.cost??0)));return Number.isFinite(c)?Math.round(c):0}function Rn(e){return typeof e.expensesTotal=="number"?Number(e.expensesTotal)||0:Array.isArray(e.expenses)?e.expenses.reduce((t,a)=>t+(Number(a.amount)||0),0):0}function _n(e){const t=new Date,a=e.start?new Date(e.start):null,s=e.end?new Date(e.end):null;return a&&!Number.isNaN(a.getTime())&&a>t?"upcoming":s&&!Number.isNaN(s.getTime())&&s<t?"completed":"ongoing"}function Bn(){if(p.search){let e;p.search.addEventListener("input",()=>{clearTimeout(e),e=setTimeout(()=>{S.filters.search=p.search.value.trim(),re()},180)})}p.payment&&(p.payment.value=S.filters.payment,p.payment.addEventListener("change",()=>{S.filters.payment=p.payment.value||"all",re()})),p.dateRange&&(p.dateRange.addEventListener("change",Hn),p.dateRange.value=S.filters.range),p.startDate&&p.startDate.addEventListener("change",()=>{S.filters.startDate=p.startDate.value,S.filters.range==="custom"&&re()}),p.endDate&&p.endDate.addEventListener("change",()=>{S.filters.endDate=p.endDate.value,S.filters.range==="custom"&&re()}),p.refreshBtn&&p.refreshBtn.addEventListener("click",()=>{if(S.filters.range!=="custom"){re();return}S.filters.startDate=p.startDate?.value||"",S.filters.endDate=p.endDate?.value||"",re()})}function Hn(e){const t=e.target.value;S.filters.range=t,t==="custom"?p.customRangeWrapper?.classList.add("active"):(p.customRangeWrapper?.classList.remove("active"),S.filters.startDate="",S.filters.endDate="",p.startDate&&(p.startDate.value=""),p.endDate&&(p.endDate.value=""),re())}async function ut(){aa();try{await Promise.all([zt(),Va()])}catch(e){console.error("❌ [projectsReports] Data mutation refresh failed",e),ze(e)&&console.warn("Projects API error:",e.message)}finally{sa(),re(),na()}}function qn(){oa(),re()}function Vn(e){e.key&&!["projects","reservations","customers"].includes(e.key)||ut().catch(t=>{console.error("❌ [projectsReports] Storage sync failed",t)})}function re(){const e=On();wt(),Wn(e),Yn(e),Xn(e),Qn(e),Zn(e),es(e)}function On(){const{search:e,statuses:t,payment:a,range:s,startDate:r,endDate:l}=S.filters,i=ra(e),u=new Date,c=Number(s);let m=null;if(s==="custom"){m=r?new Date(r):null;const d=l?new Date(l):null;return S.projects.filter(x=>!It(x,t)||!Mt(x,a)||!Rt(x,i)?!1:zn(x.start,m,d))}return s!=="all"&&Number.isFinite(c)&&(m=new Date,m.setDate(u.getDate()-c)),S.projects.filter(d=>!It(d,t)||!Mt(d,a)||!Rt(d,i)?!1:s==="all"?!0:Un(d.start,m,u))}function It(e,t){return t.includes(e.status)}function Mt(e,t){return t==="all"?!0:e.paymentStatus===t}function Rt(e,t){return t?ra([e.title,e.projectCode,e.clientName,e.clientCompany,e.type,e.description].filter(Boolean).join(" ")).includes(t):!0}function Un(e,t,a){return!e||!(e instanceof Date)||Number.isNaN(e.getTime())?!1:t?e>=t&&e<=a:!0}function zn(e,t,a){if(!t&&!a)return!0;if(!e||Number.isNaN(e.getTime()))return!1;const s=e.getTime();return!(t&&!Number.isNaN(t.getTime())&&s<t.getTime()||a&&!Number.isNaN(a.getTime())&&s>a.getTime())}function ra(e){return e?g(String(e)).toLowerCase().trim():""}function Wn(e){if(!p.kpiGrid)return;const t=e.length,a=e.reduce((i,u)=>i+u.overallTotal,0),s=e.reduce((i,u)=>i+u.unpaidValue,0),r=e.reduce((i,u)=>i+u.expensesTotal,0),l=[{icon:Be.projects,label:n("projects.reports.kpi.totalProjects","Total projects"),value:pt(t),meta:n("projects.reports.kpi.totalProjectsMeta","After applying the current filters")},{icon:Be.value,label:n("projects.reports.kpi.totalValue","Total value"),value:ae(a),meta:n("projects.reports.kpi.totalValueMeta","Includes projects and linked reservations")},{icon:Be.outstanding,label:n("projects.reports.kpi.unpaidValue","Outstanding value"),value:ae(s),meta:n("projects.reports.kpi.unpaidValueMeta","Projects not fully paid yet")},{icon:Be.expenses,label:n("projects.reports.kpi.expenses","تكلفة الخدمات الإنتاجية"),value:ae(r),meta:n("projects.reports.kpi.expensesMeta","تكلفة الخدمات الإنتاجية للمشاريع المحددة")}];p.kpiGrid.innerHTML=l.map(({icon:i,label:u,value:c,meta:m})=>`
  ...
  `).join(""),Kn(e)}function Kn(e){try{const t=Gn(e),a="projects-revenue-breakdown";let s=document.getElementById(a);const r=[{label:n("reservations.reports.kpi.revenue.details.gross","الإيراد الكلي","Gross revenue"),value:ae(t.grossRevenue)},{label:n("reservations.reports.kpi.revenue.details.share","نسبة الشركة","Company share"),value:ae(t.companyShareTotal)},{label:n("reservations.reports.kpi.revenue.details.tax","الضريبة","Tax"),value:ae(t.taxTotal)},{label:n("reservations.reports.kpi.revenue.details.crewGross","إجمالي الطاقم","Crew total"),value:ae(t.crewTotal)},{label:n("reservations.reports.kpi.revenue.details.crew","تكلفة الطاقم","Crew cost"),value:ae(t.crewCostTotal)},{label:n("reservations.reports.kpi.revenue.details.equipment","إجمالي المعدات","Equipment total"),value:ae(t.equipmentTotalCombined)},{label:n("projects.reports.kpi.revenue.details.projectExpenses","تكلفة الخدمات الإنتاجية","Project expenses"),value:`−${ae(t.projectExpensesTotal)}`},{label:n("reservations.reports.kpi.revenue.details.net","صافي الربح","Net profit"),value:ae(t.netProfit)}],l=`
    ...
    `;s?s.outerHTML=l:p.kpiGrid.insertAdjacentHTML("afterend",l)}catch(t){console.warn("[projectsReports] Failed to render revenue breakdown",t)}}function Gn(e){const t=new Set(e.map(D=>String(D.id))),a=S.reservations.filter(D=>D.projectId!=null&&t.has(String(D.projectId)));let s=0,r=0,l=0,i=0,u=0,c=0,m=0;a.forEach(D=>{const N=Ya(D);s+=N.finalTotal||0,r+=N.equipmentTotal||0,l+=N.crewTotal||0,i+=N.crewCostTotal||0,u+=N.companyShareAmount||0,c+=N.taxAmount||0,m+=N.netProfit||0});const d=e.reduce((D,N)=>D+(Number(N.expensesTotal)||0),0),x=e.reduce((D,N)=>D+(Number(N.raw?.equipmentEstimate)||0),0),P=e.reduce((D,N)=>{const z=N.applyTax===!0,oe=(Number(N.raw?.equipmentEstimate)||0)+(Number(N.expensesTotal)||0),Y=z?oe*dt:0;return D+Y},0),k=s+x+P,_=r+x,E=c+P,ne=m-d;return{grossRevenue:k,companyShareTotal:u,taxTotal:E,crewTotal:l,crewCostTotal:i,equipmentTotalCombined:_,projectExpensesTotal:d,netProfit:ne}}function oa(){if(!p.statusChips)return;const e=ea.map(t=>{const a=n(`projects.status.${t}`,t);return`<button type="button" class="btn btn-outline-primary reports-status-chip" data-status="${t}">${W(a)}</button>`}).join("");p.statusChips.innerHTML=e,p.statusChips.dataset.listenerAttached||(p.statusChips.addEventListener("click",Jn),p.statusChips.dataset.listenerAttached="true"),wt()}function Jn(e){const t=e.target.closest("[data-status]");if(!t)return;const a=t.dataset.status;if(!a)return;const s=new Set(S.filters.statuses);s.has(a)?s.delete(a):s.add(a),s.size===0&&ea.forEach(r=>s.add(r)),S.filters.statuses=Array.from(s),wt(),re()}function wt(){if(!p.statusChips)return;const e=new Set(S.filters.statuses);p.statusChips.querySelectorAll("[data-status]").forEach(t=>{t.classList.toggle("is-active",e.has(t.dataset.status))})}function Yn(e){if(!Q)return;const t=document.getElementById("reports-status-chart");if(!t)return;const a=["upcoming","ongoing","completed"],s=a.map(c=>e.filter(m=>m.status===c).length),r=a.map(c=>n(`projects.status.${c}`,c)),i=s.reduce((c,m)=>c+m,0)>0?s:[],u={chart:{type:"donut",height:320,toolbar:{show:!1}},labels:r,series:i,colors:["#3b82f6","#fbbf24","#22c55e"],dataLabels:{formatter:c=>Number.isFinite(c)?`${Math.round(c)}%`:"0%"},legend:{position:"bottom",fontSize:"13px"},stroke:{width:0},tooltip:{y:{formatter:c=>ye(c)}},noData:{text:n("projects.reports.noData","لا توجد بيانات متاحة")},responsive:[{breakpoint:1024,options:{chart:{height:280}}}]};We("status",t,u)}function Xn(e){if(!Q)return;const t=document.getElementById("reports-timeline-chart");if(!t)return;const a=new Map,s=new Intl.DateTimeFormat(as(),{month:"short",year:"numeric"});e.forEach(d=>{if(!d.start||Number.isNaN(d.start.getTime()))return;const x=`${d.start.getFullYear()}-${d.start.getMonth()+1}`,P=a.get(x)||{total:0,label:s.format(d.start)};P.total+=d.overallTotal,a.set(x,P)});const l=Array.from(a.keys()).sort((d,x)=>{const[P,k]=d.split("-").map(Number),[_,E]=x.split("-").map(Number);return P===_?k-E:P-_}).slice(-12),i=l.map(d=>a.get(d)?.label||d),u=l.map(d=>Math.round(a.get(d)?.total||0)),c=u.length?[{name:n("projects.reports.datasets.value","Total value"),data:u}]:[],m={chart:{type:"area",height:320,toolbar:{show:!1}},series:c,xaxis:{categories:i,labels:{rotate:-35}},yaxis:{labels:{formatter:d=>ye(d)}},dataLabels:{enabled:!1},stroke:{curve:"smooth",width:3},fill:{type:"gradient",gradient:{shadeIntensity:.35,opacityFrom:.5,opacityTo:.05}},markers:{size:4},colors:["#4c6ef5"],tooltip:{y:{formatter:d=>ye(d)}},noData:{text:n("projects.reports.noData","لا توجد بيانات متاحة")}};We("timeline",t,m)}function Qn(e){if(!Q)return;const t=document.getElementById("reports-expense-chart");if(!t)return;const a=[...e].sort((m,d)=>d.overallTotal-m.overallTotal).slice(0,6),s=a.map(m=>m.title||m.projectCode),r=a.map(m=>Math.round(m.overallTotal)),l=a.map(m=>Math.round(m.expensesTotal)),i=s.length?[{name:n("projects.reports.datasets.value","Total value"),data:r},{name:n("projects.reports.datasets.expenses","تكلفة الخدمات الإنتاجية"),data:l}]:[],c={chart:{type:"bar",height:Math.max(320,s.length*60||0),toolbar:{show:!1}},series:i,plotOptions:{bar:{horizontal:!0,barHeight:"55%",borderRadius:8}},xaxis:{categories:s,labels:{formatter:m=>ye(m)}},dataLabels:{enabled:!1},legend:{position:"bottom",fontSize:"13px"},colors:["#4c6ef5","#f472b6"],tooltip:{y:{formatter:m=>ye(m)}},noData:{text:n("projects.reports.noData","لا توجد بيانات متاحة")}};We("expenses",t,c)}function Zn(e){if(!Q)return;const t=document.getElementById("reports-clients-chart");if(!t)return;const a=new Map;e.forEach(c=>{const m=c.clientName||c.clientCompany||n("projects.fallback.unknownClient","Unknown client"),d=a.get(m)||0;a.set(m,d+c.overallTotal)});const s=Array.from(a.entries()).sort((c,m)=>m[1]-c[1]).slice(0,6),r=s.map(([c])=>c),l=s.map(([,c])=>Math.round(c)),i=l.length?[{name:n("projects.reports.datasets.value","Total value"),data:l}]:[],u={chart:{type:"bar",height:320,toolbar:{show:!1}},series:i,plotOptions:{bar:{borderRadius:6,columnWidth:"60%"}},xaxis:{categories:r,labels:{rotate:-35}},yaxis:{labels:{formatter:c=>ye(c)}},dataLabels:{enabled:!1},colors:["#3b82f6"],tooltip:{y:{formatter:c=>ye(c)}},legend:{show:!1},noData:{text:n("projects.reports.noData","لا توجد بيانات متاحة")}};We("clients",t,u)}function We(e,t,a={}){if(!Q||!t)return;if(_e[e]){try{_e[e].destroy()}catch(r){console.warn(`⚠️ [projectsReports] Failed to destroy ${e} chart`,r)}delete _e[e]}t.innerHTML="";const s={...a};Array.isArray(s.series)||(s.series=[]);try{const r=new Q(t,s);_e[e]=r,r.render().catch(l=>{console.error(`❌ [projectsReports] Failed to render ${e} chart`,l)})}catch(r){console.error(`❌ [projectsReports] Failed to render ${e} chart`,r)}}function es(e){if(!p.table||!p.tableBody||!p.tableEmpty)return;if(!e.length){p.table.style.display="none",p.tableEmpty.classList.add("active"),p.tableMeta&&(p.tableMeta.textContent="");return}p.table.style.display="",p.tableEmpty.classList.remove("active");const t=e.map(a=>{const s=ts(a.start,a.end),r=n(`projects.status.${a.status}`,a.status),l=n(`projects.paymentStatus.${a.paymentStatus}`,a.paymentStatus),i=a.clientCompany?`${W(a.clientName)} <small class="text-muted">${W(a.clientCompany)}</small>`:W(a.clientName||n("projects.fallback.unknownClient","Unknown client"));return`
      <tr>
        <td>
        ...
        <td>${W(r)}</td>
        <td>${W(s)}</td>
        <td>${W(ae(a.overallTotal))}</td>
        <td>${W(l)}</td>
      </tr>
    `}).join("");if(p.tableBody.innerHTML=t,p.tableMeta){const a=n("projects.reports.table.meta","Showing {count} of {total} projects");p.tableMeta.textContent=a.replace("{count}",pt(e.length)).replace("{total}",pt(S.totalProjects))}}function ts(e,t){if(!e&&!t)return"—";const a=e?At(e.toISOString()):"—",s=t?At(t.toISOString()):"—";return t?`${a} → ${s}`:a}function ae(e){const t=Number(e)||0,s=Oe()==="ar"?"ar-SA-u-ca-gregory-nu-latn":"en-US",r=new Intl.NumberFormat(s,{minimumFractionDigits:0,maximumFractionDigits:0}).format(Math.round(t));return`${g(r)} SR`}function pt(e){const a=Oe()==="ar"?"ar-SA-u-ca-gregory-nu-latn":"en-US";return g(new Intl.NumberFormat(a).format(e))}function ye(e){const a=Oe()==="ar"?"ar-SA-u-ca-gregory-nu-latn":"en-US";return g(new Intl.NumberFormat(a,{notation:"compact",compactDisplay:"short"}).format(e))}function as(){return Oe()==="ar"?"ar-SA-u-ca-gregory-nu-latn":"en-US"}function W(e=""){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}
