import{s as da,f as ua,e as _t,u as ft,j as M,t as n,d as Bt,n as j,q as pa,a as ma,m as fa,c as ha,i as ba,v as At,p as Oe}from"./auth.BFR8Y3ym.js";import{i as ya}from"./dashboardShell.BAk5SsJR.js";import{d as b,r as we,a as De,u as Fe,s as $,b as va,f as ht,h as ga,i as ja,j as o,k as P,l as xa,m as bt,n as Sa,o as $t,e as rt,p as Nt,q as wa,t as Ta,v as Pa,w as Aa,g as $a,c as Na,x as Ea,y as Ht,z as Ca,A as ka,B as La,C as Da,D as Fa,E as Ia,F as Ma,G as Ra,H as _a,I as Ba,J as Ha,K as Ue,L as qa,M as qt,N as Va,O as Oa}from"./form.D9tQ5toC.js";import"./customers.Shj-Fh8v.js";import"./state.uepyuVVl.js";import{e as Ua,r as za}from"./controller.IS28vYjb.js";import{e as Vt}from"./reservationsActions.lKCqMmGa.js";import{updateProjectApi as Ot,getProjectsState as yt,isApiError as ze,buildProjectPayload as Wa,refreshProjectsFromApi as Ut,ensureProjectsLoaded as Ka}from"./projectsService.Cwss6WRR.js";import{P as vt,a as gt,b as Et,c as He,s as Ga,d as ot,e as it}from"./constants.ahksS1fi.js";import{g as jt,f as Ja,c as qe,d as ct,e as zt,D as lt,r as Ya}from"./reservationsService.CQfVwYeY.js";import{g as Xa,w as Qa}from"./uiBridge.Dv6JMAlF.js";import{c as Za}from"./calculations.DEalIgcD.js";import"./details.D8A8CH_k.js";import"./equipment.Dy1tRg0o.js";import"./quotePdf.C2lQPEPC.js";import"./canvasColorUtils.CviLtv6S.js";let Ct=null;function en(e){e&&Wt()!==e&&ft({[vt]:e}).catch(t=>{console.warn("⚠️ [projects] Failed to persist projects main tab preference",t)})}function Wt(){return _t()?.[vt]||""}function Kt(e){e&&dt()!==e&&ft({[gt]:e}).catch(t=>{console.warn("⚠️ [projects] Failed to persist projects sub-tab preference",t)})}function dt(){return _t()?.[gt]||""}function tn(e){if(!e)return"";const t=e.trim();return t?Object.values(Et).includes(t)?t:Et[t]||"":""}function an(){if(typeof window>"u")return"";try{const t=new URLSearchParams(window.location.search||"").get("subTab");if(t){const a=tn(t);if(a)return a}}catch{}return""}function Gt(e,t){!e||!b.tabPanes||!b.tabButtons||(b.tabButtons.forEach(a=>{const s=a===t;a.classList.toggle("active",s),a.classList.contains("tab-button")&&a.classList.toggle("tab-active",s)}),b.tabPanes.forEach(a=>{a.dataset.tabPane===e?a.classList.remove("d-none"):a.classList.add("d-none")}),t&&en(e))}function nn(){if(!b.tabButtons||!b.tabButtons.length)return;b.tabButtons.forEach(a=>{a.dataset.tabListenerAttached!=="true"&&(a.addEventListener("click",s=>{s.preventDefault();const r=a.dataset.tabTarget;r&&(Gt(r,a),r==="projects-section"&&($.filters.search="",b.search&&(b.search.value=""),we(),De(),Fe()))}),a.dataset.tabListenerAttached="true")});const e=Wt(),t=e&&b.tabButtons.find(a=>a.dataset.tabTarget===e);t&&t.click()}function xt(e,t){!e||!b.projectSubTabButtons||!b.projectSubTabPanes||(b.projectSubTabButtons.forEach(a=>{const s=a===t;a.classList.toggle("active",s),a.classList.contains("tab")&&a.classList.toggle("tab-active",s)}),b.projectSubTabPanes.forEach(a=>{a.dataset.projectSubtab===e?a.classList.remove("d-none"):a.classList.add("d-none")}))}function sn(){!b.projectSubTabButtons||!b.projectSubTabButtons.length||(b.projectSubTabButtons.forEach(e=>{e.dataset.tabListenerAttached!=="true"&&(e.addEventListener("click",t=>{t.preventDefault();const a=e.dataset.projectSubtabTarget;a&&(xt(a,e),Kt(a))}),e.dataset.tabListenerAttached="true")}),rn())}function rn(){const t=an()||dt();if(!t)return;const a=b.projectSubTabButtons?.[0],s=b.projectSubTabButtons?.find(l=>l.dataset.projectSubtabTarget===t)||a,r=s?.dataset.projectSubtabTarget;r&&(t!==dt()&&Kt(r),xt(r,s))}function on(){return b.tabButtons?b.tabButtons.find(t=>t.classList.contains("active"))?.dataset.tabTarget==="projects-section":!1}function kt(e={}){if(e){if(b.tabButtons&&b.tabButtons.length){const a=b.tabButtons.find(r=>r.classList.contains("active"))?.dataset.tabTarget||"",s=e[vt];if(s&&s!==a){const r=b.tabButtons.find(l=>l.dataset.tabTarget===s);r&&Gt(s,r)}}if(b.projectSubTabButtons&&b.projectSubTabButtons.length&&on()){const a=b.projectSubTabButtons.find(r=>r.classList.contains("active"))?.dataset.projectSubtabTarget||"",s=e[gt];if(s&&s!==a){const r=b.projectSubTabButtons.find(l=>l.dataset.projectSubtabTarget===s);r&&xt(s,r)}}}}function cn(){Ct||(Ct=da(e=>{kt(e)})),ua().then(e=>{kt(e)}).catch(e=>{console.warn("⚠️ [projects] Failed to synchronise project preferences",e)})}function ge(e){const t=$.projects.find(w=>String(w.id)===String(e));if(!t||!b.detailsBody)return;b.detailsBody.dataset.mode="view",b.detailsBody.dataset.projectId=String(t.id);const s=($.customers.length?$.customers:Bt().customers||[]).find(w=>String(w.id)===String(t.clientId)),r=Qt(t.type),i=t.description?.trim()||n("projects.fallback.noDescription","لا يوجد وصف"),u=s?.customerName||n("projects.fallback.unknownClient","عميل غير معروف"),c=s?.phone??s?.customerPhone??t.clientPhone??t.customerPhone??"",f=c?j(String(c).trim()):n("projects.details.client.noPhone","لا يوجد رقم متاح"),d=s?.email??t.clientEmail??t.customerEmail??"",y=d?String(d).trim():n("projects.details.client.noEmail","لا يوجد بريد متاح"),x=(t.clientCompany||s?.companyName||"").trim(),z=t.projectCode||`PRJ-${j(String(t.id))}`,N=j(z),R=ht(t.id),_=R.reduce((w,D)=>w+Zt(D),0),B=Number(_.toFixed(2)),k=R.length,{subtotal:oe,applyTax:J,expensesTotal:ie}=ga(t),te=Number(t?.servicesClientPrice??t?.services_client_price??0),Te=oe,Ke=J?Number(((Te+B)*He).toFixed(2)):0,Ge=Number((Te+B+Ke).toFixed(2)),Pe=ja(t),ye=t?.cancelled===!0||t?.status==="cancelled"||t?.status==="canceled"?"cancelled":Pe,me=n(`projects.status.${ye}`,Ga[ye]||ye),Ae=(()=>{try{const w=t.start?new Date(t.start):null,D=t.end?new Date(t.end):w?new Date(w.getTime()+3600*1e3):null;return!w||!D||Number.isNaN(w.getTime())||Number.isNaN(D.getTime())?!1:$.projects.some(F=>{if(!F||String(F.id)===String(t.id))return!1;const H=F.start?new Date(F.start):null,I=F.end?new Date(F.end):H?new Date(H.getTime()+3600*1e3):null;if(!H||!I||Number.isNaN(H.getTime())||Number.isNaN(I.getTime()))return!1;const U=Math.max(w.getTime(),H.getTime()),de=Math.min(D.getTime(),I.getTime());return U<de})}catch{return!1}})()&&(ye==="upcoming"||ye==="ongoing")?"conflict":ye,Je={upcoming:"قادم",ongoing:"قيد التنفيذ",completed:"مكتمل",conflict:"تعارض"}[Ae]||me,ae={upcoming:"timeline-status-badge timeline-status-badge--upcoming",ongoing:"timeline-status-badge timeline-status-badge--ongoing",completed:"timeline-status-badge timeline-status-badge--completed",conflict:"timeline-status-badge timeline-status-badge--conflict",cancelled:"timeline-status-badge timeline-status-badge--cancelled"}[Ae]||"timeline-status-badge timeline-status-badge--upcoming",Se=typeof t.paymentStatus=="string"?t.paymentStatus.toLowerCase():"",fe=gn(t),Me=fe.length>0,$e=Me?0:Number(t.paidAmount)||0,Ne=Me?0:Number(t.paidPercent)||0;let m=Ge,h,v,g,S,T,E,L,V,Q,G;const Z=yn(fe),Ye=n("projects.focus.confirmed","✅ مشروع مؤكد"),Ee=t.confirmed===!0||t.confirmed==="true"?`<span class="reservation-chip status-confirmed">${o(Ye)}</span>`:"";let C=[];if(k>0){const w=R.reduce((he,se)=>{const ia=Array.isArray(se.items)?se.items:[],Pt=Array.isArray(se.crewAssignments)?se.crewAssignments:[],be=Pt.length?Pt:Array.isArray(se.technicians)?se.technicians:[],ca=Array.isArray(be)&&be.length&&typeof be[0]=="object",la=Array.isArray(be)&&be.length&&typeof be[0]!="object",st=Ja({items:ia,technicianIds:la?be:[],crewAssignments:ca?be:[],discount:se.discount??0,discountType:se.discountType||"percent",applyTax:!1,start:se.start,end:se.end,companySharePercent:null,groupingSource:se});return he.equipment+=Number(st.equipmentTotal||0),he.crew+=Number(st.crewTotal||0),he.crewCost+=Number(st.crewCostTotal||0),he},{equipment:0,crew:0,crewCost:0}),D=Number(ie||0),F=Number((w.equipment+w.crew+te).toFixed(2)),H=Number.parseFloat(t?.discount??t?.discountValue??0)||0;let U=(t?.discountType==="amount"?"amount":"percent")==="amount"?H:F*(H/100);(!Number.isFinite(U)||U<0)&&(U=0),U>F&&(U=F);const de=J===!0,le=t?.companyShareEnabled===!0||t?.companyShareEnabled==="true"||t?.company_share_enabled===!0||t?.company_share_enabled==="true",ne=Number.parseFloat(t?.companySharePercent??t?.company_share_percent??t?.companyShare??t?.company_share??0)||0,ve=le&&ne>0?ne:0,q=Math.max(0,F-U),K=Number((q*(ve/100)).toFixed(2)),O=de?Number(((q+K)*He).toFixed(2)):0,ue=Number((q+K+O).toFixed(2)),pe=Number((ue-K-O-D-w.crewCost).toFixed(2));w.equipment>0&&C.push({icon:"🎛️",label:n("projects.details.summary.equipmentTotal","إجمالي المعدات"),value:P(w.equipment)}),w.crew>0&&C.push({icon:"😎",label:n("projects.details.summary.crewTotal","إجمالي الفريق"),value:P(w.crew)}),w.crewCost>0&&C.push({icon:"🧾",label:n("projects.details.summary.crewCostTotal","تكلفة الفريق"),value:P(w.crewCost)}),te>0&&C.push({icon:"💼",label:n("projects.details.summary.servicesClientPrice","الخدمات الإنتاجية"),value:P(te)}),D>0&&C.push({icon:"🧾",label:n("projects.details.summary.expensesTotal","تكلفة الخدمات الإنتاجية"),value:P(D)}),U>0&&C.push({icon:"🏷️",label:n("projects.details.summary.discount","الخصم"),value:`−${P(U)}`}),C.push({icon:"🧮",label:n("projects.details.summary.grossAfterDiscount","الإجمالي بعد الخصم"),value:P(q)}),K>0&&C.push({icon:"🏦",label:n("projects.details.summary.companyShare","نسبة الشركة"),value:`−${P(K)}`}),O>0&&C.push({icon:"💸",label:n("projects.details.summary.tax","الضريبة (15٪)"),value:`−${P(O)}`}),C.push({icon:"💵",label:n("projects.details.summary.netProfit","صافي الربح"),value:P(pe)}),C.push({icon:"💰",label:n("projects.details.summary.finalTotal","المجموع النهائي"),value:P(ue)}),m=ue}else{const w=Number(ie||0),D=Math.max(0,Number(te)||0),F=Number.parseFloat(t?.discount??t?.discountValue??0)||0;let I=(t?.discountType==="amount"?"amount":"percent")==="amount"?F:D*(F/100);(!Number.isFinite(I)||I<0)&&(I=0),I>D&&(I=D);const U=Math.max(0,D-I),de=J===!0,le=t?.companyShareEnabled===!0||t?.companyShareEnabled==="true"||t?.company_share_enabled===!0||t?.company_share_enabled==="true",ne=Number.parseFloat(t?.companySharePercent??t?.company_share_percent??t?.companyShare??t?.company_share??0)||0,ve=le&&ne>0?ne:0,q=Number((U*(ve/100)).toFixed(2)),K=de?Number(((U+q)*He).toFixed(2)):0,O=Number((U+q+K).toFixed(2)),ue=Number((O-q-K-w).toFixed(2));C=[],C.push({icon:"💼",label:n("projects.details.summary.servicesClientPrice","الخدمات الإنتاجية"),value:P(D)}),I>0&&C.push({icon:"🏷️",label:n("projects.details.summary.discount","الخصم"),value:`−${P(I)}`}),C.push({icon:"🧮",label:n("projects.details.summary.grossAfterDiscount","الإجمالي بعد الخصم"),value:P(U)}),q>0&&C.push({icon:"🏦",label:n("projects.details.summary.companyShare","نسبة الشركة"),value:`−${P(q)}`}),K>0&&C.push({icon:"💸",label:n("projects.details.summary.tax","الضريبة (15٪)"),value:`−${P(K)}`}),C.push({icon:"💵",label:n("projects.details.summary.netProfit","صافي الربح"),value:P(ue)}),C.push({icon:"💰",label:n("projects.details.summary.finalTotal","المجموع النهائي"),value:P(O)}),m=O}h=qe({totalAmount:m,paidAmount:$e,paidPercent:Ne,history:fe}),v=ct({manualStatus:Se||"unpaid",paidAmount:h.paidAmount,paidPercent:h.paidPercent,totalAmount:m}),g=n(`projects.paymentStatus.${v}`,v==="paid"?"Paid":v==="partial"?"Partial":"Unpaid"),S=v==="paid"?"status-paid":v==="partial"?"status-partial":"status-unpaid",T=Number.isFinite(Number(h.paidAmount))?Number(h.paidAmount):0,E=Number.isFinite(Number(h.paidPercent))?Number(h.paidPercent):0,L=Math.max(0,Number((m-T).toFixed(2))),V=P(T),Q=`${j(E.toFixed(2))}%`,G=P(L);const Xe=C.map(({icon:w,label:D,value:F})=>`
  ...
  `,Qe=[{icon:"👤",label:n("projects.details.client","العميل"),value:u},{icon:"📞",label:n("projects.details.labels.clientPhone","رقم العميل"),value:f},{icon:"✉️",label:n("projects.details.labels.clientEmail","البريد الإلكتروني"),value:y},x?{icon:"🏢",label:n("projects.details.company","شركة العميل"),value:x}:null,{icon:"🏷️",label:n("projects.details.type","نوع المشروع"),value:`<span class="project-type-chip project-type-chip--${t.type||"default"}">${o(r)}</span>`},Dt("start",t.start),Dt("end",t.end)].filter(Boolean),Ze=n("projects.details.overview.heading","معلومات المشروع"),et=`
    <div class="project-details-outline">
      ...
      <ul class="project-details-outline__list">
        ${Qe.map(({icon:w,label:D,value:F,meta:H})=>{const I=String(F??""),de=I.trim().startsWith("<")?I:o(I),le=String(H??""),ne=le?o(le):"";return`
          <li>
  ...
  `,tt=k>0?n("projects.details.chips.linkedReservation","مربوط بحجز"):n("projects.details.chips.notLinkedReservation","غير مربوط بحجز"),at=k>0?"reservation-chip status-confirmed":"reservation-chip status-info",ke=[`<span class="${ae}">${o(Je)}</span>`,`<span class="${at}">${o(tt)}</span>`,`<span class="reservation-chip ${S}">${o(g)}</span>`,Ee].filter(Boolean).join("");n("projects.details.expensesTotal","تكلفة الخدمات الإنتاجية"),n("projects.details.reservationsTotal","إجمالي الحجوزات");const Re=n("projects.details.expenses","خدمات إنتاجية ({amount})").replace("{amount}",P(ie)),nt=ln(Array.isArray(t.expenses)?t.expenses:[]);b.detailsBody.innerHTML=`
  ...
  `,pn(t);const W=b.detailsBody.querySelector("#project-details-export-btn");W&&W.addEventListener("click",async w=>{if(w.preventDefault(),W.blur(),!W.disabled){W.disabled=!0;try{await Ua({project:t})}catch(D){console.error("❌ [projects/details] export project PDF failed",D),M(n("projects.details.exportFailed","⚠️ تعذر تصدير المشروع إلى PDF"),"error")}finally{W.disabled=!1}}}),b.detailsModalEl&&window.bootstrap?.Modal&&window.bootstrap.Modal.getOrCreateInstance(b.detailsModalEl).show()}function ln(e=[]){if(!(Array.isArray(e)&&e.length>0)){const s=o(n("projects.expenses.table.empty","ستظهر المصاريف المسجلة هنا فور إضافتها."));return`
  ...
  `}function yn(e=[]){return!Array.isArray(e)||e.length===0?`<div class="reservation-payment-history-empty">${o(n("reservations.paymentHistory.empty","لا توجد دفعات مسجلة"))}</div>`:`<ul class="reservation-payment-history-list">${e.map(t=>{const a=t?.type==="percent"?n("reservations.paymentHistory.type.percent","دفعة نسبة"):t?.type==="amount"?n("reservations.paymentHistory.type.amount","دفعة مالية"):n("reservations.paymentHistory.type.unknown","دفعة"),s=Number.isFinite(Number(t?.amount))&&Number(t.amount)>0?o(P(Number(t.amount))):"—",r=Number.isFinite(Number(t?.percentage))&&Number(t.percentage)>0?`${j(Number(t.percentage).toFixed(2))}%`:"—",l=t?.recordedAt?j(bt(t.recordedAt)):"—",i=t?.note?`<div class="payment-history-note">${o(j(t.note))}</div>`:"";return`
      <li>
    ...
    `}).join("")}</ul>`}function vn(e=[]){if(!Array.isArray(e)||e.length===0)return`<div class="reservation-payment-history__empty">${o(n("reservations.paymentHistory.empty","لا توجد دفعات مسجلة"))}</div>`;const t=e.map((a,s)=>{const r=a?.type==="percent"?n("reservations.paymentHistory.type.percent","دفعة نسبة"):n("reservations.paymentHistory.type.amount","دفعة مالية"),l=Number.isFinite(Number(a?.amount))&&Number(a.amount)>0?o(P(Number(a.amount))):"—",i=Number.isFinite(Number(a?.percentage))&&Number(a.percentage)>0?`${j(Number(a.percentage).toFixed(2))}%`:"—",u=a?.recordedAt?j(bt(a.recordedAt)):"—",c=a?.note?o(j(a.note)):"",f=o(n("reservations.paymentHistory.actions.delete","حذف الدفعة"));return`
      <tr>
        <td>${o(r)}</td>
        <td>${l}</td>
        <td>${i}</td>
  ...
  `}function gn(e={}){const a=(Array.isArray(e.paymentHistory)?e.paymentHistory:Array.isArray(e.payment_history)?e.payment_history:[]).map(jn).filter(Boolean);if(a.length>0)return a;const s=Ve(e.paidPercent??e.paid_percent),r=Ve(e.paidAmount??e.paid_amount),l=e.updatedAt??e.updated_at??e.createdAt??e.created_at??null,i=Xt(l);return s!=null&&s>0?[{type:"percent",amount:r!=null&&r>0?r:null,percentage:s,value:s,note:null,recordedAt:i}]:r!=null&&r>0?[{type:"amount",amount:r,percentage:null,value:r,note:null,recordedAt:i}]:[]}function jn(e){if(!e||typeof e!="object")return null;const t=e.type??e.payment_type??e.paymentType??null;let a=typeof t=="string"?t.toLowerCase().trim():null;a!=="percent"&&(a="amount");const s=Ve(e.amount??(a==="amount"?e.value:null)),r=Ve(e.percentage??(a==="percent"?e.value:null)),l=a==="percent"?r??null:s??null,i=e.note??e.memo??null,u=Xt(e.recordedAt??e.recorded_at??e.date??e.created_at??null);return a==="amount"&&s==null||a==="percent"&&r==null?null:{type:a,amount:s??null,percentage:r??null,value:l,note:i&&String(i).trim().length?String(i).trim():null,recordedAt:u}}function Ve(e){if(e==null||e==="")return null;const t=j(String(e)).replace(/%/g,"").trim();if(!t)return null;const a=Number.parseFloat(t);return Number.isFinite(a)?a:null}function Xt(e){if(!e)return new Date().toISOString();const t=new Date(e);return Number.isNaN(t.getTime())?new Date().toISOString():t.toISOString()}function Dt(e,t){if(!t)return null;const{date:a,time:s}=xn(bt(t)),r=e==="start",l=r?"⏱️":"⌛",i=r?n("projects.details.labels.start","بداية المشروع"):n("projects.details.labels.end","نهاية المشروع");return{icon:l,label:i,value:a,meta:s}}function xn(e){if(!e||e==="—")return{date:"—",time:""};const t=e.split(" ").filter(Boolean),a=t.shift()||"—",s=t.join(" ");return{date:a,time:s}}function Qt(e){if(!e)return n("projects.form.types.unknown","نوع غير محدد");const t={commercial:"projects.form.types.commercial",coverage:"projects.form.types.coverage",photography:"projects.form.types.photography",social:"projects.form.types.social"}[e]||"projects.form.types.unknown";return n(t,e)}function Zt(e){if(!e)return 0;const t=Array.isArray(e.items)?e.items:[],a=e.discount??0,s=Number(j(String(a)))||0,r=e.discountType||"percent",l=Array.isArray(e.crewAssignments)?e.crewAssignments:[],i=l.length?l:Array.isArray(e.technicians)?e.technicians:[],u=zt(t,s,r,!1,i,{start:e.start,end:e.end});if(Number.isFinite(u))return u;const c=Number(j(String(e.cost??0)));return Number.isFinite(c)?Math.round(c):0}function St(e){if(typeof window>"u")return null;try{const s=new URLSearchParams(window.location.search||"").get(e);if(s)return s}catch{}const t=window.location.hash?window.location.hash.replace(/^#/,""):"";if(t&&t.includes(`${e}=`))try{const s=new URLSearchParams(t).get(e);if(s)return s}catch{}return null}function Sn(){return St(ot)}function wn(){return St(it)}function Tn(){if(!(typeof window>"u"||typeof window.history?.replaceState!="function"))try{const e=new URLSearchParams(window.location.search||""),t=window.location.hash?window.location.hash.replace(/^#/,""):"";let a=!1;[ot,it,"linked"].forEach(c=>{e.has(c)&&(e.delete(c),a=!0)});let s=t,r=!1;if(t)try{const c=new URLSearchParams(t);let f=!1;[ot,it,"linked"].forEach(d=>{c.has(d)&&(c.delete(d),f=!0)}),f&&(s=c.toString(),r=!0)}catch{}if(!a&&!r)return;const l=window.location.pathname,i=e.toString(),u=`${l}${i?`?${i}`:""}${s?`#${s}`:""}`;window.history.replaceState({},"",u)}catch{}}function Pn(){const e=Sn(),t=wn(),a=St("linked");e&&($.pendingProjectDetailId=e),t&&($.pendingProjectEditId=t,$.pendingProjectDetailId||($.pendingProjectDetailId=t)),a!=null&&String(a)!==""&&String(a)!=="0"&&String(a).toLowerCase()!=="false"&&($.pendingLinkedToast=!0),(e||t)&&Tn()}function An(){if(!$.pendingProjectDetailId)return;const e=$.pendingProjectDetailId,t=String(e),a=$.projects.find(r=>[r?.id,r?.projectId,r?.project_id].some(i=>i!=null&&String(i)===t));if(!a)return;$.pendingProjectDetailId=null;const s=a?.id??a?.projectId??a?.project_id??t;if(ge(s),$.pendingLinkedToast){$.pendingLinkedToast=!1;try{M(n("projects.toast.linkedReservationCreated","✅ تم ربط الحجز بالمشروع"))}catch{}}if($.pendingProjectEditId!=null){const r=String($.pendingProjectEditId);[a.id,a.projectId,a.project_id].some(i=>i!=null&&String(i)===r)&&($.pendingProjectEditId=null,setTimeout(()=>Jt(a),0))}}function $n(){document.addEventListener("DOMContentLoaded",()=>{cn(),Pn(),Ea(),Ht(),Ca(),nn(),sn(),ka(),La(),Da(),Fa(),Ia(),Ma(),Ra({onViewDetails:ge}),dn({onOpenProject:ge}),_a(),Nn()}),document.addEventListener("language:changed",Ft),document.addEventListener("language:translationsReady",Ft),document.addEventListener("customers:changed",En),document.addEventListener("technicians:updated",Cn),document.addEventListener("reservations:changed",()=>Ba(ge)),document.addEventListener(pa.USER_UPDATED,()=>{we()})}async function Nn(){try{await Vt({suppressError:!0}),await Ut()}catch(e){console.error("❌ [projects] Failed to initialise projects data",e);const t=e?.message||n("projects.toast.fetchFailed","تعذر تحميل بيانات المشاريع، حاول لاحقًا");M(t,"error")}finally{Ha(),Ue(),qa(),qt(),we(),Fe(),De(),An()}}function Ft(){Ue(),qt(),we(),Fe(),De(),Ht()}function En(){Va(),Ue()}function Cn(){Oa(),Ue()}ma();fa();ha();za();$n();document.addEventListener("DOMContentLoaded",()=>{ya(),ba()});const ut=.15,_e={},kn="https://cdn.jsdelivr.net/npm/apexcharts@3.49.0/dist/apexcharts.min.js";let Le=0;const A={projects:[],customers:[],reservations:[],totalProjects:0,filters:{search:"",statuses:["upcoming","ongoing","completed"],payment:"all",range:"all",startDate:"",endDate:""}},p={search:null,payment:null,dateRange:null,customRangeWrapper:null,startDate:null,endDate:null,refreshBtn:null,kpiGrid:null,statusChips:null,table:null,tableBody:null,tableMeta:null,tableEmpty:null,chartCards:{},chartLoaders:{}},Be=Object.freeze({projects:`
  ...
  `});let X=null;const ea=["upcoming","ongoing","completed"];async function Ln({forceProjects:e=!1}={}){try{await Vt({suppressError:!0}),await Ka({force:e})}catch(t){console.error("❌ [projectsReports] Failed to load initial data",t),ze(t)&&console.warn("Projects API error:",t.message)}sa()}async function Dn(){Mn(),aa(),await Fn();try{await Ln({forceProjects:!0}),oa(),Vn(),re()}finally{na()}document.addEventListener("language:changed",Un),document.addEventListener("projects:changed",()=>{pt().catch(e=>{console.error("❌ [projectsReports] Failed to refresh after projects change",e)})}),document.addEventListener("reservations:changed",()=>{pt().catch(e=>{console.error("❌ [projectsReports] Failed to refresh after reservations change",e)})}),window.addEventListener("storage",zn)}document.addEventListener("DOMContentLoaded",Dn);async function Fn(){if(X)return X;if(typeof window>"u")return null;if(window.ApexCharts)return X=window.ApexCharts,X;try{await In(kn),X=window.ApexCharts||null}catch(e){console.warn("ApexCharts failed to load",e),X=null}return X}function In(e){return new Promise((t,a)=>{if(typeof document>"u"){a(new Error("Document is not available to load scripts."));return}const s=document.querySelector(`script[src="${e}"]`);if(s){if(s.dataset.loaded==="true"){t();return}s.addEventListener("load",t,{once:!0}),s.addEventListener("error",()=>a(new Error(`Failed to load script ${e}`)),{once:!0});return}const r=document.createElement("script");r.src=e,r.async=!0,r.dataset.loaded="false",r.onload=()=>{r.dataset.loaded="true",t()},r.onerror=()=>a(new Error(`Failed to load script ${e}`)),document.head.appendChild(r)})}function Mn(){p.search=document.getElementById("reports-search"),p.statusChips=document.getElementById("reports-status-chips"),p.payment=document.getElementById("reports-payment"),p.dateRange=document.getElementById("reports-date-range"),p.customRangeWrapper=document.getElementById("reports-custom-range"),p.startDate=document.getElementById("reports-start-date"),p.endDate=document.getElementById("reports-end-date"),p.refreshBtn=document.getElementById("reports-refresh"),p.kpiGrid=document.getElementById("reports-kpi-grid"),p.table=document.getElementById("reports-table"),p.tableBody=p.table?.querySelector("tbody"),p.tableMeta=document.getElementById("reports-table-meta"),p.tableEmpty=document.getElementById("reports-empty"),p.chartCards={},p.chartLoaders={},document.querySelectorAll("[data-chart-card]").forEach(e=>{const t=e.dataset.chartCard;if(!t)return;p.chartCards[t]=e;const a=e.querySelector("[data-chart-loading]");a&&(p.chartLoaders[t]=a)})}function ta(e){const t=!!e;Object.entries(p.chartCards||{}).forEach(([a,s])=>{if(!s)return;s.classList.toggle("is-loading",t),s.setAttribute("aria-busy",t?"true":"false");const r=p.chartLoaders?.[a];r&&(r.hidden=!t)})}function aa(){Le+=1,Le===1&&ta(!0)}function na(){Le=Math.max(0,Le-1),Le===0&&ta(!1)}function sa(){const{customers:e=[]}=Bt();A.customers=Array.isArray(e)?e:[],A.reservations=jt();const t=new Map(A.customers.map(s=>[String(s.id),s])),a=yt();A.projects=Array.isArray(a)?a.map(s=>Rn(s,t)):[],A.totalProjects=A.projects.length}function Rn(e,t){const a=e.paymentStatus==="paid"?"paid":"unpaid",s=t.get(String(e.clientId)),r=_n(e.id),l=r.reduce((_,B)=>_+Bn(B),0),i=Hn(e),u=Number(e?.equipmentEstimate)||0,c=Number((u+i).toFixed(2)),f=e?.applyTax===!0||e?.applyTax==="true",d=f?Number((c*ut).toFixed(2)):0,y=f?Number(((c+l)*ut).toFixed(2)):0,x=Number((c+l+y).toFixed(2)),z=qn(e),N=e.start?new Date(e.start):null,R=e.end?new Date(e.end):null;return{raw:e,id:e.id,projectCode:e.projectCode||e.id,title:(e.title||"").trim(),clientId:e.clientId,clientName:s?.customerName||s?.name||"",clientCompany:e.clientCompany||s?.companyName||"",type:e.type||e.projectType||"",description:e.description||"",paymentStatus:a,confirmed:e.confirmed===!0||e.confirmed==="true",start:N,end:R,applyTax:f,status:z,reservationsTotal:Number(l.toFixed(2)),expensesTotal:i,subtotal:c,taxAmount:d,combinedTaxAmount:y,overallTotal:x,unpaidValue:a==="paid"?0:x,reservationsCount:r.length}}function _n(e){return Array.isArray(A.reservations)?A.reservations.filter(t=>String(t.projectId)===String(e)):[]}function Bn(e){if(!e)return 0;const t=Array.isArray(e.items)?e.items:[],a=e.discount??0,s=Number(j(String(a)))||0,r=e.discountType||"percent",l=Array.isArray(e.crewAssignments)?e.crewAssignments:[],i=l.length?l:Array.isArray(e.technicians)?e.technicians:[],u=zt(t,s,r,!1,i,{start:e.start,end:e.end});if(Number.isFinite(u))return u;const c=Number(j(String(e.cost??0)));return Number.isFinite(c)?Math.round(c):0}function Hn(e){return typeof e.expensesTotal=="number"?Number(e.expensesTotal)||0:Array.isArray(e.expenses)?e.expenses.reduce((t,a)=>t+(Number(a.amount)||0),0):0}function qn(e){const t=new Date,a=e.start?new Date(e.start):null,s=e.end?new Date(e.end):null;return a&&!Number.isNaN(a.getTime())&&a>t?"upcoming":s&&!Number.isNaN(s.getTime())&&s<t?"completed":"ongoing"}function Vn(){if(p.search){let e;p.search.addEventListener("input",()=>{clearTimeout(e),e=setTimeout(()=>{A.filters.search=p.search.value.trim(),re()},180)})}p.payment&&(p.payment.value=A.filters.payment,p.payment.addEventListener("change",()=>{A.filters.payment=p.payment.value||"all",re()})),p.dateRange&&(p.dateRange.addEventListener("change",On),p.dateRange.value=A.filters.range),p.startDate&&p.startDate.addEventListener("change",()=>{A.filters.startDate=p.startDate.value,A.filters.range==="custom"&&re()}),p.endDate&&p.endDate.addEventListener("change",()=>{A.filters.endDate=p.endDate.value,A.filters.range==="custom"&&re()}),p.refreshBtn&&p.refreshBtn.addEventListener("click",()=>{if(A.filters.range!=="custom"){re();return}A.filters.startDate=p.startDate?.value||"",A.filters.endDate=p.endDate?.value||"",re()})}function On(e){const t=e.target.value;A.filters.range=t,t==="custom"?p.customRangeWrapper?.classList.add("active"):(p.customRangeWrapper?.classList.remove("active"),A.filters.startDate="",A.filters.endDate="",p.startDate&&(p.startDate.value=""),p.endDate&&(p.endDate.value=""),re())}async function pt(){aa();try{await Promise.all([Ut(),Ya()])}catch(e){console.error("❌ [projectsReports] Data mutation refresh failed",e),ze(e)&&console.warn("Projects API error:",e.message)}finally{sa(),re(),na()}}function Un(){oa(),re()}function zn(e){e.key&&!["projects","reservations","customers"].includes(e.key)||pt().catch(t=>{console.error("❌ [projectsReports] Storage sync failed",t)})}function re(){const e=Wn();wt(),Jn(e),Zn(e),es(e),ts(e),as(e),ns(e)}function Wn(){const{search:e,statuses:t,payment:a,range:s,startDate:r,endDate:l}=A.filters,i=ra(e),u=new Date,c=Number(s);let f=null;if(s==="custom"){f=r?new Date(r):null;const d=l?new Date(l):null;return A.projects.filter(y=>!It(y,t)||!Mt(y,a)||!Rt(y,i)?!1:Gn(y.start,f,d))}return s!=="all"&&Number.isFinite(c)&&(f=new Date,f.setDate(u.getDate()-c)),A.projects.filter(d=>!It(d,t)||!Mt(d,a)||!Rt(d,i)?!1:s==="all"?!0:Kn(d.start,f,u))}function It(e,t){return t.includes(e.status)}function Mt(e,t){return t==="all"?!0:e.paymentStatus===t}function Rt(e,t){return t?ra([e.title,e.projectCode,e.clientName,e.clientCompany,e.type,e.description].filter(Boolean).join(" ")).includes(t):!0}function Kn(e,t,a){return!e||!(e instanceof Date)||Number.isNaN(e.getTime())?!1:t?e>=t&&e<=a:!0}function Gn(e,t,a){if(!t&&!a)return!0;if(!e||Number.isNaN(e.getTime()))return!1;const s=e.getTime();return!(t&&!Number.isNaN(t.getTime())&&s<t.getTime()||a&&!Number.isNaN(a.getTime())&&s>a.getTime())}function ra(e){return e?j(String(e)).toLowerCase().trim():""}function Jn(e){if(!p.kpiGrid)return;const t=e.length,a=e.reduce((i,u)=>i+u.overallTotal,0),s=e.reduce((i,u)=>i+u.unpaidValue,0),r=e.reduce((i,u)=>i+u.expensesTotal,0),l=[{icon:Be.projects,label:n("projects.reports.kpi.totalProjects","Total projects"),value:mt(t),meta:n("projects.reports.kpi.totalProjectsMeta","After applying the current filters")},{icon:Be.value,label:n("projects.reports.kpi.totalValue","Total value"),value:ee(a),meta:n("projects.reports.kpi.totalValueMeta","Includes projects and linked reservations")},{icon:Be.outstanding,label:n("projects.reports.kpi.unpaidValue","Outstanding value"),value:ee(s),meta:n("projects.reports.kpi.unpaidValueMeta","Projects not fully paid yet")},{icon:Be.expenses,label:n("projects.reports.kpi.expenses","تكلفة الخدمات الإنتاجية"),value:ee(r),meta:n("projects.reports.kpi.expensesMeta","تكلفة الخدمات الإنتاجية للمشاريع المحددة")}];p.kpiGrid.innerHTML=l.map(({icon:i,label:u,value:c,meta:f})=>`
  ...
  `).join(""),Yn(e)}function Yn(e){try{const t=Xn(e),a="projects-revenue-breakdown";let s=document.getElementById(a);const r=[{label:n("reservations.reports.kpi.revenue.details.gross","الإيراد الكلي","Gross revenue"),value:ee(t.grossRevenue)},{label:n("reservations.reports.kpi.revenue.details.share","نسبة الشركة","Company share"),value:ee(t.companyShareTotal)},{label:n("reservations.reports.kpi.revenue.details.tax","الضريبة","Tax"),value:ee(t.taxTotal)},{label:n("reservations.reports.kpi.revenue.details.crewGross","إجمالي الطاقم","Crew total"),value:ee(t.crewTotal)},{label:n("reservations.reports.kpi.revenue.details.crew","تكلفة الطاقم","Crew cost"),value:ee(t.crewCostTotal)},{label:n("reservations.reports.kpi.revenue.details.equipment","إجمالي المعدات","Equipment total"),value:ee(t.equipmentTotalCombined)},{label:n("projects.reports.kpi.revenue.details.projectExpenses","تكلفة الخدمات الإنتاجية","Project expenses"),value:`−${ee(t.projectExpensesTotal)}`},{label:n("reservations.reports.kpi.revenue.details.net","صافي الربح","Net profit"),value:ee(t.netProfit)}],l=`
    ...
    `;s?s.outerHTML=l:p.kpiGrid.insertAdjacentHTML("afterend",l)}catch(t){console.warn("[projectsReports] Failed to render revenue breakdown",t)}}function Xn(e){const t=new Set(e.map(B=>String(B.id))),a=A.reservations.filter(B=>B.projectId!=null&&t.has(String(B.projectId)));let s=0,r=0,l=0,i=0,u=0,c=0,f=0;a.forEach(B=>{const k=Za(B);s+=k.finalTotal||0,r+=k.equipmentTotal||0,l+=k.crewTotal||0,i+=k.crewCostTotal||0,u+=k.companyShareAmount||0,c+=k.taxAmount||0,f+=k.netProfit||0});const d=e.reduce((B,k)=>B+(Number(k.expensesTotal)||0),0),y=e.reduce((B,k)=>B+(Number(k.raw?.equipmentEstimate)||0),0),x=e.reduce((B,k)=>{const oe=k.applyTax===!0,J=(Number(k.raw?.equipmentEstimate)||0)+(Number(k.expensesTotal)||0),ie=oe?J*ut:0;return B+ie},0),z=s+y+x,N=r+y,R=c+x,_=f-d;return{grossRevenue:z,companyShareTotal:u,taxTotal:R,crewTotal:l,crewCostTotal:i,equipmentTotalCombined:N,projectExpensesTotal:d,netProfit:_}}function oa(){if(!p.statusChips)return;const e=ea.map(t=>{const a=n(`projects.status.${t}`,t);return`<button type="button" class="btn btn-outline-primary reports-status-chip" data-status="${t}">${Y(a)}</button>`}).join("");p.statusChips.innerHTML=e,p.statusChips.dataset.listenerAttached||(p.statusChips.addEventListener("click",Qn),p.statusChips.dataset.listenerAttached="true"),wt()}function Qn(e){const t=e.target.closest("[data-status]");if(!t)return;const a=t.dataset.status;if(!a)return;const s=new Set(A.filters.statuses);s.has(a)?s.delete(a):s.add(a),s.size===0&&ea.forEach(r=>s.add(r)),A.filters.statuses=Array.from(s),wt(),re()}function wt(){if(!p.statusChips)return;const e=new Set(A.filters.statuses);p.statusChips.querySelectorAll("[data-status]").forEach(t=>{t.classList.toggle("is-active",e.has(t.dataset.status))})}function Zn(e){if(!X)return;const t=document.getElementById("reports-status-chart");if(!t)return;const a=["upcoming","ongoing","completed"],s=a.map(c=>e.filter(f=>f.status===c).length),r=a.map(c=>n(`projects.status.${c}`,c)),i=s.reduce((c,f)=>c+f,0)>0?s:[],u={chart:{type:"donut",height:320,toolbar:{show:!1}},labels:r,series:i,colors:["#3b82f6","#fbbf24","#22c55e"],dataLabels:{formatter:c=>Number.isFinite(c)?`${Math.round(c)}%`:"0%"},legend:{position:"bottom",fontSize:"13px"},stroke:{width:0},tooltip:{y:{formatter:c=>je(c)}},noData:{text:n("projects.reports.noData","لا توجد بيانات متاحة")},responsive:[{breakpoint:1024,options:{chart:{height:280}}}]};We("status",t,u)}function es(e){if(!X)return;const t=document.getElementById("reports-timeline-chart");if(!t)return;const a=new Map,s=new Intl.DateTimeFormat(rs(),{month:"short",year:"numeric"});e.forEach(d=>{if(!d.start||Number.isNaN(d.start.getTime()))return;const y=`${d.start.getFullYear()}-${d.start.getMonth()+1}`,x=a.get(y)||{total:0,label:s.format(d.start)};x.total+=d.overallTotal,a.set(y,x)});const l=Array.from(a.keys()).sort((d,y)=>{const[x,z]=d.split("-").map(Number),[N,R]=y.split("-").map(Number);return x===N?z-R:x-N}).slice(-12),i=l.map(d=>a.get(d)?.label||d),u=l.map(d=>Math.round(a.get(d)?.total||0)),c=u.length?[{name:n("projects.reports.datasets.value","Total value"),data:u}]:[],f={chart:{type:"area",height:320,toolbar:{show:!1}},series:c,xaxis:{categories:i,labels:{rotate:-35}},yaxis:{labels:{formatter:d=>je(d)}},dataLabels:{enabled:!1},stroke:{curve:"smooth",width:3},fill:{type:"gradient",gradient:{shadeIntensity:.35,opacityFrom:.5,opacityTo:.05}},markers:{size:4},colors:["#4c6ef5"],tooltip:{y:{formatter:d=>je(d)}},noData:{text:n("projects.reports.noData","لا توجد بيانات متاحة")}};We("timeline",t,f)}function ts(e){if(!X)return;const t=document.getElementById("reports-expense-chart");if(!t)return;const a=[...e].sort((f,d)=>d.overallTotal-f.overallTotal).slice(0,6),s=a.map(f=>f.title||f.projectCode),r=a.map(f=>Math.round(f.overallTotal)),l=a.map(f=>Math.round(f.expensesTotal)),i=s.length?[{name:n("projects.reports.datasets.value","Total value"),data:r},{name:n("projects.reports.datasets.expenses","تكلفة الخدمات الإنتاجية"),data:l}]:[],c={chart:{type:"bar",height:Math.max(320,s.length*60||0),toolbar:{show:!1}},series:i,plotOptions:{bar:{horizontal:!0,barHeight:"55%",borderRadius:8}},xaxis:{categories:s,labels:{formatter:f=>je(f)}},dataLabels:{enabled:!1},legend:{position:"bottom",fontSize:"13px"},colors:["#4c6ef5","#f472b6"],tooltip:{y:{formatter:f=>je(f)}},noData:{text:n("projects.reports.noData","لا توجد بيانات متاحة")}};We("expenses",t,c)}function as(e){if(!X)return;const t=document.getElementById("reports-clients-chart");if(!t)return;const a=new Map;e.forEach(c=>{const f=c.clientName||c.clientCompany||n("projects.fallback.unknownClient","Unknown client"),d=a.get(f)||0;a.set(f,d+c.overallTotal)});const s=Array.from(a.entries()).sort((c,f)=>f[1]-c[1]).slice(0,6),r=s.map(([c])=>c),l=s.map(([,c])=>Math.round(c)),i=l.length?[{name:n("projects.reports.datasets.value","Total value"),data:l}]:[],u={chart:{type:"bar",height:320,toolbar:{show:!1}},series:i,plotOptions:{bar:{borderRadius:6,columnWidth:"60%"}},xaxis:{categories:r,labels:{rotate:-35}},yaxis:{labels:{formatter:c=>je(c)}},dataLabels:{enabled:!1},colors:["#3b82f6"],tooltip:{y:{formatter:c=>je(c)}},legend:{show:!1},noData:{text:n("projects.reports.noData","لا توجد بيانات متاحة")}};We("clients",t,u)}function We(e,t,a={}){if(!X||!t)return;if(_e[e]){try{_e[e].destroy()}catch(r){console.warn(`⚠️ [projectsReports] Failed to destroy ${e} chart`,r)}delete _e[e]}t.innerHTML="";const s={...a};Array.isArray(s.series)||(s.series=[]);try{const r=new X(t,s);_e[e]=r,r.render().catch(l=>{console.error(`❌ [projectsReports] Failed to render ${e} chart`,l)})}catch(r){console.error(`❌ [projectsReports] Failed to render ${e} chart`,r)}}function ns(e){if(!p.table||!p.tableBody||!p.tableEmpty)return;if(!e.length){p.table.style.display="none",p.tableEmpty.classList.add("active"),p.tableMeta&&(p.tableMeta.textContent="");return}p.table.style.display="",p.tableEmpty.classList.remove("active");const t=e.map(a=>{const s=ss(a.start,a.end),r=n(`projects.status.${a.status}`,a.status),l=n(`projects.paymentStatus.${a.paymentStatus}`,a.paymentStatus),i=a.clientCompany?`${Y(a.clientName)} <small class="text-muted">${Y(a.clientCompany)}</small>`:Y(a.clientName||n("projects.fallback.unknownClient","Unknown client"));return`
      <tr>
        <td>
    ...
    `}).join("");if(p.tableBody.innerHTML=t,p.tableMeta){const a=n("projects.reports.table.meta","Showing {count} of {total} projects");p.tableMeta.textContent=a.replace("{count}",mt(e.length)).replace("{total}",mt(A.totalProjects))}}function ss(e,t){if(!e&&!t)return"—";const a=e?At(e.toISOString()):"—",s=t?At(t.toISOString()):"—";return t?`${a} → ${s}`:a}function ee(e){const t=Number(e)||0,s=Oe()==="ar"?"ar-SA-u-ca-gregory-nu-latn":"en-US",r=new Intl.NumberFormat(s,{minimumFractionDigits:0,maximumFractionDigits:0}).format(Math.round(t));return`${j(r)} SR`}function mt(e){const a=Oe()==="ar"?"ar-SA-u-ca-gregory-nu-latn":"en-US";return j(new Intl.NumberFormat(a).format(e))}function je(e){const a=Oe()==="ar"?"ar-SA-u-ca-gregory-nu-latn":"en-US";return j(new Intl.NumberFormat(a,{notation:"compact",compactDisplay:"short"}).format(e))}function rs(){return Oe()==="ar"?"ar-SA-u-ca-gregory-nu-latn":"en-US"}function Y(e=""){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}
