import{r as C,t as S}from"./calculations.Da10Qu6G.js";import{buildA4ReportPages as z,exportA4ReportPdf as A}from"./a4Unified.Dogo0Lkf.js";import"./reservationsService.B1hsYPEN.js";import"./auth.JZrLedpn.js";import"./reports.C5pBm-cr.js";import"./dashboard.ChDHYifv.js";import"./controller.BzUaX7iX.js";/* empty css              */import"./dashboardShell.BOz0qBLn.js";import"./customers.D4PMCgmj.js";import"./maintenanceService.B262iOVL.js";function I(){const o=document.createElement("div");return o.className="modal fade quote-preview-modal",o.setAttribute("tabindex","-1"),o.setAttribute("aria-hidden","true"),o.innerHTML=`
  ...
  `,o}function R(o){let e=1;const p=o.querySelector("[data-preview-frame]"),s=o.querySelector("[data-zoom-value]"),f=o.querySelector(".quote-preview-frame-wrapper"),u=()=>{p.style.transformOrigin="top center",p.style.transform=`scale(${e})`,s.textContent=`${Math.round(e*100)}%`},l=()=>{const d=f?.clientWidth||p.parentElement?.clientWidth||794;e=Math.min(1.2,Math.max(.4,(d-24)/794)),u()};o.querySelector("[data-zoom-in]").addEventListener("click",()=>{e=Math.min(2,e+.1),u()}),o.querySelector("[data-zoom-out]").addEventListener("click",()=>{e=Math.max(.4,e-.1),u()}),o.querySelector("[data-zoom-reset]").addEventListener("click",()=>{e=1,u()}),setTimeout(l,0),window.addEventListener("resize",l)}function M(o){const e=I();document.body.appendChild(e);const p=e.querySelector("[data-preview-frame]"),s=o&&o.length?o:C.lastSnapshot.tableRows||[],f=z(s,{context:"preview"});p.appendChild(f),R(e),(function(){const a=e.querySelector("[data-toggle-menu]"),d=e.querySelector("[data-toggle-open]"),m=a?.querySelector("[data-toggle-header]"),g=a?.querySelector("[data-toggle-kpis]"),b=a?.querySelector("[data-toggle-revenue]"),v=a?.querySelector("[data-columns-wrap]"),y=a?.querySelector("[data-rows-wrap]"),q=(t,r=!0)=>{try{return localStorage.getItem(`reportsPdf.hide.${t}`)==="1"?!1:r}catch{return r}},k=(t={})=>{const r=m&&!m.checked,n=g&&!g.checked,i=b&&!b.checked;f.toggleAttribute("data-hide-header",r),f.toggleAttribute("data-hide-kpis",n),f.toggleAttribute("data-hide-revenue",i);try{localStorage.setItem("reportsPdf.hide.header",r?"1":"0"),localStorage.setItem("reportsPdf.hide.kpis",n?"1":"0"),localStorage.setItem("reportsPdf.hide.revenue",i?"1":"0")}catch{}if(t.rebuild){const c=Array.from(v?.querySelectorAll('input[type="checkbox"][data-col]')||[]).filter(w=>w.checked).map(w=>w.getAttribute("data-col")),P={showPaid:y?.querySelector("[data-filter-paid]")?.checked!==!1,showUnpaid:y?.querySelector("[data-filter-unpaid]")?.checked!==!1,showConfirmed:y?.querySelector("[data-filter-confirmed]")?.checked!==!1,showPending:y?.querySelector("[data-filter-pending]")?.checked!==!1,showCompleted:y?.querySelector("[data-filter-completed]")?.checked!==!1};try{c.forEach(h=>localStorage.setItem(`reportsPdf.column.${h}`,"1")),Array.from(v?.querySelectorAll('input[type="checkbox"][data-col]')||[]).map(h=>h.getAttribute("data-col")).forEach(h=>{c.includes(h)||localStorage.setItem(`reportsPdf.column.${h}`,"0")})}catch{}const L=z(s,{context:"preview",columns:c,rowFilters:P});p.innerHTML="",p.appendChild(L)}};a&&d&&(d.addEventListener("click",()=>{a.style.display=a.style.display==="none"||!a.style.display?"block":"none"}),document.addEventListener("click",t=>{e.contains(t.target)&&!a.contains(t.target)&&t.target!==d&&(a.style.display="none")})),m&&(m.checked=q("header",!0)),g&&(g.checked=q("kpis",!0)),b&&(b.checked=q("revenue",!0));const x=(t,r)=>{const n=y?.querySelector(t);if(!n)return;const i=localStorage.getItem(`reportsPdf.rows.${r}`);i!=null&&(n.checked=i!=="0"),n.addEventListener("change",()=>{try{localStorage.setItem(`reportsPdf.rows.${r}`,n.checked?"1":"0")}catch{}})};x("[data-filter-paid]","paid"),x("[data-filter-unpaid]","unpaid"),x("[data-filter-confirmed]","confirmed"),x("[data-filter-pending]","pending"),x("[data-filter-completed]","completed"),k(),(()=>{if(!v)return;const t=Object.keys(s&&s[0]||{});v.querySelectorAll("[data-col]").forEach(r=>r.parentElement?.remove()),t.forEach(r=>{const n=document.createElement("label");n.style.cssText="display:flex;gap:6px;align-items:center;padding:2px 0;";const i=document.createElement("input");i.type="checkbox",i.setAttribute("data-col",r);try{i.checked=(localStorage.getItem(`reportsPdf.column.${r}`)??"1")==="1"}catch{i.checked=!0}n.appendChild(i);const c=document.createElement("span");c.textContent=r,n.appendChild(c),v.appendChild(n),i.addEventListener("change",()=>k({rebuild:!0}))})})(),[m,g,b].forEach(t=>t&&t.addEventListener("change",()=>k({rebuild:!0}))),y?.querySelectorAll('input[type="checkbox"]').forEach(t=>t.addEventListener("change",()=>k({rebuild:!0})));const E=()=>{const t=document.documentElement.getAttribute("data-theme")?.includes("dark")||window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches;a&&(a.style.setProperty("--dropdown-bg",t?"#0b1220":"#ffffff"),a.style.setProperty("--dropdown-fg",t?"#e5e7eb":"#111111"),a.style.setProperty("--dropdown-br",t?"rgba(148,163,184,.35)":"#e5e7eb"))};E(),document.addEventListener("theme:changed",E)})();const u=e.querySelector("[data-print-pdf]");u&&u.addEventListener("click",async()=>{const l=navigator.userAgent||"";if(/(iphone|ipad|ipod)/i.test(l)||/macintosh/i.test(l)&&"ontouchend"in document){const d=window.open("","_blank");try{d&&d.document&&(d.document.write('<!doctype html><html dir="rtl" lang="ar"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1" /><title>تحضير الطباعة…</title></head><body style="font-family:-apple-system,system-ui,Segoe UI,Roboto,sans-serif;padding:16px;">جاري التحضير للطباعة…</body></html>'),d.document.close())}catch{}await A(s,{action:"print",strict:!0,popupWindow:d})}else await A(s,{action:"save",strict:!1})});try{const l=new window.bootstrap.Modal(e,{backdrop:!0,keyboard:!0});e.addEventListener("hidden.bs.modal",()=>e.remove(),{once:!0}),l.show()}catch{e.style.display="block",e.setAttribute("open","true")}}const U={openReportsPdfPreview:M};export{U as default,M as openReportsPdfPreview};
