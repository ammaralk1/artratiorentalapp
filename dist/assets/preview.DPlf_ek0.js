const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./a4Unified.Cv1jHZIe.js","./calculations.Cuzjzmo7.js","./reservationsService.DHFcI6wO.js","./auth.DEm-O4iH.js","./auth.BYuXtjTf.css","./reports.8m0zZs4A.js","./dashboard.D_xANyYZ.js","./controller.CKj9uBP3.js","./dashboardShell.BJ8UOETr.js","./customers.DDv-F3VN.js","./index.CUo9sM62.css","./maintenanceService.-sdg2Aq9.js"])))=>i.map(i=>d[i]);
import{_ as L}from"./dashboard.D_xANyYZ.js";import{r as _,t as S}from"./calculations.Cuzjzmo7.js";import{buildA4ReportPages as A,exportA4ReportPdf as R}from"./a4Unified.Cv1jHZIe.js";import"./controller.CKj9uBP3.js";import"./auth.DEm-O4iH.js";import"./reservationsService.DHFcI6wO.js";/* empty css              */import"./dashboardShell.BJ8UOETr.js";import"./customers.DDv-F3VN.js";import"./reports.8m0zZs4A.js";import"./maintenanceService.-sdg2Aq9.js";function I(){const o=document.createElement("div");return o.className="modal fade quote-preview-modal",o.setAttribute("tabindex","-1"),o.setAttribute("aria-hidden","true"),o.innerHTML=`
            ...
            <section class="quote-preview-panel" style="flex:1;min-height:70vh;padding:18px;">
                <div class="quote-preview" data-preview-host>
                  ...
                  <div class="quote-preview-header-actions__right" style="display:flex; gap:8px; align-items:center;">
                    ...
                    <button type="button" class="btn btn-outline btn-sm" data-export-csv title="CSV">${S("reservations.reports.actions.exportCsv","🧾 تصدير CSV","Export CSV")}</button>
                  </div>
                  </div>
