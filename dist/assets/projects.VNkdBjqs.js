import{v as oa,w as ia,x as Ft,o as dt,s as D,t as n,l as Mt,n as g,A as ca,e as la,m as da,h as ua,i as pa,f as Pt,g as He}from"./auth.CFmUxZww.js";/* empty css              */import{i as ma}from"./dashboardShell.CpG9SyUN.js";import{d as m,r as je,a as $e,u as Ee,s as E,b as fa,f as ut,h as ha,i as ba,j as o,k as P,l as ya,m as pt,n as va,o as wt,e as et,p as St,q as ga,t as ja,g as xa,c as Pa,v as wa,w as Rt,x as Sa,y as Ta,z as Aa,A as $a,B as Ea,C as Na,D as Ca,E as La,F as Da,G as ka,H as Fa,I as Oe,J as Ma,K as It,L as Ra,M as Ia}from"./form.DEOgcOqj.js";import"./customers.xSpaFc27.js";import{g as mt,b as Ba,o as _e,q as tt,a as Bt,D as at,l as _a}from"./reservationsService.BuzBSxm1.js";import{P as ft,l as ht,n as Tt,u as _t,o as bt,p as Ve,t as nt,v as qa,x as Ha,i as Oa,h as Va,w as Ua,y as st,z as rt,e as qt,A as Ht,B as za,C as Wa}from"./controller.Dp7EiJmF.js";import{a as Ga}from"./calculations.JNZK6KVD.js";let At=null;function Ja(e){e&&Ot()!==e&&dt({[ft]:e}).catch(t=>{console.warn("⚠️ [projects] Failed to persist projects main tab preference",t)})}function Ot(){return Ft()?.[ft]||""}function Vt(e){e&&ot()!==e&&dt({[ht]:e}).catch(t=>{console.warn("⚠️ [projects] Failed to persist projects sub-tab preference",t)})}function ot(){return Ft()?.[ht]||""}function Ka(e){if(!e)return"";const t=e.trim();return t?Object.values(Tt).includes(t)?t:Tt[t]||"":""}function Ya(){if(typeof window>"u")return"";try{const t=new URLSearchParams(window.location.search||"").get("subTab");if(t){const a=Ka(t);if(a)return a}}catch{}return""}function Ut(e,t){!e||!m.tabPanes||!m.tabButtons||(m.tabButtons.forEach(a=>{const s=a===t;a.classList.toggle("active",s),a.classList.contains("tab-button")&&a.classList.toggle("tab-active",s)}),m.tabPanes.forEach(a=>{a.dataset.tabPane===e?a.classList.remove("d-none"):a.classList.add("d-none")}),t&&Ja(e))}function Xa(){if(!m.tabButtons||!m.tabButtons.length)return;m.tabButtons.forEach(a=>{a.dataset.tabListenerAttached!=="true"&&(a.addEventListener("click",s=>{s.preventDefault();const r=a.dataset.tabTarget;r&&(Ut(r,a),r==="projects-section"&&(E.filters.search="",m.search&&(m.search.value=""),je(),$e(),Ee()))}),a.dataset.tabListenerAttached="true")});const e=Ot(),t=e&&m.tabButtons.find(a=>a.dataset.tabTarget===e);t&&t.click()}function yt(e,t){!e||!m.projectSubTabButtons||!m.projectSubTabPanes||(m.projectSubTabButtons.forEach(a=>{const s=a===t;a.classList.toggle("active",s),a.classList.contains("tab")&&a.classList.toggle("tab-active",s)}),m.projectSubTabPanes.forEach(a=>{a.dataset.projectSubtab===e?a.classList.remove("d-none"):a.classList.add("d-none")}))}function Qa(){!m.projectSubTabButtons||!m.projectSubTabButtons.length||(m.projectSubTabButtons.forEach(e=>{e.dataset.tabListenerAttached!=="true"&&(e.addEventListener("click",t=>{t.preventDefault();const a=e.dataset.projectSubtabTarget;a&&(yt(a,e),Vt(a))}),e.dataset.tabListenerAttached="true")}),Za())}function Za(){const t=Ya()||ot();if(!t)return;const a=m.projectSubTabButtons?.[0],s=m.projectSubTabButtons?.find(l=>l.dataset.projectSubtabTarget===t)||a,r=s?.dataset.projectSubtabTarget;r&&(t!==ot()&&Vt(r),yt(r,s))}function en(){return m.tabButtons?m.tabButtons.find(t=>t.classList.contains("active"))?.dataset.tabTarget==="projects-section":!1}function $t(e={}){if(e){if(m.tabButtons&&m.tabButtons.length){const a=m.tabButtons.find(r=>r.classList.contains("active"))?.dataset.tabTarget||"",s=e[ft];if(s&&s!==a){const r=m.tabButtons.find(l=>l.dataset.tabTarget===s);r&&Ut(s,r)}}if(m.projectSubTabButtons&&m.projectSubTabButtons.length&&en()){const a=m.projectSubTabButtons.find(r=>r.classList.contains("active"))?.dataset.projectSubtabTarget||"",s=e[ht];if(s&&s!==a){const r=m.projectSubTabButtons.find(l=>l.dataset.projectSubtabTarget===s);r&&yt(s,r)}}}}function tn(){At||(At=oa(e=>{$t(e)})),ia().then(e=>{$t(e)}).catch(e=>{console.warn("⚠️ [projects] Failed to synchronise project preferences",e)})}function me(e){const t=E.projects.find(x=>String(x.id)===String(e));if(!t||!m.detailsBody)return;m.detailsBody.dataset.mode="view",m.detailsBody.dataset.projectId=String(t.id);const s=(E.customers.length?E.customers:Mt().customers||[]).find(x=>String(x.id)===String(t.clientId)),r=Jt(t.type),i=t.description?.trim()||n("projects.fallback.noDescription","لا يوجد وصف"),u=s?.customerName||n("projects.fallback.unknownClient","عميل غير معروف"),c=s?.phone??s?.customerPhone??t.clientPhone??t.customerPhone??"",f=c?g(String(c).trim()):n("projects.details.client.noPhone","لا يوجد رقم متاح"),d=s?.email??t.clientEmail??t.customerEmail??"",j=d?String(d).trim():n("projects.details.client.noEmail","لا يوجد بريد متاح"),C=(t.clientCompany||s?.companyName||"").trim(),N=t.projectCode||`PRJ-${g(String(t.id))}`,M=g(N),T=ut(t.id),Q=T.reduce((x,I)=>x+Kt(I),0),A=Number(Q.toFixed(2)),$=T.length,{subtotal:q,applyTax:Z,expensesTotal:W}=ha(t),he=Number(t?.servicesClientPrice??t?.services_client_price??0),xe=q,be=Z?Number(((xe+A)*nt).toFixed(2)):0,oe=Number((xe+A+be).toFixed(2)),le=ba(t),Pe=n(`projects.status.${le}`,qa[le]||le),te={upcoming:"status-pending",ongoing:"status-confirmed",completed:"status-completed"}[le]||"status-confirmed",ae=Z?n("projects.details.chips.vatOn","شامل الضريبة 15٪"):n("projects.details.chips.vatOff","غير شامل الضريبة"),ye=Z?"status-paid":"status-unpaid",ve=n("projects.details.chips.reservations","{count} حجوزات").replace("{count}",g(String($))),ze=typeof t.paymentStatus=="string"?t.paymentStatus.toLowerCase():"",de=mn(t),ge=de.length>0,b=ge?0:Number(t.paidAmount)||0,h=ge?0:Number(t.paidPercent)||0;let y=oe,v,S,L,B,k,F,G,R,V,Ne;const Ce=un(de),we=n("projects.focus.confirmed","✅ مشروع مؤكد"),We=t.confirmed===!0||t.confirmed==="true"?`<span class="reservation-chip status-confirmed">${o(we)}</span>`:"";let _=[];if($>0){const x=T.reduce((Re,se)=>{const ra=Array.isArray(se.items)?se.items:[],xt=Array.isArray(se.crewAssignments)?se.crewAssignments:[],pe=xt.length?xt:Array.isArray(se.technicians)?se.technicians:[],Ze=Ba({items:ra,technicianIds:Array.isArray(pe)&&!pe.length?pe:[],crewAssignments:Array.isArray(pe)&&pe.length&&typeof pe[0]=="object"?pe:[],discount:se.discount??0,discountType:se.discountType||"percent",applyTax:!1,start:se.start,end:se.end,companySharePercent:null});return Re.equipment+=Number(Ze.equipmentTotal||0),Re.crew+=Number(Ze.crewTotal||0),Re.crewCost+=Number(Ze.crewCostTotal||0),Re},{equipment:0,crew:0,crewCost:0}),I=Number(W||0),K=Number((x.equipment+x.crew+he).toFixed(2)),ue=Number.parseFloat(t?.discount??t?.discountValue??0)||0;let ne=(t?.discountType==="amount"?"amount":"percent")==="amount"?ue:K*(ue/100);(!Number.isFinite(ne)||ne<0)&&(ne=0),ne>K&&(ne=K);const U=Z===!0,ie=t?.companyShareEnabled===!0||t?.companyShareEnabled==="true"||t?.company_share_enabled===!0||t?.company_share_enabled==="true",ce=Number.parseFloat(t?.companySharePercent??t?.company_share_percent??t?.companyShare??t?.company_share??0)||0,Te=ie&&ce>0?ce:0,Y=Math.max(0,K-ne),re=Number((Y*(Te/100)).toFixed(2)),Me=U?Number(((Y+re)*nt).toFixed(2)):0,Qe=Number((Y+re+Me).toFixed(2)),sa=Number((Qe-re-Me-I-x.crewCost).toFixed(2));x.equipment>0&&_.push({icon:"🎛️",label:n("projects.details.summary.equipmentTotal","إجمالي المعدات"),value:P(x.equipment)}),x.crew>0&&_.push({icon:"😎",label:n("projects.details.summary.crewTotal","إجمالي الفريق"),value:P(x.crew)}),x.crewCost>0&&_.push({icon:"🧾",label:n("projects.details.summary.crewCostTotal","تكلفة الفريق"),value:P(x.crewCost)}),I>0&&_.push({icon:"🧾",label:n("projects.details.summary.expensesTotal","تكلفة خدمات الإنتاجية"),value:P(I)}),he>0&&_.push({icon:"💼",label:n("projects.details.summary.servicesClientPrice","سعر العميل للخدمات الإنتاجية"),value:P(he)}),ne>0&&_.push({icon:"🏷️",label:n("projects.details.summary.discount","الخصم"),value:`−${P(ne)}`}),_.push({icon:"🧮",label:n("projects.details.summary.grossAfterDiscount","الإجمالي بعد الخصم"),value:P(Y)}),re>0&&_.push({icon:"🏦",label:n("projects.details.summary.companyShare","نسبة الشركة"),value:`−${P(re)}`}),Me>0&&_.push({icon:"💸",label:n("projects.details.summary.tax","الضريبة (15٪)"),value:`−${P(Me)}`}),_.push({icon:"💵",label:n("projects.details.summary.netProfit","صافي الربح"),value:P(sa)}),_.push({icon:"💰",label:n("projects.details.summary.finalTotal","المجموع النهائي"),value:P(Qe)}),y=Qe}else _=[{icon:"💼",label:n("projects.details.summary.projectSubtotal","إجمالي المشروع"),value:P(xe)},{icon:"🔗",label:n("projects.details.summary.reservationsTotal","إجمالي المعدات / طاقم العمل"),value:P(A)},{icon:"🧮",label:n("projects.details.summary.combinedTax","إجمالي الضريبة الكلية (15٪)"),value:P(be)},{icon:"💰",label:n("projects.details.summary.overallTotal","الإجمالي الكلي"),value:P(oe)}];v=_e({totalAmount:y,paidAmount:b,paidPercent:h,history:de}),S=tt({manualStatus:ze||"unpaid",paidAmount:v.paidAmount,paidPercent:v.paidPercent,totalAmount:y}),L=n(`projects.paymentStatus.${S}`,S==="paid"?"Paid":S==="partial"?"Partial":"Unpaid"),B=S==="paid"?"status-paid":S==="partial"?"status-partial":"status-unpaid",k=Number.isFinite(Number(v.paidAmount))?Number(v.paidAmount):0,F=Number.isFinite(Number(v.paidPercent))?Number(v.paidPercent):0,G=Math.max(0,Number((y-k).toFixed(2))),R=P(k),V=`${g(F.toFixed(2))}%`,Ne=P(G);const jt=_.map(({icon:x,label:I,value:K})=>`
  ...
  `,Je=[{icon:"👤",label:n("projects.details.client","العميل"),value:u},{icon:"📞",label:n("projects.details.labels.clientPhone","رقم العميل"),value:f},{icon:"✉️",label:n("projects.details.labels.clientEmail","البريد الإلكتروني"),value:j},C?{icon:"🏢",label:n("projects.details.company","شركة العميل"),value:C}:null,{icon:"🏷️",label:n("projects.details.type","نوع المشروع"),value:r},Nt("start",t.start),Nt("end",t.end)].filter(Boolean),Ke=n("projects.details.overview.heading","معلومات المشروع"),Se=`
  ...
  `,De=[`<span class="reservation-chip ${te}">${o(Pe)}</span>`,`<span class="reservation-chip ${ye}">${o(ae)}</span>`,`<span class="reservation-chip status-info">${o(ve)}</span>`,`<span class="reservation-chip ${B}">${o(L)}</span>`,We].filter(Boolean).join(""),Ye=n("projects.details.expensesTotal","إجمالي المصاريف"),O=n("projects.details.reservationsTotal","إجمالي الحجوزات"),Xe=n("projects.details.expenses","خدمات إنتاجية ({amount})").replace("{amount}",P(W)),ke=an(Array.isArray(t.expenses)?t.expenses:[]);m.detailsBody.innerHTML=`
  ...
  `,rn(t);const J=m.detailsBody.querySelector("#project-details-export-btn");J&&J.addEventListener("click",async x=>{if(x.preventDefault(),J.blur(),!J.disabled){J.disabled=!0;try{await Ha({project:t})}catch(I){console.error("❌ [projects/details] export project PDF failed",I),D(n("projects.details.exportFailed","⚠️ تعذر تصدير المشروع إلى PDF"),"error")}finally{J.disabled=!1}}}),m.detailsModalEl&&window.bootstrap?.Modal&&window.bootstrap.Modal.getOrCreateInstance(m.detailsModalEl).show()}function an(e=[]){if(!(Array.isArray(e)&&e.length>0)){const s=o(n("projects.expenses.table.empty","ستظهر المصاريف المسجلة هنا فور إضافتها."));return`
  ...
  `}function dn(e){return["commercial","coverage","photography","social"].map(a=>{const s=Jt(a),r=a===e?"selected":"";return`<option value="${o(a)}" ${r}>${o(s)}</option>`}).join("")}function Wt(e=[]){if(!Array.isArray(e)||e.length===0){const s=o(n("projects.selected.emptyExpenses","لم يتم تسجيل أي مصروف"));return`
      ...
      </div>`}const t=o(n("actions.remove","إزالة")),a=e.map(s=>{const r=o(s?.label||""),l=o(P(s?.amount||0)),i=o(P(s?.salePrice||s?.sale_price||0)),u=o(String(s?.id||""));return`
      <tr>
        <td>${r}</td>
        <td>${l}</td>
        <td>${i}</td>
  ...
  `});let z=null;const Xt=["upcoming","ongoing","completed"];async function An({forceProjects:e=!1}={}){try{await qt({suppressError:!0}),await Wa({force:e})}catch(t){console.error("❌ [projectsReports] Failed to load initial data",t),Ve(t)&&console.warn("Projects API error:",t.message)}ta()}async function $n(){Cn(),Zt(),await En();try{await An({forceProjects:!0}),na(),Rn(),ee()}finally{ea()}document.addEventListener("language:changed",Bn),document.addEventListener("projects:changed",()=>{ct().catch(e=>{console.error("❌ [projectsReports] Failed to refresh after projects change",e)})}),document.addEventListener("reservations:changed",()=>{ct().catch(e=>{console.error("❌ [projectsReports] Failed to refresh after reservations change",e)})}),window.addEventListener("storage",_n)}document.addEventListener("DOMContentLoaded",$n);async function En(){if(z)return z;if(typeof window>"u")return null;if(window.ApexCharts)return z=window.ApexCharts,z;try{await Nn(Tn),z=window.ApexCharts||null}catch(e){console.warn("ApexCharts failed to load",e),z=null}return z}function Nn(e){return new Promise((t,a)=>{if(typeof document>"u"){a(new Error("Document is not available to load scripts."));return}const s=document.querySelector(`script[src="${e}"]`);if(s){if(s.dataset.loaded==="true"){t();return}s.addEventListener("load",t,{once:!0}),s.addEventListener("error",()=>a(new Error(`Failed to load script ${e}`)),{once:!0});return}const r=document.createElement("script");r.src=e,r.async=!0,r.dataset.loaded="false",r.onload=()=>{r.dataset.loaded="true",t()},r.onerror=()=>a(new Error(`Failed to load script ${e}`)),document.head.appendChild(r)})}function Cn(){p.search=document.getElementById("reports-search"),p.statusChips=document.getElementById("reports-status-chips"),p.payment=document.getElementById("reports-payment"),p.dateRange=document.getElementById("reports-date-range"),p.customRangeWrapper=document.getElementById("reports-custom-range"),p.startDate=document.getElementById("reports-start-date"),p.endDate=document.getElementById("reports-end-date"),p.refreshBtn=document.getElementById("reports-refresh"),p.kpiGrid=document.getElementById("reports-kpi-grid"),p.table=document.getElementById("reports-table"),p.tableBody=p.table?.querySelector("tbody"),p.tableMeta=document.getElementById("reports-table-meta"),p.tableEmpty=document.getElementById("reports-empty"),p.chartCards={},p.chartLoaders={},document.querySelectorAll("[data-chart-card]").forEach(e=>{const t=e.dataset.chartCard;if(!t)return;p.chartCards[t]=e;const a=e.querySelector("[data-chart-loading]");a&&(p.chartLoaders[t]=a)})}function Qt(e){const t=!!e;Object.entries(p.chartCards||{}).forEach(([a,s])=>{if(!s)return;s.classList.toggle("is-loading",t),s.setAttribute("aria-busy",t?"true":"false");const r=p.chartLoaders?.[a];r&&(r.hidden=!t)})}function Zt(){Ae+=1,Ae===1&&Qt(!0)}function ea(){Ae=Math.max(0,Ae-1),Ae===0&&Qt(!1)}function ta(){const{customers:e=[]}=Mt();w.customers=Array.isArray(e)?e:[],w.reservations=mt();const t=new Map(w.customers.map(s=>[String(s.id),s])),a=bt();w.projects=Array.isArray(a)?a.map(s=>Ln(s,t)):[],w.totalProjects=w.projects.length}function Ln(e,t){const a=e.paymentStatus==="paid"?"paid":"unpaid",s=t.get(String(e.clientId)),r=Dn(e.id),l=r.reduce((Q,A)=>Q+kn(A),0),i=Fn(e),u=Number(e?.equipmentEstimate)||0,c=Number((u+i).toFixed(2)),f=e?.applyTax===!0||e?.applyTax==="true",d=f?Number((c*it).toFixed(2)):0,j=f?Number(((c+l)*it).toFixed(2)):0,C=Number((c+l+j).toFixed(2)),N=Mn(e),M=e.start?new Date(e.start):null,T=e.end?new Date(e.end):null;return{raw:e,id:e.id,projectCode:e.projectCode||e.id,title:(e.title||"").trim(),clientId:e.clientId,clientName:s?.customerName||s?.name||"",clientCompany:e.clientCompany||s?.companyName||"",type:e.type||e.projectType||"",description:e.description||"",paymentStatus:a,confirmed:e.confirmed===!0||e.confirmed==="true",start:M,end:T,applyTax:f,status:N,reservationsTotal:Number(l.toFixed(2)),expensesTotal:i,subtotal:c,taxAmount:d,combinedTaxAmount:j,overallTotal:C,unpaidValue:a==="paid"?0:C,reservationsCount:r.length}}function Dn(e){return Array.isArray(w.reservations)?w.reservations.filter(t=>String(t.projectId)===String(e)):[]}function kn(e){if(!e)return 0;const t=Array.isArray(e.items)?e.items:[],a=e.discount??0,s=Number(g(String(a)))||0,r=e.discountType||"percent",l=Array.isArray(e.crewAssignments)?e.crewAssignments:[],i=l.length?l:Array.isArray(e.technicians)?e.technicians:[],u=Bt(t,s,r,!1,i,{start:e.start,end:e.end});if(Number.isFinite(u))return u;const c=Number(g(String(e.cost??0)));return Number.isFinite(c)?Math.round(c):0}function Fn(e){return typeof e.expensesTotal=="number"?Number(e.expensesTotal)||0:Array.isArray(e.expenses)?e.expenses.reduce((t,a)=>t+(Number(a.amount)||0),0):0}function Mn(e){const t=new Date,a=e.start?new Date(e.start):null,s=e.end?new Date(e.end):null;return a&&!Number.isNaN(a.getTime())&&a>t?"upcoming":s&&!Number.isNaN(s.getTime())&&s<t?"completed":"ongoing"}function Rn(){if(p.search){let e;p.search.addEventListener("input",()=>{clearTimeout(e),e=setTimeout(()=>{w.filters.search=p.search.value.trim(),ee()},180)})}p.payment&&(p.payment.value=w.filters.payment,p.payment.addEventListener("change",()=>{w.filters.payment=p.payment.value||"all",ee()})),p.dateRange&&(p.dateRange.addEventListener("change",In),p.dateRange.value=w.filters.range),p.startDate&&p.startDate.addEventListener("change",()=>{w.filters.startDate=p.startDate.value,w.filters.range==="custom"&&ee()}),p.endDate&&p.endDate.addEventListener("change",()=>{w.filters.endDate=p.endDate.value,w.filters.range==="custom"&&ee()}),p.refreshBtn&&p.refreshBtn.addEventListener("click",()=>{if(w.filters.range!=="custom"){ee();return}w.filters.startDate=p.startDate?.value||"",w.filters.endDate=p.endDate?.value||"",ee()})}function In(e){const t=e.target.value;w.filters.range=t,t==="custom"?p.customRangeWrapper?.classList.add("active"):(p.customRangeWrapper?.classList.remove("active"),w.filters.startDate="",w.filters.endDate="",p.startDate&&(p.startDate.value=""),p.endDate&&(p.endDate.value=""),ee())}async function ct(){Zt();try{await Promise.all([Ht(),_a()])}catch(e){console.error("❌ [projectsReports] Data mutation refresh failed",e),Ve(e)&&console.warn("Projects API error:",e.message)}finally{ta(),ee(),ea()}}function Bn(){na(),ee()}function _n(e){e.key&&!["projects","reservations","customers"].includes(e.key)||ct().catch(t=>{console.error("❌ [projectsReports] Storage sync failed",t)})}function ee(){const e=qn();vt(),Vn(e),Gn(e),Jn(e),Kn(e),Yn(e),Xn(e)}function qn(){const{search:e,statuses:t,payment:a,range:s,startDate:r,endDate:l}=w.filters,i=aa(e),u=new Date,c=Number(s);let f=null;if(s==="custom"){f=r?new Date(r):null;const d=l?new Date(l):null;return w.projects.filter(j=>!Lt(j,t)||!Dt(j,a)||!kt(j,i)?!1:On(j.start,f,d))}return s!=="all"&&Number.isFinite(c)&&(f=new Date,f.setDate(u.getDate()-c)),w.projects.filter(d=>!Lt(d,t)||!Dt(d,a)||!kt(d,i)?!1:s==="all"?!0:Hn(d.start,f,u))}function Lt(e,t){return t.includes(e.status)}function Dt(e,t){return t==="all"?!0:e.paymentStatus===t}function kt(e,t){return t?aa([e.title,e.projectCode,e.clientName,e.clientCompany,e.type,e.description].filter(Boolean).join(" ")).includes(t):!0}function Hn(e,t,a){return!e||!(e instanceof Date)||Number.isNaN(e.getTime())?!1:t?e>=t&&e<=a:!0}function On(e,t,a){if(!t&&!a)return!0;if(!e||Number.isNaN(e.getTime()))return!1;const s=e.getTime();return!(t&&!Number.isNaN(t.getTime())&&s<t.getTime()||a&&!Number.isNaN(a.getTime())&&s>a.getTime())}function aa(e){return e?g(String(e)).toLowerCase().trim():""}function Vn(e){if(!p.kpiGrid)return;const t=e.length,a=e.reduce((i,u)=>i+u.overallTotal,0),s=e.reduce((i,u)=>i+u.unpaidValue,0),r=e.reduce((i,u)=>i+u.expensesTotal,0),l=[{icon:Be.projects,label:n("projects.reports.kpi.totalProjects","Total projects"),value:lt(t),meta:n("projects.reports.kpi.totalProjectsMeta","After applying the current filters")},{icon:Be.value,label:n("projects.reports.kpi.totalValue","Total value"),value:X(a),meta:n("projects.reports.kpi.totalValueMeta","Includes projects and linked reservations")},{icon:Be.outstanding,label:n("projects.reports.kpi.unpaidValue","Outstanding value"),value:X(s),meta:n("projects.reports.kpi.unpaidValueMeta","Projects not fully paid yet")},{icon:Be.expenses,label:n("projects.reports.kpi.expenses","خدمات إنتاجية (التكلفة)"),value:X(r),meta:n("projects.reports.kpi.expensesMeta","تكلفة الخدمات الإنتاجية للمشاريع المحددة")}];p.kpiGrid.innerHTML=l.map(({icon:i,label:u,value:c,meta:f})=>`
    <div class="reports-kpi-card glass-card">
      ...
      <div class="reports-kpi-content">
        ...
        <span class="reports-kpi-meta">${H(f)}</span>
      </div>
    </div>
