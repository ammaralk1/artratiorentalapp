...
`)],{type:"text/csv;charset=utf-8"}),f=URL.createObjectURL(b),r=document.createElement("a");r.href=f,r.download=`${s("reservations.reports.export.filePrefix","تقرير-الحجوزات","reservations-report")}.csv`,r.style.display="none",document.body.appendChild(r),r.click(),setTimeout(()=>{URL.revokeObjectURL(f),r.remove()},1500)}}const se="https://assets.art-ratio.com/AR-Logo-v3.5-curved.png",D="https://art-ratio.sirv.com",ie="https://assets.art-ratio.com";function le(t=""){const e=String(t||"").trim();return e?e.startsWith(D)?`${ie}${e.slice(D.length)}`:e:""}function q(){try{const t=localStorage.getItem("reportsPdf.logoUrl"),e=le(t||"");if(t&&e&&t!==e&&localStorage.setItem("reportsPdf.logoUrl",e),e&&/^https?:|^data:|^blob:/.test(e))return e}catch{}return se}export{O as buildA4ReportPages,fe as exportA4ReportCsv,ue as exportA4ReportExcel,he as exportA4ReportPdf};
