import{r as _,t as s,e as q,l as A,k as I,g as L,h as C,p as H,a as X,K as G}from"./calculations.FlN4HAGv.js";import"./reservationsService.CEmNtupp.js";import"./auth.gUOZH4hF.js";import"./state.Vr6Pci5_.js";const B=`@page { size: A4; margin: 0; }
...
`)],{type:"text/csv;charset=utf-8"}),f=URL.createObjectURL(b),r=document.createElement("a");r.href=f,r.download=`${s("reservations.reports.export.filePrefix","تقرير-الحجوزات","reservations-report")}.csv`,r.style.display="none",document.body.appendChild(r),r.click(),setTimeout(()=>{URL.revokeObjectURL(f),r.remove()},1500)}}const oe="https://art-ratio.sirv.com/AR%20Logo%20v3.5%20dark%20blue%20curved.png";function M(){try{const t=localStorage.getItem("reportsPdf.logoUrl");if(t&&/^https?:|^data:|^blob:/.test(t))return t}catch{}return oe}export{O as buildA4ReportPages,me as exportA4ReportCsv,ce as exportA4ReportExcel,de as exportA4ReportPdf};
