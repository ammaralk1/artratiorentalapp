import{d as ut,w as da,n as o,v as ct,t as a}from"./auth.BFR8Y3ym.js";import{n as G,I as Q,J as gt}from"./state.uepyuVVl.js";import{a as ua,i as pa,A as ma,y as x,z as F,b as ya,f as ba,J as ha}from"./reservationsService.BV-Ogqe7.js";const va=new Map([["available","available"],["متاح","available"],["متوفر","available"],["جاهز","available"],["ready","available"],["reserved","reserved"],["محجوز","reserved"],["محجوزة","reserved"],["maintenance","maintenance"],["صيانة","maintenance"],["under_maintenance","maintenance"],["retired","retired"],["متوقف","retired"],["خارج الخدمة","retired"]]),fa=new Set(["maintenance","reserved","retired"]);function _a(e){const _=String(e??"").trim().toLowerCase();return _&&va.get(_)||"available"}function $a(e){return e?typeof e=="object"?e:xa(e):null}function Aa(e){const _=$a(e);return _?_a(_.status||_.state||_.statusLabel||_.status_label):"available"}function Ca(e){return!fa.has(Aa(e))}function Sa(e={}){return e.image||e.imageUrl||e.img||""}function Ta(e){if(!e)return null;const _=G(e),{equipment:j=[]}=ut();return(j||[]).find(B=>G(B?.barcode)===_)||null}function xa(e){const _=G(e);if(!_)return null;const{equipment:j=[]}=ut();return(j||[]).find(B=>G(B?.barcode)===_)||null}function $(e=""){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function dt(e){if(e==null)return"";const _=String(e).trim();return _?o(_):""}function Da(e,_,j=[],B,N=null){const{projectLinked:W,effectiveConfirmed:pt}=ua(e,N),qt=e.paid===!0||e.paid==="paid",It=pa(e),X=e.items||[];let{groups:D}=ma(e);const Et=t=>!!(t&&typeof t=="object"&&(t.type==="package"||Array.isArray(t.packageItems)&&t.packageItems.length||Array.isArray(t.items)&&t.items.some(i=>i&&i.type==="package"))),Rt=t=>{const i=(t?.package_code??t?.packageDisplayCode??t?.barcode??t?.description??(Array.isArray(t?.items)&&t.items[0]?.barcode)??"").toString().trim().toLowerCase();return o(i)},mt=(t,i)=>{const l=y=>{const S=Array.isArray(y?.items)?y.items[0]:null,f=[S?.price,S?.unit_price,S?.unitPrice,y?.unitPrice,y?.totalPrice];for(const q of f){const r=F(q);if(Number.isFinite(r)&&r>0)return r}return 0},m=l(t),v=l(i);return m&&v?m<=v?t:i:m?t:i},g=[],V=new Map;D.forEach(t=>{if(!Et(t)){g.push(t);return}const i=Rt(t);if(!i){if(!V.has("__unknown__"))V.set("__unknown__",g.length),g.push(t);else{const l=V.get("__unknown__");g[l]=mt(g[l],t)}return}if(!V.has(i))V.set(i,g.length),g.push(t);else{const l=V.get(i);g[l]=mt(g[l],t)}}),D=g;const{technicians:yt=[]}=ut(),Ht=[].concat(Array.isArray(j)?j:[]).concat(Array.isArray(yt)?yt:[]),Y=new Map;Ht.forEach(t=>{if(!t||t.id==null)return;const i=String(t.id),l=Y.get(i)||{};Y.set(i,{...l,...t})});const K=(Array.isArray(e.crewAssignments)&&e.crewAssignments.length?e.crewAssignments:Array.isArray(e.techniciansDetails)&&e.techniciansDetails.length?e.techniciansDetails:(e.technicians||[]).map(t=>({technicianId:t}))).map((t,i)=>{const l=t?.technicianId!=null?Y.get(String(t.technicianId)):null;let m=t.positionLabel??t.position_name??t.position_label??t.role??t.position??"";(!m||m.trim()==="")&&(m=t.positionLabelAr??t.position_label_ar??t.positionLabelEn??t.position_label_en??t.position_name_ar??t.position_name_en??"");const v=t.positionLabelAlt??t.position_label_alt??t.positionLabelEn??t.position_label_en??t.positionLabelAr??t.position_label_ar??"";let y=m,S=v;if(!y||y.trim()==="")try{const r=Q?Q():[];let s=null;if(t.positionId!=null&&(s=r.find(d=>String(d.id)===String(t.positionId))||null),!s){const d=t.positionKey??t.position_key??t.positionName??t.position_name??t.position??"";if(d&&(s=typeof gt=="function"?gt(d):null,!s&&r.length)){const b=String(d).trim().toLowerCase();s=r.find(P=>[P.name,P.labelAr,P.labelEn].filter(Boolean).map(u=>String(u).toLowerCase()).includes(b))||null}}s&&(y=s.labelAr||s.labelEn||s.name||"",(!S||String(S).trim()==="")&&(s.labelAr&&s.labelEn?S=y===s.labelAr?s.labelEn:s.labelAr:S=s.labelAr||s.labelEn||""))}catch{}const f=x(F(t.positionCost??t.position_cost??t.cost??t.daily_wage??t.dailyWage??l?.dailyWage??l?.wage??0)),q=x(F(t.positionClientPrice??t.position_client_price??t.client_price??t.clientPrice??t.daily_total??t.dailyTotal??t.total??l?.dailyTotal??l?.total??l?.total_wage??0));return{assignmentId:t.assignmentId??t.assignment_id??`crew-${i}`,positionId:t.positionId??t.position_id??null,positionKey:t.positionKey??t.position_key??t.positionName??t.position_name??t.position??null,positionLabel:y,positionLabelAlt:S,positionLabelAr:t.positionLabelAr??t.position_label_ar??null,positionLabelEn:t.positionLabelEn??t.position_label_en??null,positionCost:f,positionClientPrice:q,technicianId:t.technicianId!=null?String(t.technicianId):l?.id!=null?String(l.id):null,technicianName:t.technicianName??t.technician_name??l?.name??null,technicianRole:t.technicianRole??l?.role??null,technicianPhone:t.technicianPhone??l?.phone??null,notes:t.notes??null}}),Mt=da(),C=ya(e.start,e.end),Bt=e.discount??e.discountValue??e.discount_value??e.discountAmount??0,bt=F(Bt),zt=Number.isFinite(bt)?bt:0,jt=e.discountType??e.discount_type??e.discountMode??"percent",Vt=String(jt).toLowerCase()==="amount"?"amount":"percent",ht=W?!1:!!(e.applyTax??e.apply_tax??e.taxApplied),vt=F(e.cost??e.total??e.finalTotal),ft=Number.isFinite(vt),Kt=ft?x(vt):0,_t=e.companySharePercent??e.company_share_percent??e.companyShare??e.company_share,J=_t!=null?F(_t):Number.NaN,Ut=((e.companyShareEnabled??e.company_share_enabled??e.companyShareApplied)===!0||Number.isFinite(J)&&J>0)&&Number.isFinite(J)?J:0,T=ba({items:X,technicianIds:e.technicians||[],crewAssignments:K,discount:zt,discountType:Vt,applyTax:ht,start:e.start,end:e.end,companySharePercent:Ut,groupingSource:e}),Z=x(T.equipmentTotal),$t=x(T.crewTotal);x(T.crewCostTotal);const tt=x(T.discountAmount),Qt=x(T.subtotalAfterDiscount),et=Number.isFinite(T.companySharePercent)?T.companySharePercent:0;let at=x(T.companyShareAmount);at=et>0?x(Math.max(0,at)):0;const it=x(T.taxAmount),At=x(T.finalTotal),St=W?At:ft?Kt:At,xt=x(T.netProfit),Gt=o(String(e.reservationId??e.id??"")),Wt=e.start?o(ct(e.start)):"-",Jt=e.end?o(ct(e.end)):"-",Ot=o(String(K.length)),Xt=o(Z.toFixed(2)),Yt=o(tt.toFixed(2)),Zt=o(Qt.toFixed(2)),te=o(it.toFixed(2)),ee=o((Number.isFinite(St)?St:0).toFixed(2)),ae=o(String(C)),A=a("reservations.create.summary.currency","SR"),ie=a("reservations.details.labels.discount","الخصم"),ne=a("reservations.details.labels.tax","الضريبة (15%)"),se=a("reservations.details.labels.crewTotal","إجمالي الفريق"),oe=a("reservations.details.labels.subtotalAfterDiscount","الإجمالي"),re=a("reservations.details.labels.duration","عدد الأيام"),le=a("reservations.details.labels.companyShare","🏦 نسبة الشركة"),ce=a("reservations.details.labels.netProfit","💵 صافي الربح"),de=a("reservations.create.equipment.imageAlt","صورة"),E={item:a("reservations.equipment.table.item","المعدة"),quantity:a("reservations.equipment.table.quantity","الكمية"),unitPrice:a("reservations.equipment.table.unitPrice","سعر الوحدة"),total:a("reservations.equipment.table.total","الإجمالي"),actions:a("reservations.equipment.table.actions","الإجراءات")},ue=a("reservations.details.noItems","📦 لا توجد معدات ضمن هذا الحجز حالياً."),pe=a("reservations.details.noCrew","😎 لا يوجد فريق مرتبط بهذا الحجز.");a("reservations.details.technicians.roleUnknown","غير محدد");const me=a("reservations.details.technicians.phoneUnknown","غير متوفر");a("reservations.details.technicians.wage","{amount} {currency} / اليوم");const ye=a("reservations.list.status.confirmed","✅ مؤكد"),be=a("reservations.list.status.pending","⏳ غير مؤكد"),he=a("reservations.list.payment.paid","💳 مدفوع"),ve=a("reservations.list.payment.unpaid","💳 غير مدفوع"),fe=a("reservations.list.payment.partial","💳 مدفوع جزئياً"),_e=a("reservations.list.status.completed","📁 منتهي"),$e=a("reservations.details.labels.id","🆔 رقم الحجز"),Ae=a("reservations.details.section.bookingInfo","بيانات الحجز"),Se=a("reservations.details.section.paymentSummary","ملخص الدفع"),xe=a("reservations.details.labels.finalTotal","المجموع النهائي"),Pe=a("reservations.details.section.crew","😎 الفريق الفني"),we=a("reservations.details.crew.count","{count} عضو"),Ne=a("reservations.details.section.items","📦 المعدات المرتبطة"),Le=a("reservations.details.items.count","{count} عنصر"),ke=a("reservations.details.actions.edit","✏️ تعديل"),Fe=a("reservations.details.actions.delete","🗑️ حذف"),Ce=a("reservations.details.labels.customer","العميل"),Te=a("reservations.details.labels.contact","رقم التواصل"),De=a("reservations.details.labels.project","📁 المشروع المرتبط");a("reservations.details.project.unlinked","غير مرتبط بأي مشروع.");const ge=a("reservations.edit.project.missing","⚠️ المشروع غير متوفر (تم حذفه)"),qe=a("reservations.details.actions.openProject","📁 فتح المشروع"),Ie=a("reservations.details.labels.start","بداية الحجز"),Ee=a("reservations.details.labels.end","نهاية الحجز"),Re=a("reservations.details.labels.notes","ملاحظات"),He=a("reservations.list.noNotes","لا توجد ملاحظات"),Me=a("reservations.details.labels.itemsCount","عدد المعدات"),Be=a("reservations.details.labels.itemsTotal","إجمالي المعدات"),ze=a("reservations.paymentHistory.title","سجل الدفعات"),je=a("reservations.paymentHistory.empty","لا توجد دفعات مسجلة"),Ve=a("reservations.list.unknownCustomer","غير معروف"),nt=typeof N?.paymentStatus=="string"?N.paymentStatus.toLowerCase():null,O=W&&nt&&["paid","partial","unpaid"].includes(nt)?nt:e.paidStatus??e.paid_status??(qt?"paid":"unpaid"),st=O==="partial",Pt=O==="paid"?he:st?fe:ve;function wt(t){if(t==null)return Number.NaN;if(typeof t=="number")return Number.isFinite(t)?t:Number.NaN;const i=String(t).replace(/[^0-9.+-]/g,""),l=Number(i);return Number.isFinite(l)?l:Number.NaN}const ot=(t={})=>{const i=String(t.type??t.kind??t.category??"").toLowerCase();return!!(["package","bundle","pack"].includes(i)||Array.isArray(t.packageItems)&&t.packageItems.length)},Ke=(t={})=>[t.packageId,t.package_id,t.packageCode,t.package_code,t.bundleId,t.bundle_id].some(i=>i!=null&&i!==""),Ue=(t={})=>!t||typeof t!="object"?!1:!ot(t)&&Ke(t);let rt=Array.isArray(D)&&D.length?D.length:(Array.isArray(X)?X.filter(t=>t&&typeof t=="object"&&!Ue(t)).length:0)||1;rt=Math.max(1,Math.round(rt));const Qe=o(String(rt)),Nt=Le.replace("{count}",Qe),Ge=we.replace("{count}",Ot),We=e.notes?o(e.notes):He,Je=o($t.toFixed(2)),Oe=o(String(et)),Xe=o(at.toFixed(2)),Ye=`${Oe}% (${Xe} ${A})`,Ze=Number.isFinite(xt)?Math.max(0,xt):0,ta=o(Ze.toFixed(2)),H=[{icon:"💼",label:Be,value:`${Xt} ${A}`}];H.push({icon:"😎",label:se,value:`${Je} ${A}`}),tt>0&&H.push({icon:"💸",label:ie,value:`${Yt} ${A}`}),H.push({icon:"📊",label:oe,value:`${Zt} ${A}`}),ht&&it>0&&H.push({icon:"🧾",label:ne,value:`${te} ${A}`}),et>0&&H.push({icon:"🏦",label:le,value:Ye}),H.push({icon:"💵",label:ce,value:`${ta} ${A}`}),H.push({icon:"💰",label:xe,value:`${ee} ${A}`});const ea=H.map(({icon:t,label:i,value:l})=>`
  ...
  `).join("");let Lt="";try{const i=new URL(window.location.href).searchParams.get("debugFinance");if(i==="1"||i==="true"){const l=r=>(r?.type||"").toLowerCase()==="package"&&String(r?.pricingMode||"").toLowerCase()==="fixed"?"fixed":"daily",m=r=>{if((r?.type||"").toLowerCase()==="package")return!1;const s=Array.isArray(r?.items)?r.items:[];if(!s.length)return!1;if(s.some(u=>u?.reservation_id!=null||u?.reservationId!=null))return!0;const b=s.every(u=>u?.unit_price!=null||u?.unitPrice!=null),P=s.some(u=>u?.daily_rate!=null||u?.dailyRate!=null||u?.unit_rate!=null||u?.unitRate!=null||u?.price!=null);return b&&!P};let v=0,y=0,S=0,f=0;const q=(Array.isArray(D)?D:[]).map((r,s)=>{const d=Number.isFinite(Number(r?.quantity))?Number(r.quantity):0,b=Number.isFinite(Number(r?.unitPrice))?Number(r.unitPrice):0,P=l(r);let u=P==="fixed"?d*b:d*b*C,L="";if((r?.type||"").toLowerCase()==="package")try{const w={package_code:r?.package_code||r?.packageDisplayCode||r?.barcode||r?.packageId||r?.key,packageItems:Array.isArray(r?.packageItems)?r.packageItems:void 0},M=Number(r?.unitPrice);let c;if(Number.isFinite(M)&&M>0)c=d*M;else{const n=ha(w,{packageQuantity:d,days:C});c=Number.isFinite(Number(n.perDayTotal))?Number(n.perDayTotal):d*b}u=c*C,v+=c,y+=u;const p=(pricing.lines||[]).map((n,h)=>`
          ...
          <tr>
            ...
            <td>${P}</td>
            <td>${o(String(d))}</td>
            <td>${o(String(b.toFixed?b.toFixed(2):b))}</td>
        ...
        <details class="reservation-finance-debug" style="margin-top:12px">
          ...
          <div style="padding:8px 0; font-size: 12px">
            <div>الأيام: ${o(String(C))}</div>
            <div style="margin-top:6px"><strong>مجاميع سريعة:</strong></div>
            <div>من الحِزم (يومي): ${o(String(v.toFixed(2)))} ${A}</div>
            <div>من الحِزم (كامل المدة): ${o(String(y.toFixed(2)))} ${A}</div>
            <div>مفردة خارج الحِزم (يومي): ${o(String(S.toFixed(2)))} ${A}</div>
            <div>مفردة خارج الحِزم (كامل المدة): ${o(String(f.toFixed(2)))} ${A}</div>
            <div style="margin-top:4px">Equipment Total (breakdown): ${o(String(Z.toFixed(2)))} ${A}</div>
