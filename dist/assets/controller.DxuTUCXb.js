...
`)}function Br(e,{existingItems:t=[],start:n,end:a,ignoreReservationId:s=null}={}){const r=Rn(e);if(!r)return{success:!1,reason:"invalid",message:o("reservations.toast.packageInvalid","⚠️ يرجى اختيار حزمة صالحة أولاً")};const i=Bl(r);if(!i)return{success:!1,reason:"not_found",message:o("reservations.toast.packageNotFound","⚠️ تعذر العثور على بيانات الحزمة المحددة")};if(!n||!a)return{success:!1,reason:"missing_dates",message:o("reservations.toast.requireDatesBeforeAdd","⚠️ يرجى تحديد تاريخ ووقت البداية والنهاية قبل إضافة المعدات")};if(t.some(p=>p?.type==="package"&&Rn(p.packageId)===r))return{success:!1,reason:"duplicate",message:o("reservations.toast.packageDuplicate","⚠️ هذه الحزمة مضافة بالفعل إلى الحجز")};if(Tc(r,n,a,s)){const p=i.name||r;return{success:!1,reason:"package_conflict",message:o("reservations.toast.packageTimeConflict",`⚠️ الحزمة ${p} محجوزة بالفعل في الفترة المختارة`)}}const c=Array.isArray(i.items)&&i.items.length?i.items:Fs(i.raw??{}),l=ti(t),d=[],u=new Set;if(c.forEach(p=>{const m=ae(p?.normalizedBarcode??p?.barcode);if(m){if(u.has(m)){d.push({item:p,type:"internal"});return}u.add(m),l.has(m)&&d.push({item:p,type:"external"})}}),d.length){const p=d.map(({item:g})=>g?.desc||g?.description||g?.name||g?.barcode||g?.normalizedBarcode||o("equipment.packages.items.unknown","معدة بدون اسم")).map(g=>v(String(g))).join(", ");return{success:!1,reason:"package_duplicate_equipment",message:d.some(g=>g.type==="external")?o("reservations.toast.packageDuplicateEquipmentExternal","⚠️ لا يمكن إضافة الحزمة لأن العناصر التالية موجودة مسبقاً في الحجز: {items}").replace("{items}",p):o("reservations.toast.packageDuplicateEquipmentInternal","⚠️ بيانات الحزمة تحتوي على عناصر مكررة: {items}").replace("{items}",p),duplicates:d}}const b=[];return c.forEach(p=>{const m=ae(p?.normalizedBarcode??p?.barcode);if(m&&gt(m,n,a,s)){const g=Rs(m,n,a,s);b.push({item:p,blockingPackages:g})}}),b.length?{success:!1,reason:"item_conflict",message:Kl(i,b),conflicts:b}:{success:!0,package:{id:`package::${r}`,packageId:r,type:"package",desc:i.name||`Package ${r}`,qty:1,price:Number.isFinite(Number(i.price))?Number(i.price):0,barcode:i.code||i.raw?.package_code||`pkg-${r}`,packageItems:c.map(p=>({equipmentId:p?.equipmentId??null,barcode:p?.barcode??p?.normalizedBarcode??"",normalizedBarcode:ae(p?.normalizedBarcode??p?.barcode),desc:p?.desc??"",qty:Number.isFinite(Number(p?.qty))?Number(p.qty):1,price:Number.isFinite(Number(p?.price))?Number(p.price):0})),image:c.find(p=>p?.image)?.image??null},packageInfo:i}}function Dr(e,{silent:t=!1}={}){const n=Rn(e);if(!n)return t||E(o("reservations.toast.packageInvalid","⚠️ يرجى اختيار حزمة صالحة أولاً")),{success:!1,reason:"invalid"};const{start:a,end:s}=cn(),r=ht(),i=Br(n,{existingItems:r,start:a,end:s});if(!i.success){if(!t){const l={invalid:o("reservations.toast.packageInvalid","⚠️ يرجى اختيار حزمة صالحة أولاً"),not_found:o("reservations.toast.packageNotFound","⚠️ تعذر العثور على بيانات الحزمة المحددة"),missing_dates:o("reservations.toast.requireDatesBeforeAdd","⚠️ يرجى تحديد تاريخ ووقت البداية والنهاية قبل إضافة المعدات"),duplicate:o("reservations.toast.packageDuplicate","⚠️ هذه الحزمة مضافة بالفعل إلى الحجز")}[i.reason]||o("reservations.toast.packageInvalid","⚠️ يرجى اختيار حزمة صالحة أولاً");E(i.message||l)}return i}return Pa(i.package),kt(),ye(),t||E(o("reservations.toast.packageAdded","✅ تم إضافة الحزمة بنجاح")),{success:!0,package:i.package}}function Fr(){const{packageSelect:e}=Kn();!e||e.dataset.autoAddAttached==="true"||(e.addEventListener("change",()=>{const t=e.value;if(!t)return;Dr(t)?.success&&(e.options.length>0?e.selectedIndex=0:e.value="")}),e.dataset.autoAddAttached="true")}function Ql(){const{packageAddButton:e,packageSelect:t}=Kn();!e||e.dataset.listenerAttached||(e.addEventListener("click",()=>{const n=t?.value||"";if(!n){E(o("reservations.toast.packageInvalid","⚠️ يرجى اختيار حزمة صالحة أولاً"));return}Dr(n)}),e.dataset.listenerAttached="true")}function Rr(){const{modeRadios:e}=Kn();if(!e.length)return;e.forEach(a=>{a.dataset.listenerAttached||(a.addEventListener("change",s=>{s.target.checked&&Ss(s.target.value)}),a.dataset.listenerAttached="true")}),Ql(),Fr();const t=da(),n=e.find(a=>a.value===t);n&&(n.checked=!0),Ss(t)}function kt(e="reservation-items"){const t=document.getElementById(e);if(!t)return;const n=ht(),a=o("reservations.create.equipment.noneAdded","لا توجد معدات مضافة"),s=o("reservations.create.summary.currency","SR"),r=o("reservations.create.equipment.imageAlt","صورة"),i=o("reservations.equipment.actions.increase","زيادة الكمية"),c=o("reservations.equipment.actions.decrease","تقليل الكمية"),l=o("reservations.equipment.actions.remove","إزالة البند");if(n.length===0){t.innerHTML=`<tr><td colspan="5" class="text-center">${a}</td></tr>`;return}const d=Sn(n);t.innerHTML=d.map(u=>{const b=u.items[0]||{},y=rn(b)||u.image,p=y?`<img src="${y}" alt="${r}" class="reservation-item-thumb">`:'<div class="reservation-item-thumb reservation-item-thumb--placeholder" aria-hidden="true">🎥</div>',m=v(String(u.count)),g=Number.isFinite(Number(u.unitPrice))?Number(u.unitPrice):0,h=Number.isFinite(Number(u.totalPrice))?Number(u.totalPrice):g*u.count,_=`${v(g.toFixed(2))} ${s}`,q=`${v(h.toFixed(2))} ${s}`,A=u.items.some(I=>I?.type==="package"),T=u.barcodes.map(I=>v(String(I||""))).filter(Boolean),K=T.length?`<details class="reservation-item-barcodes">
  ...
  `).join("");console.debug("[reservations/details] payment history raw",e.paymentHistory,e.payment_history);let kn=[];Array.isArray(e.paymentHistory)?kn=e.paymentHistory:Array.isArray(e.payment_history)&&(kn=e.payment_history);const vc=Array.isArray(e.paymentLogs)?e.paymentLogs:[],gi=Array.isArray(kn)&&kn.length>0?kn:vc,qc=gi.length?`<ul class="reservation-payment-history-list">${gi.map(f=>{const R=f?.type==="amount"?o("reservations.paymentHistory.type.amount","دفعة مالية"):f?.type==="percent"?o("reservations.paymentHistory.type.percent","دفعة نسبة"):o("reservations.paymentHistory.type.unknown","دفعة"),Z=Number.isFinite(Number(f?.amount))&&Number(f.amount)>0?`${v(Number(f.amount).toFixed(2))} ${te}`:"—",me=Number.isFinite(Number(f?.percentage))&&Number(f.percentage)>0?`${v(Number(f.percentage).toFixed(2))}%`:"—",ge=f?.recordedAt?v(Ze(f.recordedAt)):"—",Ae=f?.note?`<div class="payment-history-note">${Qe(v(f.note))}</div>`:"";return`
        ...
        `}).join("")}</ul>`:`<div class="reservation-payment-history-empty">${Qe(sc)}</div>`,hi=[{text:i?dt:qt,className:i?"status-confirmed":"status-pending"},{text:rc,className:Ja==="paid"?"status-paid":fi?"status-partial":"status-unpaid"}];l&&hi.push({text:Jn,className:"status-completed"});const Sc=hi.map(({text:f,className:R})=>`<span class="status-chip ${R}">${f}</span>`).join(""),Ut=(f,R,Z)=>`
...
`);return e&&e.value.trim().length===0&&(e.value=n),t&&t.value.trim().length===0&&(t.value=n),[...We]}const vd=[{id:"customerInfo",labelKey:"reservations.quote.sections.customer",fallback:"بيانات العميل",defaultSelected:!0},{id:"reservationInfo",labelKey:"reservations.quote.sections.reservation",fallback:"تفاصيل الحجز",defaultSelected:!0},{id:"projectInfo",labelKey:"reservations.quote.sections.project",fallback:"بيانات المشروع",defaultSelected:!0},{id:"financialSummary",labelKey:"reservations.quote.sections.financial",fallback:"الملخص المالي",defaultSelected:!0},{id:"items",labelKey:"reservations.quote.sections.items",fallback:"قائمة المعدات",defaultSelected:!0},{id:"crew",labelKey:"reservations.quote.sections.crew",fallback:"طاقم العمل",defaultSelected:!0},{id:"notes",labelKey:"reservations.quote.sections.notes",fallback:"ملاحظات الحجز",defaultSelected:!0}],Wr=[{id:"rowNumber",labelKey:null,fallback:"#",render:(e,t)=>w(v(String(t+1)))},{id:"code",labelKey:"reservations.details.table.headers.code",fallback:"الكود",render:e=>{if(e?.isPackage){const t=e?.packageCodeResolved||e?.barcode||"";return w(t||"-")}return w(e?.barcode||"-")}},{id:"description",labelKey:"reservations.details.table.headers.description",fallback:"الوصف",render:e=>w(e?.desc||e?.description||"-")},{id:"quantity",labelKey:"reservations.details.table.headers.quantity",fallback:"الكمية",render:e=>w(v(String(e?.qty||1)))},{id:"price",labelKey:"reservations.details.table.headers.price",fallback:"السعر",render:e=>w(v(Number(e?.price||0).toFixed(2)))}],Xr=[{id:"rowNumber",labelKey:null,fallback:"#",render:(e,t)=>w(v(String(t+1)))},{id:"position",labelKey:"reservations.details.crew.position",fallback:"المنصب",render:e=>w(v(e?.positionLabel??e?.position_name??e?.role??o("reservations.crew.positionFallback","منصب بدون اسم")))},{id:"price",labelKey:"reservations.details.crew.clientPrice",fallback:"سعر العميل",render:e=>{const t=Number.isFinite(Number(e?.positionClientPrice))?Number(e.positionClientPrice):0;return w(`${v(t.toFixed(2))} ${o("reservations.create.summary.currency","SR")}`)}}],As={customerInfo:[{id:"customerName",labelKey:"reservations.details.labels.customer",fallback:"العميل"},{id:"customerCompany",labelKey:"reservations.details.labels.company",fallback:"الشركة"},{id:"customerPhone",labelKey:"reservations.details.labels.phone",fallback:"الهاتف"},{id:"customerEmail",labelKey:"reservations.details.labels.email",fallback:"البريد"}],reservationInfo:[{id:"reservationId",labelKey:"reservations.details.labels.reservationId",fallback:"رقم الحجز"},{id:"reservationStart",labelKey:"reservations.details.labels.start",fallback:"بداية الحجز"},{id:"reservationEnd",labelKey:"reservations.details.labels.end",fallback:"نهاية الحجز"},{id:"reservationDuration",labelKey:"reservations.details.labels.duration",fallback:"عدد الأيام"}],projectInfo:[{id:"projectTitle",labelKey:"reservations.details.labels.project",fallback:"المشروع"},{id:"projectCode",labelKey:"reservations.details.labels.code",fallback:"الرمز"}],financialSummary:[{id:"equipmentTotal",labelKey:"reservations.details.labels.equipmentTotal",fallback:"إجمالي المعدات"},{id:"crewTotal",labelKey:"reservations.details.labels.crewTotal",fallback:"إجمالي الفريق"},{id:"discountAmount",labelKey:"reservations.details.labels.discount",fallback:"الخصم"},{id:"taxAmount",labelKey:"reservations.details.labels.tax",fallback:"الضريبة"},{id:"finalTotal",labelKey:"reservations.details.labels.total",fallback:"الإجمالي النهائي"}],payment:[{id:"beneficiary",labelKey:"reservations.quote.labels.beneficiary",fallback:"اسم المستفيد"},{id:"bank",labelKey:"reservations.quote.labels.bank",fallback:"اسم البنك"},{id:"account",labelKey:"reservations.quote.labels.account",fallback:"رقم الحساب"},{id:"iban",labelKey:"reservations.quote.labels.iban",fallback:"رقم الآيبان"}],items:Wr.map(({id:e,labelKey:t,fallback:n})=>({id:e,labelKey:t,fallback:n})),crew:Xr.map(({id:e,labelKey:t,fallback:n})=>({id:e,labelKey:t,fallback:n}))},Jr=[{id:"rowNumber",labelKey:null,fallback:"#",render:(e,t)=>w(v(String(t+1)))},{id:"name",labelKey:null,fallback:"الاسم",render:e=>w(e?.name||e?.full_name||e?.fullName||"-")},{id:"role",labelKey:null,fallback:"الدور",render:e=>w(e?.role||e?.title||o("reservations.details.technicians.roleUnknown","غير محدد"))},{id:"phone",labelKey:null,fallback:"الهاتف",render:e=>w(e?.phone||e?.mobile||o("reservations.details.technicians.phoneUnknown","غير متوفر"))}],Yr=[{id:"rowNumber",labelKey:null,fallback:"#",render:(e,t)=>w(v(String(t+1)))},{id:"label",labelKey:null,fallback:"البند",render:e=>w(e?.label||"-")},{id:"amount",labelKey:null,fallback:"المبلغ",render:e=>w(e?.displayAmount||"—")},{id:"note",labelKey:null,fallback:"ملاحظات",render:e=>w(e?.note||"-")}],Zr=[{id:"rowNumber",labelKey:null,fallback:"#",render:(e,t)=>w(v(String(t+1)))},{id:"description",labelKey:null,fallback:"الوصف",render:e=>w(e?.description||"-")},{id:"totalQuantity",labelKey:null,fallback:"إجمالي الكمية",render:e=>w(v(String(e?.totalQuantity||0)))},{id:"reservationsCount",labelKey:null,fallback:"عدد الحجوزات",render:e=>w(v(String(e?.reservationsCount||0)))},{id:"totalCost",labelKey:null,fallback:"التكلفة التقديرية",render:e=>w(e?.displayCost||"—")}],qd=[{id:"customerInfo",labelKey:"projects.quote.sections.customer",fallback:"بيانات العميل",defaultSelected:!0},{id:"projectInfo",labelKey:"projects.quote.sections.project",fallback:"بيانات المشروع",defaultSelected:!0},{id:"projectExpenses",labelKey:"projects.quote.sections.expenses",fallback:"متطلبات المشروع",defaultSelected:!0},{id:"projectCrew",labelKey:"projects.quote.sections.crew",fallback:"طاقم العمل",defaultSelected:!0},{id:"financialSummary",labelKey:"projects.quote.sections.financial",fallback:"الملخص المالي",defaultSelected:!0},{id:"projectEquipment",labelKey:"projects.quote.sections.equipment",fallback:"المعدات",defaultSelected:!0},{id:"projectNotes",labelKey:"projects.quote.sections.notes",fallback:"ملاحظات المشروع",defaultSelected:!0}],Sd={customerInfo:As.customerInfo,projectInfo:[{id:"projectTitle",labelKey:"projects.details.overview.heading",fallback:"معلومات المشروع"},{id:"projectCode",labelKey:"projects.details.labels.code",fallback:"رقم المشروع"},{id:"projectType",labelKey:"projects.details.type",fallback:"نوع المشروع"},{id:"projectStart",labelKey:"projects.details.start",fallback:"بداية المشروع"},{id:"projectEnd",labelKey:"projects.details.end",fallback:"نهاية المشروع"},{id:"projectDuration",labelKey:"projects.details.duration",fallback:"مدة المشروع"},{id:"projectStatus",labelKey:"projects.details.status",fallback:"حالة المشروع"}],financialSummary:[{id:"projectSubtotal",labelKey:"projects.details.summary.projectSubtotal",fallback:"إجمالي المشروع"},{id:"expensesTotal",labelKey:"projects.details.expensesTotal",fallback:"إجمالي المصاريف"},{id:"reservationsTotal",labelKey:"projects.details.reservationsTotal",fallback:"إجمالي الحجوزات"},{id:"discountAmount",labelKey:"projects.details.summary.discount",fallback:"الخصم"},{id:"taxAmount",labelKey:"projects.details.summary.combinedTax",fallback:"الضريبة"},{id:"overallTotal",labelKey:"projects.details.summary.overallTotal",fallback:"الإجمالي الكلي"},{id:"paidAmount",labelKey:"projects.details.summary.paidAmount",fallback:"المدفوع"},{id:"remainingAmount",labelKey:"projects.details.summary.remainingAmount",fallback:"المتبقي للدفع"}],payment:As.payment,projectExpenses:Yr.map(({id:e,labelKey:t,fallback:n})=>({id:e,labelKey:t,fallback:n})),projectCrew:Jr.map(({id:e,labelKey:t,fallback:n})=>({id:e,labelKey:t,fallback:n})),projectEquipment:Zr.map(({id:e,labelKey:t,fallback:n})=>({id:e,labelKey:t,fallback:n})),projectNotes:[]},is=new Map;function Oa(e="reservation"){if(is.has(e))return is.get(e);const t=e==="project"?qd:vd,n=e==="project"?Sd:As,a=new Set(t.map(({id:i})=>i)),s=Object.fromEntries(Object.entries(n).map(([i,c=[]])=>[i,new Set(c.map(l=>l.id))])),r={sectionDefs:t,fieldDefs:n,sectionIdSet:a,fieldIdMap:s};return is.set(e,r),r}function Ha(e="reservation"){return Oa(e).sectionDefs}function eo(e="reservation"){return Oa(e).fieldDefs}function to(e="reservation"){return Oa(e).sectionIdSet}function no(e="reservation"){return Oa(e).fieldIdMap}function ao(e){switch(e){case"export":return o("reservations.quote.status.exporting","جاري تجهيز ملف PDF...");case"render":default:return o("reservations.quote.status.rendering","جاري تحديث المعاينة...")}}const Ed="https://cdn.jsdelivr.net/npm/html2pdf.js@0.10.1/dist/html2pdf.bundle.min.js",wd="https://cdn.jsdelivr.net/npm/html2canvas@1.4.1/dist/html2canvas.min.js",Ad="https://cdn.jsdelivr.net/npm/jspdf@2.5.1/dist/jspdf.umd.min.js",so=ud.trim(),io=/^data:image\/svg\+xml/i,xd=/\.svg($|[?#])/i,Tn=512,xs="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mP8/B8AAusB9YwpClgAAAAASUVORK5CYII=",ro=96,oo=25.4,Is=210,oa=297,ca=Math.round(Is/oo*ro),la=Math.round(oa/oo*ro),Id=2,co=/safari/i,_d=/(iphone|ipad|ipod)/i,Ni=/(iphone|ipad|ipod)/i,kd=/(crios|fxios|edgios|opios)/i,wa="[reservations/pdf]";let Y=null,N=null,yt=1,Pn=null,Cn=null,jt=null,fn=null,jn=!1;function Yt(e="render",{message:t,actionLabel:n,onAction:a,showSpinner:s=e!=="error"}={}){if(!Y?.statusIndicator||!Y?.statusText)return;Y.statusKind=e;const r=t||ao(e);Y.statusText.textContent=r,Y.statusSpinner&&(Y.statusSpinner.hidden=!s),Y.statusAction&&(Y.statusAction.hidden=!0,Y.statusAction.onclick=null,n&&typeof a=="function"&&(Y.statusAction.textContent=n,Y.statusAction.hidden=!1,Y.statusAction.onclick=i=>{i.preventDefault(),a()})),Y.statusIndicator.hidden=!1,requestAnimationFrame(()=>{Y.statusIndicator.classList.add("is-visible")})}function rs(e){try{return String(e||"").toLowerCase().normalize("NFKD").replace(/[\u064B-\u065F\u0670\u06D6-\u06ED]/g,"").replace(/\s+/g," ").trim()}catch{return String(e||"").trim().toLowerCase()}}function Bn(e){!Y?.statusIndicator||!Y?.statusText||(Y.statusKind=null,Y.statusIndicator.classList.remove("is-visible"),setTimeout(()=>{Y?.statusIndicator&&(Y.statusIndicator.hidden=!0,Y.statusAction&&(Y.statusAction.hidden=!0,Y.statusAction.onclick=null),Y.statusSpinner&&(Y.statusSpinner.hidden=!1))},220))}function _s(){return!!window?.bootstrap?.Modal}function $d(e){if(e&&!e.classList.contains("show")){e.classList.add("show"),e.style.display="block",e.removeAttribute("aria-hidden"),e.setAttribute("aria-modal","true"),e.getAttribute("role")||e.setAttribute("role","dialog"),document.body.classList.add("modal-open"),jt||(jt=document.createElement("div"),jt.className="modal-backdrop fade show",jt.dataset.quotePdfFallbackBackdrop="true",document.body.appendChild(jt)),fn||(fn=t=>{t.key==="Escape"&&ks(e)},document.addEventListener("keydown",fn));try{e.focus({preventScroll:!0})}catch{}}}function ks(e){!e||!e.classList.contains("show")||(e.classList.remove("show"),e.style.display="none",e.setAttribute("aria-hidden","true"),e.removeAttribute("aria-modal"),document.body.classList.remove("modal-open"),jt&&(jt.remove(),jt=null),fn&&(document.removeEventListener("keydown",fn),fn=null))}function Pd(e){if(e){if(_s()){window.bootstrap.Modal.getOrCreateInstance(e).show();return}$d(e)}}function Cd(){if(jn)return;jn=!0;const e=o("reservations.quote.toast.viewGuide","📘 عرض دليل الحل السريع"),t=o("reservations.quote.toast.retry","إعادة المحاولة"),n=o("reservations.quote.toast.assetsFailed","⚠️ تعذر تحميل بعض الصور ضمن عرض السعر."),a=!!Y?.modal?.classList.contains("show"),s=()=>{Y?.modal?.classList.contains("show")&&(Yt("render"),jn=!1,ln())};Gi({message:n,duration:9e3,actionLabel:a?t:void 0,onAction:a?s:void 0,linkLabel:e,linkHref:Gr}),a&&Yt("error",{message:n,actionLabel:t,onAction:s,showSpinner:!1})}function Va(e="reservation"){const t={},n=eo(e);return Object.entries(n).forEach(([a,s=[]])=>{t[a]=new Set(s.filter(r=>r?.default!==!1).map(r=>r.id))}),t}function ni(e={}){const t={};return Object.entries(e).forEach(([n,a])=>{t[n]=new Set(Array.from(a||[]))}),t}function Ld(e={},t){if(t)return e[t]||(e[t]=new Set),e[t]}function ai(e={},t,n){const a=e?.[t];return a?a instanceof Set?a.has(n):Array.isArray(a)?a.includes(n):!!a?.[n]:!0}function si(e="reservation"){return Object.fromEntries(Ha(e).map(({id:t})=>[t,!1]))}function ii(e,t){return e.sectionExpansions||(e.sectionExpansions=si(e.context||"reservation")),t&&typeof e.sectionExpansions[t]!="boolean"&&(e.sectionExpansions[t]=!1),e.sectionExpansions}function Td(e,t){return ii(e,t)?.[t]!==!1}function ri(){return typeof window>"u"||typeof window.matchMedia!="function"?!1:window.matchMedia("(max-width: 768px)").matches}function Nd(){if(typeof navigator>"u")return!1;const e=navigator.userAgent||navigator.platform||"";return _d.test(e)}function jd(){if(typeof navigator>"u")return!1;const e=navigator.userAgent||"",t=co.test(e),n=e.includes("Chrome")||e.includes("CriOS")||e.includes("Chromium"),a=e.includes("Edg");return t&&!n&&!a}function lo(){return Nd()&&jd()}function Ua(){if(typeof navigator>"u")return!1;const e=navigator.userAgent||"",t=navigator.platform||"",n=Number.isFinite(navigator.maxTouchPoints)?navigator.maxTouchPoints:0,a=Ni.test(e)||Ni.test(t),s=/Macintosh/i.test(e)&&n>1;return co.test(e)&&!kd.test(e)&&(a||s)}function os(e,...t){try{console.log(`${wa} ${e}`,...t)}catch{}}function It(e,...t){try{console.warn(`${wa} ${e}`,...t)}catch{}}function Bd(e,t,...n){try{t?console.error(`${wa} ${e}`,t,...n):console.error(`${wa} ${e}`,...n)}catch{}}function Pe(e,{blockType:t="section",extraAttributes:n=""}={}){if(!e)return"";const a=n?` ${n.trim()}`:"";return e.replace(/^(<\w+)/,`$1 data-quote-block data-block-type="${t}"${a}`)}function Dd(e,t="لا توجد بيانات للعرض."){const n=w(o(e,t));return Pe(`<section class="quote-section quote-placeholder">${n}</section>`,{blockType:"placeholder"})}function Aa(e,t){return Array.isArray(e)&&e.length?e:[Dd(t)]}const Fd=/[\u0600-\u06FF\u0750-\u077F\u08A0-\u08FF]/;function uo(e=""){return Fd.test(e)}function Rd(){const e=window.CanvasRenderingContext2D?.prototype;if(!e||e.__artRatioDirectionPatched)return;const t=n=>{const a=e[n];typeof a=="function"&&(e[n]=function(r,...i){if(typeof r!="string"||!uo(r))return a.call(this,r,...i);let c,l=!1;try{"direction"in this&&(c=this.direction,c!=="rtl"&&(this.direction="rtl"),l=!0)}catch{}try{if(!l){const d=this.canvas;d&&d.style?.direction!=="rtl"&&(d.__artRatioOriginalDirection=d.style.direction,d.style.direction="rtl")}return a.call(this,r,...i)}finally{if(l&&c!==void 0&&c!=="rtl")try{this.direction=c}catch{}else if(!l){const d=this.canvas;d&&d.__artRatioOriginalDirection!==void 0&&(d.style.direction=d.__artRatioOriginalDirection,delete d.__artRatioOriginalDirection)}}})};t("fillText"),t("strokeText"),e.__artRatioDirectionPatched=!0}function ji(e,t=Tn){if(typeof e!="string"&&typeof e!="number")return t;const n=parseFloat(String(e).replace(/[^0-9.+-]/g,""));return Number.isFinite(n)&&n>0?n:t}function Md(e){if(!e)return{width:Tn,height:Tn};const t=e.getAttribute?.("width"),n=e.getAttribute?.("height");let a=t?ji(t,0):0,s=n?ji(n,0):0;if(a>0&&s>0)return{width:a,height:s};const r=e.getAttribute?.("viewBox");if(r){const i=r.trim().split(/[\s,]+/).map(c=>parseFloat(c||"0"));if(i.length>=4){const[,,c,l]=i;a=a||(Number.isFinite(c)&&c>0?c:0),s=s||(Number.isFinite(l)&&l>0?l:0)}}return{width:a||Tn,height:s||Tn}}function po(e=""){return typeof e!="string"?!1:io.test(e)||xd.test(e)}function zd(e=""){const t=e.indexOf(",");if(t===-1)return"";const n=e.slice(0,t),a=e.slice(t+1);try{return/;base64/i.test(n)?typeof atob=="function"?atob(a):"":decodeURIComponent(a)}catch(s){return console.warn("[reservations/pdf] failed to decode SVG data URI",s),""}}function Od(e,{crossOrigin:t}={}){return new Promise((n,a)=>{const s=new Image;t&&(s.crossOrigin=t),s.onload=()=>n(s),s.onerror=r=>{const i=r?.message||`Unable to load image from ${e}`;a(new Error(i))},s.src=e})}async function mo(e,t={}){if(!e)return null;const n=document,a=new Blob([e],{type:"image/svg+xml;charset=utf-8"}),s=URL.createObjectURL(a);try{const r=await Od(s),i=n.createElement("canvas"),c=Math.max(t.width||r.naturalWidth||r.width||0,1),l=Math.max(t.height||r.naturalHeight||r.height||c,1);i.width=c,i.height=l;const d=i.getContext("2d");return d.clearRect(0,0,c,l),d.drawImage(r,0,0,c,l),i.toDataURL("image/png")}catch(r){return console.warn("[reservations/pdf] failed to rasterize SVG content",r),null}finally{URL.revokeObjectURL(s)}}async function Hd(e){if(!e)return null;if(io.test(e))return zd(e);try{const t=await fetch(e,{mode:"cors",credentials:"omit",cache:"default"});return t.ok?await t.text():(console.warn("[reservations/pdf] failed to fetch SVG image",e,t.status),null)}catch(t){return console.warn("[reservations/pdf] error fetching SVG image",e,t),null}}async function Vd(e){if(!e)return!1;const t=e.getAttribute?.("src")||"";if(!po(t))return!1;const n=await Hd(t);if(!n)return e.dataset.svgRasterization="failed",e.setAttribute("src",xs),!1;const a=await mo(n);return a?(e.dataset.svgOriginalSrc=t,e.setAttribute("src",a),e.setAttribute("data-rasterized","true"),!0):(e.dataset.svgRasterization="failed",e.setAttribute("src",xs),!1)}async function Ud(e){if(!e||e.tagName?.toLowerCase()!=="svg")return!1;const n=new XMLSerializer().serializeToString(e),a=Md(e),s=await mo(n,a),i=(e.ownerDocument||document).createElement("img");i.setAttribute("src",s||xs),i.setAttribute("alt",e.getAttribute("aria-label")||e.getAttribute("title")||""),i.setAttribute("data-svg-replaced","true"),e.hasAttribute("class")&&i.setAttribute("class",e.getAttribute("class")),e.hasAttribute("style")&&i.setAttribute("style",e.getAttribute("style"));const c=e.getAttribute("width"),l=e.getAttribute("height");return c&&i.setAttribute("width",c),l&&i.setAttribute("height",l),e.parentNode?.replaceChild(i,e),!!s}async function fo(e){if(!e)return;const t=Array.from(e.querySelectorAll?.("img")||[]),n=Array.from(e.querySelectorAll?.("svg")||[]),a=[];t.forEach(s=>{po(s.getAttribute?.("src"))&&a.push(Vd(s))}),n.forEach(s=>{a.push(Ud(s))}),a.length&&await Promise.allSettled(a)}function Kd(e,{pixelRatio:t=1}={}){if(!e)return null;const n=e.ownerDocument||document,s=(n.defaultView||window).getComputedStyle?.(e);if(!s)return null;const r=(M,B=0)=>{const D=parseFloat(M);return Number.isFinite(D)?D:B},i=r(s.paddingTop),c=r(s.paddingBottom),l=r(s.paddingRight),d=r(s.paddingLeft),u=r(s.borderRadius),b=r(s.fontSize,14),y=(()=>{const M=s.lineHeight;if(!M||M==="normal")return b*1.6;const B=r(M,b*1.6);return B>0?B:b*1.6})(),p=Math.max(e.clientWidth||0,e.scrollWidth||0,r(s.width,0));if(p<=0)return null;const m=Math.max(1,p-d-l),g=e.textContent||"",h=g.split(/\r?\n/),_=n.createElement("canvas"),q=_.getContext("2d");if(!q)return null;const A=s.fontStyle||"normal",T=s.fontVariant||"normal",K=s.fontWeight||"400",S=s.fontFamily||"sans-serif",I=s.fontStretch||"normal",$=M=>M.join(" "),P=[],H=M=>q.measureText(M).width;q.font=`${A} ${T} ${K} ${I} ${b}px ${S}`,h.forEach(M=>{const B=M.trim();if(B.length===0){P.push("");return}const D=B.split(/\s+/);let O=[];D.forEach((J,re)=>{const se=J.trim();if(!se)return;const de=$(O.concat(se));if(H(de)<=m||O.length===0){O.push(se);return}P.push($(O)),O=[se]}),O.length&&P.push($(O))}),P.length||P.push("");const C=i+c+P.length*y,j=Math.ceil(Math.max(1,p)*t),W=Math.ceil(Math.max(1,C)*t);_.width=j,_.height=W,_.style.width=`${Math.max(1,p)}px`,_.style.height=`${Math.max(1,C)}px`,q.scale(t,t);const k=s.backgroundColor&&s.backgroundColor!=="rgba(0, 0, 0, 0)"?s.backgroundColor:"#ffffff";if(u>0){q.save(),q.beginPath();const M=Math.max(1,p),B=Math.max(1,C),D=Math.min(u,M/2,B/2);q.moveTo(D,0),q.lineTo(M-D,0),q.quadraticCurveTo(M,0,M,D),q.lineTo(M,B-D),q.quadraticCurveTo(M,B,M-D,B),q.lineTo(D,B),q.quadraticCurveTo(0,B,0,B-D),q.lineTo(0,D),q.quadraticCurveTo(0,0,D,0),q.closePath(),q.clip()}if(q.fillStyle=k,q.fillRect(0,0,Math.max(1,p),Math.max(1,C)),q.font=`${A} ${T} ${K} ${I} ${b}px ${S}`,q.fillStyle=s.color||"#000000",q.textBaseline="top",q.textAlign="right","direction"in q)try{q.direction="rtl"}catch{}const F=Math.max(0,p-l);let x=i;P.forEach(M=>{const B=M.length?M:" ";q.fillText(B,F,x,m),x+=y});const X=n.createElement("img");let Q;try{Q=_.toDataURL("image/png")}catch(M){return It("note canvas toDataURL failed",M),null}return X.src=Q,X.alt=g,X.style.width=`${Math.max(1,p)}px`,X.style.height=`${Math.max(1,C)}px`,X.style.display="block",X.setAttribute("data-quote-note-image","true"),{image:X,canvas:_,totalHeight:C,width:p}}function Qd(e,{pixelRatio:t=1}={}){if(!e||!Ua())return;Array.from(e.querySelectorAll?.(".quote-notes")||[]).forEach(a=>{if(!a||a.dataset.quoteNoteRasterized==="true"||!uo(a.textContent||""))return;let s;try{s=Kd(a,{pixelRatio:t})}catch(r){It("failed to rasterize note content",r),s=null}s&&(a.dataset.quoteNoteRasterized="true",a.innerHTML="",a.appendChild(s.image))})}function $s(e,t="export",{toastMessage:n,suppressToast:a=!1}={}){Bd(`${t} failed`,e);const s=!!(e&&e.__artRatioPdfNotified);if(!a&&!s){const r=o("reservations.quote.errors.exportFailed","⚠️ تعذر إنشاء ملف PDF، يرجى المحاولة مرة أخرى."),i=n||r,c=o("reservations.quote.toast.viewGuide","📘 عرض دليل الحل السريع"),l=o("reservations.quote.toast.retry","إعادة المحاولة"),d=["exportQuoteAsPdf","renderQuotePreview","layoutQuoteDocument","pageCapture"].includes(t),u=()=>{t==="exportQuoteAsPdf"?(Yt("export"),xo()):(Yt("render"),jn=!1,ln())};if(Gi({message:i,duration:9e3,actionLabel:d?l:void 0,onAction:d?u:void 0,linkLabel:c,linkHref:Gr}),Y?.modal?.classList.contains("show")&&Yt("error",{message:i,actionLabel:d?l:void 0,onAction:d?u:void 0,showSpinner:!1}),e&&typeof e=="object")try{Object.defineProperty(e,"__artRatioPdfNotified",{value:!0,writable:!1,enumerable:!1,configurable:!0})}catch{}}}function Ps({container:e,safariWindowRef:t,mobileWindowRef:n}={}){try{n&&!n.closed&&n.close()}catch(a){It("failed to close mobile window",a)}try{t&&!t.closed&&t.close()}catch(a){It("failed to close safari window",a)}e&&e.parentNode&&e.parentNode.removeChild(e)}function oi(e){return new Promise((t,n)=>{const a=document.querySelector(`script[src="${e}"]`);if(a){a.addEventListener("load",()=>t()),a.addEventListener("error",r=>n(r)),a.readyState==="complete"&&t();return}const s=document.createElement("script");s.src=e,s.async=!0,s.onload=()=>t(),s.onerror=r=>n(r),document.head.appendChild(s)})}function Bi(){const e=[window.jspdf?.jsPDF,typeof window.jspdf=="function"?window.jspdf:null,window.jsPDF?.jsPDF,typeof window.jsPDF=="function"?window.jsPDF:null].filter(t=>typeof t=="function");return e.length?e[0]:null}function Di(){return typeof window.html2canvas=="function"?window.html2canvas:null}async function Gd(){const e=Di();return e||(Cn||(Cn=oi(wd).catch(t=>{throw Cn=null,t}).then(()=>{const t=Di();if(!t)throw Cn=null,new Error("تعذر تحميل مكتبة html2canvas المطلوبة.");return t})),Cn)}async function Wd(){const e=Bi();return e||(Pn||(Pn=oi(Ad).catch(t=>{throw Pn=null,t}).then(()=>{const t=Bi();if(!t)throw Pn=null,new Error("تعذر تحميل مكتبة jsPDF المطلوبة.");return t})),Pn)}async function Xd(){if(window.html2pdf||await oi(Ed),window.html2pdf&&!window.html2pdf.__artRatioConfigured){const e=window.html2pdf.defaultOptions||window.html2pdf.defaultOpt||{},t={...e.html2canvas||{}};t.useCORS=!0,t.allowTaint=!1,t.logging=!0;const n={unit:"mm",format:"a4",orientation:"portrait",compress:!0,...e.jsPDF||{}},a={image:{type:"jpeg",quality:.95,...e.image||{}},margin:e.margin??[0,0,0,0],filename:e.filename||"document.pdf",html2canvas:t,jsPDF:n};window.html2pdf.defaultOptions=a,window.html2pdf.defaultOpt=a,window.html2pdf.__artRatioConfigured=!0}yd(),Rd()}function w(e=""){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Jd(e="reservation"){return e==="project"?"QP":"Q"}function Yd(e,t="reservation"){const n=Number(e),a=Jd(t);return!Number.isFinite(n)||n<=0?`${a}-0001`:`${a}-${String(n).padStart(4,"0")}`}function Zd(){const e=window.localStorage?.getItem?.(Qr),t=parseInt(e??"",10);return Number.isFinite(t)&&t>0?t:0}function yo(e="reservation"){const n=Zd()+1;return{sequence:n,quoteNumber:Yd(n,e)}}function eu(e){try{const t=Number(e);if(!Number.isFinite(t)||t<=0)return;window.localStorage?.setItem?.(Qr,String(t))}catch(t){console.warn("⚠️ [reservations/pdf] failed to persist quote sequence",t)}}function bo(e="reservation"){return Ti[e]||Ti.reservation}function tu(e="reservation"){try{const t=bo(e),n=window.localStorage?.getItem?.(t);if(!n)return null;const a=JSON.parse(n);return a&&typeof a=="object"?a:null}catch(t){return console.warn("⚠️ [reservations/pdf] failed to read toggle preferences",t),null}}function nu(e,t="reservation"){try{const n=bo(t);if(!e){window.localStorage?.removeItem?.(n);return}window.localStorage?.setItem?.(n,JSON.stringify(e))}catch(n){console.warn("⚠️ [reservations/pdf] failed to persist toggle preferences",n)}}function au(e){if(!e)return{ids:null,emptyExplicitly:!1};if(e instanceof Set)return{ids:Array.from(e),emptyExplicitly:e.size===0};if(Array.isArray(e))return{ids:e.slice(),emptyExplicitly:e.length===0};if(typeof e=="object"){const t=Object.entries(e).filter(([,n])=>!!n);return{ids:t.map(([n])=>n),emptyExplicitly:t.length===0}}return{ids:null,emptyExplicitly:!1}}function su(e,t="reservation"){if(!e)return null;const n=to(t),a=no(t),s=Array.from(e.sections instanceof Set?e.sections:new Set(e.sections||[])).filter(c=>n.has(c)),r={},i=e.fields||{};return Object.entries(a).forEach(([c,l])=>{const d=i[c];if(d==null)return;const{ids:u,emptyExplicitly:b}=au(d);if(!u&&!b)return;const y=Array.isArray(u)?u.filter(p=>l.has(p)):[];(y.length>0||b)&&(r[c]=y)}),{version:1,sections:s,fields:r}}function go(e){if(!e)return;const t=e.context||"reservation",n=su(e,t);n&&nu(n,t)}function ho(e){if(!e)return;const t=e.context||"reservation",n=tu(t);if(!n)return;const a=to(t),s=Array.isArray(n.sections)?n.sections.filter(r=>a.has(r)):[];if(s.length&&(e.sections=new Set(s)),n.fields&&typeof n.fields=="object"){const r=ni(e.fields||Va(t)),i=no(t);Object.entries(n.fields).forEach(([c,l])=>{const d=i[c];if(!d)return;const u=Array.isArray(l)?l.filter(b=>d.has(b)):[];r[c]=new Set(u)}),e.fields=r}}function vo(e=new Date){try{return e.toLocaleDateString("en-GB",{year:"numeric",month:"2-digit",day:"2-digit"})}catch{return e.toISOString().slice(0,10)}}function iu(e){const t=bn()||[],{technicians:n=[]}=he(),a=[].concat(Array.isArray(t)?t:[]).concat(Array.isArray(n)?n:[]),s=new Map;return a.forEach(i=>{if(!i||i.id==null)return;const c=String(i.id),l=s.get(c)||{};s.set(c,{...l,...i})}),(Array.isArray(e.crewAssignments)&&e.crewAssignments.length?e.crewAssignments:Array.isArray(e.techniciansDetails)&&e.techniciansDetails.length?e.techniciansDetails:(e.technicians||[]).map(i=>({technicianId:i}))).map((i,c)=>{const l=i?.technicianId!=null?s.get(String(i.technicianId)):null;let d=i.positionLabel??i.position_name??i.position_label??i.role??i.position??l?.role??o("reservations.crew.positionFallback","منصب بدون اسم");(!d||d.trim()==="")&&(d=i.positionLabelAr??i.position_label_ar??i.positionLabelEn??i.position_label_en??i.position_name_ar??i.position_name_en??l?.role??o("reservations.crew.positionFallback","منصب بدون اسم"));try{const y=typeof Tt=="function"?Tt()||[]:[];let p=null;if(i?.positionId!=null&&(p=y.find(m=>String(m?.id)===String(i.positionId))||null),!p){const m=i.positionKey??i.position_key??i.positionName??i.position_name??i.position??"";if(m&&(p=typeof ua=="function"&&ua(m)||null,!p&&y.length)){const g=String(m).trim().toLowerCase();p=y.find(h=>[h.name,h.labelAr,h.labelEn].filter(Boolean).map(_=>String(_).toLowerCase()).includes(g))||null}}if(p){const m=p.labelAr||p.labelEn||p.name||"";m&&m.trim()&&(d=m)}}catch{}const u=Se(je(i.positionCost??i.position_cost??i.cost??i.daily_wage??i.dailyWage??l?.dailyWage??l?.wage??0)),b=Se(je(i.positionClientPrice??i.position_client_price??i.client_price??i.clientPrice??i.daily_total??i.dailyTotal??i.total??l?.dailyTotal??l?.total??l?.total_wage??0));return{assignmentId:i.assignmentId??i.assignment_id??`crew-${c}`,positionId:i.positionId??i.position_id??null,positionLabel:d,positionLabelAlt:i.positionLabelAlt??i.position_label_alt??"",positionCost:u,positionClientPrice:b,technicianId:i.technicianId!=null?String(i.technicianId):l?.id!=null?String(l.id):null,technicianName:i.technicianName??i.technician_name??l?.name??null,technicianRole:i.technicianRole??l?.role??null}})}function ru(e,t,n){const{projectLinked:a}=Mt(e,n);Ta(e.start,e.end);const s=e.discount??e.discountValue??0,r=Number(v(String(s)))||0,i=e.discountType??e.discount_type??"percent",c=String(i).toLowerCase()==="amount"?"amount":"percent",l=a?!1:!!(e.applyTax??e.apply_tax??e.taxApplied),d=e.companySharePercent??e.company_share_percent??e.companyShare??e.company_share??null,u=d!=null?je(d):Number.NaN,y=(e.companyShareEnabled??e.company_share_enabled??e.companyShareApplied??e.company_share_applied)===!0&&Number.isFinite(u)&&u>0?u:null,p=Array.isArray(t)?t.map(T=>T?.technicianId).filter(Boolean):[],m=ir({items:Array.isArray(e.items)?e.items:[],technicianIds:p,crewAssignments:Array.isArray(t)?t:[],discount:r,discountType:c,applyTax:l,start:e.start,end:e.end,companySharePercent:y}),g=je(e.cost??e.total??e.finalTotal),h=Number.isFinite(g),_=a?m.finalTotal:h?Se(g):m.finalTotal,q={equipmentTotal:m.equipmentTotal,crewTotal:m.crewTotal,crewCostTotal:m.crewCostTotal,discountAmount:m.discountAmount,subtotalAfterDiscount:m.subtotalAfterDiscount,taxableAmount:m.taxableAmount,taxAmount:m.taxAmount,finalTotal:_,companySharePercent:m.companySharePercent,companyShareAmount:m.companyShareAmount,netProfit:m.netProfit},A={equipmentTotal:v(m.equipmentTotal.toFixed(2)),crewTotal:v(m.crewTotal.toFixed(2)),discountAmount:v(m.discountAmount.toFixed(2)),subtotalAfterDiscount:v(m.subtotalAfterDiscount.toFixed(2)),taxableAmount:v(m.taxableAmount.toFixed(2)),taxAmount:v(m.taxAmount.toFixed(2)),finalTotal:v(_.toFixed(2)),companySharePercent:v((Number.isFinite(m.companySharePercent)?m.companySharePercent:0).toFixed(2)),companyShareAmount:v(m.companyShareAmount.toFixed(2)),netProfit:v(m.netProfit.toFixed(2))};return{totals:q,totalsDisplay:A,rentalDays:m.rentalDays}}function qn(e){if(e==null||e==="")return null;const t=Number.parseFloat(v(String(e)));return Number.isFinite(t)?t:null}function qo(e){if(!e)return new Date().toISOString();const t=new Date(e);return Number.isNaN(t.getTime())?new Date().toISOString():t.toISOString()}function ou(e){if(!e||typeof e!="object")return null;const t=e.type??e.payment_type??e.paymentType??null;let n=typeof t=="string"?t.trim().toLowerCase():null;n!=="percent"&&(n="amount");const a=qn(e.amount??(n==="amount"?e.value:null)),s=qn(e.percentage??(n==="percent"?e.value:null)),r=n==="percent"?s??null:a??null,i=e.note??e.memo??null,c=qo(e.recordedAt??e.recorded_at??e.date??e.created_at??null);return n==="amount"&&a==null||n==="percent"&&s==null?null:{type:n,amount:a??null,percentage:s??null,value:r,note:i,recordedAt:c}}function cu(e={}){const n=(Array.isArray(e.paymentHistory)?e.paymentHistory:Array.isArray(e.payment_history)?e.payment_history:[]).map(ou).filter(Boolean);if(n.length>0)return n;const a=qn(e.paidPercent??e.paid_percent),s=qn(e.paidAmount??e.paid_amount),r=e.updatedAt??e.updated_at??e.createdAt??e.created_at??null,i=qo(r);return a!=null&&a>0?[{type:"percent",amount:s!=null&&s>0?s:null,percentage:a,value:a,note:null,recordedAt:i}]:s!=null&&s>0?[{type:"amount",amount:s,percentage:null,value:s,note:null,recordedAt:i}]:[]}function lu(e){if(!e)return o("projects.form.types.unknown","نوع غير محدد");const t={commercial:"projects.form.types.commercial",coverage:"projects.form.types.coverage",photography:"projects.form.types.photography",social:"projects.form.types.social"}[e]||"projects.form.types.unknown";return o(t,e)}function du(e){const t=new Date,n=e?.start?new Date(e.start):null,a=e?.end?new Date(e.end):null;return n&&!Number.isNaN(n.getTime())&&n>t?"upcoming":a&&!Number.isNaN(a.getTime())&&a<t?"completed":"ongoing"}function uu(e){return typeof e?.expensesTotal=="number"?e.expensesTotal:Array.isArray(e?.expenses)?e.expenses.reduce((t,n)=>t+(Number(n?.amount)||0),0):0}function pu(e){const t=Number(e?.equipmentEstimate)||0,n=uu(e),a=t+n,s=e?.applyTax===!0||e?.applyTax==="true",r=Number.parseFloat(e?.discount??e?.discountValue??0)||0;let c=(e?.discountType==="amount"?"amount":"percent")==="amount"?r:a*(r/100);(!Number.isFinite(c)||c<0)&&(c=0),c>a&&(c=a);const l=Math.max(0,a-c),d=e?.companyShareEnabled===!0||e?.companyShareEnabled==="true"||e?.company_share_enabled===!0||e?.company_share_enabled==="true",u=Number.parseFloat(e?.companySharePercent??e?.company_share_percent??e?.companyShare??e?.company_share??0)||0,b=d&&s&&u>0?u:0,y=b>0?Number((l*(b/100)).toFixed(2)):0,p=l+y;let m=s?p*Or:0;(!Number.isFinite(m)||m<0)&&(m=0),m=Number(m.toFixed(2));let g=s?Number(e?.totalWithTax):p;return s?(!Number.isFinite(g)||g<=0)&&(g=Number((p+m).toFixed(2))):g=p,{equipmentEstimate:t,expensesTotal:n,baseSubtotal:a,discountAmount:c,subtotalAfterDiscount:l,companyShareAmount:y,subtotal:p,applyTax:s,taxAmount:m,totalWithTax:g}}function mu(e){if(!e)return 0;const t=Array.isArray(e.items)?e.items:[],n=e.discount??0,a=Number(v(String(n)))||0,s=e.discountType||"percent",r=Array.isArray(e.crewAssignments)?e.crewAssignments:[],i=r.length?r:Array.isArray(e.technicians)?e.technicians:[],c=Ms(t,a,s,!1,i,{start:e.start,end:e.end});if(Number.isFinite(c))return c;const l=Number(v(String(e.cost??0)));return Number.isFinite(l)?Math.round(l):0}function fu(e,t){if(!e)return"—";const n=Ze(e);return t?`${n} - ${Ze(t)}`:n}function le(e,t="SR",n=2){const a=Number(e)||0,s=Number.isInteger(n)?n:2;return`${v(a.toFixed(s))} ${t}`}function Fi(e,t=2){if(!Number.isFinite(Number(e)))return"0%";const n=Number.isInteger(t)?t:2;return`${v(Number(e).toFixed(n))}%`}function yu(e){if(!e?.start)return null;if(!e?.end)return 1;const t=Ta(e.start,e.end);return Number.isFinite(t)?t:1}function bu(e){return Number.isFinite(e)?e<=1?"يوم واحد":`${v(String(Math.round(e)))} أيام`:"غير محدد"}function gu(e){const t=o("reservations.create.summary.currency","SR"),{customers:n=[],reservations:a=[],projects:s=[],technicians:r=[]}=he(),i=e?.id!=null?s.find(L=>String(L.id)===String(e.id))||e:e||null,c={projectStatusLabel:o("projects.status.ongoing","قيد التنفيذ"),paymentStatusLabel:o("projects.paymentStatus.unpaid","غير مدفوع")};if(!i)return{project:null,customer:null,clientInfo:{name:"-",company:"-",phone:"-",email:"-"},projectInfo:{title:"-",code:"-",typeLabel:"-",startDisplay:"-",endDisplay:"-",durationLabel:"-",statusLabel:c.projectStatusLabel},expenses:[],equipment:[],reservations:[],totals:{equipmentEstimate:0,expensesTotal:0,baseSubtotal:0,discountAmount:0,subtotalAfterDiscount:0,companyShareAmount:0,subtotal:0,applyTax:!1,taxAmount:0,totalWithTax:0},totalsDisplay:{projectSubtotal:le(0,t),expensesTotal:le(0,t),reservationsTotal:le(0,t),discountAmount:le(0,t),taxAmount:le(0,t),overallTotal:le(0,t),paidAmount:le(0,t),remainingAmount:le(0,t)},projectTotals:{combinedTaxAmount:0,overallTotal:0,reservationsTotal:0,paidAmount:0,paidPercent:0,remainingAmount:0,paymentStatus:"unpaid"},paymentSummary:{status:"unpaid",statusLabel:c.paymentStatusLabel,paidAmount:0,paidPercent:0,remainingAmount:0,paidAmountDisplay:le(0,t),remainingAmountDisplay:le(0,t),paidPercentDisplay:Fi(0)},notes:"",currencyLabel:t,projectStatus:"ongoing",projectStatusLabel:c.projectStatusLabel,projectDurationDays:null,projectDurationLabel:"غير محدد",paymentHistory:[]};const l=i.clientId??i.customerId??i.client_id??i.customer_id??null,d=l!=null&&n.find(L=>String(L.id)===String(l))||null,u=d?.customerName??d?.name??i.clientName??i.customerName??o("projects.fallback.unknownClient","عميل غير معروف"),b=(i.clientCompany||d?.companyName||d?.company||"").trim(),y=d?.phone??d?.customerPhone??i.clientPhone??i.customerPhone??"",p=y?v(String(y).trim()):o("projects.details.client.noPhone","لا يوجد رقم متاح"),m=d?.email??i.clientEmail??i.customerEmail??"",g=m?String(m).trim():o("projects.details.client.noEmail","لا يوجد بريد متاح"),h=i.projectCode||`PRJ-${v(String(i.id??""))}`,_=v(String(h)),q=(i.title||"").trim()||o("projects.fallback.untitled","مشروع بدون عنوان"),A=lu(i.type),T=i.start?Ze(i.start):"—",K=i.end?Ze(i.end):"—",S=yu(i),I=S!=null?bu(S):"غير محدد",$=du(i),P={upcoming:"قادم",ongoing:"قيد التنفيذ",completed:"مكتمل"},H=o(`projects.status.${$}`,P[$]||$),C=i.id!=null?String(i.id):null,j=C?a.filter(L=>String(L.projectId)===C):[],k=j.map(L=>{const ce=L.reservationId||L.id||"",te=L.status||L.state||"pending",qe=String(te).toLowerCase(),be=o(`reservations.status.${qe}`,qe),Xe=mu(L),ct=L.start?new Date(L.start).getTime():0;return{reservationId:v(String(ce||"-")),status:qe,statusLabel:be,total:Xe,totalLabel:le(Xe,t),dateRange:fu(L.start,L.end),startTimestamp:Number.isNaN(ct)?0:ct}}).sort((L,ce)=>ce.startTimestamp-L.startTimestamp).map(({startTimestamp:L,...ce})=>ce).reduce((L,ce)=>L+(Number(ce.total)||0),0),F=new Map;j.forEach(L=>{const ce=Array.isArray(L.items)?L.items:[],te=Ta(L.start,L.end),qe=L.reservationId||L.id||"";ce.forEach((be,Xe)=>{if(!be)return;const ct=be.barcode||be.code||be.id||be.desc||be.description||`item-${Xe}`,Ke=String(ct||`item-${Xe}`),lt=F.get(Ke)||{description:be.desc||be.description||be.name||be.barcode||`#${v(String(Xe+1))}`,totalQuantity:0,reservationsCount:0,reservationIds:new Set,totalCost:0},$t=Number(be.qty)||1,_n=Number(be.price)||0;lt.totalQuantity+=$t,lt.reservationIds.add(String(qe));const He=_n*$t*Math.max(1,te);Number.isFinite(He)&&(lt.totalCost+=He),F.set(Ke,lt)})});const x=Array.from(F.values()).map(L=>({description:L.description,totalQuantity:L.totalQuantity,reservationsCount:L.reservationIds.size,displayCost:le(L.totalCost,t)})),X=new Map((r||[]).filter(Boolean).map(L=>[String(L.id),L])),Q=new Map,M=L=>{if(!L)return;let ce=null;typeof L=="object"?ce=L.id??L.technicianId??L.technician_id??L.userId??L.user_id??null:(typeof L=="string"||typeof L=="number")&&(ce=L);const te=ce!=null?String(ce):null,qe=te&&X.has(te)?X.get(te):typeof L=="object"?L:null,be=qe?.name||qe?.full_name||qe?.fullName||qe?.displayName||(typeof L=="string"?L:null),Xe=qe?.role||qe?.title||null,ct=qe?.phone||qe?.mobile||qe?.contact||null;if(!be&&!te)return;const Ke=te||be;Q.has(Ke)||Q.set(Ke,{id:te,name:be||"-",role:Xe||null,phone:ct||null})};Array.isArray(i?.technicians)&&i.technicians.forEach(L=>M(L)),j.forEach(L=>{(Array.isArray(L.crewAssignments)&&L.crewAssignments.length?L.crewAssignments:Array.isArray(L.technicians)?L.technicians.map(te=>({technicianId:te})):[]).forEach(te=>M(te))});const B=Array.from(Q.values()),D=Array.isArray(i.expenses)?i.expenses.map(L=>{const ce=Number(L?.amount)||0;return{label:L?.label||L?.name||"-",amount:ce,displayAmount:le(ce,t),note:L?.note||L?.description||""}}):[],O=pu(i),J=O.applyTax?Number(((O.subtotal+k)*Or).toFixed(2)):0,re=Number((O.subtotal+k+J).toFixed(2)),se=cu(i),de=qn(i.paidAmount??i.paid_amount)||0,V=qn(i.paidPercent??i.paid_percent)||0,oe=zs({totalAmount:re,paidAmount:de,paidPercent:V,history:se}),we=typeof i.paymentStatus=="string"?i.paymentStatus.toLowerCase():"",Ee=Os({manualStatus:we,paidAmount:oe.paidAmount,paidPercent:oe.paidPercent,totalAmount:re}),Ce={paid:"مدفوع",partial:"مدفوع جزئياً",unpaid:"غير مدفوع"},G=o(`projects.paymentStatus.${Ee}`,Ce[Ee]||Ee),ee=Number(oe.paidAmount||0),ue=Number(oe.paidPercent||0),_e=Math.max(0,Number((re-ee).toFixed(2))),Fe={projectSubtotal:le(O.subtotal,t),expensesTotal:le(O.expensesTotal,t),reservationsTotal:le(k,t),discountAmount:le(O.discountAmount,t),taxAmount:le(J,t),overallTotal:le(re,t),paidAmount:le(ee,t),remainingAmount:le(_e,t)},pe={status:Ee,statusLabel:G,paidAmount:ee,paidPercent:ue,remainingAmount:_e,paidAmountDisplay:le(ee,t),remainingAmountDisplay:le(_e,t),paidPercentDisplay:Fi(ue)},U=(i.description||"").trim();return{project:i,customer:d,clientInfo:{name:u,company:b||"—",phone:p,email:g},projectInfo:{title:q,code:_,typeLabel:A,startDisplay:T,endDisplay:K,durationLabel:I,statusLabel:H},expenses:D,equipment:x,crew:B,totals:O,totalsDisplay:Fe,projectTotals:{combinedTaxAmount:J,overallTotal:re,reservationsTotal:k,paidAmount:ee,paidPercent:ue,remainingAmount:_e,paymentStatus:Ee},paymentSummary:pe,notes:U,currencyLabel:t,projectStatus:$,projectStatusLabel:H,projectDurationDays:S,projectDurationLabel:I,paymentHistory:se}}function hu({project:e,clientInfo:t={},projectInfo:n={},projectCrew:a=[],projectExpenses:s=[],projectEquipment:r=[],totalsDisplay:i={},projectTotals:c={},paymentSummary:l={},currencyLabel:d="SR",sections:u,fieldSelections:b={},quoteNumber:y,quoteDate:p,terms:m=We}){const g=ni(b),h=(G,ee)=>ai(g,G,ee),_=G=>u?.has?.(G),q=`<div class="quote-placeholder">${w(o("reservations.quote.placeholder.noFields","لم يتم اختيار أي معلومات للعرض في هذا القسم."))}</div>`,A=(G,ee)=>`<div class="info-plain__item">
  ...
  `}function So(e){if(e?.context==="project")return hu(e);const{reservation:t,customer:n,project:a,crewAssignments:s,totals:r,totalsDisplay:i,rentalDays:c,currencyLabel:l,sections:d,fieldSelections:u={},quoteNumber:b,quoteDate:y,terms:p=We}=e,m=v(String(t?.reservationId??t?.id??"")),g=t.start?v(Ze(t.start)):"-",h=t.end?v(Ze(t.end)):"-",_=n?.customerName||n?.full_name||n?.name||"-",q=n?.phone||"-",A=n?.email||"-",T=n?.company||n?.company_name||"-",K=v(q),S=a?.title||a?.name||o("reservations.details.project.none","غير مرتبط بمشروع"),I=a?.code||a?.projectCode||"",$=v(String(c)),P=t?.notes||"",H=Array.isArray(p)&&p.length?p:We,C=ni(u),j=(z,Le)=>ai(C,z,Le),W=z=>d?.has?.(z),k=`<div class="quote-placeholder">${w(o("reservations.quote.placeholder.noFields","لم يتم اختيار أي معلومات للعرض في هذا القسم."))}</div>`,F=(z,Le)=>`<div class="info-plain__item">${w(z)} <span class="info-plain__slash">/</span> <strong class="info-plain__value">${w(Le)}</strong></div>`,x=(z,Le,{variant:dt="inline"}={})=>dt==="final"?`<div class="totals-item totals-item--final">
      ...
      </footer>`,Ke=[];M&&D?Ke.push(Pe(`<div class="quote-section-row">${M}${D}</div>`,{blockType:"group"})):(D&&Ke.push(Pe(D)),M&&Ke.push(Pe(M))),J&&Ke.push(Pe(J));const lt=[];Fe&&lt.push(Pe(Fe,{blockType:"table",extraAttributes:'data-table-id="items"'})),te&&lt.push(Pe(te,{blockType:"table",extraAttributes:'data-table-id="crew"'}));const $t=[];oe&&$t.push(Pe(oe,{blockType:"summary"})),qe&&$t.push(Pe(qe));const _n=[Pe(Xe,{blockType:"payment"}),Pe(ct,{blockType:"footer"})],He=[...Aa(Ke,"reservations.quote.placeholder.page1"),...lt,...Aa($t,"reservations.quote.placeholder.page2"),..._n],Wa=`
    <header class="quote-header" data-quote-header-template>
      <div class="quote-header__logo">
        <img class="quote-logo" src="${w(De.logoUrl)}" alt="${w(De.companyName)}" crossorigin="anonymous"/>
      </div>
...
`);Y.termsInput.value!==e&&(Y.termsInput.value=e)}function _u(e){if(!N)return;const t=ws(e?.target?.value??"");if(t.length){N.terms=t;const n=document.getElementById("reservation-terms");n&&(n.value=e.target.value);const a=document.getElementById("edit-res-terms");a&&(a.value=e.target.value)}else{N.terms=[...We],li();const n=We.join(`
