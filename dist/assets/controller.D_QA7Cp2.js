...
.totals-inline__item {
  ...
  justify-content: center;
  gap: 3px;
  padding: 6px 12px; /* رفع المحتوى بإضافة حشوة رأسية */
  border-radius: 9px;
  background: #f8fafc;
  border: 1px solid rgba(148, 163, 184, 0.3);
  white-space: nowrap;
...
.totals-item--final {
  ...
  padding: 10px 16px; /* رفع المحتوى وإتاحة مساحة رأسية متوازنة */
  min-width: 200px;
  display: inline-flex;
  align-items: center;
  justify-content: center;
...
/* نَقلة طفيفة إلى أعلى داخل جذور PDF لفقاعات الإجماليات كي لا تلتصق بأسفل الخلفية */
