import{r as _,t as s,h as T,f as L,d as C,p as q}from"./calculations.Cn-QUPk9.js";import{e as H,l as A,a as X,b as B}from"./reports.D6lObPVM.js";import"./reservationsService.CALbne_H.js";import"./auth.5z46nnko.js";import"./state.BVtSUgLA.js";import"./preload-helper.PPVm8Dsz.js";import"./maintenanceService.Boj2nwnb.js";import"./canvasColorUtils.CviLtv6S.js";const G=`@page { size: A4; margin: 0; }
...
`)],{type:"text/csv;charset=utf-8"}),f=URL.createObjectURL(b),r=document.createElement("a");r.href=f,r.download=`${s("reservations.reports.export.filePrefix","تقرير-الحجوزات","reservations-report")}.csv`,r.style.display="none",document.body.appendChild(r),r.click(),setTimeout(()=>{URL.revokeObjectURL(f),r.remove()},1500)}}const oe="https://art-ratio.sirv.com/AR-Logo-v3.5-curved.png";function M(){try{const t=localStorage.getItem("reportsPdf.logoUrl");if(t&&/^https?:|^data:|^blob:/.test(t))return t}catch{}return oe}export{O as buildA4ReportPages,ge as exportA4ReportCsv,fe as exportA4ReportExcel,ue as exportA4ReportPdf};
