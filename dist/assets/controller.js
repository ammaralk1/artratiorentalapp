...
`,Gt="reservations.quote.sequence",J={logoUrl:"https://art-ratio.sirv.com/AR%20Logo%20v3.5%20curved.png",companyName:"شركة فود آرت للدعاية والإعلان (شركة شخص واحد)",commercialRegistry:"4030485240",beneficiaryName:"شركة فود آرت للدعاية والإعلان (شركة شخص واحد)",bankName:"مصرف الراجحي",accountNumber:"٣٥٨٠٠٠٠١٠٠٠٦٠٨٦٠٦٥٧٠٦",iban:"SA1680000358608016065706",approvalNote:"الموافقة على هذا العرض تعتبر موافقة على جميع الشروط والأحكام."},Gs=["يوم العمل هو 12 ساعة، ويتم احتساب نصف يوم إضافي بعد 20 ساعة، ثم يوم كامل بعد ذلك.","يمنع استخدام المعدات في أنشطة غير قانونية.","يتحمل المستأجر مسؤولية أي تلف أو فقدان.","يجب إعادة المعدات في حالتها الأصلية.","يتم فرض رسوم على الإلغاء إذا لم يتم الإبلاغ قبل 24 ساعة."],Kt=[{id:"customerInfo",labelKey:"reservations.quote.sections.customer",fallback:"بيانات العميل",defaultSelected:!0},{id:"reservationInfo",labelKey:"reservations.quote.sections.reservation",fallback:"تفاصيل الحجز",defaultSelected:!0},{id:"projectInfo",labelKey:"reservations.quote.sections.project",fallback:"بيانات المشروع",defaultSelected:!0},{id:"financialSummary",labelKey:"reservations.quote.sections.financial",fallback:"الملخص المالي",defaultSelected:!0},{id:"items",labelKey:"reservations.quote.sections.items",fallback:"قائمة المعدات",defaultSelected:!0},{id:"crew",labelKey:"reservations.quote.sections.crew",fallback:"طاقم العمل",defaultSelected:!0},{id:"notes",labelKey:"reservations.quote.sections.notes",fallback:"ملاحظات الحجز",defaultSelected:!0}],Ks="https://cdn.jsdelivr.net/npm/html2pdf.js@0.10.1/dist/html2pdf.bundle.min.js",Xs=Ys.trim(),Zs=/color\([^)]*\)/gi,Xt=96,Zt=25.4,Js=210,ea=297,Et=Math.round(Js/Zt*Xt),It=Math.round(ea/Zt*Xt);let U=null,C=null,ve=1;function Re(e){if(!e)return;const t=(n="")=>typeof n=="string"&&n.includes("color(")?n.replace(Zs,"#000"):n;e.querySelectorAll?.("style")?.forEach?.(n=>{const s=n.textContent;typeof s=="string"&&s.includes("color(")&&(n.textContent=t(s))}),e.querySelectorAll?.("[style]")?.forEach?.(n=>{const s=n.getAttribute("style");typeof s=="string"&&s.includes("color(")&&n.setAttribute("style",t(s))})}function ta(e){e&&(Re(e),Re(e?.documentElement),Re(e?.body))}function na(e){return new Promise((t,n)=>{const s=document.querySelector(`script[src="${e}"]`);if(s){s.addEventListener("load",()=>t()),s.addEventListener("error",r=>n(r)),s.readyState==="complete"&&t();return}const i=document.createElement("script");i.src=e,i.async=!0,i.onload=()=>t(),i.onerror=r=>n(r),document.head.appendChild(i)})}async function sa(){window.html2pdf||await na(Ks)}function b(e=""){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function aa(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"Q-0001":`Q-${String(t).padStart(4,"0")}`}function ra(){const e=window.localStorage?.getItem?.(Gt),t=parseInt(e??"",10);return Number.isFinite(t)&&t>0?t:0}function ia(){const t=ra()+1;return{sequence:t,quoteNumber:aa(t)}}function oa(e){try{const t=Number(e);if(!Number.isFinite(t)||t<=0)return;window.localStorage?.setItem?.(Gt,String(t))}catch(t){console.warn("⚠️ [reservations/pdf] failed to persist quote sequence",t)}}function ca(e=new Date){try{return e.toLocaleDateString("en-GB",{year:"numeric",month:"2-digit",day:"2-digit"})}catch{return e.toISOString().slice(0,10)}}function la(e={}){const t=[e.dailyWage,e.daily_rate,e.dailyRate,e.wage,e.rate];for(const n of t){if(n==null)continue;const s=parseFloat(v(String(n)));if(Number.isFinite(s))return s}return 0}function da(e){const t=He()||[],{technicians:n=[]}=V(),s=[].concat(Array.isArray(t)?t:[]).concat(Array.isArray(n)?n:[]),i=new Map;return s.forEach(r=>{if(!r||r.id==null)return;const o=String(r.id),c=i.get(o)||{};i.set(o,{...c,...r})}),(e.technicians||[]).map(r=>i.get(String(r))).filter(Boolean)}function ua(e,t,n){const{projectLinked:s}=ce(e,n),i=Mt(e.start,e.end),c=(Array.isArray(e.items)?e.items:[]).reduce((R,x)=>R+(Number(x?.qty)||1)*(Number(x?.price)||0),0)*i,m=t.reduce((R,x)=>R+la(x),0)*i,d=c+m,h=parseFloat(e.discount)||0,q=e.discountType==="amount"?h:d*(h/100),u=Math.max(0,d-q),g=(s?!1:e.applyTax)?u*.15:0,y=Number(e.cost),p=Number.isFinite(y),f=u+g,A=s?Math.round(f):p?y:Math.round(f),k={equipmentTotal:c,crewTotal:m,discountAmount:q,taxAmount:g,finalTotal:A??0},$={equipmentTotal:v(c.toFixed(2)),crewTotal:v(m.toFixed(2)),discountAmount:v(q.toFixed(2)),taxAmount:v(g.toFixed(2)),finalTotal:v((A??0).toFixed(2))};return{totals:k,totalsDisplay:$,rentalDays:i}}function Jt({reservation:e,customer:t,project:n,technicians:s,totalsDisplay:i,rentalDays:r,currencyLabel:o,sections:c,quoteNumber:l,quoteDate:m}){const d=v(String(e?.reservationId??e?.id??"")),h=e.start?v(fe(e.start)):"-",q=e.end?v(fe(e.end)):"-",u=t?.customerName||t?.full_name||t?.name||"-",S=t?.phone||"-",g=t?.email||"-",y=t?.company||t?.company_name||"-",p=v(S),f=n?.title||n?.name||a("reservations.details.project.none","غير مرتبط بمشروع"),A=n?.code||n?.projectCode||"",k=v(String(r)),$=e?.notes||"",R=s.length?s.map((B,Z)=>{const ne=v(String(Z+1)),de=b(B?.name||B?.full_name||"-"),F=b(B?.role||a("reservations.details.technicians.roleUnknown","غير محدد")),ue=b(B?.phone||a("reservations.details.technicians.phoneUnknown","غير متوفر"));return`<tr>
          <td>${ne}</td>
          <td>${de}</td>
          <td>${F}</td>
          <td>${ue}</td>
