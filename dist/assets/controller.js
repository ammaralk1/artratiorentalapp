...
`)}function vr(e,{existingItems:t=[],start:n,end:a,ignoreReservationId:s=null}={}){const r=wn(e);if(!r)return{success:!1,reason:"invalid",message:o("reservations.toast.packageInvalid","⚠️ يرجى اختيار حزمة صالحة أولاً")};const i=bl(r);if(!i)return{success:!1,reason:"not_found",message:o("reservations.toast.packageNotFound","⚠️ تعذر العثور على بيانات الحزمة المحددة")};if(!n||!a)return{success:!1,reason:"missing_dates",message:o("reservations.toast.requireDatesBeforeAdd","⚠️ يرجى تحديد تاريخ ووقت البداية والنهاية قبل إضافة المعدات")};if(t.some(m=>m?.type==="package"&&wn(m.packageId)===r))return{success:!1,reason:"duplicate",message:o("reservations.toast.packageDuplicate","⚠️ هذه الحزمة مضافة بالفعل إلى الحجز")};if(yc(r,n,a,s)){const m=i.name||r;return{success:!1,reason:"package_conflict",message:o("reservations.toast.packageTimeConflict",`⚠️ الحزمة ${m} محجوزة بالفعل في الفترة المختارة`)}}const c=Array.isArray(i.items)&&i.items.length?i.items:As(i.raw??{}),l=Hs(t),d=[],u=new Set;if(c.forEach(m=>{const p=ee(m?.normalizedBarcode??m?.barcode);if(p){if(u.has(p)){d.push({item:m,type:"internal"});return}u.add(p),l.has(p)&&d.push({item:m,type:"external"})}}),d.length){const m=d.map(({item:b})=>b?.desc||b?.description||b?.name||b?.barcode||b?.normalizedBarcode||o("equipment.packages.items.unknown","معدة بدون اسم")).map(b=>h(String(b))).join(", ");return{success:!1,reason:"package_duplicate_equipment",message:d.some(b=>b.type==="external")?o("reservations.toast.packageDuplicateEquipmentExternal","⚠️ لا يمكن إضافة الحزمة لأن العناصر التالية موجودة مسبقاً في الحجز: {items}").replace("{items}",m):o("reservations.toast.packageDuplicateEquipmentInternal","⚠️ بيانات الحزمة تحتوي على عناصر مكررة: {items}").replace("{items}",m),duplicates:d}}const y=[];return c.forEach(m=>{const p=ee(m?.normalizedBarcode??m?.barcode);if(p&&ct(p,n,a,s)){const b=ws(p,n,a,s);y.push({item:m,blockingPackages:b})}}),y.length?{success:!1,reason:"item_conflict",message:Il(i,y),conflicts:y}:{success:!0,package:{id:`package::${r}`,packageId:r,type:"package",desc:i.name||`Package ${r}`,qty:1,price:Number.isFinite(Number(i.price))?Number(i.price):0,barcode:i.code||i.raw?.package_code||`pkg-${r}`,packageItems:c.map(m=>({equipmentId:m?.equipmentId??null,barcode:m?.barcode??m?.normalizedBarcode??"",normalizedBarcode:ee(m?.normalizedBarcode??m?.barcode),desc:m?.desc??"",qty:Number.isFinite(Number(m?.qty))?Number(m.qty):1,price:Number.isFinite(Number(m?.price))?Number(m.price):0})),image:c.find(m=>m?.image)?.image??null},packageInfo:i}}function qr(e,{silent:t=!1}={}){const n=wn(e);if(!n)return t||x(o("reservations.toast.packageInvalid","⚠️ يرجى اختيار حزمة صالحة أولاً")),{success:!1,reason:"invalid"};const{start:a,end:s}=Qt(),r=lt(),i=vr(n,{existingItems:r,start:a,end:s});if(!i.success){if(!t){const l={invalid:o("reservations.toast.packageInvalid","⚠️ يرجى اختيار حزمة صالحة أولاً"),not_found:o("reservations.toast.packageNotFound","⚠️ تعذر العثور على بيانات الحزمة المحددة"),missing_dates:o("reservations.toast.requireDatesBeforeAdd","⚠️ يرجى تحديد تاريخ ووقت البداية والنهاية قبل إضافة المعدات"),duplicate:o("reservations.toast.packageDuplicate","⚠️ هذه الحزمة مضافة بالفعل إلى الحجز")}[i.reason]||o("reservations.toast.packageInvalid","⚠️ يرجى اختيار حزمة صالحة أولاً");x(i.message||l)}return i}return pa(i.package),ht(),de(),t||x(o("reservations.toast.packageAdded","✅ تم إضافة الحزمة بنجاح")),{success:!0,package:i.package}}function Sr(){const{packageSelect:e}=Nn();!e||e.dataset.autoAddAttached==="true"||(e.addEventListener("change",()=>{const t=e.value;if(!t)return;qr(t)?.success&&(e.options.length>0?e.selectedIndex=0:e.value="")}),e.dataset.autoAddAttached="true")}function kl(){const{packageAddButton:e,packageSelect:t}=Nn();!e||e.dataset.listenerAttached||(e.addEventListener("click",()=>{const n=t?.value||"";if(!n){x(o("reservations.toast.packageInvalid","⚠️ يرجى اختيار حزمة صالحة أولاً"));return}qr(n)}),e.dataset.listenerAttached="true")}function Er(){const{modeRadios:e}=Nn();if(!e.length)return;e.forEach(a=>{a.dataset.listenerAttached||(a.addEventListener("change",s=>{s.target.checked&&rs(s.target.value)}),a.dataset.listenerAttached="true")}),kl(),Sr();const t=Xn(),n=e.find(a=>a.value===t);n&&(n.checked=!0),rs(t)}function ht(e="reservation-items"){const t=document.getElementById(e);if(!t)return;const n=lt(),a=o("reservations.create.equipment.noneAdded","لا توجد معدات مضافة"),s=o("reservations.create.summary.currency","SR"),r=o("reservations.create.equipment.imageAlt","صورة"),i=o("reservations.equipment.actions.increase","زيادة الكمية"),c=o("reservations.equipment.actions.decrease","تقليل الكمية"),l=o("reservations.equipment.actions.remove","إزالة البند");if(n.length===0){t.innerHTML=`<tr><td colspan="5" class="text-center">${a}</td></tr>`;return}const d=rn(n);t.innerHTML=d.map(u=>{const y=u.items[0]||{},f=Ut(y)||u.image,m=f?`<img src="${f}" alt="${r}" class="reservation-item-thumb">`:'<div class="reservation-item-thumb reservation-item-thumb--placeholder" aria-hidden="true">🎥</div>',p=h(String(u.count)),b=Number.isFinite(Number(u.unitPrice))?Number(u.unitPrice):0,q=Number.isFinite(Number(u.totalPrice))?Number(u.totalPrice):b*u.count,k=`${h(b.toFixed(2))} ${s}`,v=`${h(q.toFixed(2))} ${s}`,S=u.items.some(I=>I?.type==="package"),j=u.barcodes.map(I=>h(String(I||""))).filter(Boolean),Q=j.length?`<details class="reservation-item-barcodes">
    ...
    `}).join("")}function ze(e=""){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Oa(e){if(e==null)return"";const t=String(e).trim();return t?h(t):""}function Ul(e,t,n=[],a,s=null){const{projectLinked:r,effectiveConfirmed:i}=kt(e,s),c=e.paid===!0||e.paid==="paid",l=$s(e),d=e.items||[],{groups:u}=Ui(e),{technicians:y=[]}=ye(),f=[].concat(Array.isArray(n)?n:[]).concat(Array.isArray(y)?y:[]),m=new Map;f.forEach(g=>{if(!g||g.id==null)return;const O=String(g.id),re=m.get(O)||{};m.set(O,{...re,...g})});const b=(Array.isArray(e.crewAssignments)&&e.crewAssignments.length?e.crewAssignments:Array.isArray(e.techniciansDetails)&&e.techniciansDetails.length?e.techniciansDetails:(e.technicians||[]).map(g=>({technicianId:g}))).map((g,O)=>{const re=g?.technicianId!=null?m.get(String(g.technicianId)):null;let xe=g.positionLabel??g.position_name??g.position_label??g.role??g.position??re?.role??o("reservations.crew.positionFallback","منصب بدون اسم");(!xe||xe.trim()==="")&&(xe=g.positionLabelAr??g.position_label_ar??g.positionLabelEn??g.position_label_en??g.position_name_ar??g.position_name_en??re?.role??o("reservations.crew.positionFallback","منصب بدون اسم"));const Ae=g.positionLabelAlt??g.position_label_alt??g.positionLabelEn??g.position_label_en??g.positionLabelAr??g.position_label_ar??"",Ue=he(Te(g.positionCost??g.position_cost??g.cost??g.daily_wage??g.dailyWage??re?.dailyWage??re?.wage??0)),Je=he(Te(g.positionClientPrice??g.position_client_price??g.client_price??g.clientPrice??g.daily_total??g.dailyTotal??g.total??re?.dailyTotal??re?.total??re?.total_wage??0));return{assignmentId:g.assignmentId??g.assignment_id??`crew-${O}`,positionId:g.positionId??g.position_id??null,positionLabel:xe,positionLabelAlt:Ae,positionLabelAr:g.positionLabelAr??g.position_label_ar??null,positionLabelEn:g.positionLabelEn??g.position_label_en??null,positionCost:Ue,positionClientPrice:Je,technicianId:g.technicianId!=null?String(g.technicianId):re?.id!=null?String(re.id):null,technicianName:g.technicianName??g.technician_name??re?.name??null,technicianRole:g.technicianRole??re?.role??null,technicianPhone:g.technicianPhone??re?.phone??null,notes:g.notes??null}}),q=Ot(),k=ba(e.start,e.end),v=e.discount??e.discountValue??e.discount_value??e.discountAmount??0,S=Te(v),j=Number.isFinite(S)?S:0,Q=e.discountType??e.discount_type??e.discountMode??"percent",E=String(Q).toLowerCase()==="amount"?"amount":"percent",I=r?!1:!!(e.applyTax??e.apply_tax??e.taxApplied),$=Te(e.cost??e.total??e.finalTotal),P=Number.isFinite($),H=P?he($):0,_=e.companySharePercent??e.company_share_percent??e.companyShare??e.company_share,L=_!=null?Te(_):Number.NaN;let B=((e.companyShareEnabled??e.company_share_enabled??e.companyShareApplied)===!0||Number.isFinite(L)&&L>0)&&Number.isFinite(L)?L:0;I&&B<=0&&(B=xt);const w=Ac({items:d,technicianIds:e.technicians||[],crewAssignments:b,discount:j,discountType:E,applyTax:I,start:e.start,end:e.end,companySharePercent:B}),X=he(w.equipmentTotal),U=he(w.crewTotal);he(w.crewCostTotal);const D=he(w.discountAmount),F=he(w.subtotalAfterDiscount),R=Number.isFinite(w.companySharePercent)?w.companySharePercent:0;let M=he(w.companyShareAmount);M=R>0?he(Math.max(0,M)):0;const K=he(w.taxAmount),se=he(w.finalTotal),te=r?se:P?H:se,ue=he(w.netProfit),J=h(String(e.reservationId??e.id??"")),oe=e.start?h(Ge(e.start)):"-",qe=e.end?h(Ge(e.end)):"-",Se=h(String(b.length)),Ce=h(X.toFixed(2)),V=h(D.toFixed(2)),Z=h(F.toFixed(2)),ne=h(K.toFixed(2)),Ee=h((Number.isFinite(te)?te:0).toFixed(2)),Re=h(String(k)),ae=o("reservations.create.summary.currency","SR"),Y=o("reservations.details.labels.discount","الخصم"),be=o("reservations.details.labels.tax","الضريبة (15%)"),T=o("reservations.details.labels.crewTotal","إجمالي الفريق"),ie=o("reservations.details.labels.subtotalAfterDiscount","الإجمالي"),fe=o("reservations.details.labels.duration","عدد الأيام"),ge=o("reservations.details.labels.companyShare","🏦 نسبة الشركة"),me=o("reservations.details.labels.netProfit","💵 صافي الربح"),Ve=o("reservations.create.equipment.imageAlt","صورة"),_e={item:o("reservations.equipment.table.item","المعدة"),quantity:o("reservations.equipment.table.quantity","الكمية"),unitPrice:o("reservations.equipment.table.unitPrice","سعر الوحدة"),total:o("reservations.equipment.table.total","الإجمالي"),actions:o("reservations.equipment.table.actions","الإجراءات")},Me=o("reservations.details.noItems","📦 لا توجد معدات ضمن هذا الحجز حالياً."),et=o("reservations.details.noCrew","😎 لا يوجد فريق مرتبط بهذا الحجز.");o("reservations.details.technicians.roleUnknown","غير محدد");const vt=o("reservations.details.technicians.phoneUnknown","غير متوفر");o("reservations.details.technicians.wage","{amount} {currency} / اليوم");const un=o("reservations.list.status.confirmed","✅ مؤكد"),Wt=o("reservations.list.status.pending","⏳ غير مؤكد"),ja=o("reservations.list.payment.paid","💳 مدفوع"),z=o("reservations.list.payment.unpaid","💳 غير مدفوع"),ke=o("reservations.list.payment.partial","💳 مدفوع جزئياً"),tt=o("reservations.list.status.completed","📁 منتهي"),ut=o("reservations.details.labels.id","🆔 رقم الحجز"),Bn=o("reservations.details.section.bookingInfo","بيانات الحجز"),Dn=o("reservations.details.section.paymentSummary","ملخص الدفع"),Na=o("reservations.details.labels.finalTotal","المجموع النهائي"),Fn=o("reservations.details.section.crew","😎 الفريق الفني"),La=o("reservations.details.crew.count","{count} عضو"),Xt=o("reservations.details.section.items","📦 المعدات المرتبطة"),Jt=o("reservations.details.items.count","{count} عنصر"),Ao=o("reservations.details.actions.edit","✏️ تعديل"),wo=o("reservations.details.actions.delete","🗑️ حذف"),Io=o("reservations.details.labels.customer","العميل"),ko=o("reservations.details.labels.contact","رقم التواصل"),_o=o("reservations.details.labels.project","📁 المشروع المرتبط");o("reservations.details.project.unlinked","غير مرتبط بأي مشروع.");const $o=o("reservations.edit.project.missing","⚠️ المشروع غير متوفر (تم حذفه)"),Po=o("reservations.details.actions.openProject","📁 فتح المشروع"),Co=o("reservations.details.labels.start","بداية الحجز"),To=o("reservations.details.labels.end","نهاية الحجز"),jo=o("reservations.details.labels.notes","ملاحظات"),No=o("reservations.list.noNotes","لا توجد ملاحظات"),Lo=o("reservations.details.labels.itemsCount","عدد المعدات"),Bo=o("reservations.details.labels.itemsTotal","إجمالي المعدات"),Do=o("reservations.paymentHistory.title","سجل الدفعات"),Fo=o("reservations.paymentHistory.empty","لا توجد دفعات مسجلة"),Ro=o("reservations.list.unknownCustomer","غير معروف"),Ba=e.paidStatus??e.paid_status??(c?"paid":"unpaid"),ni=Ba==="partial",Mo=Ba==="paid"?ja:ni?ke:z;function Da(g){if(g==null)return Number.NaN;if(typeof g=="number")return Number.isFinite(g)?g:Number.NaN;const O=String(g).replace(/[^0-9.+-]/g,""),re=Number(O);return Number.isFinite(re)?re:Number.NaN}const Rn=(g={})=>{const O=String(g.type??g.kind??g.category??"").toLowerCase();return!!(["package","bundle","pack"].includes(O)||Array.isArray(g.packageItems)&&g.packageItems.length)},zo=(g={})=>[g.packageId,g.package_id,g.packageCode,g.package_code,g.bundleId,g.bundle_id].some(O=>O!=null&&O!==""),Ho=(g={})=>!g||typeof g!="object"?!1:!Rn(g)&&zo(g),ai=(g={})=>{const O=Rn(g),re=[{value:g.qty,key:"qty",limit:999},{value:g.quantity,key:"quantity",limit:999},{value:g.units,key:"units",limit:999},{value:g.count,key:"count",limit:50},{value:g.package_quantity,key:"package_quantity",limit:999},{value:g.packageQty,key:"packageQty",limit:999},{value:g.packageCount,key:"packageCount",limit:999}];let xe=NaN;for(const Ae of re){if(Ae.value==null||Ae.value==="")continue;const Ue=typeof Ae.value=="string"?Ae.value.trim():String(Ae.value??"");if(Ae.key==="count"&&Ue.length>6)continue;const Je=Da(Ae.value);if(!Number.isFinite(Je)||Je<=0)continue;const je=Math.round(Je);if(!(je>Ae.limit)){xe=Math.max(1,je);break}}return(!Number.isFinite(xe)||xe<=0)&&(xe=1),O?Math.max(1,Math.min(99,xe)):Math.max(1,Math.min(9999,xe))};let Ne=(Array.isArray(d)?d:[]).reduce((g,O)=>!O||typeof O!="object"||Ho(O)?g:g+ai(O),0);Ne<=0&&Array.isArray(u)&&u.length&&(Ne=u.reduce((g,O)=>{const re=ai({...O,type:O.type});return g+re},0)),!Number.isFinite(Ne)||Ne<=0?Ne=Array.isArray(u)&&u.length?u.length:(Array.isArray(d)?d.length:0)||1:Ne>1e6&&(Ne=Math.min(Ne,Array.isArray(u)?u.length:Ne),(!Number.isFinite(Ne)||Ne<=0)&&(Ne=(Array.isArray(d)?d.length:0)||1)),Ne=Math.max(1,Math.round(Ne));const Oo=h(String(Ne)),si=Jt.replace("{count}",Oo),Vo=La.replace("{count}",Se),Uo=e.notes?h(e.notes):No,Ko=h(U.toFixed(2)),Qo=h(String(R)),Go=h(M.toFixed(2)),Wo=`${Qo}% (${Go} ${ae})`,Xo=Number.isFinite(ue)?Math.max(0,ue):0,Jo=h(Xo.toFixed(2)),qt=[{icon:"💼",label:Bo,value:`${Ce} ${ae}`}];qt.push({icon:"😎",label:T,value:`${Ko} ${ae}`}),D>0&&qt.push({icon:"💸",label:Y,value:`${V} ${ae}`}),qt.push({icon:"📊",label:ie,value:`${Z} ${ae}`}),I&&K>0&&qt.push({icon:"🧾",label:be,value:`${ne} ${ae}`}),R>0&&qt.push({icon:"🏦",label:ge,value:Wo}),qt.push({icon:"💵",label:me,value:`${Jo} ${ae}`}),qt.push({icon:"💰",label:Na,value:`${Ee} ${ae}`});const Yo=qt.map(({icon:g,label:O,value:re})=>`
    <div class="summary-details-row">
      <span class="summary-details-label">${g} ${O}</span>
      <span class="summary-details-value">${re}</span>
    </div>
  `).join("");console.debug("[reservations/details] payment history raw",e.paymentHistory,e.payment_history);let mn=[];Array.isArray(e.paymentHistory)?mn=e.paymentHistory:Array.isArray(e.payment_history)&&(mn=e.payment_history);const Zo=Array.isArray(e.paymentLogs)?e.paymentLogs:[],ii=Array.isArray(mn)&&mn.length>0?mn:Zo,ec=ii.length?`<ul class="reservation-payment-history-list">${ii.map(g=>{const O=g?.type==="amount"?o("reservations.paymentHistory.type.amount","دفعة مالية"):g?.type==="percent"?o("reservations.paymentHistory.type.percent","دفعة نسبة"):o("reservations.paymentHistory.type.unknown","دفعة"),re=Number.isFinite(Number(g?.amount))&&Number(g.amount)>0?`${h(Number(g.amount).toFixed(2))} ${ae}`:"—",xe=Number.isFinite(Number(g?.percentage))&&Number(g.percentage)>0?`${h(Number(g.percentage).toFixed(2))}%`:"—",Ae=g?.recordedAt?h(Ge(g.recordedAt)):"—",Ue=g?.note?`<div class="payment-history-note">${ze(h(g.note))}</div>`:"";return`
          <li>
  ...
  `,ic=b.map((g,O)=>{const re=h(String(O+1));let xe=g.positionLabel??g.position_name??g.position_label??g.role??g.position??null;(!xe||xe.trim()==="")&&(xe=g.positionLabelAr??g.position_label_ar??g.positionLabelEn??g.position_label_en??g.position_name_ar??g.position_name_en??null);const Ae=Oa(xe)||o("reservations.crew.positionFallback","منصب بدون اسم"),Ue=Oa(g.positionLabelAlt??g.position_label_alt??g.positionLabelEn??g.position_label_en??g.positionLabelAr??g.position_label_ar??g.position_name_en??g.position_name_ar??""),Je=Oa(g.technicianName)||o("technicians.picker.noTechnicianOption","— بدون تعيين —"),je=g.technicianPhone||vt,Mn=he(Te(g.positionCost??g.position_cost??g.cost??g.daily_wage??g.dailyWage??g.internal_cost??0)),pn=he(Te(g.positionClientPrice??g.position_client_price??g.client_price??g.clientPrice??g.daily_total??g.dailyTotal??g.total??0)),we=`${h(pn.toFixed(2))} ${ae}`,Le=Mn>0?`${h(Mn.toFixed(2))} ${ae}`:null;return`
    ...
    `}).join(""),rc=b.length?`<div class="reservation-technicians-grid">${ic}</div>`:`<ul class="reservation-modal-technicians"><li>${et}</li></ul>`;return`
    <div class="reservation-modal">
      ...
      <div class="reservation-modal-actions">
        ...
        <button type="button" class="modal-action-btn modal-action-btn--primary" id="reservation-details-edit-btn" data-index="${a}">${Ao}</button>
        ${q?`<button type="button" class="modal-action-btn modal-action-btn--danger" id="reservation-details-delete-btn" data-index="${a}">${wo}</button>`:""}
      </div>
    </div>
...
`);return e&&e.value.trim().length===0&&(e.value=n),t&&t.value.trim().length===0&&(t.value=n),[...Oe]}const ed=[{id:"customerInfo",labelKey:"reservations.quote.sections.customer",fallback:"بيانات العميل",defaultSelected:!0},{id:"reservationInfo",labelKey:"reservations.quote.sections.reservation",fallback:"تفاصيل الحجز",defaultSelected:!0},{id:"projectInfo",labelKey:"reservations.quote.sections.project",fallback:"بيانات المشروع",defaultSelected:!0},{id:"financialSummary",labelKey:"reservations.quote.sections.financial",fallback:"الملخص المالي",defaultSelected:!0},{id:"items",labelKey:"reservations.quote.sections.items",fallback:"قائمة المعدات",defaultSelected:!0},{id:"crew",labelKey:"reservations.quote.sections.crew",fallback:"طاقم العمل",defaultSelected:!0},{id:"notes",labelKey:"reservations.quote.sections.notes",fallback:"ملاحظات الحجز",defaultSelected:!0}],Tr=[{id:"rowNumber",labelKey:null,fallback:"#",render:(e,t)=>A(h(String(t+1)))},{id:"code",labelKey:"reservations.details.table.headers.code",fallback:"الكود",render:e=>A(e?.barcode||"-")},{id:"description",labelKey:"reservations.details.table.headers.description",fallback:"الوصف",render:e=>A(e?.desc||e?.description||"-")},{id:"quantity",labelKey:"reservations.details.table.headers.quantity",fallback:"الكمية",render:e=>A(h(String(e?.qty||1)))},{id:"price",labelKey:"reservations.details.table.headers.price",fallback:"السعر",render:e=>A(h(Number(e?.price||0).toFixed(2)))}],jr=[{id:"rowNumber",labelKey:null,fallback:"#",render:(e,t)=>A(h(String(t+1)))},{id:"position",labelKey:"reservations.details.crew.position",fallback:"المنصب",render:e=>A(h(e?.positionLabel??e?.position_name??e?.role??o("reservations.crew.positionFallback","منصب بدون اسم")))},{id:"price",labelKey:"reservations.details.crew.clientPrice",fallback:"سعر العميل",render:e=>{const t=Number.isFinite(Number(e?.positionClientPrice))?Number(e.positionClientPrice):0;return A(`${h(t.toFixed(2))} ${o("reservations.create.summary.currency","SR")}`)}}],ls={customerInfo:[{id:"customerName",labelKey:"reservations.details.labels.customer",fallback:"العميل"},{id:"customerCompany",labelKey:"reservations.details.labels.company",fallback:"الشركة"},{id:"customerPhone",labelKey:"reservations.details.labels.phone",fallback:"الهاتف"},{id:"customerEmail",labelKey:"reservations.details.labels.email",fallback:"البريد"}],reservationInfo:[{id:"reservationId",labelKey:"reservations.details.labels.reservationId",fallback:"رقم الحجز"},{id:"reservationStart",labelKey:"reservations.details.labels.start",fallback:"بداية الحجز"},{id:"reservationEnd",labelKey:"reservations.details.labels.end",fallback:"نهاية الحجز"},{id:"reservationDuration",labelKey:"reservations.details.labels.duration",fallback:"عدد الأيام"}],projectInfo:[{id:"projectTitle",labelKey:"reservations.details.labels.project",fallback:"المشروع"},{id:"projectCode",labelKey:"reservations.details.labels.code",fallback:"الرمز"}],financialSummary:[{id:"equipmentTotal",labelKey:"reservations.details.labels.equipmentTotal",fallback:"إجمالي المعدات"},{id:"crewTotal",labelKey:"reservations.details.labels.crewTotal",fallback:"إجمالي الفريق"},{id:"discountAmount",labelKey:"reservations.details.labels.discount",fallback:"الخصم"},{id:"taxAmount",labelKey:"reservations.details.labels.tax",fallback:"الضريبة"},{id:"finalTotal",labelKey:"reservations.details.labels.total",fallback:"الإجمالي النهائي"}],payment:[{id:"beneficiary",labelKey:"reservations.quote.labels.beneficiary",fallback:"اسم المستفيد"},{id:"bank",labelKey:"reservations.quote.labels.bank",fallback:"اسم البنك"},{id:"account",labelKey:"reservations.quote.labels.account",fallback:"رقم الحساب"},{id:"iban",labelKey:"reservations.quote.labels.iban",fallback:"رقم الآيبان"}],items:Tr.map(({id:e,labelKey:t,fallback:n})=>({id:e,labelKey:t,fallback:n})),crew:jr.map(({id:e,labelKey:t,fallback:n})=>({id:e,labelKey:t,fallback:n}))},Nr=[{id:"rowNumber",labelKey:null,fallback:"#",render:(e,t)=>A(h(String(t+1)))},{id:"name",labelKey:null,fallback:"الاسم",render:e=>A(e?.name||e?.full_name||e?.fullName||"-")},{id:"role",labelKey:null,fallback:"الدور",render:e=>A(e?.role||e?.title||o("reservations.details.technicians.roleUnknown","غير محدد"))},{id:"phone",labelKey:null,fallback:"الهاتف",render:e=>A(e?.phone||e?.mobile||o("reservations.details.technicians.phoneUnknown","غير متوفر"))}],Lr=[{id:"rowNumber",labelKey:null,fallback:"#",render:(e,t)=>A(h(String(t+1)))},{id:"label",labelKey:null,fallback:"البند",render:e=>A(e?.label||"-")},{id:"amount",labelKey:null,fallback:"المبلغ",render:e=>A(e?.displayAmount||"—")},{id:"note",labelKey:null,fallback:"ملاحظات",render:e=>A(e?.note||"-")}],Br=[{id:"rowNumber",labelKey:null,fallback:"#",render:(e,t)=>A(h(String(t+1)))},{id:"description",labelKey:null,fallback:"الوصف",render:e=>A(e?.description||"-")},{id:"totalQuantity",labelKey:null,fallback:"إجمالي الكمية",render:e=>A(h(String(e?.totalQuantity||0)))},{id:"reservationsCount",labelKey:null,fallback:"عدد الحجوزات",render:e=>A(h(String(e?.reservationsCount||0)))},{id:"totalCost",labelKey:null,fallback:"التكلفة التقديرية",render:e=>A(e?.displayCost||"—")}],td=[{id:"customerInfo",labelKey:"projects.quote.sections.customer",fallback:"بيانات العميل",defaultSelected:!0},{id:"projectInfo",labelKey:"projects.quote.sections.project",fallback:"بيانات المشروع",defaultSelected:!0},{id:"projectExpenses",labelKey:"projects.quote.sections.expenses",fallback:"متطلبات المشروع",defaultSelected:!0},{id:"projectCrew",labelKey:"projects.quote.sections.crew",fallback:"طاقم العمل",defaultSelected:!0},{id:"financialSummary",labelKey:"projects.quote.sections.financial",fallback:"الملخص المالي",defaultSelected:!0},{id:"projectEquipment",labelKey:"projects.quote.sections.equipment",fallback:"المعدات",defaultSelected:!0},{id:"projectNotes",labelKey:"projects.quote.sections.notes",fallback:"ملاحظات المشروع",defaultSelected:!0}],nd={customerInfo:ls.customerInfo,projectInfo:[{id:"projectTitle",labelKey:"projects.details.overview.heading",fallback:"معلومات المشروع"},{id:"projectCode",labelKey:"projects.details.labels.code",fallback:"رقم المشروع"},{id:"projectType",labelKey:"projects.details.type",fallback:"نوع المشروع"},{id:"projectStart",labelKey:"projects.details.start",fallback:"بداية المشروع"},{id:"projectEnd",labelKey:"projects.details.end",fallback:"نهاية المشروع"},{id:"projectDuration",labelKey:"projects.details.duration",fallback:"مدة المشروع"},{id:"projectStatus",labelKey:"projects.details.status",fallback:"حالة المشروع"}],financialSummary:[{id:"projectSubtotal",labelKey:"projects.details.summary.projectSubtotal",fallback:"إجمالي المشروع"},{id:"expensesTotal",labelKey:"projects.details.expensesTotal",fallback:"إجمالي المصاريف"},{id:"reservationsTotal",labelKey:"projects.details.reservationsTotal",fallback:"إجمالي الحجوزات"},{id:"discountAmount",labelKey:"projects.details.summary.discount",fallback:"الخصم"},{id:"taxAmount",labelKey:"projects.details.summary.combinedTax",fallback:"الضريبة"},{id:"overallTotal",labelKey:"projects.details.summary.overallTotal",fallback:"الإجمالي الكلي"},{id:"paidAmount",labelKey:"projects.details.summary.paidAmount",fallback:"المدفوع"},{id:"remainingAmount",labelKey:"projects.details.summary.remainingAmount",fallback:"المتبقي للدفع"}],payment:ls.payment,projectExpenses:Lr.map(({id:e,labelKey:t,fallback:n})=>({id:e,labelKey:t,fallback:n})),projectCrew:Nr.map(({id:e,labelKey:t,fallback:n})=>({id:e,labelKey:t,fallback:n})),projectEquipment:Br.map(({id:e,labelKey:t,fallback:n})=>({id:e,labelKey:t,fallback:n})),projectNotes:[]},Va=new Map;function Ia(e="reservation"){if(Va.has(e))return Va.get(e);const t=e==="project"?td:ed,n=e==="project"?nd:ls,a=new Set(t.map(({id:i})=>i)),s=Object.fromEntries(Object.entries(n).map(([i,c=[]])=>[i,new Set(c.map(l=>l.id))])),r={sectionDefs:t,fieldDefs:n,sectionIdSet:a,fieldIdMap:s};return Va.set(e,r),r}function ka(e="reservation"){return Ia(e).sectionDefs}function Dr(e="reservation"){return Ia(e).fieldDefs}function Fr(e="reservation"){return Ia(e).sectionIdSet}function Rr(e="reservation"){return Ia(e).fieldIdMap}function Mr(e){switch(e){case"export":return o("reservations.quote.status.exporting","جاري تجهيز ملف PDF...");case"render":default:return o("reservations.quote.status.rendering","جاري تحديث المعاينة...")}}const ad="https://cdn.jsdelivr.net/npm/html2pdf.js@0.10.1/dist/html2pdf.bundle.min.js",sd="https://cdn.jsdelivr.net/npm/html2canvas@1.4.1/dist/html2canvas.min.js",id="https://cdn.jsdelivr.net/npm/jspdf@2.5.1/dist/jspdf.umd.min.js",zr=Kl.trim(),Hr=/^data:image\/svg\+xml/i,rd=/\.svg($|[?#])/i,hn=512,ds="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mP8/B8AAusB9YwpClgAAAAASUVORK5CYII=",Or=96,Vr=25.4,us=210,Qn=297,Gn=Math.round(us/Vr*Or),Wn=Math.round(Qn/Vr*Or),od=2,Ur=/safari/i,cd=/(iphone|ipad|ipod)/i,xi=/(iphone|ipad|ipod)/i,ld=/(crios|fxios|edgios|opios)/i,oa="[reservations/pdf]";let W=null,N=null,it=1,yn=null,bn=null,Et=null,en=null,Sn=!1;function Ft(e="render",{message:t,actionLabel:n,onAction:a,showSpinner:s=e!=="error"}={}){if(!W?.statusIndicator||!W?.statusText)return;W.statusKind=e;const r=t||Mr(e);W.statusText.textContent=r,W.statusSpinner&&(W.statusSpinner.hidden=!s),W.statusAction&&(W.statusAction.hidden=!0,W.statusAction.onclick=null,n&&typeof a=="function"&&(W.statusAction.textContent=n,W.statusAction.hidden=!1,W.statusAction.onclick=i=>{i.preventDefault(),a()})),W.statusIndicator.hidden=!1,requestAnimationFrame(()=>{W.statusIndicator.classList.add("is-visible")})}function En(e){!W?.statusIndicator||!W?.statusText||(W.statusKind=null,W.statusIndicator.classList.remove("is-visible"),setTimeout(()=>{W?.statusIndicator&&(W.statusIndicator.hidden=!0,W.statusAction&&(W.statusAction.hidden=!0,W.statusAction.onclick=null),W.statusSpinner&&(W.statusSpinner.hidden=!1))},220))}function ms(){return!!window?.bootstrap?.Modal}function dd(e){if(e&&!e.classList.contains("show")){e.classList.add("show"),e.style.display="block",e.removeAttribute("aria-hidden"),e.setAttribute("aria-modal","true"),e.getAttribute("role")||e.setAttribute("role","dialog"),document.body.classList.add("modal-open"),Et||(Et=document.createElement("div"),Et.className="modal-backdrop fade show",Et.dataset.quotePdfFallbackBackdrop="true",document.body.appendChild(Et)),en||(en=t=>{t.key==="Escape"&&ps(e)},document.addEventListener("keydown",en));try{e.focus({preventScroll:!0})}catch{}}}function ps(e){!e||!e.classList.contains("show")||(e.classList.remove("show"),e.style.display="none",e.setAttribute("aria-hidden","true"),e.removeAttribute("aria-modal"),document.body.classList.remove("modal-open"),Et&&(Et.remove(),Et=null),en&&(document.removeEventListener("keydown",en),en=null))}function ud(e){if(e){if(ms()){window.bootstrap.Modal.getOrCreateInstance(e).show();return}dd(e)}}function md(){if(Sn)return;Sn=!0;const e=o("reservations.quote.toast.viewGuide","📘 عرض دليل الحل السريع"),t=o("reservations.quote.toast.retry","إعادة المحاولة"),n=o("reservations.quote.toast.assetsFailed","⚠️ تعذر تحميل بعض الصور ضمن عرض السعر."),a=!!W?.modal?.classList.contains("show"),s=()=>{W?.modal?.classList.contains("show")&&(Ft("render"),Sn=!1,Gt())};Bi({message:n,duration:9e3,actionLabel:a?t:void 0,onAction:a?s:void 0,linkLabel:e,linkHref:Cr}),a&&Ft("error",{message:n,actionLabel:t,onAction:s,showSpinner:!1})}function _a(e="reservation"){const t={},n=Dr(e);return Object.entries(n).forEach(([a,s=[]])=>{t[a]=new Set(s.filter(r=>r?.default!==!1).map(r=>r.id))}),t}function Os(e={}){const t={};return Object.entries(e).forEach(([n,a])=>{t[n]=new Set(Array.from(a||[]))}),t}function pd(e={},t){if(t)return e[t]||(e[t]=new Set),e[t]}function Vs(e={},t,n){const a=e?.[t];return a?a instanceof Set?a.has(n):Array.isArray(a)?a.includes(n):!!a?.[n]:!0}function Us(e="reservation"){return Object.fromEntries(ka(e).map(({id:t})=>[t,!1]))}function Ks(e,t){return e.sectionExpansions||(e.sectionExpansions=Us(e.context||"reservation")),t&&typeof e.sectionExpansions[t]!="boolean"&&(e.sectionExpansions[t]=!1),e.sectionExpansions}function fd(e,t){return Ks(e,t)?.[t]!==!1}function Qs(){return typeof window>"u"||typeof window.matchMedia!="function"?!1:window.matchMedia("(max-width: 768px)").matches}function yd(){if(typeof navigator>"u")return!1;const e=navigator.userAgent||navigator.platform||"";return cd.test(e)}function bd(){if(typeof navigator>"u")return!1;const e=navigator.userAgent||"",t=Ur.test(e),n=e.includes("Chrome")||e.includes("CriOS")||e.includes("Chromium"),a=e.includes("Edg");return t&&!n&&!a}function Kr(){return yd()&&bd()}function $a(){if(typeof navigator>"u")return!1;const e=navigator.userAgent||"",t=navigator.platform||"",n=Number.isFinite(navigator.maxTouchPoints)?navigator.maxTouchPoints:0,a=xi.test(e)||xi.test(t),s=/Macintosh/i.test(e)&&n>1;return Ur.test(e)&&!ld.test(e)&&(a||s)}function Ua(e,...t){try{console.log(`${oa} ${e}`,...t)}catch{}}function bt(e,...t){try{console.warn(`${oa} ${e}`,...t)}catch{}}function gd(e,t,...n){try{t?console.error(`${oa} ${e}`,t,...n):console.error(`${oa} ${e}`,...n)}catch{}}function Ie(e,{blockType:t="section",extraAttributes:n=""}={}){if(!e)return"";const a=n?` ${n.trim()}`:"";return e.replace(/^(<\w+)/,`$1 data-quote-block data-block-type="${t}"${a}`)}function hd(e,t="لا توجد بيانات للعرض."){const n=A(o(e,t));return Ie(`<section class="quote-section quote-placeholder">${n}</section>`,{blockType:"placeholder"})}function ca(e,t){return Array.isArray(e)&&e.length?e:[hd(t)]}const vd=/[\u0600-\u06FF\u0750-\u077F\u08A0-\u08FF]/;function Qr(e=""){return vd.test(e)}function qd(){const e=window.CanvasRenderingContext2D?.prototype;if(!e||e.__artRatioDirectionPatched)return;const t=n=>{const a=e[n];typeof a=="function"&&(e[n]=function(r,...i){if(typeof r!="string"||!Qr(r))return a.call(this,r,...i);let c,l=!1;try{"direction"in this&&(c=this.direction,c!=="rtl"&&(this.direction="rtl"),l=!0)}catch{}try{if(!l){const d=this.canvas;d&&d.style?.direction!=="rtl"&&(d.__artRatioOriginalDirection=d.style.direction,d.style.direction="rtl")}return a.call(this,r,...i)}finally{if(l&&c!==void 0&&c!=="rtl")try{this.direction=c}catch{}else if(!l){const d=this.canvas;d&&d.__artRatioOriginalDirection!==void 0&&(d.style.direction=d.__artRatioOriginalDirection,delete d.__artRatioOriginalDirection)}}})};t("fillText"),t("strokeText"),e.__artRatioDirectionPatched=!0}function Ai(e,t=hn){if(typeof e!="string"&&typeof e!="number")return t;const n=parseFloat(String(e).replace(/[^0-9.+-]/g,""));return Number.isFinite(n)&&n>0?n:t}function Sd(e){if(!e)return{width:hn,height:hn};const t=e.getAttribute?.("width"),n=e.getAttribute?.("height");let a=t?Ai(t,0):0,s=n?Ai(n,0):0;if(a>0&&s>0)return{width:a,height:s};const r=e.getAttribute?.("viewBox");if(r){const i=r.trim().split(/[\s,]+/).map(c=>parseFloat(c||"0"));if(i.length>=4){const[,,c,l]=i;a=a||(Number.isFinite(c)&&c>0?c:0),s=s||(Number.isFinite(l)&&l>0?l:0)}}return{width:a||hn,height:s||hn}}function Gr(e=""){return typeof e!="string"?!1:Hr.test(e)||rd.test(e)}function Ed(e=""){const t=e.indexOf(",");if(t===-1)return"";const n=e.slice(0,t),a=e.slice(t+1);try{return/;base64/i.test(n)?typeof atob=="function"?atob(a):"":decodeURIComponent(a)}catch(s){return console.warn("[reservations/pdf] failed to decode SVG data URI",s),""}}function xd(e,{crossOrigin:t}={}){return new Promise((n,a)=>{const s=new Image;t&&(s.crossOrigin=t),s.onload=()=>n(s),s.onerror=r=>{const i=r?.message||`Unable to load image from ${e}`;a(new Error(i))},s.src=e})}async function Wr(e,t={}){if(!e)return null;const n=document,a=new Blob([e],{type:"image/svg+xml;charset=utf-8"}),s=URL.createObjectURL(a);try{const r=await xd(s),i=n.createElement("canvas"),c=Math.max(t.width||r.naturalWidth||r.width||0,1),l=Math.max(t.height||r.naturalHeight||r.height||c,1);i.width=c,i.height=l;const d=i.getContext("2d");return d.clearRect(0,0,c,l),d.drawImage(r,0,0,c,l),i.toDataURL("image/png")}catch(r){return console.warn("[reservations/pdf] failed to rasterize SVG content",r),null}finally{URL.revokeObjectURL(s)}}async function Ad(e){if(!e)return null;if(Hr.test(e))return Ed(e);try{const t=await fetch(e,{mode:"cors",credentials:"omit",cache:"default"});return t.ok?await t.text():(console.warn("[reservations/pdf] failed to fetch SVG image",e,t.status),null)}catch(t){return console.warn("[reservations/pdf] error fetching SVG image",e,t),null}}async function wd(e){if(!e)return!1;const t=e.getAttribute?.("src")||"";if(!Gr(t))return!1;const n=await Ad(t);if(!n)return e.dataset.svgRasterization="failed",e.setAttribute("src",ds),!1;const a=await Wr(n);return a?(e.dataset.svgOriginalSrc=t,e.setAttribute("src",a),e.setAttribute("data-rasterized","true"),!0):(e.dataset.svgRasterization="failed",e.setAttribute("src",ds),!1)}async function Id(e){if(!e||e.tagName?.toLowerCase()!=="svg")return!1;const n=new XMLSerializer().serializeToString(e),a=Sd(e),s=await Wr(n,a),i=(e.ownerDocument||document).createElement("img");i.setAttribute("src",s||ds),i.setAttribute("alt",e.getAttribute("aria-label")||e.getAttribute("title")||""),i.setAttribute("data-svg-replaced","true"),e.hasAttribute("class")&&i.setAttribute("class",e.getAttribute("class")),e.hasAttribute("style")&&i.setAttribute("style",e.getAttribute("style"));const c=e.getAttribute("width"),l=e.getAttribute("height");return c&&i.setAttribute("width",c),l&&i.setAttribute("height",l),e.parentNode?.replaceChild(i,e),!!s}async function Xr(e){if(!e)return;const t=Array.from(e.querySelectorAll?.("img")||[]),n=Array.from(e.querySelectorAll?.("svg")||[]),a=[];t.forEach(s=>{Gr(s.getAttribute?.("src"))&&a.push(wd(s))}),n.forEach(s=>{a.push(Id(s))}),a.length&&await Promise.allSettled(a)}function kd(e,{pixelRatio:t=1}={}){if(!e)return null;const n=e.ownerDocument||document,s=(n.defaultView||window).getComputedStyle?.(e);if(!s)return null;const r=(D,F=0)=>{const R=parseFloat(D);return Number.isFinite(R)?R:F},i=r(s.paddingTop),c=r(s.paddingBottom),l=r(s.paddingRight),d=r(s.paddingLeft),u=r(s.borderRadius),y=r(s.fontSize,14),f=(()=>{const D=s.lineHeight;if(!D||D==="normal")return y*1.6;const F=r(D,y*1.6);return F>0?F:y*1.6})(),m=Math.max(e.clientWidth||0,e.scrollWidth||0,r(s.width,0));if(m<=0)return null;const p=Math.max(1,m-d-l),b=e.textContent||"",q=b.split(/\r?\n/),k=n.createElement("canvas"),v=k.getContext("2d");if(!v)return null;const S=s.fontStyle||"normal",j=s.fontVariant||"normal",Q=s.fontWeight||"400",E=s.fontFamily||"sans-serif",I=s.fontStretch||"normal",$=D=>D.join(" "),P=[],H=D=>v.measureText(D).width;v.font=`${S} ${j} ${Q} ${I} ${y}px ${E}`,q.forEach(D=>{const F=D.trim();if(F.length===0){P.push("");return}const R=F.split(/\s+/);let M=[];R.forEach((K,se)=>{const te=K.trim();if(!te)return;const ue=$(M.concat(te));if(H(ue)<=p||M.length===0){M.push(te);return}P.push($(M)),M=[te]}),M.length&&P.push($(M))}),P.length||P.push("");const _=i+c+P.length*f,L=Math.ceil(Math.max(1,m)*t),G=Math.ceil(Math.max(1,_)*t);k.width=L,k.height=G,k.style.width=`${Math.max(1,m)}px`,k.style.height=`${Math.max(1,_)}px`,v.scale(t,t);const C=s.backgroundColor&&s.backgroundColor!=="rgba(0, 0, 0, 0)"?s.backgroundColor:"#ffffff";if(u>0){v.save(),v.beginPath();const D=Math.max(1,m),F=Math.max(1,_),R=Math.min(u,D/2,F/2);v.moveTo(R,0),v.lineTo(D-R,0),v.quadraticCurveTo(D,0,D,R),v.lineTo(D,F-R),v.quadraticCurveTo(D,F,D-R,F),v.lineTo(R,F),v.quadraticCurveTo(0,F,0,F-R),v.lineTo(0,R),v.quadraticCurveTo(0,0,R,0),v.closePath(),v.clip()}if(v.fillStyle=C,v.fillRect(0,0,Math.max(1,m),Math.max(1,_)),v.font=`${S} ${j} ${Q} ${I} ${y}px ${E}`,v.fillStyle=s.color||"#000000",v.textBaseline="top",v.textAlign="right","direction"in v)try{v.direction="rtl"}catch{}const B=Math.max(0,m-l);let w=i;P.forEach(D=>{const F=D.length?D:" ";v.fillText(F,B,w,p),w+=f});const X=n.createElement("img");let U;try{U=k.toDataURL("image/png")}catch(D){return bt("note canvas toDataURL failed",D),null}return X.src=U,X.alt=b,X.style.width=`${Math.max(1,m)}px`,X.style.height=`${Math.max(1,_)}px`,X.style.display="block",X.setAttribute("data-quote-note-image","true"),{image:X,canvas:k,totalHeight:_,width:m}}function _d(e,{pixelRatio:t=1}={}){if(!e||!$a())return;Array.from(e.querySelectorAll?.(".quote-notes")||[]).forEach(a=>{if(!a||a.dataset.quoteNoteRasterized==="true"||!Qr(a.textContent||""))return;let s;try{s=kd(a,{pixelRatio:t})}catch(r){bt("failed to rasterize note content",r),s=null}s&&(a.dataset.quoteNoteRasterized="true",a.innerHTML="",a.appendChild(s.image))})}function fs(e,t="export",{toastMessage:n,suppressToast:a=!1}={}){gd(`${t} failed`,e);const s=!!(e&&e.__artRatioPdfNotified);if(!a&&!s){const r=o("reservations.quote.errors.exportFailed","⚠️ تعذر إنشاء ملف PDF، يرجى المحاولة مرة أخرى."),i=n||r,c=o("reservations.quote.toast.viewGuide","📘 عرض دليل الحل السريع"),l=o("reservations.quote.toast.retry","إعادة المحاولة"),d=["exportQuoteAsPdf","renderQuotePreview","layoutQuoteDocument","pageCapture"].includes(t),u=()=>{t==="exportQuoteAsPdf"?(Ft("export"),oo()):(Ft("render"),Sn=!1,Gt())};if(Bi({message:i,duration:9e3,actionLabel:d?l:void 0,onAction:d?u:void 0,linkLabel:c,linkHref:Cr}),W?.modal?.classList.contains("show")&&Ft("error",{message:i,actionLabel:d?l:void 0,onAction:d?u:void 0,showSpinner:!1}),e&&typeof e=="object")try{Object.defineProperty(e,"__artRatioPdfNotified",{value:!0,writable:!1,enumerable:!1,configurable:!0})}catch{}}}function ys({container:e,safariWindowRef:t,mobileWindowRef:n}={}){try{n&&!n.closed&&n.close()}catch(a){bt("failed to close mobile window",a)}try{t&&!t.closed&&t.close()}catch(a){bt("failed to close safari window",a)}e&&e.parentNode&&e.parentNode.removeChild(e)}function Gs(e){return new Promise((t,n)=>{const a=document.querySelector(`script[src="${e}"]`);if(a){a.addEventListener("load",()=>t()),a.addEventListener("error",r=>n(r)),a.readyState==="complete"&&t();return}const s=document.createElement("script");s.src=e,s.async=!0,s.onload=()=>t(),s.onerror=r=>n(r),document.head.appendChild(s)})}function wi(){const e=[window.jspdf?.jsPDF,typeof window.jspdf=="function"?window.jspdf:null,window.jsPDF?.jsPDF,typeof window.jsPDF=="function"?window.jsPDF:null].filter(t=>typeof t=="function");return e.length?e[0]:null}function Ii(){return typeof window.html2canvas=="function"?window.html2canvas:null}async function $d(){const e=Ii();return e||(bn||(bn=Gs(sd).catch(t=>{throw bn=null,t}).then(()=>{const t=Ii();if(!t)throw bn=null,new Error("تعذر تحميل مكتبة html2canvas المطلوبة.");return t})),bn)}async function Pd(){const e=wi();return e||(yn||(yn=Gs(id).catch(t=>{throw yn=null,t}).then(()=>{const t=wi();if(!t)throw yn=null,new Error("تعذر تحميل مكتبة jsPDF المطلوبة.");return t})),yn)}async function Cd(){if(window.html2pdf||await Gs(ad),window.html2pdf&&!window.html2pdf.__artRatioConfigured){const e=window.html2pdf.defaultOptions||window.html2pdf.defaultOpt||{},t={...e.html2canvas||{}};t.useCORS=!0,t.allowTaint=!1,t.logging=!0;const n={unit:"mm",format:"a4",orientation:"portrait",compress:!0,...e.jsPDF||{}},a={image:{type:"jpeg",quality:.95,...e.image||{}},margin:e.margin??[0,0,0,0],filename:e.filename||"document.pdf",html2canvas:t,jsPDF:n};window.html2pdf.defaultOptions=a,window.html2pdf.defaultOpt=a,window.html2pdf.__artRatioConfigured=!0}Xl(),qd()}function A(e=""){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Td(e="reservation"){return e==="project"?"QP":"Q"}function jd(e,t="reservation"){const n=Number(e),a=Td(t);return!Number.isFinite(n)||n<=0?`${a}-0001`:`${a}-${String(n).padStart(4,"0")}`}function Nd(){const e=window.localStorage?.getItem?.(Pr),t=parseInt(e??"",10);return Number.isFinite(t)&&t>0?t:0}function Jr(e="reservation"){const n=Nd()+1;return{sequence:n,quoteNumber:jd(n,e)}}function Ld(e){try{const t=Number(e);if(!Number.isFinite(t)||t<=0)return;window.localStorage?.setItem?.(Pr,String(t))}catch(t){console.warn("⚠️ [reservations/pdf] failed to persist quote sequence",t)}}function Yr(e="reservation"){return Ei[e]||Ei.reservation}function Bd(e="reservation"){try{const t=Yr(e),n=window.localStorage?.getItem?.(t);if(!n)return null;const a=JSON.parse(n);return a&&typeof a=="object"?a:null}catch(t){return console.warn("⚠️ [reservations/pdf] failed to read toggle preferences",t),null}}function Dd(e,t="reservation"){try{const n=Yr(t);if(!e){window.localStorage?.removeItem?.(n);return}window.localStorage?.setItem?.(n,JSON.stringify(e))}catch(n){console.warn("⚠️ [reservations/pdf] failed to persist toggle preferences",n)}}function Fd(e){if(!e)return{ids:null,emptyExplicitly:!1};if(e instanceof Set)return{ids:Array.from(e),emptyExplicitly:e.size===0};if(Array.isArray(e))return{ids:e.slice(),emptyExplicitly:e.length===0};if(typeof e=="object"){const t=Object.entries(e).filter(([,n])=>!!n);return{ids:t.map(([n])=>n),emptyExplicitly:t.length===0}}return{ids:null,emptyExplicitly:!1}}function Rd(e,t="reservation"){if(!e)return null;const n=Fr(t),a=Rr(t),s=Array.from(e.sections instanceof Set?e.sections:new Set(e.sections||[])).filter(c=>n.has(c)),r={},i=e.fields||{};return Object.entries(a).forEach(([c,l])=>{const d=i[c];if(d==null)return;const{ids:u,emptyExplicitly:y}=Fd(d);if(!u&&!y)return;const f=Array.isArray(u)?u.filter(m=>l.has(m)):[];(f.length>0||y)&&(r[c]=f)}),{version:1,sections:s,fields:r}}function Zr(e){if(!e)return;const t=e.context||"reservation",n=Rd(e,t);n&&Dd(n,t)}function eo(e){if(!e)return;const t=e.context||"reservation",n=Bd(t);if(!n)return;const a=Fr(t),s=Array.isArray(n.sections)?n.sections.filter(r=>a.has(r)):[];if(s.length&&(e.sections=new Set(s)),n.fields&&typeof n.fields=="object"){const r=Os(e.fields||_a(t)),i=Rr(t);Object.entries(n.fields).forEach(([c,l])=>{const d=i[c];if(!d)return;const u=Array.isArray(l)?l.filter(y=>d.has(y)):[];r[c]=new Set(u)}),e.fields=r}}function to(e=new Date){try{return e.toLocaleDateString("en-GB",{year:"numeric",month:"2-digit",day:"2-digit"})}catch{return e.toISOString().slice(0,10)}}function Md(e){const t=Cn()||[],{technicians:n=[]}=ye(),a=[].concat(Array.isArray(t)?t:[]).concat(Array.isArray(n)?n:[]),s=new Map;return a.forEach(i=>{if(!i||i.id==null)return;const c=String(i.id),l=s.get(c)||{};s.set(c,{...l,...i})}),(Array.isArray(e.crewAssignments)&&e.crewAssignments.length?e.crewAssignments:Array.isArray(e.techniciansDetails)&&e.techniciansDetails.length?e.techniciansDetails:(e.technicians||[]).map(i=>({technicianId:i}))).map((i,c)=>{const l=i?.technicianId!=null?s.get(String(i.technicianId)):null;let d=i.positionLabel??i.position_name??i.position_label??i.role??i.position??l?.role??o("reservations.crew.positionFallback","منصب بدون اسم");(!d||d.trim()==="")&&(d=i.positionLabelAr??i.position_label_ar??i.positionLabelEn??i.position_label_en??i.position_name_ar??i.position_name_en??l?.role??o("reservations.crew.positionFallback","منصب بدون اسم"));const u=he(Te(i.positionCost??i.position_cost??i.cost??i.daily_wage??i.dailyWage??l?.dailyWage??l?.wage??0)),y=he(Te(i.positionClientPrice??i.position_client_price??i.client_price??i.clientPrice??i.daily_total??i.dailyTotal??i.total??l?.dailyTotal??l?.total??l?.total_wage??0));return{assignmentId:i.assignmentId??i.assignment_id??`crew-${c}`,positionId:i.positionId??i.position_id??null,positionLabel:d,positionLabelAlt:i.positionLabelAlt??i.position_label_alt??"",positionCost:u,positionClientPrice:y,technicianId:i.technicianId!=null?String(i.technicianId):l?.id!=null?String(l.id):null,technicianName:i.technicianName??i.technician_name??l?.name??null,technicianRole:i.technicianRole??l?.role??null}})}function zd(e,t,n){const{projectLinked:a}=kt(e,n);ba(e.start,e.end);const s=e.discount??e.discountValue??0,r=Number(h(String(s)))||0,i=e.discountType??e.discount_type??"percent",c=String(i).toLowerCase()==="amount"?"amount":"percent",l=a?!1:!!(e.applyTax??e.apply_tax??e.taxApplied),d=e.companySharePercent??e.company_share_percent??e.companyShare??e.company_share??null,u=d!=null?Te(d):Number.NaN,f=(e.companyShareEnabled??e.company_share_enabled??e.companyShareApplied??e.company_share_applied)===!0&&Number.isFinite(u)&&u>0?u:null,m=Array.isArray(t)?t.map(j=>j?.technicianId).filter(Boolean):[],p=calculateDraftFinancialBreakdown({items:Array.isArray(e.items)?e.items:[],technicianIds:m,crewAssignments:Array.isArray(t)?t:[],discount:r,discountType:c,applyTax:l,start:e.start,end:e.end,companySharePercent:f}),b=Te(e.cost??e.total??e.finalTotal),q=Number.isFinite(b),k=a?p.finalTotal:q?he(b):p.finalTotal,v={equipmentTotal:p.equipmentTotal,crewTotal:p.crewTotal,crewCostTotal:p.crewCostTotal,discountAmount:p.discountAmount,subtotalAfterDiscount:p.subtotalAfterDiscount,taxableAmount:p.taxableAmount,taxAmount:p.taxAmount,finalTotal:k,companySharePercent:p.companySharePercent,companyShareAmount:p.companyShareAmount,netProfit:p.netProfit},S={equipmentTotal:h(p.equipmentTotal.toFixed(2)),crewTotal:h(p.crewTotal.toFixed(2)),discountAmount:h(p.discountAmount.toFixed(2)),subtotalAfterDiscount:h(p.subtotalAfterDiscount.toFixed(2)),taxableAmount:h(p.taxableAmount.toFixed(2)),taxAmount:h(p.taxAmount.toFixed(2)),finalTotal:h(k.toFixed(2)),companySharePercent:h((Number.isFinite(p.companySharePercent)?p.companySharePercent:0).toFixed(2)),companyShareAmount:h(p.companyShareAmount.toFixed(2)),netProfit:h(p.netProfit.toFixed(2))};return{totals:v,totalsDisplay:S,rentalDays:p.rentalDays}}function sn(e){if(e==null||e==="")return null;const t=Number.parseFloat(h(String(e)));return Number.isFinite(t)?t:null}function no(e){if(!e)return new Date().toISOString();const t=new Date(e);return Number.isNaN(t.getTime())?new Date().toISOString():t.toISOString()}function Hd(e){if(!e||typeof e!="object")return null;const t=e.type??e.payment_type??e.paymentType??null;let n=typeof t=="string"?t.trim().toLowerCase():null;n!=="percent"&&(n="amount");const a=sn(e.amount??(n==="amount"?e.value:null)),s=sn(e.percentage??(n==="percent"?e.value:null)),r=n==="percent"?s??null:a??null,i=e.note??e.memo??null,c=no(e.recordedAt??e.recorded_at??e.date??e.created_at??null);return n==="amount"&&a==null||n==="percent"&&s==null?null:{type:n,amount:a??null,percentage:s??null,value:r,note:i,recordedAt:c}}function Od(e={}){const n=(Array.isArray(e.paymentHistory)?e.paymentHistory:Array.isArray(e.payment_history)?e.payment_history:[]).map(Hd).filter(Boolean);if(n.length>0)return n;const a=sn(e.paidPercent??e.paid_percent),s=sn(e.paidAmount??e.paid_amount),r=e.updatedAt??e.updated_at??e.createdAt??e.created_at??null,i=no(r);return a!=null&&a>0?[{type:"percent",amount:s!=null&&s>0?s:null,percentage:a,value:a,note:null,recordedAt:i}]:s!=null&&s>0?[{type:"amount",amount:s,percentage:null,value:s,note:null,recordedAt:i}]:[]}function Vd(e){if(!e)return o("projects.form.types.unknown","نوع غير محدد");const t={commercial:"projects.form.types.commercial",coverage:"projects.form.types.coverage",photography:"projects.form.types.photography",social:"projects.form.types.social"}[e]||"projects.form.types.unknown";return o(t,e)}function Ud(e){const t=new Date,n=e?.start?new Date(e.start):null,a=e?.end?new Date(e.end):null;return n&&!Number.isNaN(n.getTime())&&n>t?"upcoming":a&&!Number.isNaN(a.getTime())&&a<t?"completed":"ongoing"}function Kd(e){return typeof e?.expensesTotal=="number"?e.expensesTotal:Array.isArray(e?.expenses)?e.expenses.reduce((t,n)=>t+(Number(n?.amount)||0),0):0}function Qd(e){const t=Number(e?.equipmentEstimate)||0,n=Kd(e),a=t+n,s=e?.applyTax===!0||e?.applyTax==="true",r=Number.parseFloat(e?.discount??e?.discountValue??0)||0;let c=(e?.discountType==="amount"?"amount":"percent")==="amount"?r:a*(r/100);(!Number.isFinite(c)||c<0)&&(c=0),c>a&&(c=a);const l=Math.max(0,a-c),d=e?.companyShareEnabled===!0||e?.companyShareEnabled==="true"||e?.company_share_enabled===!0||e?.company_share_enabled==="true",u=Number.parseFloat(e?.companySharePercent??e?.company_share_percent??e?.companyShare??e?.company_share??0)||0,y=d&&s&&u>0?u:0,f=y>0?Number((l*(y/100)).toFixed(2)):0,m=l+f;let p=s?m*wr:0;(!Number.isFinite(p)||p<0)&&(p=0),p=Number(p.toFixed(2));let b=s?Number(e?.totalWithTax):m;return s?(!Number.isFinite(b)||b<=0)&&(b=Number((m+p).toFixed(2))):b=m,{equipmentEstimate:t,expensesTotal:n,baseSubtotal:a,discountAmount:c,subtotalAfterDiscount:l,companyShareAmount:f,subtotal:m,applyTax:s,taxAmount:p,totalWithTax:b}}function Gd(e){if(!e)return 0;const t=Array.isArray(e.items)?e.items:[],n=e.discount??0,a=Number(h(String(n)))||0,s=e.discountType||"percent",r=Array.isArray(e.crewAssignments)?e.crewAssignments:[],i=r.length?r:Array.isArray(e.technicians)?e.technicians:[],c=Is(t,a,s,!1,i,{start:e.start,end:e.end});if(Number.isFinite(c))return c;const l=Number(h(String(e.cost??0)));return Number.isFinite(l)?Math.round(l):0}function Wd(e,t){if(!e)return"—";const n=Ge(e);return t?`${n} - ${Ge(t)}`:n}function ce(e,t="SR",n=2){const a=Number(e)||0,s=Number.isInteger(n)?n:2;return`${h(a.toFixed(s))} ${t}`}function ki(e,t=2){if(!Number.isFinite(Number(e)))return"0%";const n=Number.isInteger(t)?t:2;return`${h(Number(e).toFixed(n))}%`}function Xd(e){if(!e?.start)return null;if(!e?.end)return 1;const t=ba(e.start,e.end);return Number.isFinite(t)?t:1}function Jd(e){return Number.isFinite(e)?e<=1?"يوم واحد":`${h(String(Math.round(e)))} أيام`:"غير محدد"}function Yd(e){const t=o("reservations.create.summary.currency","SR"),{customers:n=[],reservations:a=[],projects:s=[],technicians:r=[]}=ye(),i=e?.id!=null?s.find(T=>String(T.id)===String(e.id))||e:e||null,c={projectStatusLabel:o("projects.status.ongoing","قيد التنفيذ"),paymentStatusLabel:o("projects.paymentStatus.unpaid","غير مدفوع")};if(!i)return{project:null,customer:null,clientInfo:{name:"-",company:"-",phone:"-",email:"-"},projectInfo:{title:"-",code:"-",typeLabel:"-",startDisplay:"-",endDisplay:"-",durationLabel:"-",statusLabel:c.projectStatusLabel},expenses:[],equipment:[],reservations:[],totals:{equipmentEstimate:0,expensesTotal:0,baseSubtotal:0,discountAmount:0,subtotalAfterDiscount:0,companyShareAmount:0,subtotal:0,applyTax:!1,taxAmount:0,totalWithTax:0},totalsDisplay:{projectSubtotal:ce(0,t),expensesTotal:ce(0,t),reservationsTotal:ce(0,t),discountAmount:ce(0,t),taxAmount:ce(0,t),overallTotal:ce(0,t),paidAmount:ce(0,t),remainingAmount:ce(0,t)},projectTotals:{combinedTaxAmount:0,overallTotal:0,reservationsTotal:0,paidAmount:0,paidPercent:0,remainingAmount:0,paymentStatus:"unpaid"},paymentSummary:{status:"unpaid",statusLabel:c.paymentStatusLabel,paidAmount:0,paidPercent:0,remainingAmount:0,paidAmountDisplay:ce(0,t),remainingAmountDisplay:ce(0,t),paidPercentDisplay:ki(0)},notes:"",currencyLabel:t,projectStatus:"ongoing",projectStatusLabel:c.projectStatusLabel,projectDurationDays:null,projectDurationLabel:"غير محدد",paymentHistory:[]};const l=i.clientId??i.customerId??i.client_id??i.customer_id??null,d=l!=null&&n.find(T=>String(T.id)===String(l))||null,u=d?.customerName??d?.name??i.clientName??i.customerName??o("projects.fallback.unknownClient","عميل غير معروف"),y=(i.clientCompany||d?.companyName||d?.company||"").trim(),f=d?.phone??d?.customerPhone??i.clientPhone??i.customerPhone??"",m=f?h(String(f).trim()):o("projects.details.client.noPhone","لا يوجد رقم متاح"),p=d?.email??i.clientEmail??i.customerEmail??"",b=p?String(p).trim():o("projects.details.client.noEmail","لا يوجد بريد متاح"),q=i.projectCode||`PRJ-${h(String(i.id??""))}`,k=h(String(q)),v=(i.title||"").trim()||o("projects.fallback.untitled","مشروع بدون عنوان"),S=Vd(i.type),j=i.start?Ge(i.start):"—",Q=i.end?Ge(i.end):"—",E=Xd(i),I=E!=null?Jd(E):"غير محدد",$=Ud(i),P={upcoming:"قادم",ongoing:"قيد التنفيذ",completed:"مكتمل"},H=o(`projects.status.${$}`,P[$]||$),_=i.id!=null?String(i.id):null,L=_?a.filter(T=>String(T.projectId)===_):[],C=L.map(T=>{const ie=T.reservationId||T.id||"",fe=T.status||T.state||"pending",ge=String(fe).toLowerCase(),me=o(`reservations.status.${ge}`,ge),Ve=Gd(T),_e=T.start?new Date(T.start).getTime():0;return{reservationId:h(String(ie||"-")),status:ge,statusLabel:me,total:Ve,totalLabel:ce(Ve,t),dateRange:Wd(T.start,T.end),startTimestamp:Number.isNaN(_e)?0:_e}}).sort((T,ie)=>ie.startTimestamp-T.startTimestamp).map(({startTimestamp:T,...ie})=>ie).reduce((T,ie)=>T+(Number(ie.total)||0),0),B=new Map;L.forEach(T=>{const ie=Array.isArray(T.items)?T.items:[],fe=ba(T.start,T.end),ge=T.reservationId||T.id||"";ie.forEach((me,Ve)=>{if(!me)return;const _e=me.barcode||me.code||me.id||me.desc||me.description||`item-${Ve}`,Me=String(_e||`item-${Ve}`),et=B.get(Me)||{description:me.desc||me.description||me.name||me.barcode||`#${h(String(Ve+1))}`,totalQuantity:0,reservationsCount:0,reservationIds:new Set,totalCost:0},vt=Number(me.qty)||1,un=Number(me.price)||0;et.totalQuantity+=vt,et.reservationIds.add(String(ge));const Wt=un*vt*Math.max(1,fe);Number.isFinite(Wt)&&(et.totalCost+=Wt),B.set(Me,et)})});const w=Array.from(B.values()).map(T=>({description:T.description,totalQuantity:T.totalQuantity,reservationsCount:T.reservationIds.size,displayCost:ce(T.totalCost,t)})),X=new Map((r||[]).filter(Boolean).map(T=>[String(T.id),T])),U=new Map,D=T=>{if(!T)return;let ie=null;typeof T=="object"?ie=T.id??T.technicianId??T.technician_id??T.userId??T.user_id??null:(typeof T=="string"||typeof T=="number")&&(ie=T);const fe=ie!=null?String(ie):null,ge=fe&&X.has(fe)?X.get(fe):typeof T=="object"?T:null,me=ge?.name||ge?.full_name||ge?.fullName||ge?.displayName||(typeof T=="string"?T:null),Ve=ge?.role||ge?.title||null,_e=ge?.phone||ge?.mobile||ge?.contact||null;if(!me&&!fe)return;const Me=fe||me;U.has(Me)||U.set(Me,{id:fe,name:me||"-",role:Ve||null,phone:_e||null})};Array.isArray(i?.technicians)&&i.technicians.forEach(T=>D(T)),L.forEach(T=>{(Array.isArray(T.crewAssignments)&&T.crewAssignments.length?T.crewAssignments:Array.isArray(T.technicians)?T.technicians.map(fe=>({technicianId:fe})):[]).forEach(fe=>D(fe))});const F=Array.from(U.values()),R=Array.isArray(i.expenses)?i.expenses.map(T=>{const ie=Number(T?.amount)||0;return{label:T?.label||T?.name||"-",amount:ie,displayAmount:ce(ie,t),note:T?.note||T?.description||""}}):[],M=Qd(i),K=M.applyTax?Number(((M.subtotal+C)*wr).toFixed(2)):0,se=Number((M.subtotal+C+K).toFixed(2)),te=Od(i),ue=sn(i.paidAmount??i.paid_amount)||0,J=sn(i.paidPercent??i.paid_percent)||0,oe=ks({totalAmount:se,paidAmount:ue,paidPercent:J,history:te}),qe=typeof i.paymentStatus=="string"?i.paymentStatus.toLowerCase():"",Se=_s({manualStatus:qe,paidAmount:oe.paidAmount,paidPercent:oe.paidPercent,totalAmount:se}),Ce={paid:"مدفوع",partial:"مدفوع جزئياً",unpaid:"غير مدفوع"},V=o(`projects.paymentStatus.${Se}`,Ce[Se]||Se),Z=Number(oe.paidAmount||0),ne=Number(oe.paidPercent||0),Ee=Math.max(0,Number((se-Z).toFixed(2))),Re={projectSubtotal:ce(M.subtotal,t),expensesTotal:ce(M.expensesTotal,t),reservationsTotal:ce(C,t),discountAmount:ce(M.discountAmount,t),taxAmount:ce(K,t),overallTotal:ce(se,t),paidAmount:ce(Z,t),remainingAmount:ce(Ee,t)},ae={status:Se,statusLabel:V,paidAmount:Z,paidPercent:ne,remainingAmount:Ee,paidAmountDisplay:ce(Z,t),remainingAmountDisplay:ce(Ee,t),paidPercentDisplay:ki(ne)},Y=(i.description||"").trim();return{project:i,customer:d,clientInfo:{name:u,company:y||"—",phone:m,email:b},projectInfo:{title:v,code:k,typeLabel:S,startDisplay:j,endDisplay:Q,durationLabel:I,statusLabel:H},expenses:R,equipment:w,crew:F,totals:M,totalsDisplay:Re,projectTotals:{combinedTaxAmount:K,overallTotal:se,reservationsTotal:C,paidAmount:Z,paidPercent:ne,remainingAmount:Ee,paymentStatus:Se},paymentSummary:ae,notes:Y,currencyLabel:t,projectStatus:$,projectStatusLabel:H,projectDurationDays:E,projectDurationLabel:I,paymentHistory:te}}function Zd({project:e,clientInfo:t={},projectInfo:n={},projectCrew:a=[],projectExpenses:s=[],projectEquipment:r=[],totalsDisplay:i={},projectTotals:c={},paymentSummary:l={},currencyLabel:d="SR",sections:u,fieldSelections:y={},quoteNumber:f,quoteDate:m,terms:p=Oe}){const b=Os(y),q=(V,Z)=>Vs(b,V,Z),k=V=>u?.has?.(V),v=`<div class="quote-placeholder">${A(o("reservations.quote.placeholder.noFields","لم يتم اختيار أي معلومات للعرض في هذا القسم."))}</div>`,S=(V,Z)=>`<div class="info-plain__item">
      ...
      <span class="payment-row__value">${A(Z)}</span>
        ...
        </section>`:"",B=Lr.filter(V=>q("projectExpenses",V.id)),w=k("projectExpenses")?B.length?`<section class="quote-section quote-section--table">
  ...
  `}function ao(e){if(e?.context==="project")return Zd(e);const{reservation:t,customer:n,project:a,crewAssignments:s,totals:r,totalsDisplay:i,rentalDays:c,currencyLabel:l,sections:d,fieldSelections:u={},quoteNumber:y,quoteDate:f,terms:m=Oe}=e,p=h(String(t?.reservationId??t?.id??"")),b=t.start?h(Ge(t.start)):"-",q=t.end?h(Ge(t.end)):"-",k=n?.customerName||n?.full_name||n?.name||"-",v=n?.phone||"-",S=n?.email||"-",j=n?.company||n?.company_name||"-",Q=h(v),E=a?.title||a?.name||o("reservations.details.project.none","غير مرتبط بمشروع"),I=a?.code||a?.projectCode||"",$=h(String(c)),P=t?.notes||"",H=Array.isArray(m)&&m.length?m:Oe,_=Os(u),L=(z,ke)=>Vs(_,z,ke),G=z=>d?.has?.(z),C=`<div class="quote-placeholder">${A(o("reservations.quote.placeholder.noFields","لم يتم اختيار أي معلومات للعرض في هذا القسم."))}</div>`,B=(z,ke)=>`<div class="info-plain__item">${A(z)} <span class="info-plain__slash">/</span> <strong class="info-plain__value">${A(ke)}</strong></div>`,w=(z,ke,{variant:tt="inline"}={})=>tt==="final"?`<div class="totals-item totals-item--final">
