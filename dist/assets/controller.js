import{d as Z,n as q,f as Ui,t as o,b as Te,h as S,j as mt,o as Kt,s as Sa,A as Ss,z as Qi,k as Qe,B as Es,u as Ki}from"./auth.js";import{n as J,D as He,l as Ea,o as Za,p as zt,q as ws,t as Gi,v as We,w as Xe,x as wa,y as Wi,z as Xi,A as xs,h as Is,B as As,C as _s,E as $s,F as Yi,s as Gt,i as xn,G as ks,H as Ji,I as Ls,J as Cs,f as Ts,a as Ps,g as ot,K as Zi,L as eo,M as Yn,N as to,O as no,u as ao,P as so,k as ro}from"./reservationsService.js";const Un="select.form-select:not([data-no-enhance]):not([multiple])",Pe=new WeakMap;let Qn=null,es=!1,Fe=null;function Xl(e=document){e&&(e.querySelectorAll(Un).forEach(t=>rn(t)),!Qn&&e===document&&(Qn=new MutationObserver(t=>{for(const n of t)n.addedNodes?.forEach(a=>{a instanceof Element&&(a.matches?.(Un)&&rn(a),a.querySelectorAll?.(Un).forEach(s=>rn(s)))})}),Qn.observe(document.body,{childList:!0,subtree:!0})),es||(es=!0,document.addEventListener("pointerdown",co,{capture:!0})))}function sn(e){if(!(e instanceof HTMLSelectElement))return;if(!e.dataset.enhancedSelect){rn(e);return}const t=e.closest(".enhanced-select");t&&(xa(t),un(t),Jn(t))}function rn(e){if(!(e instanceof HTMLSelectElement))return;if(e.dataset.enhancedSelect){sn(e);return}if(e.multiple||e.size>1)return;const t=document.createElement("div");t.className="enhanced-select";const n=e.parentNode;n&&n.insertBefore(t,e),t.appendChild(e),e.dataset.enhancedSelect="true",e.classList.add("enhanced-select__native"),e.setAttribute("tabindex","-1"),e.setAttribute("aria-hidden","true");const a=document.createElement("button");a.type="button",a.className="enhanced-select__trigger",a.setAttribute("aria-haspopup","listbox"),a.setAttribute("aria-expanded","false");const s=document.createElement("ul");s.className="enhanced-select__menu",s.setAttribute("role","listbox"),s.setAttribute("tabindex","-1"),t.append(a,s);const r={select:e,trigger:a,menu:s,observer:null,refreshRaf:null};Pe.set(t,r),a.addEventListener("click",()=>oo(t)),a.addEventListener("keydown",i=>lo(i,t)),s.addEventListener("click",i=>mo(i,t)),s.addEventListener("keydown",i=>uo(i,t)),e.addEventListener("change",()=>{un(t),Bs(t)}),r.observer=new MutationObserver(i=>{let c=!1,l=!1;for(const d of i)d.type==="attributes"&&d.attributeName==="disabled"&&(l=!0),d.type==="childList"&&(c=!0);l&&Jn(t),c&&io(r,t)}),r.observer.observe(e,{attributes:!0,attributeFilter:["disabled"],childList:!0}),xa(t),un(t),Jn(t)}function io(e,t){e&&(e.refreshRaf||(e.refreshRaf=requestAnimationFrame(()=>{e.refreshRaf=null,xa(t),un(t)})))}function xa(e){const t=Pe.get(e);if(!t)return;const{select:n,menu:a}=t;if(!n||!a)return;const s=Array.from(n.options||[]),r=document.createDocumentFragment();s.forEach(i=>{const c=document.createElement("li");c.className="enhanced-select__option",c.textContent=i.textContent??i.value??"",c.dataset.value=i.value??"",c.setAttribute("role","option"),c.setAttribute("tabindex","-1"),i.disabled&&(c.setAttribute("aria-disabled","true"),c.classList.add("is-disabled")),i.selected&&(c.setAttribute("aria-selected","true"),c.dataset.selected="true",c.setAttribute("tabindex","0")),r.appendChild(c)}),a.innerHTML="",a.appendChild(r),Bs(e)}function un(e){const t=Pe.get(e);if(!t)return;const{select:n,trigger:a}=t;if(!n||!a)return;const s=n.selectedOptions?.[0]??n.options?.[n.selectedIndex],r=s?.textContent?.trim()||s?.value||"";a.textContent=r}function Bs(e){const t=Pe.get(e);if(!t)return;const{select:n,menu:a}=t;if(!n||!a)return;const s=n.value;a.querySelectorAll(".enhanced-select__option").forEach(i=>{const c=i.dataset.value===s;i.toggleAttribute("aria-selected",c),i.dataset.selected=c?"true":"",i.setAttribute("tabindex",c?"0":"-1")})}function Jn(e){const t=Pe.get(e);if(!t)return;const{select:n,trigger:a}=t,s=!!n?.disabled;e.classList.toggle("enhanced-select--disabled",s),a.disabled=s}function oo(e){Pe.get(e)&&(e.getAttribute("data-open")==="true"?At(e):Ns(e))}function Ns(e){const t=Pe.get(e);if(!t)return;Fe&&Fe!==e&&At(Fe,{focusTrigger:!1}),e.setAttribute("data-open","true"),t.trigger.setAttribute("aria-expanded","true"),Fe=e;const n=t.menu.querySelector('.enhanced-select__option[aria-selected="true"]')??t.menu.querySelector(".enhanced-select__option:not([aria-disabled='true'])");n?n.focus():t.menu.focus()}function At(e,{focusTrigger:t=!0}={}){const n=Pe.get(e);n&&(e.setAttribute("data-open","false"),n.trigger.setAttribute("aria-expanded","false"),t&&n.trigger.focus({preventScroll:!0}),Fe===e&&(Fe=null))}function co(e){if(!Fe)return;const t=e.target;t instanceof Node&&(Fe.contains(t)||At(Fe,{focusTrigger:!1}))}function lo(e,t){const n=e.key;n==="ArrowDown"||n==="ArrowUp"||n===" "||n==="Enter"?(e.preventDefault(),Ns(t)):n==="Escape"&&At(t)}function uo(e,t){const n=e.key,a=Pe.get(t);if(!a)return;const s=Array.from(a.menu.querySelectorAll(".enhanced-select__option:not([aria-disabled='true'])"));if(!s.length)return;const r=s.findIndex(i=>i===document.activeElement);if(n==="ArrowDown"||n==="ArrowUp"){e.preventDefault();const c=(r+(n==="ArrowDown"?1:-1)+s.length)%s.length;s[c].focus()}else if(n==="Home")e.preventDefault(),s[0].focus();else if(n==="End")e.preventDefault(),s[s.length-1].focus();else if(n==="Enter"||n===" "){e.preventDefault();const i=document.activeElement;i&&i.classList.contains("enhanced-select__option")&&Ds(i,t)}else n==="Escape"&&(e.preventDefault(),At(t))}function mo(e,t){const n=e.target?.closest?.(".enhanced-select__option");n&&Ds(n,t)}function Ds(e,t){const n=Pe.get(t);if(!n||e.getAttribute("aria-disabled")==="true")return;const{select:a}=n,s=e.dataset.value??"";a.value!==s&&(a.value=s,a.dispatchEvent(new Event("change",{bubbles:!0}))),At(t)}const po=Z()||{};let Ve=(po.equipment||[]).map(go),Zn=!1,Rt="",it=null,lt=null,dt=null,In=!1;function fo(e){if(!e)return null;const t=window?.bootstrap?.Modal??(typeof bootstrap<"u"?bootstrap.Modal:null);return t?t.getOrCreateInstance(e):null}function yo(){document.dispatchEvent(new CustomEvent("equipment:changed"))}function go(e={}){return Ia({...e,subcategory:e.subcategory??e.sub??"",description:e.description??e.desc??e.name??"",quantity:e.quantity??e.qty??0,unit_price:e.unit_price??e.price??0,image_url:e.image_url??e.imageUrl??e.image??""})}function An(e={}){return Ia(e)}function Ia(e={}){const t=e.id??e.equipment_id??e.equipmentId??e.item_id??e.itemId??null,n=e.description??e.desc??e.name??"",a=e.category??"",s=e.subcategory??e.sub??"",r=Wt(e.quantity??e.qty??0),i=_n(e.unit_price??e.price??0),c=q(String(e.barcode??"").trim()),l=me(e.status??e.state??e.status_label??e.statusLabel??"available"),d=e.image_url??e.imageUrl??e.image??"",u=e.name??e.item_name??n;return{id:bo(t)?String(t):"",category:a,sub:s,desc:n,name:u,qty:r,price:i,barcode:c,status:l,image:d,imageUrl:d,created_at:e.created_at??null,updated_at:e.updated_at??null}}function bo(e){return e!=null&&e!==""}function Wt(e){const t=Number.parseInt(e,10);return Number.isFinite(t)&&t>=0?t:0}function _n(e){const t=Number.parseFloat(e);return Number.isFinite(t)?Math.round(t*100)/100:0}function vo(e){!e||e.dataset.englishDigitsAttached||(e.addEventListener("input",()=>{const{selectionStart:t,selectionEnd:n,value:a}=e,s=q(a);if(s!==a&&(e.value=s,t!=null&&n!=null)){const r=s.length-a.length,i=t+r,c=n+r;e.setSelectionRange(i,c)}}),e.dataset.englishDigitsAttached="true")}function ts(e){if(!e)return"";const t=q(String(e.barcode??"")).trim();if(t)return t;if(Array.isArray(e.variants))for(const n of e.variants){const a=q(String(n?.barcode??"")).trim();if(a)return a}return""}function ho(e,t){const n=ts(e),a=ts(t);if(!n&&!a)return 0;if(!n)return 1;if(!a)return-1;const s=/^[0-9]+$/,r=s.test(n),i=s.test(a);if(r&&i){if(n.length!==a.length)return n.length-a.length;const d=n.localeCompare(a,"ar",{numeric:!0,sensitivity:"base"});if(d!==0)return d}else{if(r!==i)return r?-1:1;{const d=n.localeCompare(a,"ar",{numeric:!0,sensitivity:"base"});if(d!==0)return d}}const c=mn(e?.desc||e?.description||e?.name||""),l=mn(t?.desc||t?.description||t?.name||"");return c.localeCompare(l,"ar",{sensitivity:"base"})}function ue(e=""){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function me(e){switch(String(e??"").trim().toLowerCase()){case"available":case"متاح":case"متوفر":return"available";case"reserved":case"محجوز":return"reserved";case"maintenance":case"صيانة":return"maintenance";case"retired":case"متوقف":case"خارج الخدمة":return"retired";default:return"available"}}function qo(e){return me(e)}function be(){return Ve}function ut(e){Ve=Array.isArray(e)?e.map(Ia):[],Sa({equipment:Ve}),yo()}function mn(e){return String(e??"").trim().toLowerCase()}function Ke(e){if(!e)return"";const t=e.desc||e.description||e.name||"";let n=mn(t);return n||(n=mn(e.category||"")),n||(n=q(String(e.barcode||"")).trim().toLowerCase()),n}function $n(e){const t=Ke(e);return t?be().filter(n=>Ke(n)===t):[]}function kn(e){const t=document.getElementById("equipment-details-cover");if(!t)return;const n=Ln(e);if(n){const a=ue(e.desc||e.description||e.name||"");t.innerHTML=`<img src="${ue(n)}" alt="${a}">`,t.classList.add("has-image")}else t.innerHTML='<span class="equipment-details-header__placeholder" aria-hidden="true">📦</span>',t.classList.remove("has-image")}function Aa(){return{category:document.getElementById("edit-equipment-category"),subcategory:document.getElementById("edit-equipment-subcategory"),description:document.getElementById("edit-equipment-description"),quantity:document.getElementById("edit-equipment-quantity"),price:document.getElementById("edit-equipment-price"),image:document.getElementById("edit-equipment-image"),barcode:document.getElementById("edit-equipment-barcode"),status:document.getElementById("edit-equipment-status")}}function pn(){const e=Aa();return{category:e.category?.value??"",subcategory:e.subcategory?.value??"",description:e.description?.value??"",quantity:e.quantity?.value??"",price:e.price?.value??"",image:e.image?.value??"",barcode:e.barcode?.value??"",status:e.status?.value??""}}function _a(e={}){const t=Aa();t.category&&(t.category.value=e.category??""),t.subcategory&&(t.subcategory.value=e.subcategory??""),t.description&&(t.description.value=e.description??""),t.quantity&&(t.quantity.value=e.quantity!=null?q(String(e.quantity)):""),t.price&&(t.price.value=e.price!=null?q(String(e.price)):""),t.image&&(t.image.value=e.image??""),t.barcode&&(t.barcode.value=e.barcode??""),t.status&&(t.status.value=e.status??"")}function wt(e){In=e;const t=Aa(),n=document.getElementById("equipment-edit-cancel"),a=document.getElementById("save-equipment-changes"),s=document.getElementById("edit-equipment-form");if(s&&s.classList.toggle("equipment-details-form--editing",e),[t.category,t.subcategory,t.description,t.quantity,t.price,t.image].forEach(i=>{i&&(e?i.removeAttribute("disabled"):i.setAttribute("disabled","disabled"))}),n&&(n.hidden=!e,n.disabled=!e),a){a.disabled=!1;const i=e?"equipment.modal.actions.save":"equipment.modal.actions.edit",c=e?"💾 حفظ التعديلات":"✏️ تعديل";a.textContent=o(i,c),a.dataset.mode=e?"save":"view"}if(e){const i=t.description||t.category||t.subcategory;i&&setTimeout(()=>{i.focus(),typeof i.select=="function"&&i.select()},0)}}async function Yl(e){if(!mt()){Kt();return}if(!e)return;try{await Eo()}catch(n){console.error("❌ [equipment.js] Unable to load XLSX",n),alert(o("equipment.toast.xlsxMissing","⚠️ مكتبة Excel (XLSX) غير محملة."));return}const t=new FileReader;t.onload=async function(n){try{const a=new Uint8Array(n.target.result),s=XLSX.read(a,{type:"array"}),r=s.Sheets[s.SheetNames[0]],i=XLSX.utils.sheet_to_json(r,{defval:""});if(!Array.isArray(i)||i.length===0){S(o("equipment.toast.uploadEmpty","⚠️ لم يتم العثور على بيانات في الملف"));return}const c=[];let l=0;if(i.forEach(d=>{const u=d.القسم??d.category??"",m=d["القسم الثانوي"]??d.subcategory??"",p=d.الوصف??d.description??d.name??"",f=d.الكمية??d.quantity??0,g=d.السعر??d.price??0,y=d.الباركود??d.barcode??"",b=d.الحالة??d.status??"متاح",w=d.الصورة??d.image_url??d.image??"",h=q(String(y||"")).trim();if(!p||!h){l+=1;return}c.push($a({category:u,subcategory:m,description:p,quantity:f,unit_price:g,barcode:h,status:b,image_url:w}))}),!c.length){S(o("equipment.toast.uploadEmpty","⚠️ لم يتم العثور على بيانات في الملف"));return}try{const d=await Te("/equipment/?bulk=1",{method:"POST",body:c}),u=Array.isArray(d?.data)?d.data.map(An):[];if(u.length){const f=[...be(),...u];ut(f)}await Cn({showToastOnError:!1}),pe();const m=d?.meta?.count??u.length,p=[];m&&p.push(`${m} ✔️`),l&&p.push(`${l} ⚠️`),S(o("equipment.toast.uploadSuccess","✅ تم رفع المعدات بنجاح")+(p.length?` (${p.join(" / ")})`:""))}catch(d){const u=_t(d,"equipment.toast.uploadFailed","❌ حدث خطأ أثناء قراءة ملف الإكسل");S(u,"error")}}catch(a){console.error("❌ [equipment.js] Failed to process Excel file",a),S(o("equipment.toast.uploadFailed","❌ حدث خطأ أثناء قراءة ملف الإكسل"),"error")}},t.onerror=function(){console.error("❌ [equipment.js] FileReader error",t.error),S(o("equipment.toast.uploadFailed","❌ حدث خطأ أثناء قراءة ملف الإكسل"),"error")},t.readAsArrayBuffer(e)}const So="https://cdn.jsdelivr.net/npm/xlsx@0.18.5/dist/xlsx.full.min.js";let Bt=null;function Eo(){return typeof XLSX<"u"?Promise.resolve():typeof window>"u"||typeof document>"u"?Promise.reject(new Error("XLSX library is not available in this environment")):Bt||(Bt=new Promise((e,t)=>{const n=document.querySelector('script[data-xlsx-loader="true"]');if(n){n.addEventListener("load",s,{once:!0}),n.addEventListener("error",r,{once:!0});return}const a=document.createElement("script");a.src=So,a.async=!0,a.defer=!0,a.dataset.xlsxLoader="true",a.addEventListener("load",s,{once:!0}),a.addEventListener("error",r,{once:!0}),document.head.appendChild(a);function s(){if(typeof XLSX>"u"){t(new Error("XLSX did not load correctly"));return}e()}function r(){t(new Error("Failed to load XLSX library"))}}).catch(e=>{throw console.warn("⚠️ [equipment.js] ensureXLSXLoaded failed",e),Bt=null,e}),Bt)}function $a({category:e="",subcategory:t="",description:n="",quantity:a=0,unit_price:s=0,barcode:r="",status:i="متاح",image_url:c=""}){const l=q(String(r||"")).trim(),d=qo(i);return{category:e?.trim()||null,subcategory:t?.trim()||null,name:n?.trim()||null,description:n?.trim()||null,quantity:Wt(a),unit_price:_n(s),barcode:l,status:d,image_url:c?.trim()||null}}async function wo(){if(!mt()){Kt();return}if(confirm(o("equipment.toast.clearConfirm","⚠️ هل أنت متأكد من حذف كل المعدات؟")))try{const t=(await Te("/equipment/?all=1",{method:"DELETE"}))?.meta?.deleted??0;await Cn({showToastOnError:!1}),S(o("equipment.toast.clearSuccess","🗑️ تم مسح جميع المعدات")+(t?` (${t})`:""))}catch(e){const t=_t(e,"equipment.toast.clearFailed","⚠️ تعذر حذف بعض المعدات");S(t,"error")}}function Ln(e){return e.image||e.imageUrl||e.img||""}function xo(e){const t=me(e),n={available:{label:o("equipment.form.options.available","✅ متاح"),className:"equipment-status-badge equipment-status-badge--available"},reserved:{label:o("equipment.form.options.booked","📌 محجوز"),className:"equipment-status-badge equipment-status-badge--reserved"},maintenance:{label:o("equipment.form.options.maintenance","🛠️ صيانة"),className:"equipment-status-badge equipment-status-badge--maintenance"},retired:{label:o("equipment.form.options.retired","📦 خارج الخدمة"),className:"equipment-status-badge equipment-status-badge--retired"}},{label:a,className:s}=n[t]||{label:e||"-",className:"equipment-status-badge equipment-status-badge--default"};return`<span class="${s}">${a}</span>`}function fn(){const e=document.getElementById("equipment-variants-section"),t=document.getElementById("equipment-variants-table-body"),n=document.getElementById("equipment-variants-count");if(e&&(e.hidden=!0),t){const a=o("equipment.modal.variants.empty","لا توجد قطع مرتبطة أخرى.");t.innerHTML=`<tr><td colspan="4" class="text-center text-muted">${ue(a)}</td></tr>`}n&&(n.textContent="0")}function js(e){const t=document.getElementById("equipment-variants-section"),n=document.getElementById("equipment-variants-table-body"),a=document.getElementById("equipment-variants-count");if(!t||!n||!e)return;const r=it?.groupKey||Ke(e);if(!r){fn();return}const i=be().filter(m=>Ke(m)===r).sort((m,p)=>{const f=String(m.barcode||"").trim(),g=String(p.barcode||"").trim();return!f&&!g?0:f?g?f.localeCompare(g,"ar",{numeric:!0,sensitivity:"base"}):-1:1});if(!i.length){fn();return}t.hidden=!1,a&&(a.textContent=String(i.length));const c=o("equipment.modal.variants.current","الحالي"),l=o("equipment.form.labels.quantity","الكمية"),d=be(),u=i.map(m=>{const p=m.id&&e.id?String(m.id)===String(e.id):String(m.barcode||"")===String(e.barcode||""),f=p?"equipment-variants-table__row--current":"",g=ue(String(m.barcode||"-")),y=p?`<span class="equipment-variants-current-badge">${ue(c)}</span>`:"",b=q(String(Number.isFinite(Number(m.qty))?Number(m.qty):0)),w=d.indexOf(m),h=ue(o("equipment.item.actions.delete","🗑️ حذف")),I=w>=0?`<div class="table-action-buttons equipment-variant-actions">
  ...
  `,P=[];i&&P.push(`<button type="button" class="btn btn-sm equipment-card__action-btn equipment-card__action-btn--delete" data-equipment-action="delete" data-equipment-index="${t}">${a}</button>`);const N=P.length?`<div class="equipment-card__actions equipment-card__actions--center">${P.join(`
`)}</div>`:"",z=ue(v);return`
    <article
  ...
  `).join("");console.debug("[reservations/details] payment history raw",e.paymentHistory,e.payment_history);let Pt=[];Array.isArray(e.paymentHistory)?Pt=e.paymentHistory:Array.isArray(e.payment_history)&&(Pt=e.payment_history);const Pi=Array.isArray(e.paymentLogs)?e.paymentLogs:[],Wa=Array.isArray(Pt)&&Pt.length>0?Pt:Pi,Bi=Wa.length?`<ul class="reservation-payment-history-list">${Wa.map(L=>{const G=L?.type==="amount"?o("reservations.paymentHistory.type.amount","دفعة مالية"):L?.type==="percent"?o("reservations.paymentHistory.type.percent","دفعة نسبة"):o("reservations.paymentHistory.type.unknown","دفعة"),ae=Number.isFinite(Number(L?.amount))&&Number(L.amount)>0?`${q(Number(L.amount).toFixed(2))} ${te}`:"—",qe=Number.isFinite(Number(L?.percentage))&&Number(L.percentage)>0?`${q(Number(L.percentage).toFixed(2))}%`:"—",qt=L?.recordedAt?q(Qe(L.recordedAt)):"—",St=L?.note?`<div class="payment-history-note">${Se(q(L.note))}</div>`:"";return`
        ...
        `}).join("")}</ul>`:`<div class="reservation-payment-history-empty">${Se(hi)}</div>`,Xa=[{text:i?Ur:Qr,className:i?"status-confirmed":"status-pending"},{text:Si,className:On==="paid"?"status-paid":Qa?"status-partial":"status-unpaid"}];l&&Xa.push({text:Xr,className:"status-completed"});const Ni=Xa.map(({text:L,className:G})=>`<span class="status-chip ${G}">${L}</span>`).join(""),at=(L,G,ae)=>`
    <div class="res-info-row">
      <span class="label">${L} ${G}</span>
      <span class="value">${ae}</span>
    </div>
  `;let zn="";if(e.projectId){let L=Se(di);if(s){const G=s.title||o("projects.fallback.untitled","مشروع بدون اسم");L=`${Se(G)} <button type="button" class="btn btn-sm btn-outline-primary" data-action="open-project" data-project-id="${s.id}">${Se(ui)}</button>`}zn=`
      <div class="res-info-row">
        <span class="label">📁 ${li}</span>
        <span class="value">${L}</span>
      </div>
    `}const Ne=[];Ne.push(at("👤",oi,t?.customerName||qi)),Ne.push(at("📞",ci,t?.phone||"—")),Ne.push(at("🗓️",mi,Be)),Ne.push(at("🗓️",pi,_e)),Ne.push(at("📦",gi,Ka)),Ne.push(at("⏱️",tt,se)),Ne.push(at("📝",fi,Ii)),zn&&Ne.push(zn);const Di=Ne.join(""),ji=u.length?u.map(L=>{const G=L.items[0]||{},ae=pt(G)||L.image,qe=ae?`<img src="${ae}" alt="${Mn}" class="reservation-item-thumb">`:'<div class="reservation-item-thumb reservation-item-thumb--placeholder" aria-hidden="true">🎥</div>',qt=Number(L.quantity)||Number(L.count)||0,St=q(String(qt)),Ya=Number.isFinite(Number(L.unitPrice))?Number(L.unitPrice):0,Hi=Number.isFinite(Number(L.totalPrice))?Number(L.totalPrice):Ya*qt,Oi=`${q(Ya.toFixed(2))} ${te}`,zi=`${q(Hi.toFixed(2))} ${te}`,Ja=L.barcodes.map(Vn=>q(String(Vn||""))).filter(Boolean),Vi=Ja.length?`<details class="reservation-item-barcodes">
              <summary>${o("reservations.equipment.barcodes.summary","عرض الباركودات")}</summary>
              <ul class="reservation-barcode-list">
          ...
          <tr>
            <td class="reservation-modal-items-table__cell reservation-modal-items-table__cell--item">
              <div class="reservation-item-info">
                ...
                <div class="reservation-item-copy">
                  <div class="reservation-item-title">${Se(G.desc||G.description||G.name||L.description||"-")}</div>
                  ${Vi}
                </div>
              </div>
            </td>
  ...
  `,Ri=g.map((L,G)=>{const ae=q(String(G+1)),qe=L.role||ce,qt=L.phone||nt,St=L.wage?Vr.replace("{amount}",q(String(L.wage))).replace("{currency}",te):"";return`
...
`);return e&&e.value.trim().length===0&&(e.value=n),t&&t.value.trim().length===0&&(t.value=n),[...we]}const Pn=[{id:"customerInfo",labelKey:"reservations.quote.sections.customer",fallback:"بيانات العميل",defaultSelected:!0},{id:"reservationInfo",labelKey:"reservations.quote.sections.reservation",fallback:"تفاصيل الحجز",defaultSelected:!0},{id:"projectInfo",labelKey:"reservations.quote.sections.project",fallback:"بيانات المشروع",defaultSelected:!0},{id:"financialSummary",labelKey:"reservations.quote.sections.financial",fallback:"الملخص المالي",defaultSelected:!0},{id:"items",labelKey:"reservations.quote.sections.items",fallback:"قائمة المعدات",defaultSelected:!0},{id:"crew",labelKey:"reservations.quote.sections.crew",fallback:"طاقم العمل",defaultSelected:!0},{id:"notes",labelKey:"reservations.quote.sections.notes",fallback:"ملاحظات الحجز",defaultSelected:!0}],rr=[{id:"rowNumber",labelKey:null,fallback:"#",render:(e,t)=>k(q(String(t+1)))},{id:"code",labelKey:"reservations.details.table.headers.code",fallback:"الكود",render:e=>k(e?.barcode||"-")},{id:"description",labelKey:"reservations.details.table.headers.description",fallback:"الوصف",render:e=>k(e?.desc||e?.description||"-")},{id:"quantity",labelKey:"reservations.details.table.headers.quantity",fallback:"الكمية",render:e=>k(q(String(e?.qty||1)))},{id:"price",labelKey:"reservations.details.table.headers.price",fallback:"السعر",render:e=>k(q(Number(e?.price||0).toFixed(2)))}],ir=[{id:"rowNumber",labelKey:null,fallback:"#",render:(e,t)=>k(q(String(t+1)))},{id:"name",labelKey:"reservations.details.technicians.name",fallback:"الاسم",render:e=>k(e?.name||e?.full_name||"-")},{id:"role",labelKey:"reservations.details.technicians.role",fallback:"الدور",render:e=>k(e?.role||o("reservations.details.technicians.roleUnknown","غير محدد"))},{id:"phone",labelKey:"reservations.details.technicians.phone",fallback:"الهاتف",render:e=>k(e?.phone||o("reservations.details.technicians.phoneUnknown","غير متوفر"))}],Na={customerInfo:[{id:"customerName",labelKey:"reservations.details.labels.customer",fallback:"العميل"},{id:"customerCompany",labelKey:"reservations.details.labels.company",fallback:"الشركة"},{id:"customerPhone",labelKey:"reservations.details.labels.phone",fallback:"الهاتف"},{id:"customerEmail",labelKey:"reservations.details.labels.email",fallback:"البريد"}],reservationInfo:[{id:"reservationId",labelKey:"reservations.details.labels.reservationId",fallback:"رقم الحجز"},{id:"reservationStart",labelKey:"reservations.details.labels.start",fallback:"بداية الحجز"},{id:"reservationEnd",labelKey:"reservations.details.labels.end",fallback:"نهاية الحجز"},{id:"reservationDuration",labelKey:"reservations.details.labels.duration",fallback:"عدد الأيام"}],projectInfo:[{id:"projectTitle",labelKey:"reservations.details.labels.project",fallback:"المشروع"},{id:"projectCode",labelKey:"reservations.details.labels.code",fallback:"الرمز"}],financialSummary:[{id:"equipmentTotal",labelKey:"reservations.details.labels.equipmentTotal",fallback:"إجمالي المعدات"},{id:"crewTotal",labelKey:"reservations.details.labels.crewTotal",fallback:"إجمالي الفريق"},{id:"discountAmount",labelKey:"reservations.details.labels.discount",fallback:"الخصم"},{id:"taxAmount",labelKey:"reservations.details.labels.tax",fallback:"الضريبة"},{id:"finalTotal",labelKey:"reservations.details.labels.total",fallback:"الإجمالي النهائي"}],payment:[{id:"beneficiary",labelKey:"reservations.quote.labels.beneficiary",fallback:"اسم المستفيد"},{id:"bank",labelKey:"reservations.quote.labels.bank",fallback:"اسم البنك"},{id:"account",labelKey:"reservations.quote.labels.account",fallback:"رقم الحساب"},{id:"iban",labelKey:"reservations.quote.labels.iban",fallback:"رقم الآيبان"}],items:rr.map(({id:e,labelKey:t,fallback:n})=>({id:e,labelKey:t,fallback:n})),crew:ir.map(({id:e,labelKey:t,fallback:n})=>({id:e,labelKey:t,fallback:n}))},or=new Set(Pn.map(({id:e})=>e)),cr=Object.fromEntries(Object.entries(Na).map(([e,t=[]])=>[e,new Set(t.map(n=>n.id))]));function lr(e){switch(e){case"export":return o("reservations.quote.status.exporting","جاري تجهيز ملف PDF...");case"render":default:return o("reservations.quote.status.rendering","جاري تحديث المعاينة...")}}const bc="https://cdn.jsdelivr.net/npm/html2pdf.js@0.10.1/dist/html2pdf.bundle.min.js",vc="https://cdn.jsdelivr.net/npm/html2canvas@1.4.1/dist/html2canvas.min.js",hc="https://cdn.jsdelivr.net/npm/jspdf@2.5.1/dist/jspdf.umd.min.js",qc=fc.trim(),Sc=/color\([^)]*\)/gi,qn=/(color\(|color-mix\()/i,Ec=document.createElement("canvas"),an=Ec.getContext("2d"),dr=/^data:image\/svg\+xml/i,wc=/\.svg($|[?#])/i,Ft=512,la="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mP8/B8AAusB9YwpClgAAAAASUVORK5CYII=",ur=96,mr=25.4,da=210,cn=297,ln=Math.round(da/mr*ur),dn=Math.round(cn/mr*ur),xc=2,pr=/safari/i,Ic=/(iphone|ipad|ipod)/i,ds=/(iphone|ipad|ipod)/i,Ac=/(crios|fxios|edgios|opios)/i,Sn="[reservations/pdf]";let F=null,T=null,Le=1,Nt=null,Dt=null,Ue=null,Et=null,Ht=!1;function ct(e="render",{message:t,actionLabel:n,onAction:a,showSpinner:s=e!=="error"}={}){if(!F?.statusIndicator||!F?.statusText)return;F.statusKind=e;const r=t||lr(e);F.statusText.textContent=r,F.statusSpinner&&(F.statusSpinner.hidden=!s),F.statusAction&&(F.statusAction.hidden=!0,F.statusAction.onclick=null,n&&typeof a=="function"&&(F.statusAction.textContent=n,F.statusAction.hidden=!1,F.statusAction.onclick=i=>{i.preventDefault(),a()})),F.statusIndicator.hidden=!1,requestAnimationFrame(()=>{F.statusIndicator.classList.add("is-visible")})}function Ot(e){!F?.statusIndicator||!F?.statusText||(F.statusKind=null,F.statusIndicator.classList.remove("is-visible"),setTimeout(()=>{F?.statusIndicator&&(F.statusIndicator.hidden=!0,F.statusAction&&(F.statusAction.hidden=!0,F.statusAction.onclick=null),F.statusSpinner&&(F.statusSpinner.hidden=!1))},220))}function ua(){return!!window?.bootstrap?.Modal}function _c(e){if(e&&!e.classList.contains("show")){e.classList.add("show"),e.style.display="block",e.removeAttribute("aria-hidden"),e.setAttribute("aria-modal","true"),e.getAttribute("role")||e.setAttribute("role","dialog"),document.body.classList.add("modal-open"),Ue||(Ue=document.createElement("div"),Ue.className="modal-backdrop fade show",Ue.dataset.quotePdfFallbackBackdrop="true",document.body.appendChild(Ue)),Et||(Et=t=>{t.key==="Escape"&&ma(e)},document.addEventListener("keydown",Et));try{e.focus({preventScroll:!0})}catch{}}}function ma(e){!e||!e.classList.contains("show")||(e.classList.remove("show"),e.style.display="none",e.setAttribute("aria-hidden","true"),e.removeAttribute("aria-modal"),document.body.classList.remove("modal-open"),Ue&&(Ue.remove(),Ue=null),Et&&(document.removeEventListener("keydown",Et),Et=null))}function $c(e){if(e){if(ua()){window.bootstrap.Modal.getOrCreateInstance(e).show();return}_c(e)}}function kc(){if(Ht)return;Ht=!0;const e=o("reservations.quote.toast.viewGuide","📘 عرض دليل الحل السريع"),t=o("reservations.quote.toast.retry","إعادة المحاولة"),n=o("reservations.quote.toast.assetsFailed","⚠️ تعذر تحميل بعض الصور ضمن عرض السعر."),a=!!F?.modal?.classList.contains("show"),s=()=>{F?.modal?.classList.contains("show")&&(ct("render"),Ht=!1,gt())};Es({message:n,duration:9e3,actionLabel:a?t:void 0,onAction:a?s:void 0,linkLabel:e,linkHref:sr}),a&&ct("error",{message:n,actionLabel:t,onAction:s,showSpinner:!1})}function Da(){const e={};return Object.entries(Na).forEach(([t,n=[]])=>{e[t]=new Set(n.filter(a=>a?.default!==!1).map(a=>a.id))}),e}function fr(e={}){const t={};return Object.entries(e).forEach(([n,a])=>{t[n]=new Set(Array.from(a||[]))}),t}function Lc(e={},t){if(t)return e[t]||(e[t]=new Set),e[t]}function yr(e={},t,n){const a=e?.[t];return a?a instanceof Set?a.has(n):Array.isArray(a)?a.includes(n):!!a?.[n]:!0}function gr(){return Object.fromEntries(Pn.map(({id:e})=>[e,!1]))}function ja(e,t){return e.sectionExpansions||(e.sectionExpansions=gr()),t&&typeof e.sectionExpansions[t]!="boolean"&&(e.sectionExpansions[t]=!1),e.sectionExpansions}function Cc(e,t){return ja(e,t)?.[t]!==!1}function Fa(){return typeof window>"u"||typeof window.matchMedia!="function"?!1:window.matchMedia("(max-width: 768px)").matches}function Tc(){if(typeof navigator>"u")return!1;const e=navigator.userAgent||navigator.platform||"";return Ic.test(e)}function Pc(){if(typeof navigator>"u")return!1;const e=navigator.userAgent||"",t=pr.test(e),n=e.includes("Chrome")||e.includes("CriOS")||e.includes("Chromium"),a=e.includes("Edg");return t&&!n&&!a}function br(){return Tc()&&Pc()}function Bn(){if(typeof navigator>"u")return!1;const e=navigator.userAgent||"",t=navigator.platform||"",n=Number.isFinite(navigator.maxTouchPoints)?navigator.maxTouchPoints:0,a=ds.test(e)||ds.test(t),s=/Macintosh/i.test(e)&&n>1;return pr.test(e)&&!Ac.test(e)&&(a||s)}function Wn(e,...t){try{console.log(`${Sn} ${e}`,...t)}catch{}}function Me(e,...t){try{console.warn(`${Sn} ${e}`,...t)}catch{}}function Bc(e,t,...n){try{t?console.error(`${Sn} ${e}`,t,...n):console.error(`${Sn} ${e}`,...n)}catch{}}function Ee(e,{blockType:t="section",extraAttributes:n=""}={}){if(!e)return"";const a=n?` ${n.trim()}`:"";return e.replace(/^(<\w+)/,`$1 data-quote-block data-block-type="${t}"${a}`)}function Nc(e,t="لا توجد بيانات للعرض."){const n=k(o(e,t));return Ee(`<section class="quote-section quote-placeholder">${n}</section>`,{blockType:"placeholder"})}function us(e,t){return Array.isArray(e)&&e.length?e:[Nc(t)]}function pa(e,t="#000"){if(!an||!e)return t;try{return an.fillStyle="#000",an.fillStyle=e,an.fillStyle||t}catch{return t}}function Dc(){const e=window.html2canvas;if(!e?.Color||e.Color.__artRatioPatched)return;const t=e.Color.fromString.bind(e.Color);e.Color.fromString=n=>{try{return t(n)}catch(a){if(typeof n=="string"&&n.trim().toLowerCase().startsWith("color(")){console.warn("[quote/pdf] html2canvas color fallback",n);const s=pa(n)||"#000";try{return t(s)}catch{return t("#000")}}throw a}},e.Color.__artRatioPatched=!0}const jc=/[\u0600-\u06FF\u0750-\u077F\u08A0-\u08FF]/;function vr(e=""){return jc.test(e)}function Fc(){const e=window.CanvasRenderingContext2D?.prototype;if(!e||e.__artRatioDirectionPatched)return;const t=n=>{const a=e[n];typeof a=="function"&&(e[n]=function(r,...i){if(typeof r!="string"||!vr(r))return a.call(this,r,...i);let c,l=!1;try{"direction"in this&&(c=this.direction,c!=="rtl"&&(this.direction="rtl"),l=!0)}catch{}try{if(!l){const d=this.canvas;d&&d.style?.direction!=="rtl"&&(d.__artRatioOriginalDirection=d.style.direction,d.style.direction="rtl")}return a.call(this,r,...i)}finally{if(l&&c!==void 0&&c!=="rtl")try{this.direction=c}catch{}else if(!l){const d=this.canvas;d&&d.__artRatioOriginalDirection!==void 0&&(d.style.direction=d.__artRatioOriginalDirection,delete d.__artRatioOriginalDirection)}}})};t("fillText"),t("strokeText"),e.__artRatioDirectionPatched=!0}function hr(e){if(!e)return;const t=(n="")=>typeof n=="string"&&n.includes("color(")?n.replace(Sc,"#000"):n;e.querySelectorAll?.("style")?.forEach?.(n=>{const a=n.textContent;typeof a=="string"&&a.includes("color(")&&(n.textContent=t(a))}),e.querySelectorAll?.("[style]")?.forEach?.(n=>{const a=n.getAttribute("style");typeof a=="string"&&a.includes("color(")&&n.setAttribute("style",t(a))})}const Rc=["color","backgroundColor","borderColor","borderTopColor","borderRightColor","borderBottomColor","borderLeftColor","outlineColor","fill","stroke"];function qr(e,t=window){if(!e||!t||typeof t.getComputedStyle!="function")return;e.querySelectorAll("*").forEach(a=>{const s=t.getComputedStyle(a);if(!s)return;Rc.forEach(i=>{const c=s[i];if(c&&qn.test(c)){const l=i.replace(/[A-Z]/g,m=>`-${m.toLowerCase()}`),d=i==="backgroundColor"?"#ffffff":s.color||"#000000",u=pa(c,d);a.style.setProperty(l,u,"important")}});const r=s.backgroundImage;if(r&&qn.test(r)){const i=pa(s.backgroundColor||"#ffffff","#ffffff");a.style.setProperty("background-image","none","important"),a.style.setProperty("background-color",i,"important")}})}function Sr(e,t=window){!e||!t||typeof t.getComputedStyle!="function"||e.querySelectorAll("*").forEach(n=>{const a=t.getComputedStyle(n);if(!a)return;["color","backgroundColor","borderColor","borderTopColor","borderRightColor","borderBottomColor","borderLeftColor"].forEach(r=>{const i=a[r];if(i&&qn.test(i)){const c=r.replace(/[A-Z]/g,d=>`-${d.toLowerCase()}`),l=r==="backgroundColor"?"#ffffff":"#000000";n.style.setProperty(c,l,"important")}});const s=a.backgroundImage;s&&qn.test(s)&&(n.style.setProperty("background-image","none","important"),n.style.setProperty("background-color","#ffffff","important"))})}function ms(e,t=Ft){if(typeof e!="string"&&typeof e!="number")return t;const n=parseFloat(String(e).replace(/[^0-9.+-]/g,""));return Number.isFinite(n)&&n>0?n:t}function Mc(e){if(!e)return{width:Ft,height:Ft};const t=e.getAttribute?.("width"),n=e.getAttribute?.("height");let a=t?ms(t,0):0,s=n?ms(n,0):0;if(a>0&&s>0)return{width:a,height:s};const r=e.getAttribute?.("viewBox");if(r){const i=r.trim().split(/[\s,]+/).map(c=>parseFloat(c||"0"));if(i.length>=4){const[,,c,l]=i;a=a||(Number.isFinite(c)&&c>0?c:0),s=s||(Number.isFinite(l)&&l>0?l:0)}}return{width:a||Ft,height:s||Ft}}function Er(e=""){return typeof e!="string"?!1:dr.test(e)||wc.test(e)}function Hc(e=""){const t=e.indexOf(",");if(t===-1)return"";const n=e.slice(0,t),a=e.slice(t+1);try{return/;base64/i.test(n)?typeof atob=="function"?atob(a):"":decodeURIComponent(a)}catch(s){return console.warn("[reservations/pdf] failed to decode SVG data URI",s),""}}function Oc(e,{crossOrigin:t}={}){return new Promise((n,a)=>{const s=new Image;t&&(s.crossOrigin=t),s.onload=()=>n(s),s.onerror=r=>{const i=r?.message||`Unable to load image from ${e}`;a(new Error(i))},s.src=e})}async function wr(e,t={}){if(!e)return null;const n=document,a=new Blob([e],{type:"image/svg+xml;charset=utf-8"}),s=URL.createObjectURL(a);try{const r=await Oc(s),i=n.createElement("canvas"),c=Math.max(t.width||r.naturalWidth||r.width||0,1),l=Math.max(t.height||r.naturalHeight||r.height||c,1);i.width=c,i.height=l;const d=i.getContext("2d");return d.clearRect(0,0,c,l),d.drawImage(r,0,0,c,l),i.toDataURL("image/png")}catch(r){return console.warn("[reservations/pdf] failed to rasterize SVG content",r),null}finally{URL.revokeObjectURL(s)}}async function zc(e){if(!e)return null;if(dr.test(e))return Hc(e);try{const t=await fetch(e,{mode:"cors",credentials:"omit",cache:"default"});return t.ok?await t.text():(console.warn("[reservations/pdf] failed to fetch SVG image",e,t.status),null)}catch(t){return console.warn("[reservations/pdf] error fetching SVG image",e,t),null}}async function Vc(e){if(!e)return!1;const t=e.getAttribute?.("src")||"";if(!Er(t))return!1;const n=await zc(t);if(!n)return e.dataset.svgRasterization="failed",e.setAttribute("src",la),!1;const a=await wr(n);return a?(e.dataset.svgOriginalSrc=t,e.setAttribute("src",a),e.setAttribute("data-rasterized","true"),!0):(e.dataset.svgRasterization="failed",e.setAttribute("src",la),!1)}async function Uc(e){if(!e||e.tagName?.toLowerCase()!=="svg")return!1;const n=new XMLSerializer().serializeToString(e),a=Mc(e),s=await wr(n,a),i=(e.ownerDocument||document).createElement("img");i.setAttribute("src",s||la),i.setAttribute("alt",e.getAttribute("aria-label")||e.getAttribute("title")||""),i.setAttribute("data-svg-replaced","true"),e.hasAttribute("class")&&i.setAttribute("class",e.getAttribute("class")),e.hasAttribute("style")&&i.setAttribute("style",e.getAttribute("style"));const c=e.getAttribute("width"),l=e.getAttribute("height");return c&&i.setAttribute("width",c),l&&i.setAttribute("height",l),e.parentNode?.replaceChild(i,e),!!s}async function xr(e){if(!e)return;const t=Array.from(e.querySelectorAll?.("img")||[]),n=Array.from(e.querySelectorAll?.("svg")||[]),a=[];t.forEach(s=>{Er(s.getAttribute?.("src"))&&a.push(Vc(s))}),n.forEach(s=>{a.push(Uc(s))}),a.length&&await Promise.allSettled(a)}function Qc(e,{pixelRatio:t=1}={}){if(!e)return null;const n=e.ownerDocument||document,s=(n.defaultView||window).getComputedStyle?.(e);if(!s)return null;const r=(A,H=0)=>{const Q=parseFloat(A);return Number.isFinite(Q)?Q:H},i=r(s.paddingTop),c=r(s.paddingBottom),l=r(s.paddingRight),d=r(s.paddingLeft),u=r(s.borderRadius),m=r(s.fontSize,14),p=(()=>{const A=s.lineHeight;if(!A||A==="normal")return m*1.6;const H=r(A,m*1.6);return H>0?H:m*1.6})(),f=Math.max(e.clientWidth||0,e.scrollWidth||0,r(s.width,0));if(f<=0)return null;const g=Math.max(1,f-d-l),y=e.textContent||"",b=y.split(/\r?\n/),w=n.createElement("canvas"),h=w.getContext("2d");if(!h)return null;const I=s.fontStyle||"normal",$=s.fontVariant||"normal",D=s.fontWeight||"400",v=s.fontFamily||"sans-serif",E=s.fontStretch||"normal",_=A=>A.join(" "),C=[],R=A=>h.measureText(A).width;h.font=`${I} ${$} ${D} ${E} ${m}px ${v}`,b.forEach(A=>{const H=A.trim();if(H.length===0){C.push("");return}const Q=H.split(/\s+/);let ee=[];Q.forEach((U,oe)=>{const Y=U.trim();if(!Y)return;const re=_(ee.concat(Y));if(R(re)<=g||ee.length===0){ee.push(Y);return}C.push(_(ee)),ee=[Y]}),ee.length&&C.push(_(ee))}),C.length||C.push("");const x=i+c+C.length*p,j=Math.ceil(Math.max(1,f)*t),O=Math.ceil(Math.max(1,x)*t);w.width=j,w.height=O,w.style.width=`${Math.max(1,f)}px`,w.style.height=`${Math.max(1,x)}px`,h.scale(t,t);const M=s.backgroundColor&&s.backgroundColor!=="rgba(0, 0, 0, 0)"?s.backgroundColor:"#ffffff";if(u>0){h.save(),h.beginPath();const A=Math.max(1,f),H=Math.max(1,x),Q=Math.min(u,A/2,H/2);h.moveTo(Q,0),h.lineTo(A-Q,0),h.quadraticCurveTo(A,0,A,Q),h.lineTo(A,H-Q),h.quadraticCurveTo(A,H,A-Q,H),h.lineTo(Q,H),h.quadraticCurveTo(0,H,0,H-Q),h.lineTo(0,Q),h.quadraticCurveTo(0,0,Q,0),h.closePath(),h.clip()}if(h.fillStyle=M,h.fillRect(0,0,Math.max(1,f),Math.max(1,x)),h.font=`${I} ${$} ${D} ${E} ${m}px ${v}`,h.fillStyle=s.color||"#000000",h.textBaseline="top",h.textAlign="right","direction"in h)try{h.direction="rtl"}catch{}const P=Math.max(0,f-l);let N=i;C.forEach(A=>{const H=A.length?A:" ";h.fillText(H,P,N,g),N+=p});const z=n.createElement("img");let B;try{B=w.toDataURL("image/png")}catch(A){return Me("note canvas toDataURL failed",A),null}return z.src=B,z.alt=y,z.style.width=`${Math.max(1,f)}px`,z.style.height=`${Math.max(1,x)}px`,z.style.display="block",z.setAttribute("data-quote-note-image","true"),{image:z,canvas:w,totalHeight:x,width:f}}function Kc(e,{pixelRatio:t=1}={}){if(!e||!Bn())return;Array.from(e.querySelectorAll?.(".quote-notes")||[]).forEach(a=>{if(!a||a.dataset.quoteNoteRasterized==="true"||!vr(a.textContent||""))return;let s;try{s=Qc(a,{pixelRatio:t})}catch(r){Me("failed to rasterize note content",r),s=null}s&&(a.dataset.quoteNoteRasterized="true",a.innerHTML="",a.appendChild(s.image))})}function fa(e,t="export",{toastMessage:n,suppressToast:a=!1}={}){Bc(`${t} failed`,e);const s=!!(e&&e.__artRatioPdfNotified);if(!a&&!s){const r=o("reservations.quote.errors.exportFailed","⚠️ تعذر إنشاء ملف PDF، يرجى المحاولة مرة أخرى."),i=n||r,c=o("reservations.quote.toast.viewGuide","📘 عرض دليل الحل السريع"),l=o("reservations.quote.toast.retry","إعادة المحاولة"),d=["exportQuoteAsPdf","renderQuotePreview","layoutQuoteDocument","pageCapture"].includes(t),u=()=>{t==="exportQuoteAsPdf"?(ct("export"),Cr()):(ct("render"),Ht=!1,gt())};if(Es({message:i,duration:9e3,actionLabel:d?l:void 0,onAction:d?u:void 0,linkLabel:c,linkHref:sr}),F?.modal?.classList.contains("show")&&ct("error",{message:i,actionLabel:d?l:void 0,onAction:d?u:void 0,showSpinner:!1}),e&&typeof e=="object")try{Object.defineProperty(e,"__artRatioPdfNotified",{value:!0,writable:!1,enumerable:!1,configurable:!0})}catch{}}}function ya({container:e,safariWindowRef:t,mobileWindowRef:n}={}){try{n&&!n.closed&&n.close()}catch(a){Me("failed to close mobile window",a)}try{t&&!t.closed&&t.close()}catch(a){Me("failed to close safari window",a)}e&&e.parentNode&&e.parentNode.removeChild(e)}function Ra(e){return new Promise((t,n)=>{const a=document.querySelector(`script[src="${e}"]`);if(a){a.addEventListener("load",()=>t()),a.addEventListener("error",r=>n(r)),a.readyState==="complete"&&t();return}const s=document.createElement("script");s.src=e,s.async=!0,s.onload=()=>t(),s.onerror=r=>n(r),document.head.appendChild(s)})}function ps(){const e=[window.jspdf?.jsPDF,typeof window.jspdf=="function"?window.jspdf:null,window.jsPDF?.jsPDF,typeof window.jsPDF=="function"?window.jsPDF:null].filter(t=>typeof t=="function");return e.length?e[0]:null}function fs(){return typeof window.html2canvas=="function"?window.html2canvas:null}async function Gc(){const e=fs();return e||(Dt||(Dt=Ra(vc).catch(t=>{throw Dt=null,t}).then(()=>{const t=fs();if(!t)throw Dt=null,new Error("تعذر تحميل مكتبة html2canvas المطلوبة.");return t})),Dt)}async function Wc(){const e=ps();return e||(Nt||(Nt=Ra(hc).catch(t=>{throw Nt=null,t}).then(()=>{const t=ps();if(!t)throw Nt=null,new Error("تعذر تحميل مكتبة jsPDF المطلوبة.");return t})),Nt)}async function Xc(){if(window.html2pdf||await Ra(bc),window.html2pdf&&!window.html2pdf.__artRatioConfigured){const e=window.html2pdf.defaultOptions||window.html2pdf.defaultOpt||{},t={...e.html2canvas||{}};t.useCORS=!0,t.allowTaint=!1,t.logging=!0;const n={unit:"mm",format:"a4",orientation:"portrait",compress:!0,...e.jsPDF||{}},a={image:{type:"jpeg",quality:.95,...e.image||{}},margin:e.margin??[0,0,0,0],filename:e.filename||"document.pdf",html2canvas:t,jsPDF:n};window.html2pdf.defaultOptions=a,window.html2pdf.defaultOpt=a,window.html2pdf.__artRatioConfigured=!0}Dc(),Fc()}function k(e=""){return String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Yc(e){const t=Number(e);return!Number.isFinite(t)||t<=0?"Q-0001":`Q-${String(t).padStart(4,"0")}`}function Jc(){const e=window.localStorage?.getItem?.(ar),t=parseInt(e??"",10);return Number.isFinite(t)&&t>0?t:0}function Zc(){const t=Jc()+1;return{sequence:t,quoteNumber:Yc(t)}}function el(e){try{const t=Number(e);if(!Number.isFinite(t)||t<=0)return;window.localStorage?.setItem?.(ar,String(t))}catch(t){console.warn("⚠️ [reservations/pdf] failed to persist quote sequence",t)}}function tl(){try{const e=window.localStorage?.getItem?.(oa);if(!e)return null;const t=JSON.parse(e);return t&&typeof t=="object"?t:null}catch(e){return console.warn("⚠️ [reservations/pdf] failed to read toggle preferences",e),null}}function nl(e){try{if(!e){window.localStorage?.removeItem?.(oa);return}window.localStorage?.setItem?.(oa,JSON.stringify(e))}catch(t){console.warn("⚠️ [reservations/pdf] failed to persist toggle preferences",t)}}function al(e){if(!e)return{ids:null,emptyExplicitly:!1};if(e instanceof Set)return{ids:Array.from(e),emptyExplicitly:e.size===0};if(Array.isArray(e))return{ids:e.slice(),emptyExplicitly:e.length===0};if(typeof e=="object"){const t=Object.entries(e).filter(([,n])=>!!n);return{ids:t.map(([n])=>n),emptyExplicitly:t.length===0}}return{ids:null,emptyExplicitly:!1}}function sl(e){if(!e)return null;const t=Array.from(e.sections instanceof Set?e.sections:new Set(e.sections||[])).filter(s=>or.has(s)),n={},a=e.fields||{};return Object.entries(cr).forEach(([s,r])=>{const i=a[s];if(i==null)return;const{ids:c,emptyExplicitly:l}=al(i);if(!c&&!l)return;const d=Array.isArray(c)?c.filter(u=>r.has(u)):[];(d.length>0||l)&&(n[s]=d)}),{version:1,sections:t,fields:n}}function Ir(e){const t=sl(e);t&&nl(t)}function rl(e){if(!e)return;const t=tl();if(!t)return;const n=Array.isArray(t.sections)?t.sections.filter(a=>or.has(a)):[];if(n.length&&(e.sections=new Set(n)),t.fields&&typeof t.fields=="object"){const a=fr(e.fields||Da());Object.entries(t.fields).forEach(([s,r])=>{const i=cr[s];if(!i)return;const c=Array.isArray(r)?r.filter(l=>i.has(l)):[];a[s]=new Set(c)}),e.fields=a}}function il(e=new Date){try{return e.toLocaleDateString("en-GB",{year:"numeric",month:"2-digit",day:"2-digit"})}catch{return e.toISOString().slice(0,10)}}function Ar(e={}){const t=[e.dailyWage,e.daily_rate,e.dailyRate,e.wage,e.rate];for(const n of t){if(n==null)continue;const a=parseFloat(q(String(n)));if(Number.isFinite(a))return a}return 0}function ol(e={}){const t=[e.dailyTotal,e.daily_total,e.totalRate,e.total,e.total_wage];for(const n of t){if(n==null)continue;const a=parseFloat(q(String(n)));if(Number.isFinite(a))return a}return Ar(e)}function cl(e){const t=Gt()||[],{technicians:n=[]}=Z(),a=[].concat(Array.isArray(t)?t:[]).concat(Array.isArray(n)?n:[]),s=new Map;return a.forEach(r=>{if(!r||r.id==null)return;const i=String(r.id),c=s.get(i)||{};s.set(i,{...c,...r})}),(e.technicians||[]).map(r=>s.get(String(r))).filter(Boolean)}function ll(e,t,n){const{projectLinked:a}=Je(e,n),s=Ts(e.start,e.end),c=(Array.isArray(e.items)?e.items:[]).reduce((B,A)=>B+(Number(A?.qty)||1)*(Number(A?.price)||0),0)*s,l=t.reduce((B,A)=>B+Ar(A),0),d=t.reduce((B,A)=>B+ol(A),0),u=l*s,m=d*s,p=c+m,f=parseFloat(e.discount)||0,g=e.discountType==="amount"?f:p*(f/100),y=Math.max(0,p-g),b=a?!1:e.applyTax,w=Number(e.cost),h=Number.isFinite(w),I=e.companySharePercent??e.company_share_percent??e.companyShare??e.company_share??null,$=I!=null?parseFloat(q(String(I).replace("%","").trim())):NaN,D=e.companyShareEnabled??e.company_share_enabled??e.companyShareApplied??e.company_share_applied??null;let E=(D!=null?D===!0||D===1||D==="1"||String(D).toLowerCase()==="true":Number.isFinite($)&&$>0)&&Number.isFinite($)?Number($):0;b&&E<=0&&(E=He);let _=E>0?Math.max(0,y*(E/100)):0;_=Number(_.toFixed(2));const C=y+_;let R=b?C*.15:0;(!Number.isFinite(R)||R<0)&&(R=0),R=Number(R.toFixed(2));const x=C+R,j=Number.isFinite(x)?Number(x.toFixed(2)):0,O=a?j:h?w:j,M=Math.max(0,c+m-g),P=Math.max(0,M-u),N={equipmentTotal:c,crewTotal:m,crewCostTotal:u,discountAmount:g,subtotalAfterDiscount:y,taxableAmount:C,taxAmount:R,finalTotal:O,companySharePercent:E,companyShareAmount:_,netProfit:P},z={equipmentTotal:q(c.toFixed(2)),crewTotal:q(m.toFixed(2)),discountAmount:q(g.toFixed(2)),subtotalAfterDiscount:q(y.toFixed(2)),taxableAmount:q(C.toFixed(2)),taxAmount:q(R.toFixed(2)),finalTotal:q(O.toFixed(2)),companySharePercent:q(E.toFixed(2)),companyShareAmount:q(_.toFixed(2)),netProfit:q(P.toFixed(2))};return{totals:N,totalsDisplay:z,rentalDays:s}}function _r({reservation:e,customer:t,project:n,technicians:a,totals:s,totalsDisplay:r,rentalDays:i,currencyLabel:c,sections:l,fieldSelections:d={},quoteNumber:u,quoteDate:m,terms:p=we}){const f=q(String(e?.reservationId??e?.id??"")),g=e.start?q(Qe(e.start)):"-",y=e.end?q(Qe(e.end)):"-",b=t?.customerName||t?.full_name||t?.name||"-",w=t?.phone||"-",h=t?.email||"-",I=t?.company||t?.company_name||"-",$=q(w),D=n?.title||n?.name||o("reservations.details.project.none","غير مرتبط بمشروع"),v=n?.code||n?.projectCode||"",E=q(String(i)),_=e?.notes||"",C=Array.isArray(p)&&p.length?p:we,R=fr(d),x=(K,ce)=>yr(R,K,ce),j=K=>l?.has?.(K),O=`<div class="quote-placeholder">${k(o("reservations.quote.placeholder.noFields","لم يتم اختيار أي معلومات للعرض في هذا القسم."))}</div>`,M=(K,ce)=>`<div class="info-plain__item">${k(K)} <span class="info-plain__slash">/</span> <strong class="info-plain__value">${k(ce)}</strong></div>`,P=(K,ce,{variant:nt="inline"}={})=>nt==="final"?`<div class="totals-item totals-item--final">
    ...
    </span>`,N=(K,ce)=>`<div class="payment-row">
      <span class="payment-row__label">${k(K)}</span>
      <span class="payment-row__slash">/</span>
      <span class="payment-row__value">${k(ce)}</span>
    </div>`,z=[];x("customerInfo","customerName")&&z.push(M(o("reservations.details.labels.customer","العميل"),b)),x("customerInfo","customerCompany")&&z.push(M(o("reservations.details.labels.company","الشركة"),I)),x("customerInfo","customerPhone")&&z.push(M(o("reservations.details.labels.phone","الهاتف"),$)),x("customerInfo","customerEmail")&&z.push(M(o("reservations.details.labels.email","البريد"),h));const B=j("customerInfo")?`<section class="quote-section quote-section--plain quote-section--customer">
      ...
      </section>`:"",Q=[];x("projectInfo","projectTitle")&&Q.push(M(o("reservations.details.labels.project","المشروع"),D)),x("projectInfo","projectCode")&&Q.push(M(o("reservations.details.labels.code","الرمز"),v||"-"));const ee=j("projectInfo")?`<section class="quote-section quote-section--plain">
        ...
        ${Q.length?`<div class="info-plain">${Q.join("")}</div>`:O}
          ...
          <div class="totals-block">
        ...
        </section>`:"",ne=rr.filter(K=>x("items",K.id)),Be=ne.length>0,_e=Be?ne.map(K=>`<th>${k(K.labelKey?o(K.labelKey,K.fallback):K.fallback)}</th>`).join(""):"",fe=Array.isArray(e.items)&&e.items.length>0?e.items.map((K,ce)=>`<tr>${ne.map(nt=>`<td>${nt.render(K,ce)}</td>`).join("")}</tr>`).join(""):`<tr><td colspan="${Math.max(ne.length,1)}" class="empty">${k(o("reservations.details.noItems","📦 لا توجد معدات ضمن هذا الحجز حالياً."))}</td></tr>`,ke=j("items")?Be?`<section class="quote-section quote-section--table">
            ...
            <h3>${k(o("reservations.details.items.title","المعدات"))}</h3>
            ${O}
          </section>`:"",de=ir.filter(K=>x("crew",K.id)),ve=de.length>0,W=ve?de.map(K=>`<th>${k(K.labelKey?o(K.labelKey,K.fallback):K.fallback)}</th>`).join(""):"",se=a.length?a.map((K,ce)=>`<tr>${de.map(nt=>`<td>${nt.render(K,ce)}</td>`).join("")}</tr>`).join(""):`<tr><td colspan="${Math.max(de.length,1)}" class="empty">${k(o("reservations.details.noCrew","😎 لا يوجد فريق مرتبط بهذا الحجز."))}</td></tr>`,te=j("crew")?ve?`<section class="quote-section quote-section--table">
      ...
      </section>`:"",Oe=[];x("payment","beneficiary")&&Oe.push(N(o("reservations.quote.labels.beneficiary","اسم المستفيد"),De.beneficiaryName)),x("payment","bank")&&Oe.push(N(o("reservations.quote.labels.bank","اسم البنك"),De.bankName)),x("payment","account")&&Oe.push(N(o("reservations.quote.labels.account","رقم الحساب"),q(De.accountNumber))),x("payment","iban")&&Oe.push(N(o("reservations.quote.labels.iban","رقم الآيبان"),q(De.iban)));const Fn=`<section class="quote-section">
      ...
      </footer>`,tt=[];B&&H?tt.push(Ee(`<div class="quote-section-row">${B}${H}</div>`,{blockType:"group"})):(H&&tt.push(Ee(H)),B&&tt.push(Ee(B))),ee&&tt.push(Ee(ee));const Ct=[];ke&&Ct.push(Ee(ke,{blockType:"table",extraAttributes:'data-table-id="items"'})),te&&Ct.push(Ee(te,{blockType:"table",extraAttributes:'data-table-id="crew"'}));const Tt=[];V&&Tt.push(Ee(V,{blockType:"summary"})),et&&Tt.push(Ee(et));const Mn=[Ee(Fn,{blockType:"payment"}),Ee(Rn,{blockType:"footer"})],he=[...us(tt,"reservations.quote.placeholder.page1"),...Ct,...us(Tt,"reservations.quote.placeholder.page2"),...Mn],Hn=`
  ...
  `}function dl(e){return e?e.complete?e.naturalHeight===0?Promise.reject(new Error(`image failed to load: ${e.src||"unknown"}`)):Promise.resolve():new Promise((t,n)=>{const a=()=>{r(),t()},s=()=>{r(),n(new Error(`image failed to load: ${e.src||"unknown"}`))},r=()=>{e.removeEventListener("load",a),e.removeEventListener("error",s)};e.addEventListener("load",a,{once:!0}),e.addEventListener("error",s,{once:!0})}):Promise.resolve()}async function Vt(e){if(!e)return;const t=e.ownerDocument||document,n=t.defaultView||window,a=Array.from(e.querySelectorAll?.("img")||[]),s=t.fonts?.ready?t.fonts.ready:Promise.resolve(),r=a.map(c=>dl(c)),i=[s,...r].map(c=>c.catch(l=>(Me("asset load failed",l),kc(),null)));await Promise.all(i),await new Promise(c=>n.requestAnimationFrame(()=>c()))}async function $r(e,{context:t="preview"}={}){if(!e)return;const n=t==="preview",a=e.ownerDocument||document;e.setAttribute("data-quote-render-context",t);const s=e.querySelector("[data-quote-pages]"),r=e.querySelector("[data-quote-source]"),i=r?.querySelector("[data-quote-header-template]");if(!s||!r||!i)return;s.style.display="block",s.style.margin="0",s.style.padding="0",s.style.gap="0px",s.style.rowGap="0px",s.style.columnGap="0px",s.style.alignItems="stretch",s.style.justifyContent="flex-start",await xr(r),await Vt(r),s.innerHTML="";const c=Array.from(r.querySelectorAll(":scope > [data-quote-block]"));let l=null,d=null;const u=v=>{v.style.margin="0 auto",v.style.breakInside="avoid",v.style.pageBreakInside="avoid",v.style.pageBreakAfter="auto",v.style.breakAfter="auto"},m=()=>{const v=a.createElement("div"),E=s.childElementCount===0;if(v.className="quote-page",v.dataset.pageIndex=String(s.childElementCount),E){v.classList.add("quote-page--primary");const C=i.cloneNode(!0);C.removeAttribute("data-quote-header-template"),v.appendChild(C)}else v.classList.add("quote-page--continuation");const _=a.createElement("main");_.className="quote-body",v.appendChild(_),s.appendChild(v),u(v),l=v,d=_},p=()=>{(!l||!d||!d.isConnected)&&m()},f=()=>{if(!l||!d||d.childElementCount>0)return;const v=l;l=null,d=null,v.parentNode&&v.parentNode.removeChild(v)},g=()=>{l=null,d=null},y=()=>l?l.scrollHeight-l.clientHeight>xc:!1,b=(v,{allowOverflow:E=!1}={})=>(p(),d.appendChild(v),y()&&!E?(d.removeChild(v),f(),!1):!0),w=v=>{const E=v.cloneNode(!0);E.removeAttribute?.("data-quote-block"),E.removeAttribute?.("data-block-type"),E.removeAttribute?.("data-table-id"),!b(E)&&(g(),!b(E)&&b(E,{allowOverflow:!0}))},h=v=>{const E=v.querySelector("table");if(!E){w(v);return}const _=v.querySelector("h3"),C=E.querySelector("thead"),R=Array.from(E.querySelectorAll("tbody tr"));if(!R.length){w(v);return}let x=null,j=0;const O=(P=!1)=>{const N=v.cloneNode(!1);N.removeAttribute("data-quote-block"),N.removeAttribute("data-block-type"),N.removeAttribute("data-table-id"),N.classList.add("quote-section--table-fragment"),P&&N.classList.add("quote-section--table-fragment--continued");const z=_?_.cloneNode(!0):null;z&&N.appendChild(z);const B=E.cloneNode(!1);B.classList.add("quote-table--fragment"),C&&B.appendChild(C.cloneNode(!0));const A=a.createElement("tbody");return B.appendChild(A),N.appendChild(B),{section:N,body:A}},M=(P=!1)=>x||(x=O(P),b(x.section)||(g(),b(x.section)||b(x.section,{allowOverflow:!0})),x);R.forEach(P=>{M(j>0);const N=P.cloneNode(!0);if(x.body.appendChild(N),y()&&(x.body.removeChild(N),x.body.childElementCount||(d.removeChild(x.section),x=null,f()),g(),x=null,M(j>0),x.body.appendChild(N),y())){x.section.classList.add("quote-section--table-fragment--overflow"),j+=1;return}j+=1}),x=null};if(!c.length)return;c.forEach(v=>{v.getAttribute("data-block-type")==="table"?h(v):w(v)});const I=Array.from(s.children),$=[];if(I.forEach((v,E)=>{const _=v.querySelector(".quote-body");if(E!==0&&(!_||_.childElementCount===0)){v.remove();return}$.push(v)}),!n){const v=a.defaultView||window,E=Math.min(3,Math.max(1,v.devicePixelRatio||1)),_=Bn()?Math.min(2,E):E;$.forEach(C=>Kc(C,{pixelRatio:_}))}$.forEach((v,E)=>{const _=E===0;v.style.pageBreakAfter="auto",v.style.breakAfter="auto",v.style.pageBreakBefore=_?"auto":"always",v.style.breakBefore=_?"auto":"page",n?v.style.boxShadow="":v.style.boxShadow="none"});const D=$[$.length-1]||null;l=D,d=D?.querySelector(".quote-body")||null,await Vt(s),n&&(s.style.display="flex",s.style.flexDirection="column",s.style.alignItems="center",s.style.justifyContent="flex-start",s.style.rowGap="18px",s.style.columnGap="0px",s.style.gap="18px")}function Ma(e,t="#000000"){if(!e)return;e.querySelectorAll('[style*="color"], [class*="text"], h1, h2, h3, h4, h5, h6, p, span, th, td, li, strong, em, label, dt, dd, caption, div').forEach(a=>{a instanceof HTMLElement&&a.style.setProperty("color",t,"important")})}async function ul(e,{filename:t,safariWindowRef:n=null,mobileWindowRef:a=null}){if(!e)return;const s=Array.from(e.querySelectorAll(".quote-page"));if(!s.length)throw new Error("لا توجد صفحات لتصديرها.");const[r,i]=await Promise.all([Wc(),Gc()]),c=e.ownerDocument||document,l=c?.defaultView?.getComputedStyle?.(e)?.direction,u=[e.getAttribute?.("dir"),e.style?.direction,l,c?.documentElement?.getAttribute?.("dir")].some(v=>typeof v=="string"&&v.toLowerCase().startsWith("rtl")),m=typeof window<"u"&&window.devicePixelRatio||1,p=Fa(),f=br(),g=Bn();let y;g?y=1.5:f?y=Math.min(1.7,Math.max(1.2,m*1.1)):p?y=Math.min(1.8,Math.max(1.25,m*1.2)):y=Math.min(2,Math.max(1.6,m*1.4));const b=g||f?.9:p?.92:.95,w=new r({unit:"mm",format:"a4",orientation:"portrait",compress:!0}),h={scale:y,useCORS:!0,allowTaint:!1,backgroundColor:"#ffffff",letterRendering:!u,removeContainer:!1,logging:!0};let I=0;const $=o("reservations.quote.errors.browserLimit","تعذر إتمام عملية التحويل بسبب قيود المتصفح، يرجى إعادة المحاولة أو تقليل حجم المحتوى.");try{for(let v=0;v<s.length;v+=1){const E=s[v];await xr(E),await Vt(E);const _=E.ownerDocument||document,C=_.createElement("div");Object.assign(C.style,{position:"fixed",top:"0",left:"-12000px",pointerEvents:"none",zIndex:"-1",backgroundColor:"#ffffff"});const R=E.cloneNode(!0);R.style.width=`${ln}px`,R.style.maxWidth=`${ln}px`,R.style.minWidth=`${ln}px`,R.style.height=`${dn}px`,R.style.maxHeight=`${dn}px`,R.style.minHeight=`${dn}px`,R.style.position="relative",R.style.background="#ffffff",Ma(R),C.appendChild(R),_.body.appendChild(C);let x;try{await Vt(R),x=await i(R,{...h,scale:y,backgroundColor:"#ffffff",scrollX:0,scrollY:0})}catch(A){throw fa(A,"pageCapture",{toastMessage:$}),A}finally{C.parentNode?.removeChild(C)}if(!x)continue;const j=x.width||1,M=(x.height||1)/j;let P=da,N=P*M,z=0;if(N>cn){const A=cn/N;N=cn,P=P*A,z=Math.max(0,(da-P)/2)}const B=x.toDataURL("image/jpeg",b);I>0&&w.addPage(),w.addImage(B,"JPEG",z,0,P,N,`page-${I+1}`,"FAST"),I+=1,await new Promise(A=>window.requestAnimationFrame(A))}}catch(v){throw ya({safariWindowRef:n,mobileWindowRef:a}),v}if(I===0)throw ya({safariWindowRef:n,mobileWindowRef:a}),new Error("PDF generation produced no pages.");if(f||g){const v=w.output("blob");if(g){const E=URL.createObjectURL(v);Ot();try{window.location.assign(E)}catch(_){Me("mobile safari blob navigation failed",_)}finally{setTimeout(()=>URL.revokeObjectURL(E),6e4)}}else{const E=URL.createObjectURL(v),_=()=>f&&n&&!n.closed?n:a&&!a.closed?a:null,C=(x,j)=>{if(Ot(),!x){window.location.assign(j);return}try{x.location.replace(j),x.focus?.()}catch(O){Me("direct blob navigation failed",O);try{x.document.open(),x.document.write(`<!DOCTYPE html><html lang="ar" dir="rtl"><head><meta charset="utf-8"><title>${k(o("reservations.quote.actions.export","تنزيل PDF"))}</title><style>html,body{margin:0;height:100%;background:#0f172a;color:#f8fafc;font-family:'Tajawal',sans-serif;} iframe{border:none;width:100%;height:100%;display:block;}</style></head><body><iframe src="${j}" title="PDF preview"></iframe></body></html>`),x.document.close()}catch(M){Me("iframe blob delivery failed",M),window.location.assign(j)}}},R=_();C(R,E),setTimeout(()=>URL.revokeObjectURL(E),6e4)}}else{Ot();const v=w.output("bloburl"),E=document.createElement("a");E.href=v,E.download=t,E.rel="noopener",E.style.display="none",document.body.appendChild(E),E.click(),setTimeout(()=>{URL.revokeObjectURL(v),E.remove()},2e3)}}function gt(){if(!T||!F)return;const{previewFrame:e}=F;if(!e)return;const t=_r({reservation:T.reservation,customer:T.customer,project:T.project,technicians:T.technicians,totals:T.totals,totalsDisplay:T.totalsDisplay,rentalDays:T.rentalDays,currencyLabel:T.currencyLabel,sections:T.sections,fieldSelections:T.fields,quoteNumber:T.quoteNumber,quoteDate:T.quoteDateLabel,terms:T.terms});ct("render"),e.srcdoc=`<!DOCTYPE html>${t}`,e.addEventListener("load",async()=>{try{const n=e.contentDocument,a=n?.defaultView||window,s=n?.documentElement||n;s&&(hr(s),qr(s,a),Sr(s,a));const r=n?.getElementById("quotation-pdf-root");try{r&&(await $r(r,{context:"preview"}),Ma(r))}catch(p){console.error("[reservations/pdf] failed to layout preview document",p)}const i=Array.from(n?.querySelectorAll?.(".quote-page")||[]),c=n?.querySelector(".quote-preview-pages"),l=ln;let d=18;if(c&&n?.defaultView){const p=n.defaultView.getComputedStyle(c),f=parseFloat(p.rowGap||p.gap||`${d}`);Number.isFinite(f)&&f>=0&&(d=f)}const u=dn,m=i.length?i.length*u+Math.max(0,(i.length-1)*d):u;if(e.dataset.baseWidth=String(l),e.dataset.baseHeight=String(m),e.style.width=`${l}px`,e.style.minWidth=`${l}px`,e.style.height=`${m}px`,e.style.minHeight=`${m}px`,F?.previewFrameWrapper&&!F?.userAdjustedZoom){const p=F.previewFrameWrapper.clientWidth-24;p>0&&p<l?Le=Math.max(p/l,.3):Le=1}Lr(Le)}finally{Ot()}},{once:!0})}function ml(e){if(!T)return;const t=e.currentTarget,n=t?.dataset?.sectionId;n&&(t.checked?T.sections.add(n):T.sections.delete(n),Ir(T),kr(),gt())}function pl(e){if(!T)return;const t=e.currentTarget,n=t?.dataset?.sectionId,a=t?.dataset?.fieldId;if(!n||!a)return;const s=T.fields||(T.fields=Da()),r=Lc(s,n);t.checked?r.add(a):r.delete(a),Ir(T),gt()}function fl(e){if(!T)return;const t=e.currentTarget,n=t?.dataset?.sectionId;n&&(ja(T,n),T.sectionExpansions[n]=t.open)}function kr(){if(!F?.toggles||!T)return;const{toggles:e}=F,t=T.fields||{};ja(T);const n=Pn.map(({id:a,labelKey:s,fallback:r})=>{const i=o(s,r),c=T.sections.has(a),l=Na[a]||[],d=Cc(T,a),u=l.length?`<div class="quote-toggle-sublist">
