...
/* English layout keeps LTR alignment */
#quotation-pdf-root[data-lang="en"] .quote-section--customer,
#quotation-pdf-root[data-lang="en"] .quote-section--project {
  text-align: left !important;
  align-items: flex-start !important;
}
#quotation-pdf-root[data-lang="en"] .quote-section--customer .quote-section__title,
#quotation-pdf-root[data-lang="en"] .quote-section--project .quote-section__title {
  text-align: left !important;
}
...
#quotation-pdf-root[data-lang="en"] .quote-section--customer .info-plain__item,
#quotation-pdf-root[data-lang="en"] .quote-section--project .info-plain__item {
  justify-content: flex-start !important;
}
...
.quote-block-drag-handle:active {
  cursor: grabbing;
}

#quotation-pdf-root[data-block-drag-mode="on"] .quote-block-drag-handle {
  display: inline-flex;
}

#quotation-pdf-root[data-block-drag-mode="on"] [data-drag-key] {
