import{r as _,t as s,e as H,l as F,k as T,g as L,h as C,p as X,a as B,K as G}from"./calculations.C8eyJRj0.js";import{q as W}from"./AR-Logo-v3.5-curved-WH.BONvRdJv.js";import"./reservationsService.BZLG_R6A.js";import"./auth.Bccf-xsM.js";import"./technicians.BROQVNHZ.js";const J=`@page { size: A4; margin: 0; }
...
`)],{type:"text/csv;charset=utf-8"}),f=URL.createObjectURL(b),r=document.createElement("a");r.href=f,r.download=`${s("reservations.reports.export.filePrefix","تقرير-الحجوزات","reservations-report")}.csv`,r.style.display="none",document.body.appendChild(r),r.click(),setTimeout(()=>{URL.revokeObjectURL(f),r.remove()},1500)}}const ie=W,D="https://art-ratio.sirv.com",le="https://assets.art-ratio.com";function pe(t=""){const e=String(t||"").trim();return e?e.startsWith(D)?`${le}${e.slice(D.length)}`:e:""}function q(){try{const t=localStorage.getItem("reportsPdf.logoUrl"),e=pe(t||"");if(t&&e&&t!==e&&localStorage.setItem("reportsPdf.logoUrl",e),e&&/^https?:|^data:|^blob:/.test(e))return e}catch{}return ie}export{O as buildA4ReportPages,be as exportA4ReportCsv,ge as exportA4ReportExcel,fe as exportA4ReportPdf};
