  ...
  packagesMap.forEach(({ source: pkg, itemSource = null, normalizedId }, mapKey) => {
    ...
    const resolvePackageDescription = () => {
      ...
      const nameCandidates = [
        ...
        primarySource?.packageTitle,
        primarySource?.package_label,
        primarySource?.packageLabel,
        primarySource?.package,
        primarySource?.pkg_name,
        primarySource?.name_ar,
        primarySource?.nameAr,
        primarySource?.name_en,
        primarySource?.nameEn,
        primarySource?.title_ar,
        primarySource?.titleAr,
        primarySource?.title_en,
        primarySource?.titleEn,
        ...
        secondarySource?.packageName,
        secondarySource?.package_title,
        secondarySource?.packageTitle,
        secondarySource?.package_label,
        secondarySource?.packageLabel,
        secondarySource?.package,
        secondarySource?.pkg_name,
        secondarySource?.name_ar,
        secondarySource?.nameAr,
        secondarySource?.name_en,
        secondarySource?.nameEn,
        secondarySource?.title_ar,
        secondarySource?.titleAr,
        secondarySource?.title_en,
        secondarySource?.titleEn,
        ...
        rawEntry ? getPackageDisplayName(rawEntry) : null,
        rawEntry?.packageName,
        rawEntry?.package_title,
        rawEntry?.packageTitle,
        rawEntry?.package_label,
        rawEntry?.packageLabel,
      ];
