(() => {
  ...
  const keyedTranslations = {
    ...
    shop_add_to_request: { en: 'Add to request list', ar: 'أضف إلى قائمة الطلب' },
    shop_added: { en: 'Added', ar: 'تمت الإضافة' },
    shop_updated: { en: 'Updated', ar: 'تم التحديث' },
    shop_qty_label: { en: 'Qty', ar: 'الكمية' },
    shop_qty_controls_aria: { en: 'Quantity controls', ar: 'التحكم في الكمية' },
    shop_qty_decrease_aria: { en: 'Decrease quantity', ar: 'تقليل الكمية' },
    ...
    about_why_title: {
      en: 'We do not chase visuals for their own sake. We build work that serves the brief and stays memorable.',
    ...
    service_intro_title: {
      ...
      ar: 'نقدّم خدمات إنتاج بصري تساعد البراند يظهر بوضوح، ويبيع بثقة، ويترك أثرًا يعلق في بال الناس.',
    },
    service_intro_copy: {
      en: 'From commercials and event coverage to social content, photography, equipment support, and production consultancy, each service is built around a different stage of the production journey.',
      ar: 'من الإعلانات والتغطيات، إلى محتوى السوشال، والتصوير، ودعم المعدات، والاستشارات الإنتاجية، كل خدمة عندنا مبنية على مرحلة مختلفة من رحلة الإنتاج.',
    },
    ...
    service_contact_link_note: {
      en: 'Not sure which service fits your brief, timeline, or budget?',
      ar: 'مو متأكد أي خدمة تناسب البريف، أو الجدول، أو الميزانية؟',
    },
    service_contact_link_button: { en: 'Talk to us here', ar: 'تواصل معنا من هنا' },
    service_cta_title: {
      type: 'html',
      en: 'Need help turning the brief into the right production path? <br>Let’s point you to the service that actually fits the job.',
      ar: 'تحتاج تحدد أي مسار إنتاجي أنسب للبريف؟<br>خلّينا نوجّهك للخدمة اللي تناسب الشغل فعلًا.',
    },
    service_cta_button: { en: 'Choose the right service', ar: 'اختر الخدمة المناسبة' },
    ...
    service_events_how_we_work: {
      en: 'What your coverage can include',
      ar: 'إيش ممكن تشمل التغطية؟',
    },
    service_events_point_1: {
      en: 'Coverage planning built around the agenda, stage, and guest flow',
      ar: 'خطة تغطية مبنية على جدول الفعالية، والمسرح، وحركة الضيوف',
    },
    ...
    service_events_point_3: {
      en: 'Photography that captures details, guests, and the atmosphere of the event',
      ar: 'تصوير فوتوغرافي يوثق التفاصيل، والضيوف، وروح الفعالية',
    },
    ...
    service_events_point_5: {
      en: 'Highlight film, recap edits, and social-ready cuts',
      ar: 'فيلم هايلايت، ومقاطع تلخيص، وقصّات جاهزة للسوشال',
    },
    service_events_point_6: {
      en: 'Live streaming or stage-feed support on request',
      ar: 'دعم للبث المباشر أو تغذية المسرح عند الطلب',
    },
    ...
    service_social_faq_a1: { en: 'Both are possible. Sometimes the content is built for one platform only, and sometimes we plan it so the same production can be edited in more than one format depending on the campaign.', ar: 'الاثنين ممكن. أحيانًا ننتج المحتوى لمنصة واحدة فقط، وأحيانًا نخطط له بحيث يخدم أكثر من صيغة وأكثر من منصة حسب الحملة.' },
    ...
    service_social_faq_a2: { en: 'We can do either. If you only need execution, we handle production and editing. If you need a fuller system, we help with planning, content direction, and production rhythm across the month.', ar: 'نقدر نشتغل بالطريقتين. إذا كان المطلوب تنفيذ فقط، نتولى التصوير والمونتاج. وإذا كان المطلوب منظومة أكمل، نساعد في التخطيط، واتجاه المحتوى، وإيقاع الإنتاج خلال الشهر.' },
    ...
    service_social_faq_a3: { en: 'Yes. We usually build the plan around content pillars so the account does not feel repetitive. That can include products, service proof, founder presence, educational material, and behind-the-scenes content.', ar: 'نعم. غالبًا نبني الخطة على محاور محتوى حتى ما يصير الحساب مكرر. وهذا ممكن يشمل المنتجات، وإثبات الخدمة، وحضور المؤسس أو الفريق، والمحتوى التوعوي، والكواليس.' },
    ...
    service_social_faq_a4: { en: 'Yes, when the workflow is agreed clearly from the start. Fast-turnaround content needs a production plan that matches the speed required without hurting quality.', ar: 'نعم، إذا كان workflow متفقًا عليه من البداية بشكل واضح. المحتوى السريع يحتاج تنظيم إنتاج يناسب السرعة المطلوبة بدون ما يضرب الجودة.' },
    ...
    service_social_faq_a5: { en: 'Yes. If the brand needs a recurring visual format such as interviews, podcast clips, or hosted content, we can build the setup, visual direction, and production flow around that format.', ar: 'نعم. إذا كان البراند يحتاج صيغة بصرية متكررة مثل الحوارات، أو مقاطع بودكاست، أو المحتوى المقدم، نقدر نبني لها التجهيزات، والرؤية البصرية، وطريقة الإنتاج المناسبة.' },
    ...
    service_social_faq_a6: { en: 'Usually we align on the brand direction, target audience, required platforms, content priorities, posting rhythm, and any visual references. From there, production becomes much clearer and faster.', ar: 'عادة نحتاج نتفق على اتجاه البراند، والجمهور المستهدف، والمنصات المطلوبة، وأولويات المحتوى، وإيقاع النشر، وأي مراجع بصرية. بعد هذا يصير الإنتاج أوضح وأسرع.' },
    ...
    service_photo_heading: {
      en: 'What your commercial shoot can include',
      ar: 'إيش ممكن تشمل جلسة التصوير التجاري؟',
    },
    service_photo_point_1: {
      en: 'Hero product shots that highlight quality, finish, and key details',
      ar: 'لقطات رئيسية للمنتج تبرز الجودة، والشكل النهائي، والتفاصيل المهمة',
    },
    service_photo_point_2: {
      en: 'Catalog and e-commerce photography built for clean listing use',
      ar: 'تصوير كتالوجات ومتاجر إلكترونية بشكل مرتب وجاهز للعرض',
    },
    service_photo_point_3: {
      en: 'Campaign and key-visual photography for launches and brand pushes',
      ar: 'تصوير حملات ولقطات بصرية رئيسية للإطلاقات وتعزيز حضور البراند',
    },
    service_photo_point_4: {
      en: 'Service and industrial photography that reflects professionalism on the ground',
      ar: 'تصوير خدمات وأعمال ميدانية يعكس الاحترافية على أرض الواقع',
    },
    service_photo_point_5: {
      en: 'Food photography that makes texture, freshness, and presentation feel real',
      ar: 'تصوير أطعمة يطلع الملمس، والانتعاش، وطريقة التقديم بشكل يشهي',
    },
    service_photo_point_6: {
      en: 'Studio sessions in a controlled setup when the product needs precision',
      ar: 'جلسات داخل الاستوديو لما يكون المنتج محتاج دقة وتحكم كامل',
    },
    service_photo_point_7: {
      en: 'On-location setups when the context around the product matters',
      ar: 'تجهيز مواقع تصوير خارجية لما يكون السياق حول المنتج جزءًا من الصورة',
    },
    service_photo_details_p6: {
      en: 'We pay attention to the details that usually decide whether the image feels premium or ordinary: shadows, reflections, texture, sharpness, and color harmony with the brand.',
      ar: 'ونهتم بالتفاصيل اللي غالبًا تفرق بين صورة عادية وصورة تحسسك بقيمة المنتج: الظل، والانعكاس، والملمس، والحدة، وتناسق الألوان مع هوية البراند.',
    },
    service_photo_details_p7: {
      en: 'We also handle professional retouching so the final images are ready for e-commerce, social media, campaigns, print, and official marketing use.',
      ar: 'ونتولى المعالجة الاحترافية بحيث تكون الصور النهائية جاهزة للمتجر الإلكتروني، والسوشال ميديا، والحملات، والطباعة، والاستخدام التسويقي الرسمي.',
    },
    ...
    service_photo_showcase_title: {
      en: 'A closer look at our commercial photography work',
      ar: 'نستعرض جانبًا من أعمالنا في التصوير التجاري',
    },
    service_photo_showcase_subtitle: {
      en: 'Selected frames that show how lighting, detail, and composition can make the product feel clearer, stronger, and more ready to sell.',
      ar: 'لقطات مختارة توضح كيف ترفع الإضاءة، والتفاصيل، والتكوين قيمة المنتج وتخليه أوضح وأقرب للبيع.',
    },
    ...
    service_rental_heading: {
      en: 'What your rental can include',
      ar: 'إيش ممكن تشمل التجهيزات؟',
    },
    service_rental_point_1: {
      en: 'Cinema cameras ready for commercial and documentary production',
      ar: 'كاميرات سينمائية جاهزة للإعلانات والإنتاج الوثائقي',
    },
    service_rental_point_2: {
      en: 'Lenses matched to interviews, products, events, and branded content',
      ar: 'عدسات تناسب المقابلات، والمنتجات، والفعاليات، ومحتوى البراند',
    },
    service_rental_point_3: {
      en: 'Lighting kits for studio setups and on-location shoots',
      ar: 'تجهيزات إضاءة للاستوديو وللتصوير الخارجي',
    },
    service_rental_point_4: {
      en: 'Audio and wireless options for clear dialogue and live capture',
      ar: 'خيارات صوت ووايرلس لحوار واضح وتسجيل مباشر',
    },
    service_rental_point_5: {
      en: 'Movement and support gear including tripods, stabilizers, and grip essentials',
      ar: 'معدات حركة ودعم تشمل الترايبود، والمثبتات، واحتياجات الجريب الأساسية',
    },
    service_rental_point_6: {
      en: 'The accessories that complete the setup without last-minute gaps',
      ar: 'الملحقات اللي تكمل التجهيزات بدون نواقص آخر لحظة',
    },
    service_rental_details_p5: {
      en: 'Every item is checked before handover, packed for practical use, and ready to go straight into production.',
      ar: 'كل قطعة تُفحص قبل التسليم، وتُجهز بشكل عملي، وتكون جاهزة تدخل التصوير مباشرة.',
    },
    service_rental_details_p6: {
      en: 'If the brief is still broad, we help you choose the setup based on the project, location, crew size, and the output you need.',
    ...
    service_rental_details_p8: {
      en: 'Our role is simple: make the equipment side of your shoot clearer, calmer, and more reliable.',
    ...
    service_consult_faq_a1: { en: 'It suits brands preparing campaigns, creators who want a stronger production direction, agencies that need a second professional eye, and teams that want clearer decisions before execution.', ar: 'تناسب البراندات اللي تجهز لحملات، وصناع المحتوى اللي يبغون اتجاه إنتاج أقوى، والوكالات اللي تحتاج عين مهنية ثانية، والفرق اللي تحتاج قرارات أوضح قبل التنفيذ.' },
    service_consult_faq_q2: { en: 'When is the best time to bring you in for consultancy?', ar: 'متى أنسب وقت ندخلكم فيه للاستشارة؟' },
    service_consult_faq_a2: { en: 'The earlier the better, especially before locking the script, crew, or equipment. But consultancy is still useful if you already have a concept and want to review it before filming starts.', ar: 'كل ما كانت أبكر كان أفضل، خصوصًا قبل اعتماد السكربت أو الفريق أو المعدات. لكن الاستشارة تظل مفيدة حتى لو عندك تصور جاهز وتبغى تراجعه قبل يبدأ التصوير.' },
    ...
    service_consult_faq_a3: { en: 'The goal is not abstract advice. We help translate the direction into practical production decisions: visual approach, equipment logic, workflow, priorities, and what needs to happen next.', ar: 'الهدف مو رأي نظري وبس. نساعد نحول الاتجاه إلى قرارات إنتاج عملية: أسلوب بصري، ومنطق المعدات، وسير العمل، والأولويات، والخطوة اللي بعدها.' },
    ...
    service_consult_faq_a4: { en: 'Yes. We can step into an existing project, review what is already built, and point out what needs to be tightened visually, production-wise, or strategically before execution.', ar: 'نعم. نقدر ندخل على مشروع قائم، ونراجع اللي تم بناؤه، ونوضح ما يحتاج شد بصريًا أو إنتاجيًا أو استراتيجيًا قبل التنفيذ.' },
    ...
    service_consult_faq_a5: { en: 'Yes. One of the biggest values of consultancy is knowing where the budget should go, what equipment is actually needed, and what can be simplified without hurting the result.', ar: 'نعم. من أهم قيمة الاستشارة إننا نحدد وين تروح الميزانية، وإيش المعدات اللي يحتاجها المشروع فعلًا، وإيش ممكن يتبسط بدون ما يضر النتيجة.' },
    ...
    service_consult_faq_a6: { en: 'Absolutely. Sometimes the consultancy works best as alignment support for the internal team, helping everyone move on one clear production direction and avoid expensive missteps.', ar: 'أكيد. أحيانًا تكون الاستشارة أنسب شيء كدعم توجيهي للفريق الداخلي، بحيث يتحرك الكل على اتجاه إنتاجي واضح ويتفادى أخطاء مكلفة.' },
    ...
    service_tv_faq_a1: { en: 'We can support from the idea stage, script development, and treatment, or step into an existing concept if you already have a clear direction. The scope depends on what the project needs.', ar: 'نقدر نبدأ معك من مرحلة الفكرة، وتطوير السكريبت، والمعالجة الإخراجية، أو ندخل على فكرة جاهزة إذا كان عندكم اتجاه واضح. الشغل يتحدد حسب احتياج المشروع.' },
    ...
    feedback_form_email_optional: { en: 'Email (Optional)', ar: 'البريد الإلكتروني (اختياري)' },
    ...
    feedback_form_recommend_optional: {
      en: 'Would you recommend us? (Optional)',
      ar: 'هل توصي بخدماتنا؟ (اختياري)',
    },
    feedback_form_delivery: {
      en: 'Delivery Satisfaction*',
      ar: 'الرضا عن التسليم*',
    },
    feedback_form_service_optional: { en: 'Service Used (Optional)', ar: 'الخدمة المستخدمة (اختياري)' },
    feedback_form_comment: { en: 'Share your experience*', ar: 'شاركنا تجربتك*' },
    feedback_form_comment_placeholder: {
      en: 'Tell us what went well and what we can improve',
      ar: 'اكتب لنا ما الذي أعجبك وما الذي يمكننا تحسينه',
    },
    feedback_form_required_note: {
      en: 'Required fields: full name, overall rating, and your feedback. Email, company, service, and recommendation are optional.',
      ar: 'الحقول المطلوبة: الاسم الكامل، التقييم العام، ورأيك. البريد الإلكتروني واسم الشركة والخدمة والتوصية اختيارية.',
    },
    feedback_form_send: { en: 'Send Feedback', ar: 'إرسال التقييم' },
    feedback_form_sending: { en: 'Sending your feedback...', ar: 'جاري إرسال تقييمك...' },
    feedback_form_success: {
      en: 'Thank you for your feedback. We appreciate your time.',
      ar: 'شكرًا على تقييمك. نقدّر وقتك وملاحظاتك.',
    },
    feedback_form_error: {
      en: 'Unable to send your feedback right now. Please try again.',
      ar: 'تعذر إرسال تقييمك الآن. حاول مرة أخرى.',
    },
    feedback_select_rating: { en: 'Select rating', ar: 'اختر التقييم' },
    feedback_select_option: { en: 'Select option', ar: 'اختر خيارًا' },
    feedback_select_option_optional: { en: 'Choose option', ar: 'اختر خيارًا' },
    feedback_option_yes: { en: 'Yes', ar: 'نعم' },
    feedback_option_no: { en: 'No', ar: 'لا' },
    feedback_service_placeholder: { en: 'Choose service', ar: 'اختر الخدمة' },
    feedback_service_consultancy: { en: 'Production Consultancy', ar: 'الاستشارات الإنتاجية' },
    feedback_service_photography: { en: 'Commercial Photography', ar: 'التصوير التجاري' },
    feedback_service_events: { en: 'Events Coverage', ar: 'تغطية الفعاليات' },
    feedback_service_social: { en: 'Social Media Content', ar: 'محتوى السوشال ميديا' },
    feedback_service_tv: { en: 'TV & Commercial Ads', ar: 'الإعلانات التلفزيونية والتجارية' },
    feedback_service_rental: { en: 'Equipment Rental', ar: 'تأجير المعدات' },
    ...
    portfolio_gallery_link_note: { en: 'Looking for more photography work?', ar: 'إذا كنت تبحث عن أعمال أكثر في الصور الفوتوغرافية،' },
    portfolio_gallery_link_button: { en: 'Browse the Photo Gallery', ar: 'تصفح معرض الصور' },
    portfolio_cta_title: { type: 'html', en: 'Seen work that feels close to your project? <br>Share the idea with us, and we will help you shape the right production path.', ar: 'شفت عمل حسّيته قريب من مشروعك؟<br>شاركنا الفكرة، ونرتب معك المسار الإنتاجي الأنسب.' },
    ...
    blog1_page_title: { en: 'How Do You Choose a Professional Video Production Company for Your Project? | Art Ratio Blog', ar: 'كيف تختار شركة إنتاج فيديو احترافية لمشروعك؟ | مدونة آرت ريشيو' },
    ...
    blog1_reply_note: { en: 'Required fields: Name and Comment. Email is optional and will not be published.', ar: 'الحقول المطلوبة: الاسم والتعليق. البريد الإلكتروني اختياري ولن يتم نشره.' },
    blog1_form_name: { en: 'Name*', ar: 'الاسم*' },
    ...
    blog_comments_load_more: { en: 'Load More', ar: 'تحميل المزيد' },
    blog_comments_loading_more: { en: 'Loading...', ar: 'جاري التحميل...' },
    ...
    blog2_page_title: { en: 'Professional Product Photography | A Complete Guide for E-Commerce', ar: 'تصوير المنتجات الاحترافي: دليل شامل لنجاح متجرك الإلكتروني | مدونة آرت ريشيو' },
    ...
    blog3_page_title: { en: 'Cinematic Lighting | A Complete Guide to Professional Video Visuals', ar: 'أساسيات الإضاءة السينمائية: كيف تصنع صورة احترافية في الفيديو؟ | مدونة آرت ريشيو' },
  ...
  const localizedRouteMap = {
    ...
    'shop-wishlist.html': { en: '/en/shop-wishlist/', ar: '/ar/المفضلة/' },
    'shop-order-recived.html': { en: '/en/shop-order-recived/', ar: '/ar/تأكيد-الطلب/' },
  ...
  const initialPageLang =
    document.body &&
    document.body.dataset &&
    (document.body.dataset.initialLang || '').toLowerCase();
  const pathLang = normalizedInitialPath.startsWith('/en') || normalizedInitialPath.includes('/dist/public-localized/en/')
    ? 'en'
    : normalizedInitialPath.includes('/dist/public-localized/ar/')
      ? 'ar'
      : '';
  let currentLang =
    forcedLang ||
    (initialPageLang === 'en' || initialPageLang === 'ar' ? initialPageLang : '') ||
    pathLang ||
