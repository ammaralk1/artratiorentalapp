(() => {
  ...
  const keyedTranslations = {
    ...
    terms_page_title: { en: 'Terms of Use | Art Ratio', ar: 'شروط الاستخدام | آرت ريشو' },
    ...
    portfolio2_page_title: { en: 'Portfolio 2 | Art Ratio', ar: 'أعمالنا 2 | آرت ريشو' },
    portfolio2_hero_title: { en: 'Portfolio 2', ar: 'أعمالنا 2' },
    portfolio3_page_title: { en: 'Portfolio 3 | Art Ratio', ar: 'أعمالنا 3 | آرت ريشو' },
    portfolio3_hero_title: { en: 'Portfolio 3', ar: 'أعمالنا 3' },
    portfolio4_page_title: { en: 'Portfolio 4 | Art Ratio', ar: 'أعمالنا 4 | آرت ريشو' },
    portfolio4_hero_title: { en: 'Portfolio 4', ar: 'أعمالنا 4' },
    portfolio5_page_title: { en: 'Portfolio 5 | Art Ratio', ar: 'أعمالنا 5 | آرت ريشو' },
    portfolio5_hero_title: { en: 'Portfolio 5', ar: 'أعمالنا 5' },
    portfolio6_page_title: { en: 'Portfolio 6 | Art Ratio', ar: 'أعمالنا 6 | آرت ريشو' },
