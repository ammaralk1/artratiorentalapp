(() => {
  ...
  const localizedRouteMap = {
    ...
    // Shop routes use localized language prefix with stable ASCII slugs.
    'shop.html': { en: '/en/shop/', ar: '/ar/shop/' },
    'shop-cart.html': { en: '/en/shop-cart/', ar: '/ar/shop-cart/' },
    'shop-checkout.html': { en: '/en/shop-checkout/', ar: '/ar/shop-checkout/' },
    'shop-product-details.html': { en: '/en/shop-product-details/', ar: '/ar/shop-product-details/' },
    'shop-wishlist.html': { en: '/en/shop-wishlist/', ar: '/ar/shop-wishlist/' },
    'shop-order-recived.html': { en: '/en/shop-order-recived/', ar: '/ar/shop-order-recived/' },
