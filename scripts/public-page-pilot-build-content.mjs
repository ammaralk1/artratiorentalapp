export const PILOT_KEYED_TRANSLATIONS = Object.freeze({
  ...
  privacy_heading: { en: 'Privacy Policy', ar: 'سياسة الخصوصية' },
  privacy_intro_full: {
  ...
  privacy_legal_kicker: { en: 'Legal', ar: 'قانوني' },
  privacy_legal_meta_html: {
    type: 'html',
  ...
  terms_heading: { en: 'Terms of Use', ar: 'شروط الاستخدام' },
  terms_intro_full_1: {
  ...
  terms_legal_kicker: { en: 'Legal', ar: 'قانوني' },
  terms_legal_meta_html: {
    type: 'html',
    ar: `<span><strong>تاريخ السريان:</strong> 9 مارس 2026</span>
        <span><strong>رقم السجل التجاري:</strong> 7030880632</span>
        <span><strong>رقم رخصة الإعلام:</strong> 159460</span>
  ...
  faq_breadcrumb: { en: 'FAQ', ar: 'الأسئلة الشائعة' },
  faq_category_delivery: { en: 'Project delivery', ar: 'تسليم المشروع' },
  faq_category_documentation: { en: 'Documentation', ar: 'التوثيق' },
  faq_category_pricing: { en: 'Pricing', ar: 'التسعير' },
  ...
  faq_q4: { en: 'Can you tell me please how to contact for project?', ar: 'كيف يمكنني التواصل معكم بخصوص مشروع؟' },
  faq_q5: { en: 'Do you makes custom logo, icon etc?', ar: 'هل تقدمون تصميم شعارات وأيقونات مخصصة؟' },
  ...
  contact_services_link_note: {
    ...
    ar: 'إذا لسه تقارن بين الخيارات، تصفح <a href="service.html">خدماتنا</a> أولًا.',
  },
  ...
  shop_breadcrumb: { en: 'Equipment List', ar: 'معداتنا' },
  shop_categories_title: { en: 'Categories', ar: 'التصنيفات' },
  shop_loading_equipment: { en: 'Loading equipment…', ar: 'جاري تحميل المعدات…' },
  ...
  shop_product_details_intro_1: {
    en: 'This sample equipment page presents the item in a straightforward format with reference visuals, basic specs, and a layout ready for request-oriented browsing.',
    ar: 'تعرض صفحة المعدة هذه العنصر بصيغة مباشرة تتضمن صورًا مرجعية ومعلومات أساسية وتخطيطًا مناسبًا للتصفح قبل إرسال الطلب.',
  },
  shop_product_details_intro_2: {
    en: 'It is built to give teams a quick sense of the item, its presentation context, and the kind of supporting information they can review before confirming rental needs.',
    ar: 'وهي مصممة لتعطي الفريق تصورًا سريعًا عن المعدة وسياق عرضها ونوع المعلومات المساندة التي يمكن مراجعتها قبل تأكيد الاحتياج التأجيري.',
  },
  shop_product_details_page_title: { en: 'Equipment Details | Art Ratio', ar: 'تفاصيل المعدة | آرت ريشيو' },
  shop_product_details_price: { en: '$20.00', ar: '$20.00' },
  shop_product_details_sku: { en: 'SKU: 0215552', ar: 'رمز الصنف: 0215552' },
  shop_product_details_tags: { en: 'Tags: Design, Brand, Clothing', ar: 'الوسوم: تصميم، علامة تجارية، ملابس' },
  shop_product_details_title: { en: 'Awesome men t-shirt', ar: 'تيشيرت رجالي مميز' },
  shop_product_form_consent: {
    en: 'By using this form you agree with the storage and handling of your data by this website. *',
    ar: 'باستخدام هذا النموذج فأنت توافق على حفظ بياناتك ومعالجتها من قبل هذا الموقع. *',
  },
  shop_product_info_color_label: { en: 'Color', ar: 'اللون' },
  shop_product_info_color_value: { en: 'Blue, Gray, Green, Red, Yellow', ar: 'أزرق، رمادي، أخضر، أحمر، أصفر' },
  shop_product_info_size_label: { en: 'Size', ar: 'المقاس' },
  shop_product_info_size_value: { en: 'Large, Medium, Small', ar: 'كبير، متوسط، صغير' },
  shop_product_email_placeholder: { type: 'attr', attr: 'placeholder', en: 'Your email *', ar: 'بريدك الإلكتروني *' },
  shop_product_name_placeholder: { type: 'attr', attr: 'placeholder', en: 'Your name *', ar: 'اسمك *' },
  shop_product_rating_label: { en: 'Your rating *', ar: 'تقييمك *' },
  shop_product_review_date: { en: 'August 12, 2023', ar: '12 أغسطس 2023' },
  shop_product_review_email_placeholder: { type: 'attr', attr: 'placeholder', en: 'Your email *', ar: 'بريدك الإلكتروني *' },
  shop_product_review_name: { en: 'Zhon Abony', ar: 'جون أبوني' },
  shop_product_review_note: {
    en: 'Your email address will not be published. Required fields are marked *',
    ar: 'لن يتم نشر بريدك الإلكتروني. الحقول المطلوبة مميزة بعلامة *',
  },
  shop_product_review_placeholder: { type: 'attr', attr: 'placeholder', en: 'Write your review *', ar: 'اكتب مراجعتك *' },
  shop_product_review_submit: { en: 'Submit', ar: 'إرسال' },
  shop_product_review_text: {
    en: 'A clean presentation and a useful level of detail. The page makes it easy to understand the item and review the supporting information before making a request.',
    ar: 'عرض مرتب ومستوى التفاصيل فيه مناسب. الصفحة تسهّل فهم العنصر ومراجعة المعلومات المساندة قبل إرسال الطلب.',
  },
  shop_product_search_placeholder: { type: 'attr', attr: 'placeholder', en: 'Search Products...', ar: 'ابحث عن المعدات...' },
  shop_product_tab_additional: { en: 'Additional information', ar: 'معلومات إضافية' },
  shop_product_tab_description: { en: 'Description', ar: 'الوصف' },
  shop_product_tab_description_body: {
    en: 'This public equipment detail page presents an example rental item with reference visuals, practical notes, and supporting information to help teams review the listing before making a request.',
    ar: 'تعرض صفحة تفاصيل المعدة هذه مثالًا لعنصر تأجير مع صور مرجعية وملاحظات عملية ومعلومات مساندة تساعد الفرق على مراجعة العرض قبل إرسال الطلب.',
  },
  shop_product_tab_review: { en: 'Review (1)', ar: 'مراجعة (1)' },
  shop_search_placeholder: { type: 'attr', attr: 'placeholder', en: 'Search Products...', ar: 'ابحث عن المعدات...' },
